...
-   Shaders: Pass UNITY_SHADOW_W as-is on HLSLcc targets([1206092](https://issuetracker.unity3d.com/issues/shadowmask-shadow-doesnt-know-how-to-be-a-shadow))
...
-   MacOS: \[URP\]\[macOS\] Game View is overlayed by background color when Background Type Solid Color property is selected([1210093](https://issuetracker.unity3d.com/issues/urp-macos-game-view-is-overlayed-by-background-color-when-background-type-solid-color-property-is-selected))
