...
*   Editor: Fixed bad clipping behavior when modifying GUI.matrix [(904987)](https://issuetracker.unity3d.com/issues/gui-elements-get-clipped-when-modifying-the-gui-dot-matrix)
