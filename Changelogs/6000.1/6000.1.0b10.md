...
- Graphics: Implemented a workaround for Vulkan MSAA resolve subpass issue on Adreno GPUs.
    ([UUM-95529](https://issuetracker.unity3d.com/issues/vulkan-cameraopaquetexture-produces-a-feedback-effect-on-android-adreno-devices-when-using-vulkan))    <br>*Fixed in 6000.1.0b11.*
...
- Mobile: Fixed an issue where user certificates were included in the app by default.
    ([UUM-97194](https://issuetracker.unity3d.com/issues/android-ios-unitywebrequest-requests-with-unitywebrequest-are-open-for-ssl-proxying))    <br>*Fixed in 6000.1.0b11.*
...
- Scene/Game View: Fixed a bug where using the public `ContextMenuUtility` API could cause the Editor to eventually crash.
    ([UUM-98587](https://issuetracker.unity3d.com/issues/crash-on-multiple-stack-traces-when-doing-actions-with-probuilder))    <br>*Fixed in 6000.1.0b11.*
...
- UI Toolkit: Fixed UI Toolkit player hang on Safari WebGL.
    ([UUM-90736](https://issuetracker.unity3d.com/issues/ios-webgl-player-freezes-when-multiple-properties-of-a-visualelement-are-changed-at-the-same-time))    <br>*Fixed in 6000.1.0b11.*

- VFX Graph: Fixed an unexpected compilation failure.
    (UUM-97805)    <br>*Fixed in 6000.1.0b11.*

- 



### New 6000.1.0b10 Entries since 6000.1.0b9
...
- Editor: Fixed a issue causing raytrace shaders to be imported incorrectly in the Editor if the target platform didn't support ray tracing \(e.g. Nintendo Switch\). Now, ray tracing can be used in the Editor even if the target platform doesn't support ray tracing.
    (UUM-91762)<br>
...
- Editor: Fixed an issue where the placeholder not showing after deleting text in numeric fields on mobile.
    (UUM-92246)<br>
...
- Editor: Fixed issues where IMGUI input fields did not update properly when using methods such as Paste and Cut.
    ([UUM-95908](https://issuetracker.unity3d.com/issues/inspector-window-tag-search-bar-is-not-populated-with-the-copy-pasted-text-when-using-ctrl-plus-v-to-paste-a-tag-name))<br>
...
- Editor: \[Build Profiles\] Creating and renaming Build Profile assets through the Build Profile window will remove all leading and trailing whitespaces.
    (UUM-95994)<br>
...
- IMGUI: Fixed ScrollWheel Event keyCode when the shift modifier was active.
    ([UUM-98452](https://issuetracker.unity3d.com/issues/wheel-up-interpreted-as-wheel-down-when-setting-up-a-shortcut-and-a-shift-modifier-is-included))<br>
    *First seen in 6000.1.0b6.*
...
- UI: Fixed scrollbar thickness on the Platform Discovery window.
    ([UUM-93878](https://issuetracker.unity3d.com/issues/the-dividing-line-in-platform-browser-window-is-wider-slash-brighter-than-in-the-build-profiles-window))<br>
    *First seen in 6000.1.0b3.*
...
#### New 6000.1.0b10 Package Changes since 6000.1.0b9

#### Packages updated

- com.unity.2d.aseprite: [1.2.1](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.2//changelog/CHANGELOG.html) to [1.2.2](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.2//changelog/CHANGELOG.html)
...
- com.unity.xr.arcore: [6.1.0-pre.5](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html) to [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.1.0-pre.5](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html) to [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.1.0-pre.5](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html) to [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html)
...
### Preview of Final 6000.1.0b10 Release Notes
...
#### Preview of Final 6000.1.0b10 Package changes
...
- com.unity.2d.aseprite: [1.1.6](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.1//changelog/CHANGELOG.html) to [1.2.2](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.2//changelog/CHANGELOG.html)

- com.unity.adaptiveperformance: [5.1.0](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance@5.1//changelog/CHANGELOG.html) to [5.1.2](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance@5.1//changelog/CHANGELOG.html)
...
- [com.unity.project-auditor@1.0.0](https://docs.unity3d.com/Packages/com.unity.project-auditor@1.0//changelog/CHANGELOG.html)
