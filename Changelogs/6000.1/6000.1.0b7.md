...
- Animation: Fixed an issue where having a Blend Tree State opened in the Animator Window while the AnimatorController is not in the scene and going into Playmode will throw "BlendTreeWorkspace is NULL" error.
    ...
    *First seen in 6000.1.0b3.*    <br>*Fixed in 6000.1.0b8.*
...
- Editor: Fixed an issue that would cause the editor to throw a null reference exception when selecting a Video Clip.
    (UUM-83274)    <br>*Fixed in 6000.1.0b8.*
...
- Scripting: Fixed crash on reimport after High Definition RP package removal.
    ([UUM-78164](https://issuetracker.unity3d.com/issues/crash-on-unityeditor-dot-assetdatabase-stopassetediting-when-removing-hdrp-package-after-having-imported-water-samples))    <br>*Fixed in 6000.1.0b8.*
...
- VFX Graph: Fixed errors that occurred when deleting Integration Update Rotation and Trigger blocks in the VFX Graph.
    ([UUM-95698](https://issuetracker.unity3d.com/issues/creating-and-then-deleting-the-integration-update-rotation-block-breaks-and-makes-unusable-vfx-graph))    <br>*Fixed in 6000.1.0b8.*
...
- VFX Graph: Fixed glitch with GPU events and strips, when the parent system particle count exceeds child system strip capacity.
    ...
    *First seen in 6000.1.0b6.*    <br>*Fixed in 6000.1.0b8.*
...
### New 6000.1.0b7 Entries since 6000.1.0b6
...
- Core: Fixed a Variable Rate Shading \(VRS\) warning about ResetShadingRate inside a render pass.
    (UUM-87671)<br>
...
- HDRP: Fixed a Sensor SDK compilation issue in DXR-enabled HDRP projects.
...
#### New 6000.1.0b7 Package Changes since 6000.1.0b6

#### Packages updated

- com.unity.learn.iet-framework: [4.0.4](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.0//changelog/CHANGELOG.html) to [4.1.0](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.1//changelog/CHANGELOG.html)
...
### Preview of Final 6000.1.0b7 Release Notes
...
#### Preview of Final 6000.1.0b7 Package changes
