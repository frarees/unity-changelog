...
- Asset Bundles: Fixed a race condition that occurred when loading AssetBundles using `AssetBundle.LoadFromStream`.
    (UUM-92381)    <br>*Fixed in 6000.1.0b5.*
...
- Editor: Fixed a memory leak in the Line Renderer component.
    ([UUM-91900](https://issuetracker.unity3d.com/issues/a-memory-leak-occurs-in-play-mode-when-using-direct3d12-graphics-api))    <br>*Fixed in 6000.1.0b5.*
...
- Editor: Fixed an issue where navigating the Scene view with a pen tablet stopped working after returning to the Editor from another application.
    ([UUM-90436](https://issuetracker.unity3d.com/issues/can-not-navigate-through-the-scene-view-when-using-a-drawing-tablet))    <br>*Fixed in 6000.1.0b5.*
...
- Editor: Fixed an issue where vertex snapping did not work in the Scene view for objects rendered using the GPU Resident Drawer.
    ([UUM-66422](https://issuetracker.unity3d.com/issues/vertex-snapping-doesnt-work-when-the-gpu-resident-drawer-is-enabled))    <br>*Fixed in 6000.1.0b5.*
...
- GI: Fixed an issue where lighting data was missing for scenes loaded from asset bundles in the Editor.
    (UUM-93115)    <br>*Fixed in 6000.1.0b5.*
...
- Graphics: Fixed a crash that occurred in the Editor and Player when encountering Unicode characters.
    ...
    *First seen in 6000.1.0a8.*    <br>*Fixed in 6000.1.0b5.*

- Input System: Fixed an issue where the Player failed to exit when using the new Input System on Windows 11 \(24H2\).
    ([UUM-91181](https://issuetracker.unity3d.com/issues/player-exe-remains-open-as-a-background-task-after-closing-it-when-active-input-handling-is-set-to-input-system-package-new))    <br>*Fixed in 6000.1.0b5.*
...
- Shadergraph: Fixed an issue where the Console logged the error "Element 'UnityEditor.UIElements.VisualSplitter' is missing a UxmlElementAttribute" when creating a new node in Shader Graph.
    ...
    *First seen in 6000.1.0a9.*    <br>*Fixed in 6000.1.0b5.*
...
- UI Toolkit: Fixed an issue where docking, maximizing and minimizing the UI Builder window would throw an exception.
    ([UUM-93248](https://issuetracker.unity3d.com/issues/assertionexception-assertion-failure-value-was-false-error-is-thrown-when-unmaximizing-a-docked-ui-builder-window))    <br>*Fixed in 6000.1.0b5.*
...
### New 6000.1.0b4 Entries since 6000.1.0b3
...
- 2D: Fixed when the user sets a manual Cell Size for the Grid of the TileSet palette, the Tile Assets are placed based on calculation of their size instead of the manual Cell Size. Now, these Tiles will be placed based on the manual Cell Size.
    (UUM-92859)<br>
    *First seen in 6000.1.0b1.*
...
- Editor: Fixed "Incompatible keyword states" errors at editor startup.
    ([UUM-91635](https://issuetracker.unity3d.com/issues/encountering-incompatible-keyword-states-error-for-shaders-when-launching-the-editor))<br>
    *First seen in 6000.1.0a10.*

- Editor: Fixed an issue where the Shortcut HelperBar could not be reactivated after being disabled in the preferences.
...
- Editor: Fixed Gizmo text issue when using fallbacks.
    ([UUM-92305](https://issuetracker.unity3d.com/issues/text-overlaps-when-displaying-cjk-and-latin-characters-on-gameobject-label-icons))<br>
    *First seen in 6000.1.0b1.*
...
- Scene/Game View: Fixed an issue where it was not possible to open the layer and gizmos dropdowns more than one time.
    ([UUM-92742](https://issuetracker.unity3d.com/issues/scene-gizmo-dropdown-only-works-once-after-domain-reload))<br>
...
- Shadergraph: Fixed an issue where the Create Node menu could become stuck if it is visible when Shader Graph is closed.
...
- UI Toolkit: Fixed hover state of element under pointer after MouseLeaveWindowEvent.
    ([UUM-92876](https://issuetracker.unity3d.com/issues/play-button-remain-highlighted-unless-hovered-on-the-toolbar-after-exiting-the-play-mode))<br>
    *First seen in 6000.1.0b2.*
...
#### New 6000.1.0b4 Package Changes since 6000.1.0b3
...
- com.unity.localization: [1.5.3](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html) to [1.5.4](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html)

### Preview of Final 6000.1.0b4 Release Notes
...
- Editor: Changed canRunInBackground to false for Windows Gaming Input gamepads since they cannot be used while the application is in background.
    ([UUM-85399](https://issuetracker.unity3d.com/issues/the-player-does-not-receive-gamepad-input-when-the-window-is-in-the-background))
...
#### Preview of Final 6000.1.0b4 Package changes
...
- com.unity.xr.arcore: [6.0.3](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.0//changelog/CHANGELOG.html) to [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.0.3](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.0//changelog/CHANGELOG.html) to [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.0.3](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.0//changelog/CHANGELOG.html) to [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html)
...
- [com.unity.web.stripping-tool@1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.web.stripping-tool@1.0//changelog/CHANGELOG.html)
