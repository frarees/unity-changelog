...
- IL2CPP: Fix fields of field types on serialized types being stripped in some cases.
    (UUM-90024)    <br>*Fixed in 6000.1.0b3.*
...
- Shaders: Fixed an assertion being triggered when switching the build target from Windows to Android.
    ...
    *First seen in 6000.1.0a9.*    <br>*Fixed in 6000.1.0b3.*
...
- Universal RP: Fixed URP RenderGraph case with MSAA and camera stacking on Windows Player.
    ([UUM-85050](https://issuetracker.unity3d.com/issues/the-scene-does-not-get-rendered-in-the-player-when-msaa-is-enabled-and-more-than-one-camera-is-used))    <br>*Fixed in 6000.1.0b3.*

- VFX Graph: Fix NullReferenceExpection happening with disconnected output contexts.
    ([UUM-92319](https://issuetracker.unity3d.com/issues/nullreferenceexception-and-temporary-graph-corruption-after-entering-playmode-if-output-node-connection-was-changed))    <br>*Fixed in 6000.1.0b3.*
...
- Editor: Creating a new script from the *AddComponent* menu now opens a dialog where you can choose a save location for the new script.
    (UUM-91424)<br>
...
- Editor: Fixed an issue where creating a new script with the Add Component menu didn't handle path separators correctly and appended two '.' for the path extension.
    (UUM-91878)<br>
...
- Editor: Fixed an issue where the title bar and about box mentions Alpha instead of Beta.
    (UUM-91786)<br>
...
- Editor: Fixed offset of toolbar's popup overlay \(top bar specifically\).
    (UUM-85320)<br>
    *First seen in 6000.1.0a1.*
...
- Editor: Fixed the layout of the Name and Configuration fields in the Platform Browser.
    (UUM-91791)<br>
    *First seen in 6000.1.0a10.*

- Editor: Fixed the period character to be used in a class name when creating a new script via the AddComponent menu.
    (UUM-92140)<br>
    *First seen in 6000.1.0b2.*
...
- Multiplayer: Fixed Dedicated Server to ensure that stripping respects quality settings set in the Project settings.
    (UUM-92239)<br>
...
- com.unity.xr.arcore: [6.0.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.0//changelog/CHANGELOG.html) to [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.0.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.0//changelog/CHANGELOG.html) to [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.0.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.0//changelog/CHANGELOG.html) to [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html)
