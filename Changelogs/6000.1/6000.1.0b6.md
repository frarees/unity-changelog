...
- DX12: Fixed an issue where released textures' memory accumulated when the Editor was out of focus.
    ([UUM-86354](https://issuetracker.unity3d.com/issues/allocated-graphics-memory-does-not-get-released-when-the-editor-is-out-of-focus-while-using-d3d12-graphics-api))    <br>*Fixed in 6000.1.0b7.*
...
- Editor: Fixed an issue where the Sprite Atlas Importer did not correctly apply texture platform settings for certain platforms \(such as iOS\) and prevented editing through the Inspector window or relevant APIs.
    ([UUM-90066](https://issuetracker.unity3d.com/issues/sprite-atlas-override-for-ios-setting-remains-disabled-when-saving-its-change-to-enabled))    <br>*Fixed in 6000.1.0b7.*
...
- Physics: Fixed a PhysX error that stated "Failed to create Convex Mesh from source mesh" which appeared when looking around the Scene view while having the Physics Debug tab open.
    ([UUM-93081](https://issuetracker.unity3d.com/issues/failed-to-create-convex-mesh-from-source-mesh-physx-errors-are-thrown-when-looking-around-the-scene-view-while-collision-geometry-is-set-to-true))    <br>*Fixed in 6000.1.0b7.*
...
- VFX Graph: Fixed an issue where the VFX Graph template window appeared empty when the Terrain Tools package was installed.
    ([UUM-95871](https://issuetracker.unity3d.com/issues/vfx-template-window-is-empty-because-of-an-exception))    <br>*Fixed in 6000.1.0b7.*
...
- Visual Effects: [VFX Graph] GpuEvent Strip and Instancing issue
...
### New 6000.1.0b6 Entries since 6000.1.0b5
...
- Editor: Fixed an issue by modifing the placement of presets dragged into the Hierarchy window to respect Scene view placement preferences.
    (UUM-92971)<br>
...
- Scene/Game View: Fixing DebugDrawMode toggle throwing exception in the console.
    (UUM-96180)<br>
...
- VFX Graph: Fixed VFX ray tracing shader errors when using flipbook or when not using the color attribute.
    ([UUM-92519](https://issuetracker.unity3d.com/issues/build-and-run-player-results-in-shader-errors-when-raytracing-is-enabled))<br>
    *First seen in 6000.1.0b2.*
...
- XR: Fixed incorrect Y-axis flipping that affected certain Quest devices using shared depth buffer or depth submission modes with Quest Link.
    ([UUM-85895](https://issuetracker.unity3d.com/issues/quest-depth-buffer-is-inverted-when-using-shared-depth-buffer-or-depth-submission-mode-with-oculus-xr-or-openxr))<br>
...
#### New 6000.1.0b6 Package Changes since 6000.1.0b5
...
### Preview of Final 6000.1.0b6 Release Notes
...
#### Preview of Final 6000.1.0b6 Package changes
