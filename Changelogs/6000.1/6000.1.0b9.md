...
- Editor: Fixed a issue causing raytrace shaders to be imported incorrectly in the Editor if the target platform didn't support ray tracing \(e.g. Nintendo Switch\). Now, ray tracing can be used in the Editor even if the target platform doesn't support ray tracing.
    (UUM-91762)<br>
    *First seen in 6000.1.0a6.*    <br>*Fixed in 6000.1.0b10.*
...
- GI: Reverted a change to packing made in Unity 6, which based lightmap packing order on the positions of lightmapped objects in the scene. This didn't have the intended effect, and significantly worsened utilization of lightmap space.
    ([UUM-96033](https://issuetracker.unity3d.com/issues/lightmap-packing-no-longer-packs-the-islands-in-the-order-of-biggest-to-smallest-resulting-in-a-worse-packing))    <br>*Fixed in 6000.1.0b10.*
...
- Package Manager: Fixed an issue where switching Projects during the import of a complete Project prevented all assets from importing, causing the Project to open incomplete.
    ([UUM-88051](https://issuetracker.unity3d.com/issues/switching-project-when-importing-complete-project-does-not-import-all-assets-and-project-opens-incomplete))    <br>*Fixed in 6000.1.0b10.*
...
- Serialization: Fixed an issue where the UniversalRenderPipelineGlobalSettings.asset file created unnecessary changes in the Git diff during Player builds.
    ([UUM-80052](https://issuetracker.unity3d.com/issues/the-universalrenderpipelineglobalsettings-dot-asset-is-creating-noise-in-the-git-diff-when-building-a-player))    <br>*Fixed in 6000.1.0b10.*
...
- UI Toolkit: Fixed click not working after an element is removed from its panel without releasing its pointer capture.
    ([UUM-98080](https://issuetracker.unity3d.com/issues/ui-toolkit-buttons-stop-receiving-inputs-when-entering-the-new-scene-while-holding-a-button-during-scene-change))    <br>*Fixed in 6000.1.0b10.*
...
- Web: Fix freeze on startup when decompression fallback is enabled and multithreading is disabled.
    ([UUM-98296](https://issuetracker.unity3d.com/issues/the-player-freezes-on-load-when-building-web-platform))    <br>*Fixed in 6000.1.0b10.*
...
### New 6000.1.0b9 Entries since 6000.1.0b8
...
- 2D: Fixed an issue by adding PositionTileTemplate as an example for specifying where to place Tile assets in the Tile Palette.
    (UUM-95996)<br>
...
- Editor: Fixe Long names when creating Build Profiles caused errors in the console and failure to create build profiles.
    ([UUM-95787](https://issuetracker.unity3d.com/issues/really-long-build-profile-name-causes-errors-in-the-console-or-fatal-error-by-quitting-the-workflow))<br>
...
- Editor: Fixed an issue when creating Build profile, the name TextField would overflow the window if too long name entered.
    ([UUM-95776](https://issuetracker.unity3d.com/issues/longer-build-name-exceeds-the-available-display-area-in-the-window))<br>
    *First seen in 6000.1.0b4.*
...
- Editor: Fixed Long build titles don't fit in the "Publish to Play" window \(accessible via the Build Profiles window with a Web build profile selected\).
    ([UUM-95440](https://issuetracker.unity3d.com/issues/long-build-titles-dont-fit-in-the-publish-to-unity-play-window))<br>
    *First seen in 6000.1.0b3.*
...
#### New 6000.1.0b9 Package Changes since 6000.1.0b8
...
### Preview of Final 6000.1.0b9 Release Notes
...
#### Preview of Final 6000.1.0b9 Package changes
