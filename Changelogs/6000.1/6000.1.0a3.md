...
- Graphics: Fix GUID conflict on the default volume profile between URP template and URP package.
    ...
    *First seen in 6000.1.0a2.*    <br>*Fixed in 6000.1.0a4.*

- Shaders: fixed a rare crash when saving the tracked shader variants into a variant collection.
    ([UUM-86510](https://issuetracker.unity3d.com/issues/editor-crash-when-saving-currently-tracked-variants-to-asset))    <br>*Fixed in 6000.1.0a4.*

- Shaders: Fixed editor rendering cyan on game/scene view at each editor startup.
    ([UUM-75262](https://issuetracker.unity3d.com/issues/shaders-are-always-recompiled-when-the-editor-is-opened))    <br>*Fixed in 6000.1.0a4.*
...
- Android: Fixed an issue where the application loses full-screen rendering on Android 11 or newer versions when the device is in overview mode.
    (UUM-85067)<br>
...
- Editor: Fixed issue where the adding of search terms in the object selector would pop open a menu that would not close along with the object selector.
    (UUM-84853)<br>
...
- Editor: \[WebGPU\] Fixed error with write_buffer for memory addresses greater than 2GB.
    (UUM-85703)<br>
...
- uGUI: Improved search in player settings.
    ([UUM-71333](https://issuetracker.unity3d.com/issues/settings-search-search-results-not-matching-search-term-correctly))<br>
    *First seen in 6000.1.0a1.*
...
- Universal RP: Fixed an issue where Forward Plus lighting in URP was causing rendering artifacts.
    (UUM-84591)<br>
    *First seen in 6000.1.0a1.*
...
- com.unity.services.multiplayer: [1.0.1](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@1.0//changelog/CHANGELOG.html) to [1.0.2](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@1.0//changelog/CHANGELOG.html)
