...
- Editor: Fixed crash in Font Asset Creator
    ([UUM-91956](https://issuetracker.unity3d.com/issues/crash-on-tlsf-free-when-generating-the-font-atlas))    <br>*Fixed in 6000.1.0b4.*
...
- Editor: Fixed rectangular selection in Scene View where objects weren't selected if they where rendered through the GPU Resident Drawer.
    ([UUM-90229](https://issuetracker.unity3d.com/issues/box-selection-in-scene-view-doesnt-select-3d-objects-when-gpu-resident-drawer-setting-is-set-to-instanced-drawing))    <br>*Fixed in 6000.1.0b4.*
...
- Kernel: Fixed a potential hang when multiple threads call JobHandle.Complete\(\) on the same JobHandle.
    (UUM-85405)    <br>*Fixed in 6000.1.0b4.*
...
- Scene/Game View: Fixed a bug where it was not possible to open the layer and gizmos dropdowns more than one time.
    ...
    *First seen in 6000.1.0b2.*    <br>*Fixed in 6000.1.0b4.*
...
- Universal RP: Fixed an issue where undoing GameObject creation didn't work when the GameObject was focused
    ([UUM-92601](https://issuetracker.unity3d.com/issues/undoing-gameobject-creation-doesnt-work))    <br>*Fixed in 6000.1.0b4.*
...
### New 6000.1.0b3 Entries since 6000.1.0b2

#### Improvements

- Core: Internal RenderGraph ResourceHandle API is now readonly to improve performance.

- Editor: Cameras created in the scene root are now positioned and aligned with the current Scene view.
    (UUM-92501)<br>
...
- Graphics: Added: Added new preset colors to the "Color" type, improving parity with third-party Color APIs.
    (UUM-91957)<br>
...
- Editor: Fixed a Render Graph Pass Merging issue which led to unnecessary Clear Load Actions.
    (UUM-77137)

- Editor: Fixed an issue where objects created in 2D didn't default to a z position of zero.
    (UUM-92494)<br>
    *First seen in 6000.1.0b3.*

- Editor: Fixed an issue where Prefabs, Models, and Meshes dropped on the Hierarchy window didn't respect the *Create at Root* Scene View preference.
    (UUM-91529)<br>
...
- Editor: Fixed an issue where the *GameObject/Move To View* option didn't preserve position z values when executed in 2D mode.
    (UUM-92494)<br>
    *First seen in 6000.1.0b3.*
...
- Shaders: Fixed an assertion being triggered when switching the build target from Windows to Android.
    ([UUM-91151](https://issuetracker.unity3d.com/issues/getactivebuildprofile-can-only-be-called-from-the-main-thread-crash-and-error-when-switching-from-windows-to-android-2))<br>
    *First seen in 6000.1.0a9.*
...
- SRP Core: Fixed crash on leaking streaming scratch buffer differently sized into the current pool.
...
- UI Toolkit: Fixed an issue where world-space settings disappeared after changing the render mode to screen space.
    (UUM-92234)<br>
    *First seen in 6000.1.0b2.*

- UI Toolkit: Fixed an issue where `UIDocument` didn't render when switching from world-space to overlay mode.
    (UUM-86415)<br>
    *First seen in 6000.1.0b1.*

- UI Toolkit: Fixed the "UnityException: Load can only be called from the main thread" error when generating text meshes.
    (UUM-91740)<br>
    *First seen in 6000.1.0a9.*
...
#### New 6000.1.0b3 Package Changes since 6000.1.0b2
...
### Preview of Final 6000.1.0b3 Release Notes
...
- Editor: Fixed memory Leak warnings message when creating material + GPU Resident Drawer.
...
- GI: Fixed global illumination data to be included in Dedicated Server builds.
    (UUM-58026)
...
#### Preview of Final 6000.1.0b3 Package changes
