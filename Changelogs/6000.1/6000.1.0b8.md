...
- Editor: Fixed UITK input for UWP
    (UUM-53385)    <br>*Fixed in 6000.1.0b9.*
...
- HDRP: Fix NullReferenceException when clicking Jump To Source button in Render Graph Viewer
    (UUM-97702)    <br>*Fixed in 6000.1.0b9.*
...
- Physics: Fixed stack corruption for Rigidbody.SweepTestAll
    ([UUM-96080](https://issuetracker.unity3d.com/issues/freeze-when-calling-rigidbody-dot-sweeptestall-in-a-specific-project))    <br>*Fixed in 6000.1.0b9.*
...
### New 6000.1.0b8 Entries since 6000.1.0b7
...
- Animation: Fixed an issue where having a Blend Tree State opened in the Animator Window while the AnimatorController is not in the scene and going into Playmode will throw "BlendTreeWorkspace is NULL" error.
    ([UUM-93220](https://issuetracker.unity3d.com/issues/error-blendtreeworkspace-is-null-spammed-in-the-console-when-entering-play-mode-with-the-blend-tree-state-opened))<br>
...
- Graphics: Fixed an issue in the Frame Debugger where color Render Textures \(RT\) were incorrectly displayed as grayscale.
    (UUM-96848)<br>
...
- Text: Fixed an issue by switching default value for Multi-Atlas and Clear Dynamic Data on Build.
    (UUM-96240)<br>
...
- VFX Graph: Fixed a glitch with GPU events and strips, when the parent system particle count exceeds child system strip capacity.
    ([UUM-97068](https://issuetracker.unity3d.com/issues/vfx-graph-gpuevent-strip-and-instancing-issue))<br>
    *First seen in 6000.1.0b6.*
...
#### New 6000.1.0b8 Package Changes since 6000.1.0b7
...
- com.unity.web.stripping-tool: [1.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.web.stripping-tool@1.0//changelog/CHANGELOG.html) to [1.0.0](https://docs.unity3d.com/Packages/com.unity.web.stripping-tool@1.0//changelog/CHANGELOG.html)

- com.unity.meta-instant-games-sdk: [1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.meta-instant-games-sdk@1.0//changelog/CHANGELOG.html) to [1.0.0](https://docs.unity3d.com/Packages/com.unity.meta-instant-games-sdk@1.0//changelog/CHANGELOG.html)

### Preview of Final 6000.1.0b8 Release Notes
...
#### Preview of Final 6000.1.0b8 Package changes
...
- com.unity.inputsystem: [1.11.1](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.11//changelog/CHANGELOG.html) to [1.13.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.13//changelog/CHANGELOG.html)
