...
*   Asset Store Tools: Asset Store tools do not work in 2020.2 Unity version ([1299815](https://issuetracker.unity3d.com/issues/asset-store-tools-do-not-work-in-2020-dot-2-unity-version))
...
*   Customer QA Onboarding: Editor Crashes when performing Undo and Redo after duplicating Game Object with LEGO Model Asset component ([1298503](https://issuetracker.unity3d.com/issues/crash-when-redoing-and-undoing-pasting-prefabs-in-scene-in-lego-microgame))
    
*   Editor: HDRP - Opening Template scene freezes or reboots Mac
...
*   MacOS: Using Eyedropper of Color Picker freezes Editor ([1298737](https://issuetracker.unity3d.com/issues/macos-using-color-picker-freezes-editor))
...
*   Profiling: Project fails to open with the command line argument "-profiler-enable" and crash logo appears ([1295637](https://issuetracker.unity3d.com/issues/deployment-management-project-fails-to-open-with-the-command-line-argument-profiler-enable-and-crash-logo-appears))
    
*   Scene Management: Crash when Exiting Play mode with Multiple scenes loaded ([1298007](https://issuetracker.unity3d.com/issues/crash-when-exiting-play-mode-with-multiple-scenes-loaded))
    
*   Scripting: Changing an assembly definition from editor-only to runtime or vice versa will now correctly update the type of the related scripts. (1296261)  
    _This is a change to a 2021.1.0 change, not seen in any released version, and will not be mentioned in final notes._  
    _Fixed in 2021.1.0b2._
...
*   UI Toolkit: \[UI Builder\] Visual Studio opens up instead of UI Builder on double-clicking on uXML file in the Project window ([1298297](https://issuetracker.unity3d.com/issues/ui-toolkit-visual-studio-opens-up-instead-of-ui-builder-on-double-clicking-on-uxml-file-in-the-project-window))
    
*   Visual Effects: \[Visual Effect Graph\] Infinite compilation when opening ([1298466](https://issuetracker.unity3d.com/issues/visual-effect-graph-infinite-compilation-when-opening))
    

### New 2021.1.0b1 Entries since 2021.1.0a9
...
*   Build Pipeline: Fixed Unity command line player build failing due to invalid path argument to '-buildLinux64Player'. ([1285375](https://issuetracker.unity3d.com/issues/linux-command-line-argument-buildlinux64player-fails-to-build-when-using-a-valid-path-name))
...
*   Editor: Fixed an exception when adding first animator parameter. ([1286618](https://issuetracker.unity3d.com/issues/animation-indexoutofrangeexception-error-is-thrown-on-creating-animator-parameter))  
...
*   Editor: Fixed layout error on linux when opening shader dropdown. ([1287721](https://issuetracker.unity3d.com/issues/urp-linux-endlayoutgroup-error-is-thrown-on-clicking-material-shader-dropdown-in-the-inspector-window))  
...
*   Editor: Fixed the issue of the Culling Mask field throwing an IndexOutOfRangeException when layer 31 is in use. ([1289876](https://issuetracker.unity3d.com/issues/camera-cullingmask-inspector-throws-an-indexoutofrangeexception-when-layer-31-is-in-use))  
    _This is a change to a 2021.1.0a2 change, not seen in any released version, and will not be mentioned in final notes._
    
*   Editor: Fixed the Static Flag toggle not being set to disabled after disabling all static flags one by one. ([1289865](https://issuetracker.unity3d.com/issues/disabling-all-static-flags-for-an-object-shows-static-checkmark-as-enabled))  
    _This is a change to a 2021.1.0a2 change, not seen in any released version, and will not be mentioned in final notes._
    
*   Editor: Fixed the Static Flag toggle not being set to enabled after enabling all static flags one by one. ([1289867](https://issuetracker.unity3d.com/issues/in-the-static-flag-dropdown-menu-checkmark-icon-next-to-everything-does-not-appear-after-enabling-all-static-flags))  
    _This is a change to a 2021.1.0a2 change, not seen in any released version, and will not be mentioned in final notes._
...
*   Graphics: Fixed SRP Batcher issues with VFX Shadow-casters. ([1296980](https://issuetracker.unity3d.com/issues/vfx-srp-batcher-issues-with-vfx-shadow-casters))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Package Manager: Fixed issue where Package Manager window layout does not survive editor relaunch. (1295681, [1296721](https://issuetracker.unity3d.com/issues/layout-package-manager-window-missed-out-on-open-new-project-in-saved-layout))  
...
*   Scripting: Backport of the fix for case 1288026: An iteration on the preexisting fix in trunk: improved code readability, removed potential for exit safe mode bug down the line, added new tests. (1288026)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Video: \[iOS\]\[tvOS\] Video Player lags when Playback Speed is changed. ([1168597](https://issuetracker.unity3d.com/issues/macos-ios-tvos-video-player-lags-when-playback-speed-is-changed))
    
*   Video: \[Video\]\[Android\]VideoTrack tests broken. (1203336)
...
*   XR: Updated com.unity.xr.legacyinputhelpers to 2.1.7  
...
*   GI: Removed very verbose logging during lighting data asset building.
...
### Preview of Final 2021.1.0b1 Release Notes
...
*   SceneManager: Made sure objects are cleaned up properly if they are children of GameObject with DontSave flag. ([1157422](https://issuetracker.unity3d.com/issues/gameobjects-with-hideflags-dot-dontsave-raise-an-error-when-reloading-the-scene))
...
*   UI: Fixed issue where a Graphic could be set as a raycast target even is disabled. ([1290917](https://issuetracker.unity3d.com/issues/graphic-dot-raycast-is-able-to-use-destroyed-ui-object-resulting-in-an-error))
