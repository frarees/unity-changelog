...
*   Animation: Animator with Update Mode set to Normal ignores Time.timeScale ([1305844](https://issuetracker.unity3d.com/issues/animator-with-update-mode-set-to-normal-ignores-time-dot-timescale))
    
*   Scene Management: Specific project crashes with "Terrain::UpdateSplatMaterials" when duplicating a prefab ([1302424](https://issuetracker.unity3d.com/issues/specific-project-crashes-with-terrain-updatesplatmaterials-when-duplicating-a-prefab))
    
*   Editor - Functionality: Drop-down menus appearing in the wrong position ([1305889](https://issuetracker.unity3d.com/issues/drop-down-menus-appearing-in-the-wrong-position))
...
*   Terrain: Terrain Selection outline is missing ([1304439](https://issuetracker.unity3d.com/issues/terrain-selection-outline-is-missing-1))
...
### New 2021.1.0b2 Entries since 2021.1.0b1

#### Fixes

*   Editor: Fixed Asset Store tools no longer working. ([1299815](https://issuetracker.unity3d.com/issues/asset-store-tools-do-not-work-in-2020-dot-2-unity-version))  
...
*   Editor: Fixed repeated 'Month must be in range \[1-12\]!' errors. ([1302915](https://issuetracker.unity3d.com/issues/month-must-be-in-range-1-12-errors-are-thrown-in-the-console-when-opening-a-project))  
...
*   Scene/Game View: Fixed exception when deleting a selected Particle Effect. ([1295035](https://issuetracker.unity3d.com/issues/editor-missingreferenceexception-when-deleting-a-selected-particle-system-while-the-scene-view-is-in-focus))
...
### Preview of Final 2021.1.0b2 Release Notes
