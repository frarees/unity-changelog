...
*   Scripting: Scripting: Fixed issue when Application.quitting event is not raised when application is terminated from OS side. ([1309540](https://issuetracker.unity3d.com/issues/application-dot-quitting-event-is-not-raised-when-closing-build))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
### Preview of Final 2021.1.0b11 Release Notes
