...
*   Terrain: Specific project crashes with "Terrain::UpdateSplatMaterials" when duplicating a prefab ([1302424](https://issuetracker.unity3d.com/issues/specific-project-crashes-with-terrain-updatesplatmaterials-when-duplicating-a-prefab))
...
### New 2021.1.0b3 Entries since 2021.1.0b2
...
*   IL2CPP: Fixed file and directory patterns ending with "._" incorrectly including files names that partially match on non Windows platforms. ([1286554](https://issuetracker.unity3d.com/issues/directory-dot-getfiles-ignores-dot-symbol-when-built-with-il2cpp))  
...
### Preview of Final 2021.1.0b3 Release Notes
