### Known Issues in 2023.1.0b19

- Editor: Fixed editor crashing when using the CCD package.
    (UUM-34288)<br>
    *First seen in 2023.1.0a9.*    <br>*Fixed in 2023.1.0b20.*
...
- Editor: FrameDebugger: Fixed an issue where render textures would leak when attached in a player using URP.
    ([UUM-28065](https://issuetracker.unity3d.com/issues/frame-debugger-vram-memory-leak))    <br>*Fixed in 2023.1.0b20.*
...
- Package Manager: Fix the error that is being thrown after uninstalling a Package that was added by Git URL.
    (UUM-34396)<br>
    *First seen in 2023.1.0b15.*    <br>*Fixed in 2023.1.0b20.*
...
### New 2023.1.0b19 Entries since 2023.1.0b18

#### Features

- Editor: It's now possible to retry and repeat tests on test level, meaning as soon as the test finishs running the first iteration, we now retry or repeat it.  Command line arguments to pass to the Editor:<br>
    -repeat x runs the test x amount of times or until it fails. It is useful for testing unstable tests<br>
...
- 2D: Fixed a null exception when the user does a Select with the Grid Select tool while the Inspector window and the Tile Palette window are docked in the same docked area.
    ([UUM-35363](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-when-making-a-grid-selection))

- 2D: Fixed \[URP\] NullReferenceException error when creating new Lens Flare Data for Lens Flare \(SRP\) component.
...
- Android: Avoid a redundant empty render pass to the backbuffer when using Vulkan on Android.
    ([UUM-32298](https://issuetracker.unity3d.com/issues/android-the-player-throws-vulkan-validation-error-vkdbgutilwarn003-in-the-logcat-when-running))
...
- Editor: Fixed the issue of "\[Windows\] create EditorWindow on 0,0 is displayed across verticals monitors".
    (UUM-27907)<br>
...
- Graphics: Disabled Vulkan DebugUtilsLabels for Linux AMD due to driver crash bug.
    (UUM-31640)
...
- UI: Make sure we correctly restore the hierarchyMode when Drawing Header.
...
- UI Toolkit: Fixed wrong face color on labels when color tags are used in combination with the DynamicColor hint or text effects.
...
- Universal RP: Fixed an issue with broken documentation links.
    (UUM-30252)
...
- com.unity.recorder: [4.0.0](https://docs.unity3d.com/Packages/com.unity.recorder@4.0//changelog/CHANGELOG.html) &#x2192; [4.0.1](https://docs.unity3d.com/Packages/com.unity.recorder@4.0//changelog/CHANGELOG.html)
...
### Preview of Final 2023.1.0b19 Release Notes
...
- Entities: Persist asset files under StreamingAssets/ into the Virtual Filesystem in WebGL builds and update non threaded async read operations.
...
#### Preview of Final 2023.1.0b19 Package changes
...
- com.unity.services.authentication: [2.0.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@2.0//changelog/CHANGELOG.html) &#x2192; [2.5.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@2.5//changelog/CHANGELOG.html)
...
- com.unity.services.core: [1.4.1](https://docs.unity3d.com/Packages/com.unity.services.core@1.4//changelog/CHANGELOG.html) &#x2192; [1.9.0](https://docs.unity3d.com/Packages/com.unity.services.core@1.9//changelog/CHANGELOG.html)
