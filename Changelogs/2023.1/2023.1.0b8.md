...
- Editor: Fixed a freeze when selecting multiple assets with different Scripted Importers.
    ...
    *First seen in 2023.1.0b3.*    <br>*Fixed in 2023.1.0b9.*
...
- Editor: Fixed a rare Editor crash when using accelerator for shader cache
    ...
    *First seen in 2023.1.0b4.*    <br>*Fixed in 2023.1.0b9.*
...
- Editor: Fixed issue when importing FBX files where memory usage grows exponentially with the amount of clips present in the file.
    ...
    *First seen in 2023.1.0a26.*    <br>*Fixed in 2023.1.0b9.*

- Editor: fixing potential GPU cbuffer out of bound read with BRG
    (UUM-29505)<br>
    *First seen in 2023.1.0b7.*    <br>*Fixed in 2023.1.0b9.*
...
- Terrain: Importing out of date terrain asset with deprecated splats will no longer cause the editor to hang/crash.
    (UUM-24843)    <br>*Fixed in 2023.1.0b9.*
...
- Universal RP: Fixed resource leak in URP deferred.
    (UUM-26626)<br>
    *First seen in 2023.1.0a21.*    <br>*Fixed in 2023.1.0b9.*
...
### New 2023.1.0b8 Entries since 2023.1.0b7
...
- Audio: Fixed a bug where SystemInfo.supportsAudio would return true on some platforms and false on others, when Unity Audio is disabled. We now always return false in this case.
    ([UUM-16017](https://issuetracker.unity3d.com/issues/android-systeminfo-dot-supportsaudio-inconsistency-when-built))<br>
...
- Editor: Fixed an issue and now the Editor continues to stay in focus when closing multiple windows in succession.
...
- Graphics: Fixed an error being generated when using RayTracingAccelerationStructure.CullInstances and MeshRenderers using Ray Traced Procedural option.
    (UUM-27943)<br>
    *First seen in 2023.1.0b4.*

- IMGUI: Fixed NullReferenceException when using a GUILayout.TextField.
...
- Profiler: Fixed GPU profiler module showing zeroes.
    ([UUM-27023](https://issuetracker.unity3d.com/issues/the-gpu-usage-module-shows-no-info-when-profiler-recording-is-enabled))<br>
    *First seen in 2023.1.0b4.*

- Universal RP: Changed the ScreenSpace Decals sorting criteria to the same used by DBuffer Decals.
...
- URP: Fixed HDR output too saturated because of a Color Grading variant not included in builds.
    (UUM-27503)<br>
...
### Preview of Final 2023.1.0b8 Release Notes
...
#### Preview of Final 2023.1.0b8 Package changes
...
- com.unity.addressables: [1.20.0](https://docs.unity3d.com/Packages/com.unity.addressables@1.20//changelog/CHANGELOG.html) &#x2192; [1.21.8](https://docs.unity3d.com/Packages/com.unity.addressables@1.21//changelog/CHANGELOG.html)
