...
- 2D: Fix regression in time to open a project and enter playmode.
    (UUM-31205)<br>
    *First seen in 2023.1.0b8.*    <br>*Fixed in 2023.1.0b12.*
...
- Editor: Fixed issue where scripted importer override could cause infinite import.
    ([UUM-26859](https://issuetracker.unity3d.com/issues/editor-hangs-opening-a-project-when-the-2d-animation-package-is-removed))    <br>*Fixed in 2023.1.0b12.*

- Editor: fixed occasional Editor crash in batch mode.
    (UUM-22301)<br>
    *First seen in 2023.1.0a24.*    <br>*Fixed in 2023.1.0b12.*
...
- Editor: \[2D\] The order of the Sprites is changed in the drop-down asset creation menu
    ([UUM-12509](https://issuetracker.unity3d.com/issues/2d-the-order-of-the-sprites-is-changed-in-the-drop-down-asset-creation-menu))    <br>*Fixed in 2023.1.0b12.*
...
### New 2023.1.0b11 Entries since 2023.1.0b10

#### Improvements

- 2D: Added icons to the Clipboard and Brush Pick overlays for Tile Palette when the overlays are collapsed.
    ([UUM-29771](https://issuetracker.unity3d.com/issues/tile-palette-brush-pick-and-tile-palette-clipboard-overlay-indicators-in-scene-view-look-the-same))<br>
...
- 2D: Fixed a cyclic dependency error when dragging a Palette Prefab to be saved under the same Palette Prefab.
    (UUM-29540)<br>
    *First seen in 2023.1.0b7.*

- 2D: Fixed graphical glitch in the Brush Picks overlay when the Tile Palette window is changed from a dockable to floating window.
    (UUM-29537)<br>
    *First seen in 2023.1.0b7.*
...
- Android: Fixed gradle build on Mac when it's placed in folder "Project \(1\)", was happening when Optimized Frame Pacing or GameActivity is enabled.
    (UUM-25255)<br>
...
- Editor: Applied better formatting to context column in Shortcut Manager.
    (UUM-28692)<br>
...
- Editor: Fixed an issue that the Linux editor progress bar is not shown on domain reload.
    (UUM-27077)<br>
...
- Editor: Fixed Highlighter text in project browser when clicking on an object field.
    ([UUM-29709](https://issuetracker.unity3d.com/issues/highlighter-text-is-misaligned-and-overlapping-when-an-asset-is-highlighted))<br>
    *First seen in 2023.1.0b7.*

- Editor: Fixed issue where -nographics command line argument was not being forwarded to the Asset Import Workers.
    (UUM-29722)

- Editor: Fixed project browser text being misaligned.
    ([UUM-26789](https://issuetracker.unity3d.com/issues/asset-names-are-aligned-incorrectly-when-in-project-browser))<br>
...
- Editor: Improved Text performance for both IMGUI and UITK.
...
- GI: Fixed editor crash when baking a scene with an invalid mesh.
...
- UI Toolkit: Fixed Placeholder does not refresh issue.
    (UUM-21819)<br>
...
- URP: 2D - Fixed NullReferenceException is thrown when opening Light Explorer with 2D Lights.
    ([UUM-19576](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-when-opening-light-explorer-with-2d-lights))<br>
    *First seen in 2023.1.0a20.*

- URP: 2D - Fixed uninitialized SpriteProps in CanvasRenderer.
    (UUM-18389)<br>
...
- VFX Graph: Fixed an issue that the Exposure weight slider was not hidden when a shadergraph was assigned to an output context.
    (UUM-4753)<br>
...
### Preview of Final 2023.1.0b11 Release Notes
...
#### Preview of Final 2023.1.0b11 Package changes
