...
- 2D: Fix: \[URP\] NullReferenceException error when creating new Lens Flare Data for Lens Flare \(SRP\) component
    ([UUM-34875](https://issuetracker.unity3d.com/issues/urp-nullreferenceexception-error-when-creating-new-lens-flare-data-for-lens-flare-srp-component))    <br>*Fixed in 2023.1.0b19.*

- Editor: Fixed for 2023.1.X: UUM-34235: Inspector override marker UI is not updated after "Apply All"
    ([UUM-34235](https://issuetracker.unity3d.com/issues/inspector-override-marker-ui-is-not-updated-after-apply-all))    <br>*Fixed in 2023.1.0b20.*

- Editor: Fixed VisualElement scheduler that may not run task in order when throttling
    (UUM-35882)    <br>*Fixed in 2023.1.0b19.*
...
- Optimization: Editor crashes when EditorUtility.UnloadUnusedAssetsImmediate is called
...
- URP: Updated the documentation to mention that the Screen Space decal technique does not support blending of normals when using the Deferred rendering path with Accurate G-Buffer Normals enabled. The Automatic decal technique now prefers the D-Buffer technique if Accurate G-Buffer Normals are enabled.
    ([UUM-25204](https://issuetracker.unity3d.com/issues/urp-decal-normal-blending-rendering-results-in-very-dark-texture-when-the-blend-value-is-exclusively-between-0-and-1))    <br>*Fixed in 2023.1.0b20.*
...
- 2D: Clean up Brush Editors when Tile Palette window is opened and enabled.
    ([UUM-33299](https://issuetracker.unity3d.com/issues/multiple-grid-brush-editors-are-enabled-when-tile-palette-window-gets-opened))<br>
...
- Editor: Added null protection in AssetStore provider when trying to display data as a table.
...
- Editor: Ensure embedded inspector can be used to enter keyboard values even if their editor is created using IMGUI.
    ([UUM-25187](https://issuetracker.unity3d.com/issues/console-throws-argumentnullexception-value-cannot-be-null-dot-when-user-works-with-the-preset-component-in-select-preset-window))<br>
    *First seen in 2023.1.0b2.*

- Editor: Ensure SearchQuery deleted from outside the SearchQueryPanel are removed from the list.
    ([UUM-31969](https://issuetracker.unity3d.com/issues/missingreferenceexception-the-object-of-type-unityeditor-dot-search-dot-searchqueryasset-has-been-destroyed-but-you-are-still-trying-to-access-it-dot-error-displayed-in-the-console-after-asset-creation-in-the-search-window))<br>
...
- Editor: Ensure that when clearing detail view or reloading it, we do not keep ref on deleted Serialized property.
    ([UUM-31865](https://issuetracker.unity3d.com/issues/nullreferenceexception-object-reference-not-set-to-an-instance-of-an-object-error-displayed-in-the-console-after-actions-in-the-search-window))<br>
    *First seen in 2023.1.0b10.*

- Editor: Fixed a compilation warning in BlockDoublingLinearAllocatorTests.

- Editor: Fixed all "Seach" \(to Search\) typos: in doc and in styling classes.
    (UUM-32607)<br>
...
- Editor: Fixed an Entities.graphics random crash when multi-thread and high number of meshes.
    (UUM-33872)
...
- Editor: Fixed an issue that Audio.Thread marker in Profiler window is lasting whole frame while audio is playing.
...
- Editor: Fixed Column naming in Edit Column menu.
    ([UUM-32469](https://issuetracker.unity3d.com/issues/search-column-actions-are-displayed-in-code-strings-edit-m-activequeryguid-not-in-human-language))<br>
    *First seen in 2023.1.0b11.*

- Editor: Fixed doc link for searchquery.
    ([UUM-32269](https://issuetracker.unity3d.com/issues/documentation-link-does-not-work-when-the-category-equals-3d-question-mark-is-clicked))<br>
    *First seen in 2023.1.0b11.*
...
- Editor: Fixed gpuSkinning property value not being correctly carried forward into meshDeformation property when upgrading Unity project.
    ([UUM-35347](https://issuetracker.unity3d.com/issues/gpu-skinning-editor-ui-is-not-correctly-showing-the-gpu-skinning-mode-after-upgrading-project))<br>
...
- Editor: Fixed not needed scrollbar and also fix clean up in preset editor to avoid ExcludedProperties exception.
    ([UUM-30379](https://issuetracker.unity3d.com/issues/inspector-section-in-the-select-preset-has-a-scrollbar-which-is-not-needed))<br>
...
- Editor: Fixed title show the major, minor and version build.
    ([UUM-26695](https://issuetracker.unity3d.com/issues/full-editor-version-is-not-displayed-in-the-toolbar))<br>
...
- Editor: Fixed ViewState assignation so it doesn't trash the main context searchview.
    ([UUM-32792](https://issuetracker.unity3d.com/issues/search-inspector-section-doesnt-display-selected-item-data))<br>
    *First seen in 2023.1.0b12.*
...
- Editor: Improved documentation for PrefabUtility.GetPropertyModifications and PrefabUtility.SetPropertyModifications.
    ([UUM-20644](https://issuetracker.unity3d.com/issues/documentation-for-prefabutility-dot-setpropertymodifications-is-lacking-helpful-information))<br>
...
- Editor: Moved "Add Column" button next to the "Reset Columns" button in the Search window, when using the table view.
    ([UUM-32305](https://issuetracker.unity3d.com/issues/search-plus-overlaps-newly-added-column-which-is-not-displayed-fully-for-the-user-in-search-table-view-window))<br>
    *First seen in 2023.1.0b11.*
...
- Editor: When executing an action from a SearchQueryEditor preview window, check if the searchwindow is null before trying to close it.
    ([UUM-33870](https://issuetracker.unity3d.com/issues/console-displays-an-error-nullreferenceexception-object-reference-not-set-to-an-instance-of-an-object))<br>
...
- Package Manager: Fixed the issue of showing Exp label on packages with invalid SemVer in the manifest.
    (UUM-35178)<br>
...
- Physics: Fixed Articulation Bodies having an incorrect linear and angular damping.
...
- Scripting: Mono: Fixed crash when opening a scene with missing references.
    ([UUM-33830](https://issuetracker.unity3d.com/issues/crash-on-object-getcachedscriptingobject-when-entering-play-mode-after-missing-a-reference-variable))<br>
    *First seen in 2023.1.0b13.*
...
- Core: Fixed an issue that the probe volume is not enabled when probe volume settings are enabled.
...
- Editor: Changing the download progress calculation in 2023.1 to use doubles when downloading asset packs on Android.
...
- Editor: Fixed editor crash in loading game scene.
...
- Package Manager: Fixed a null exception when clearing search after re-opening package manager is fixed.
    (UUM-34272)
...
- Package Manager: Fixed an issue that refresh button stays enabled if user goes offline.
    (UUM-35005)
...
- Scripting: Fixed an issue on Mac where IL post processing could trigger a SIGILL message.
    (UUM-32905)
...
- Scripting: Fixed an issue where ILPP.Runner tries to log messages to Windows event log.
    ([UUM-28447](https://issuetracker.unity3d.com/issues/an-error-occured-while-wrting-to-logger-s))

- Scripting: Fixed an issue where source-generated code was inspected by users Roslyn analyzers.
...
- Scripting: Fixed an issue with API updater when replacing an instance method with a static one.
    (UUM-16936)

- Scripting: Fixed an issue with Script updater when renaming a nested generic type.
    (UUM-16922)
...
- WebGL: Fixed missing bitfieldExtract\(\) function error in URP Lit shader in WebGL builds.
    (UUM-34043)
...
- com.unity.2d.animation: [9.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@9.0//changelog/CHANGELOG.html) &#x2192; [10.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.0//changelog/CHANGELOG.html)
...
- com.unity.services.cloudcode: [2.0.0](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.0//changelog/CHANGELOG.html) &#x2192; [2.3.2](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.3//changelog/CHANGELOG.html)
...
- com.unity.test-framework: [1.1.31](https://docs.unity3d.com/Packages/com.unity.test-framework@1.1//changelog/CHANGELOG.html) &#x2192; [1.3.4](https://docs.unity3d.com/Packages/com.unity.test-framework@1.3//changelog/CHANGELOG.html)
