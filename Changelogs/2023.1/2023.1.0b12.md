...
- Editor: Fix PlayerSettings.SetAdditionalIl2CppArgs not being respected
    ([UUM-25446](https://issuetracker.unity3d.com/issues/il2cpp-build-argument-doesnt-get-passed-when-exporting-the-project))    <br>*Fixed in 2023.1.0b13.*
...
- GI: Fix editor crash on Intel GPUs when using the OpenGL API
...
- HDRP: Fixed init order that could cause DXR setup to fail after using the HDRP wizard to enable DXR on an existing HDRP project.
    ([UUM-21776](https://issuetracker.unity3d.com/issues/the-game-view-is-black-and-the-editor-throws-a-nullreferenceexception-after-restarting-the-editor-when-pressing-the-fix-all-button-in-hdrp-wizard))<br>
    *First seen in 2023.1.0a24.*    <br>*Fixed in 2023.1.0b13.*
...
- RP Foundation: [URP] Memory leak when in Play Mode
...
### New 2023.1.0b12 Entries since 2023.1.0b11
...
- 2D: Fixed issue where the name of a Brush Pick does not automatically update when renamed.
    (UUM-29538)<br>
...
- Android: Implement Android permission request callbacks in Game Activity.
    (UUM-17231)<br>
    *First seen in 2023.1.0a14.*

- Asset Bundles: Added error message when loading bundle without typetrees in the Editor.
    ([UUM-660](https://issuetracker.unity3d.com/issues/assetbundle-dot-loadfromfileasync-causes-errors-when-bundles-are-built-using-disablewritetypetree))<br>
...
- Editor: Ensure long title do not clip the scene icon in the Scene Template Dialog.
    ([UUM-25511](https://issuetracker.unity3d.com/issues/scene-templates-with-longer-titles-are-displayed-without-the-icons-in-new-scene-window))<br>
...
- Editor: Ensure to not show the action kebab menu if in picker mode.
    ([UUM-25013](https://issuetracker.unity3d.com/issues/preset-deletion-in-select-preset-window-doesnt-work))<br>
    *First seen in 2023.1.0b1.*

- Editor: Fixed an issue that the types derived from type with CustomPreview now have a custom preview.
    ([UUM-9543](https://issuetracker.unity3d.com/issues/custompreview-doesnt-work-when-the-type-is-inherited-from-the-specified-type-in-custompreviews-parameters))<br>
...
- Editor: Fixed ellipsis in Label column for Search Table.
    ([UUM-25147](https://issuetracker.unity3d.com/issues/data-in-the-label-section-is-not-abbreviated-with-dot-dot-dot-when-the-column-is-narrowed))<br>
    *First seen in 2023.1.0b1.*
...
- Editor: Fixed recursive layout failure while displaying a SearchQueryAsset in the Search Window Inspector.
    ([UUM-26720](https://issuetracker.unity3d.com/issues/console-displays-error-layout-update-is-struggling-to-process-current-layout-when-user-selects-saved-empty-search-asset))<br>
    *First seen in 2023.1.0b3.*

- Editor: Fixed styling of extra button action bar.
    ([UUM-26518](https://issuetracker.unity3d.com/issues/search-button-hide-should-be-aligned-accordingly-to-select-and-open))<br>
    *First seen in 2023.1.0b3.*

- Editor: Fixed styling on the scene template help button.
    ([UUM-27122](https://issuetracker.unity3d.com/issues/help-icons-for-the-scene-template-asset-are-displayed-in-different-backgrounds))<br>
...
- Editor: Save Query dropdown button works properly after uitk framework event refactor.
...
- GI: Fixed heap corruption error caused by Enlighten in debug Player builds.
    (UUM-20399)<br>
...
- HDRP: Fixed exception on first frame when using water scripting interactions.
    (UUM-28748)<br>
    *First seen in 2023.1.0b5.*

- IMGUI: Fixed an issue with text used in Gizmos. It now has the correct size, position and clipping.
    ([UUM-28063](https://issuetracker.unity3d.com/issues/gameobject-name-does-not-scale-and-is-not-centered-within-icon))<br>
    *First seen in 2023.1.0b3.*
...
- UI Toolkit: Fixed an issue that Exceptions are being thrown when entering play mode with the inspector in debug mode.
    ([UUM-22475](https://issuetracker.unity3d.com/issues/errors-when-entering-playmode-while-the-debug-inspector-is-enabled))<br>
    *First seen in 2023.1.0a24.*
...
- com.unity.adaptiveperformance: [5.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance@5.0//changelog/CHANGELOG.html) &#x2192; [5.0.0](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance@5.0//changelog/CHANGELOG.html)

- com.unity.adaptiveperformance.google.android: [1.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance.google.android@1.0//changelog/CHANGELOG.html) &#x2192; [1.0.0](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance.google.android@1.0//changelog/CHANGELOG.html)
...
- com.unity.render-pipelines.core: [15.0.4](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@15.0//changelog/CHANGELOG.html) &#x2192; [15.0.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@15.0//changelog/CHANGELOG.html)

- com.unity.render-pipelines.high-definition: [15.0.4](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@15.0//changelog/CHANGELOG.html) &#x2192; [15.0.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@15.0//changelog/CHANGELOG.html)

- com.unity.render-pipelines.high-definition-config: [15.0.4](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@15.0//changelog/CHANGELOG.html) &#x2192; [15.0.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@15.0//changelog/CHANGELOG.html)

- com.unity.render-pipelines.universal: [15.0.4](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@15.0//changelog/CHANGELOG.html) &#x2192; [15.0.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@15.0//changelog/CHANGELOG.html)
...
- com.unity.shadergraph: [15.0.4](https://docs.unity3d.com/Packages/com.unity.shadergraph@15.0//changelog/CHANGELOG.html) &#x2192; [15.0.5](https://docs.unity3d.com/Packages/com.unity.shadergraph@15.0//changelog/CHANGELOG.html)

- com.unity.visualeffectgraph: [15.0.4](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@15.0//changelog/CHANGELOG.html) &#x2192; [15.0.5](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@15.0//changelog/CHANGELOG.html)
...
### Preview of Final 2023.1.0b12 Release Notes
...
#### Preview of Final 2023.1.0b12 Package changes
...
- com.unity.services.core: [1.4.1](https://docs.unity3d.com/Packages/com.unity.services.core@1.4//changelog/CHANGELOG.html) &#x2192; [1.8.1](https://docs.unity3d.com/Packages/com.unity.services.core@1.8//changelog/CHANGELOG.html)
...
- com.unity.xr.core-utils: [2.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.1//changelog/CHANGELOG.html) &#x2192; [2.2.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.2//changelog/CHANGELOG.html)

- com.unity.xr.interaction.toolkit: [2.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.1//changelog/CHANGELOG.html) &#x2192; [2.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.3//changelog/CHANGELOG.html)
...
- com.unity.terrain-tools: [5.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.terrain-tools@5.0//changelog/CHANGELOG.html) &#x2192; [5.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.terrain-tools@5.1//changelog/CHANGELOG.html)
...
- [com.unity.xr.hands@1.1.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.1//changelog/CHANGELOG.html)
