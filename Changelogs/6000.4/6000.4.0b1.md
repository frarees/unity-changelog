...
- Editor: Fixes a regression where calling PingObject\(int\) causes a recursive call.
    ([ECSB-1822](https://issuetracker.unity3d.com/issues/macos-silent-crash-after-pressing-ping-source-game-object-in-hierarchy-button-in-entities-hierarchy-window))    <br>*Fixed in 6000.4.0b2.*
...
- UI Toolkit: Fix crash when using an invalid texture in UIToolkit when rendering in worldspace
    ...
    *First seen in 6000.4.0a5.*    <br>*Fixed in 6000.4.0b2.*
...
- 2D: Fixed a user interface alignment issue for a Sprite Atlas asset's *Show Platform Settings* button.
    ([UUM-122891](https://issuetracker.unity3d.com/issues/sprite-atlas-asset-ui-issues))<br>
...
- Editor: Added minimum and maximum limits to the Project Auditor fields to prevent out-of-range values.
    ([UUM-122620](https://issuetracker.unity3d.com/issues/windows-entering-large-numbers-in-project-settings-project-auditor-section-causes-values-to-turn-negative-reproduction-steps))<br>
...
- Editor: Backport: Fix stats window display issue in editor light theme.
    ([UUM-127033](https://issuetracker.unity3d.com/issues/game-view-stats-window-is-dark-themed-when-using-the-light-theme-in-the-editor))<br>
...
- Editor: Fixed a user interface alignment issue in the Project Auditor preferences.
    ([UUM-126719](https://issuetracker.unity3d.com/issues/project-auditor-information-does-not-align-with-window-title))<br>
    *First seen in 6000.4.0a1.*
...
- Editor: Fixed an issue where the scrollbar on the Project Auditor's Summary page was visible when it was not necessary.
    ([UUM-122813](https://issuetracker.unity3d.com/issues/scrollbar-visible-in-project-auditor-window-even-when-not-required))<br>
    *First seen in 6000.4.0a3.*
...
- Editor: Fixed timeSamples set causing immediate playback when using PlayScheduled.
    ([UUM-117577](https://issuetracker.unity3d.com/issues/setting-timesamples-immediately-plays-the-clip-ignoring-previous-playscheduled))<br>
    *First seen in 6000.4.0a1.*
...
- Editor: Hierarchy: fix horizontal scrollbar behavior when columns are too wide to fit in the view.
    ([UUM-123111](https://issuetracker.unity3d.com/issues/horizontal-scrollbar-is-not-shown-when-drag-resizing-columns))<br>
    *First seen in 6000.4.0a2.*

- Editor: Hierarchy: Fixed null reference exception in Hierarchy Active and Tag columns when entering/exiting playmode.
    ([UUM-128446](https://issuetracker.unity3d.com/issues/nullreferenceexception-object-reference-not-set-to-an-instance-of-an-object-errors-are-thrown-in-play-mode-when-tag-column-is-added-in-hierarchy-v2))<br>
    *First seen in 6000.4.0a5.*
...
- Editor: Project Auditor: Made SRP Batcher compatibility check more robust.
    ([UUM-126726](https://issuetracker.unity3d.com/issues/project-auditor-shader-not-compatible-with-srp-batcher-is-not-correctly-judged))<br>
    *First seen in 6000.4.0a1.*
...
- GI: Fixed warning when building Mixed Reality template to iOS.
    ([UUM-126128](https://issuetracker.unity3d.com/issues/shader-warning-in-buildlightgrid-is-thrown-when-switching-to-ios-platform-on-mixed-reality-template))<br>
    *First seen in 6000.4.0a1.*
...
- HDRP: HDRP Wizard - NullReferenceException while pressing Fix All.
    ([UUM-125858](https://issuetracker.unity3d.com/issues/errors-argumentnullexception-value-cannot-be-null-dot-and-nullreferenceexception-object-reference-not-set-to-an-instance-of-an-object-are-present-when-clicking-fix-all-in-the-hdrp-wizard-window))<br>
    *First seen in 6000.4.0a4.*
...
- com.unity.netcode: [1.9.2](https://docs.unity3d.com/Packages/com.unity.netcode@1.9//changelog/CHANGELOG.html) to [1.10.0](https://docs.unity3d.com/Packages/com.unity.netcode@1.10//changelog/CHANGELOG.html)

- com.unity.2d.animation: [14.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html) to [14.0.2](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html)

- com.unity.2d.common: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@13.0//changelog/CHANGELOG.html) to [13.0.1](https://docs.unity3d.com/Packages/com.unity.2d.common@13.0//changelog/CHANGELOG.html)
...
- com.unity.purchasing: [4.13.2](https://docs.unity3d.com/Packages/com.unity.purchasing@4.13//changelog/CHANGELOG.html) to [4.14.0](https://docs.unity3d.com/Packages/com.unity.purchasing@4.14//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.16.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.16//changelog/CHANGELOG.html) to [1.16.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.16//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html) to [1.2.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html)

- com.unity.ai.inference: [2.2.1](https://docs.unity3d.com/Packages/com.unity.ai.inference@2.2//changelog/CHANGELOG.html) to [2.2.2](https://docs.unity3d.com/Packages/com.unity.ai.inference@2.2//changelog/CHANGELOG.html)
...
### Preview of Final 6000.4.0b1 Release Notes
...
#### Preview of Final 6000.4.0b1 Package changes
...
- com.unity.xr.hands: [1.7.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.7//changelog/CHANGELOG.html) to [1.7.1](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.7//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.16.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.16//changelog/CHANGELOG.html) to [1.16.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.16//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial@2.3//changelog/CHANGELOG.html) to [3.0.3-pre.3](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.0//changelog/CHANGELOG.html)
...
- com.unity.multiplayer.widgets: [1.0.0](https://docs.unity3d.com/Packages/com.unity.multiplayer.widgets@1.0//changelog/CHANGELOG.html) to [1.0.4](https://docs.unity3d.com/Packages/com.unity.multiplayer.widgets@1.0//changelog/CHANGELOG.html)
