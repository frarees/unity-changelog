...
- DX12: Fixed a crash that occurred on CheckDeviceStatus when executing specific InferenceEngine actions.
    ([UUM-131538](https://issuetracker.unity3d.com/issues/crash-on-checkdevicestatus-when-executing-specific-inferenceengine-actions))    <br>*Fixed in 6000.4.0b5.*

- Editor: Reverted changes that caused unsaved scene changes to be lost during builds
    (UUM-128985)    <br>*Fixed in 6000.4.0b5.*
...
- Entities: ILPP no longer hangs when a particular flavor of recursive reference in a managed component exists.
    ...
    *First seen in 6000.4.0a1.*    <br>*Fixed in 6000.4.0b5.*
...
- Shadergraph: Fixed a NullReferenceException that generated when selecting a custom preview mesh in the Shader Graph editor.
    ([UUM-131564](https://issuetracker.unity3d.com/issues/nullreferenceexception-when-selecting-custom-mesh-option-in-shader-graph-main-preview))<br>
    *First seen in 6000.4.0b3.*    <br>*Fixed in 6000.4.0b5.*

- Shaders: Fixed a rare crash when uninstalling Universal Render Pipeline package.
    ([UUM-130674](https://issuetracker.unity3d.com/issues/crash-on-keywords-printkeywordspaceinfo-when-uninstalling-universal-render-pipeline-in-a-specific-project))    <br>*Fixed in 6000.4.0b5.*
...
- Editor: Fixed asset database is read only error by marking VFXManager as dirty so clone editors will not have to reimport it.
    ([UUM-130734](https://issuetracker.unity3d.com/issues/uum-starting-virtual-player-after-project-upgrade-throws-asset-database-errors))<br>
...
- Graph Toolkit: Box selection now properly includes sticky notes.
    ([UUM-126816](https://issuetracker.unity3d.com/issues/sometimes-unable-to-box-select-a-sticky-note-after-copying-and-pasting-it))<br>
...
- Scene/Game View: Fixed an issue where the Grid Settings rotation value didn't match the inspector after using "Copy from Active Object".
    ([UUM-122639](https://issuetracker.unity3d.com/issues/rotation-values-are-not-displayed-correctly-in-grid-and-snap-settings-after-clicking-copy-from-active-object-button))<br>
...
- Scene/Game View: Fixed an issue where the warning text in the overlay preset creation prompt could be truncated on certain high-DPI displays when the preset name exceeded the maximum length.
    ([UUM-129282](https://issuetracker.unity3d.com/issues/the-warning-is-cut-off-when-preset-name-exceeds-maximum-length))<br>
    *First seen in 6000.4.0a5.*
...
- UI Toolkit: Fixed the UI Builder stylesheet pane's layout causing the empty label to overlap with existing stylesheets.
    ([UUM-128536](https://issuetracker.unity3d.com/issues/prompt-to-create-a-new-stylesheet-overlaps-parents-selector-list-when-template-is-viewed-in-context))<br>
    *First seen in 6000.4.0a5.*
...
### Preview of Final 6000.4.0b4 Release Notes
...
#### Preview of Final 6000.4.0b4 Package changes
