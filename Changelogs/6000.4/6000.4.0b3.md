...
- Editor: Fixed issue where using a proxy on Windows could crash the Editor on launch.
    ([UUM-130943](https://issuetracker.unity3d.com/issues/crash-on-getproxyforurl-when-creating-or-opening-a-project))    <br>*Fixed in 6000.4.0b4.*

- Editor: Fixed potentiel heap-buffer-overflow when applying prefabs modifications
    (UUM-131207)    <br>*Fixed in 6000.4.0b4.*
...
- Entities: Fix editor freeze when UpdateInGroup attribute has cycle.
    ([UUM-128197](https://issuetracker.unity3d.com/issues/editor-hangs-when-componentsystemgroup-update-in-itself))    <br>*Fixed in 6000.4.0b4.*

- HDRP: Fixed Screen Space Lens Flare error when using mip bias 0 setting.
    (UUM-129573)    <br>*Fixed in 6000.4.0b4.*
...
### New 6000.4.0b3 Entries since 6000.4.0b2
...
- Graphics: This PR fixes an issue of Low Resolution transparent material being rendered with incorrect depth on certain platforms. For instance, the transparent material could be rendered even if it's behind an opaque mesh.
    (UUM-120348)<br>
...
#### New 6000.4.0b3 Package Changes since 6000.4.0b2
...
### Preview of Final 6000.4.0b3 Release Notes
...
#### Preview of Final 6000.4.0b3 Package changes
