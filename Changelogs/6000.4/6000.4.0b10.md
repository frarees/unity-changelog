...
- Asset Pipeline: Fixed a crash in the AssetDatabase Profiler that could occur when a profiler marker callback was invoked on a non-main thread.
    ...
    *First seen in 6000.4.0b7.*    <br>*Fixed in 6000.4.0b11.*

- Build Pipeline: Fixed an issue where attempting to build a scene stored in a package would fail the build.
    ([UUM-133786](https://issuetracker.unity3d.com/issues/player-build-fails-with-failed-to-open-error-when-scene-is-located-in-a-package))    <br>*Fixed in 6000.4.0b11.*
...
- Editor: Fix bugs where merging too many artifacts could make LMDB crash if cancelling in the middle of the preprocessing of artifacts.
    ...
    *First seen in 6000.4.0b4.*    <br>*Fixed in 6000.4.0b11.*
...
- Editor: Fixed issue with language toggling on a physical keyboard would not work correctly.
    ([UUM-130105](https://issuetracker.unity3d.com/issues/android-legacy-tmp-and-ui-toolkit-input-field-language-toggle-to-some-non-latin-alphabet-languages-does-not-work-with-external-keyboard))    <br>*Fixed in 6000.4.0b11.*
...
- GI: Fix error on Windows saying that certain Surface Cache files are missing their meta file.
    ...
    *First seen in 6000.4.0b10.*    <br>*Fixed in 6000.4.0b11.*
...
- Graphics: \[URP\] Fixed an issue causing materials to be black when building for mobile platforms in batchmode with Decals enabled.
    ([UUM-134298](https://issuetracker.unity3d.com/issues/urp-all-materials-render-black-when-building-via-batchmode-or-without-rendering-scene-slash-game-view-in-editor-if-decal-renderer-technique-is-set-to-automatic))    <br>*Fixed in 6000.4.0b11.*
...
- Text: Fixed a memory leak by ensuring OSFallbacks are properly preserved after domain reload.
    ([UUM-132677](https://issuetracker.unity3d.com/issues/editor-memory-leak-when-entering-and-exiting-play-mode-in-a-blank-urp-project))    <br>*Fixed in 6000.4.0b11.*

- uGUI: Fixed crash caused by having very large rect transform bounds
    ([UUM-132182](https://issuetracker.unity3d.com/issues/crash-on-raiseexception-when-creating-a-multiplayer-room-while-toggling-ui))    <br>*Fixed in 6000.4.0b11.*

- Video: Fixed failure to play Video on specific mobile devices with Vulkan Graphics API
    ([UUM-133914](https://issuetracker.unity3d.com/issues/video-player-renders-no-video-on-specific-devices-when-using-vulkan))    <br>*Fixed in 6000.4.0b11.*
...
### New 6000.4.0b10 Entries since 6000.4.0b9
...
- Editor: Fixed an issue where docking the Search window didn't properly set up the QueryTree handlers.
    ([UUM-132981](https://issuetracker.unity3d.com/issues/nullreferenceexception-errors-are-thrown-in-the-console-when-clicking-on-saved-built-in-reports-in-docked-search-window))<br>
...
- Editor: Fixed inconsistent ID values between Signing Team ID and iOS/tvOS Profile ID in External Tools.
    ([UUM-132053](https://issuetracker.unity3d.com/issues/inconsistent-id-values-between-signing-team-id-and-ios-slash-tvos-profile-id-in-external-tools))<br>
...
- Graph Toolkit: Copy-pasting and duplicating asset subgraphs now works correctly.
    ([UUM-131411](https://issuetracker.unity3d.com/issues/copy-pasting-asset-subgraphs-does-not-work))<br>
    *First seen in 6000.4.0b6.*
...
- Graph Toolkit: Multi-selecting local subgraph nodes no longer throws a null reference exception.
    ([UUM-131403](https://issuetracker.unity3d.com/issues/multi-selecting-two-local-subgraphs-throws-an-error))<br>
...
- Graph Toolkit: The Select and Open button in the Asset Subgraph Node inspector now works correctly.
    ([UUM-131398](https://issuetracker.unity3d.com/issues/the-inspector-open-select-and-object-field-dont-work-on-asset-subgraph-nodes))<br>
    *First seen in 6000.4.0b6.*
...
- IL2CPP: Fix crash on Switch platform when using WebRequests with debug c++ configuration.
    (UUM-127898)
...
- WebGL: Fixed a issue with AudioSource.SetScheduledEndTime, when an AudioSource play request is pending at startup when SetScheduledEndTime is called.
    ([UUM-117576](https://issuetracker.unity3d.com/issues/setscheduled-end-time-does-not-work-on-webgl))<br>
...
- com.unity.xr.interaction.toolkit: [3.4.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.4//changelog/CHANGELOG.html) to [3.4.0](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.4//changelog/CHANGELOG.html)
...
### Preview of Final 6000.4.0b10 Release Notes
...
#### Preview of Final 6000.4.0b10 Package changes
...
- com.unity.addressables: [2.7.2](https://docs.unity3d.com/Packages/com.unity.addressables@2.7//changelog/CHANGELOG.html) to [2.9.0](https://docs.unity3d.com/Packages/com.unity.addressables@2.9//changelog/CHANGELOG.html)
...
- com.unity.inputsystem: [1.14.2](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.14//changelog/CHANGELOG.html) to [1.18.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.18//changelog/CHANGELOG.html)
...
- com.unity.scriptablebuildpipeline: [2.4.1](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.4//changelog/CHANGELOG.html) to [2.6.0](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.6//changelog/CHANGELOG.html)
...
- com.unity.services.analytics: [6.1.0](https://docs.unity3d.com/Packages/com.unity.services.analytics@6.1//changelog/CHANGELOG.html) to [6.2.1](https://docs.unity3d.com/Packages/com.unity.services.analytics@6.2//changelog/CHANGELOG.html)
...
- com.unity.ai.navigation: [2.0.7](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html) to [2.0.10](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html)
...
- com.unity.services.deployment: [1.5.0](https://docs.unity3d.com/Packages/com.unity.services.deployment@1.5//changelog/CHANGELOG.html) to [1.7.0](https://docs.unity3d.com/Packages/com.unity.services.deployment@1.7//changelog/CHANGELOG.html)
