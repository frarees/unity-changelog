...
### New 6000.4.0f1 Entries since 6000.4.0b11

#### Features

- macOS: Added support for `CAMetalDisplayLink` on the macOS Player.<br>
    To enable this feature, in the Player Settings, select `Use MetalDisplayLink (Mac Player only)`. You can also enable it by using the `UNITY_USE_METAL_DISPLAY_LINK=1` environment variable. This feature is disabled by default.<br>
...
- Asset Pipeline: Editor: Prevented duplicate cache server requests being scheduled by on-demand imports.
    (UUM-126416)<br>
...
- Editor: Fixed selection issue in SearchView.
    ([UUM-135083](https://issuetracker.unity3d.com/issues/windows-search-window-refreshes-and-first-search-result-gets-highlighted-after-double-clicking-search-result-that-creates-an-item))<br>
    *First seen in 6000.4.0b10.*

- Editor: Fixed the module details panel controller script example.

- Editor: Fixed volumetric clouds white flickering when camera was moving with close alpha clipped geometry.
    ([UUM-99279](https://issuetracker.unity3d.com/issues/artifacts-are-visible-when-moving-and-viewing-alpha-clipped-geometry-in-front-of-volumetric-clouds))<br>
    *First seen in 6000.5.0a1.*

- Editor: Repair links to the Hub documentation.

- Editor: Updated the Unity Product Name to remove beta from the title bar of the Editor.

- Entities: In rare cases the Entities ILPostProcessor would hang, preventing the project from opening.
    ([UUM-125131](https://issuetracker.unity3d.com/issues/editor-is-not-able-to-load-when-using-nuget-dll-plugins-and-scripting-define-symbol-disable-typemanager-ilpp))<br>
...
- Graphics: Made sure that builtinRP blit copy does output float4 color \(as opposed to fxed4, which is translated to half4 on metal, resulting in data truncation for u16 or f32 data\).
...
- Graphics: URP: Fixed an SSAO issue on Metal and some Vulkan devices so now SSAO uses multiple Raster render passes instead of a single Unsafe pass with multiple SetRenderTarget calls. When "After Opaque" is disabled, SSAO now renders earlier in the frame.
...
- Scripting: Fixed memory leak in UnityEvent in player builds.
    ([UUM-131348](https://issuetracker.unity3d.com/issues/unityeventbase-dot-s-unityevents-memory-leak-occurs-when-loading-and-unloading-scenes-with-ugui-components))<br>
...
- Shaders: Fixed crash when prewarming `ShaderVariantCollection`s.
    ([UUM-133596](https://issuetracker.unity3d.com/issues/crash-on-core-basic-string-when-opening-a-specific-project-and-registering-shaders-after-making-minimal-changes-to-a-scene))<br>
...
- uGUI: Fixed documentation links in the Inspector for UGUI/TMP classes.
    ([UUM-131892](https://issuetracker.unity3d.com/issues/physics-2d-raycaster-is-missing-a-documentation-link), [UUM-132126](https://issuetracker.unity3d.com/issues/horizontal-and-vertical-layout-group-components-are-missing-the-documentation-link), [UUM-132287](https://issuetracker.unity3d.com/issues/rect-transform-components-documentation-link-is-missing), [UUM-133905](https://issuetracker.unity3d.com/issues/text-component-documentation-is-missing))<br>
    *First seen in 6000.4.0b3.*
...
- WebGL: WebGPU: Fixed an error in the shader compiler that caused some shaders to fail compilation.
    ([UUM-134978](https://issuetracker.unity3d.com/issues/shader-compiler-and-shader-errors-are-thrown-in-the-console-when-building-web-platform-with-webgpu-experimental-enabled-in-auto-graphics-api))<br>
    *First seen in 6000.4.0b10.*




#### New 6000.4.0f1 Package Changes since 6000.4.0b11

#### Packages updated

- com.unity.2d.animation: [14.0.2](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html) to [14.0.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html)

- com.unity.2d.psdimporter: [13.0.1](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@13.0//changelog/CHANGELOG.html) to [13.0.2](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@13.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [14.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@14.0//changelog/CHANGELOG.html) to [14.0.1](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@14.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [7.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@7.0//changelog/CHANGELOG.html) to [7.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@7.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [4.0.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@4.0//changelog/CHANGELOG.html) to [4.0.1](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@4.0//changelog/CHANGELOG.html)

- com.unity.2d.tooling: [2.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tooling@2.0//changelog/CHANGELOG.html) to [2.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tooling@2.0//changelog/CHANGELOG.html)
...
- com.unity.netcode.gameobjects: [2.8.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.8//changelog/CHANGELOG.html) to [2.10.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.10//changelog/CHANGELOG.html)
...
### Final 6000.4.0f1 Release Notes

#### Features

- 2D: Runtime SpriteAtlas to optimize game performance by dynamically creating and managing sprite atlases at runtime.
...
- Entities: Disabled now is allowed assembly-wide.
...
- Bug Reporter: Improved Bug Reporter launch times through optimizations.
...
- Editor: Optimized Asset Hot Reloading subscription system.
...
- Installer: Removed the activation of .NET 3.5 on Windows systems, greatly reducing installation time when using the installers directly.
    (UUM-133360)
...
- Physics: Exposed log verbosity as an option in the physics pane to allow users to suppress some warnings/logs coming out of the PhysX integration. The new setting can be found under *Edit* &gt; *Project Settings* &gt; *Physics* &gt; *Settings*, within the *GameObject* tab.
    (PHYS-681)

- Physics 2D: The PhysicsComposer now implements the IDisposable interface where the public IDisposable.Dispose method simply calls "PhysicsComposer.Destroy\(\)".
...
- Shadergraph: Improve appearance of channel dropdown on UV node when node is collapsed.
...
- SRP Core: Added a confirmation prompt in the Render Pipeline Converter when converting project assets.

- SRP Core: Added a static modifier for all lambdas in `SetRenderFunc` for URP and HDRP.
...
- Windows: Improved the performance of opening files on Windows with DirectStorage enabled.
...
- 2D: Added: Exposed texture resources in Universal2DResourceData.
...
- Asset Import: Changed: Deprecated `UnityEditor.Experimental.ArtifactID` and renamed it to `UnityEditor.Experimental.ImportResultID`.
...
- Asset Pipeline: Obsoleted: Marked `InstanceIDsToValidArray(ReadOnlySpan<int>, Span<bool>)` as obsolete. Use `EntityIdToValidArray(ReadOnlySpan<EntityId>, Span<bool>)` instead.
...
- Core: Added: Added `EntityId.GetRawData` to access the underlying data of an `EntityId`.
...
- Editor: Changed: Project Auditor: Removed the MemoryIgnoreVoidReturn area and introduced returnType instead.

- Editor: Deprecated: Deprecated `BatchCullingViewType`. Use `EntityId` instead.

- Editor: Deprecated: Deprecated `HierarchyFlattenedNodeChildren` and `HierarchyViewNodesEnumerable`. Use `HierarchyFlattenedChildrenEnumerable` and `HierarchyViewModelNodesEnumerable` as their respective replacements.
    (UUM-114955)
...
- Editor: Obsoleted: The Implicit conversion between EntityId and int has been obsoleted.
...
- Editor: Obsoleted: `GetInstanceID` was marked as obsolete.
...
- Editor: Removed: Removed intermediate texture mode option from URP asset.
    (UUM-117084)
...
- EmbeddedLinux: Added: Added GameWindow events to detect position and resolution changes to the Windowing API.

- Entities: Added: Added an error log for when the generation of an `IJobEntity` schedule invocation fails.

- Entities: Added: Added the new `NativeStream.ScheduleConstruct` function for creating stream using NativeReference for specifying buffer count.

- Entities: Added: Added `UnsafeStream.ReaderState` to enable random accesses in stream buffers through `UnsafeStream.Reader`.

- Entities: Added: Provided unsafe access to NativeStream for each count ptr for IJobParallelForDefer job scheduling.

- Entities: Deprecated: Deprecated `EntityGuid(int, int, uint, uint)`. Use public `EntityGuid(EntityId, EntityId, uint, uint)` instead.

- Entities: Deprecated: Deprecated `EntityGuid.a`. It is now split up into the fields: 'OriginatingEntityId' and 'OriginatingSubEntityId'.

- Entities: Deprecated: Deprecated `EntityGuid.b`. Use 'NamespaceAndSerial' instead.
...
- Graphics: Deprecated: AdaptiveProbeVolumes.BakeAdditionalRequests\(int\[\]\) is deprecated. Use AdaptiveProbeVolumes.BakeAdditionalRequests\(EntityId\[\]\) instead.
...
- Package: Deprecated: Deprecated Multiplayer Widgets in favor of Unity Building Blocks.
...
- Package Manager: Added: Package Manager: Exposed Pack API as public.<br>
    PackRequest Pack\(string packageFolder, string targetFolder, string ownerOrgId\).

- Package Manager: Deprecated: Package Manager: Deprecated previous public Pack API.<br>
...
- Physics: Deprecated: Deprecated `ClosestPointCommand(Vector3, int, Vector3, Quaternion, Vector3)` constructor. Use `ClosestPointCommand(Vector3, EntityId, Vector3, Quaternion, Vector3)` instead.

- Physics: Deprecated: Deprecated `ClosestPointCommand.colliderInstanceID`. Use `colliderEntityId` instead.

- Physics: Deprecated: Deprecated `ColliderHit.instanceID`. Use `entityId` instead.

- Physics: Deprecated: Deprecated `ModifiableContactPair.bodyInstanceID`. Use `bodyEntityId` instead.

- Physics: Deprecated: Deprecated `ModifiableContactPair.colliderInstanceID`. Use `colliderEntityId` instead.

- Physics: Deprecated: Deprecated `ModifiableContactPair.otherBodyInstanceID`. Use `otherBodyEntityId` instead.

- Physics: Deprecated: Deprecated `ModifiableContactPair.otherColliderInstanceID`. Use `otherColliderEntityId` instead.

- Physics 2D: Added: Added missing "PhysicsComposer.ClearLayers\(\)" to remove the need to get layer handles then sequentially remove layers with those handles.
...
- Scene Manager: Deprecated: Deprecated implicit casts on `SceneHandle` and exposed `SceneHandle.FromRawData` and `SceneHandle.GetRawData` instead.
...
- Scripting: Added: - Added new method `AsReadOnlySpan` on `HierarchyFlattened` to retrieve the flattened nodes from a hierarchy flattened as a read-only span.<br>
    ...
    - Added new event `FlagsChanged` on `HierarchyViewModel`, that is invoked whenever flags are changed.<br>
...
- Scripting: Added: Added new methods for hierarchy manipulation:<br>
    *   `Hierarchy.SetParent(node, parent, index)` to change the parent of a node and move it to a specified index within the parent's children list.<br>
    *   `HierarchyCommandList.SetParent(node, parent, index)` to perform the same `SetParent` operation within a command list.<br>
    *   `HierarchyFlattened.GetChild(parent, index)` and `HierarchyViewModel.GetChild(parent, index)` to retrieve a child at a specified index from a parent node.
    (UUM-114955)

- Scripting: Changed: *   Changed the sort index to support the full range of `int`, including negative values.<br>
    *   Changed the `Hierarchy.SetName` method to return `void` instead of `bool`.<br>
    *   Changed the `Hierarchy.SetParent` method to return `void` instead of `bool`.<br>
    *   Changed `HierarchyFlattened.EnumerateChildren` to return an enumerable of `HierarchyFlattenedNode` instead of `HierarchyNode`.<br>
    *   Renamed `HierarchyFlattenedNodeChildren` to `HierarchyFlattenedChildrenEnumerable` and marked the original name as obsolete.<br>
    *   Renamed `HierarchyViewNodesEnumerable` to `HierarchyViewModelNodesEnumerable` and marked the original name as obsolete.
    (UUM-114955)

- Scripting: Changed: - The method `EndFlagsChange` now returns which flags were changed if any were.<br>
...
- SRP Core: Added: Exposed public API for declaring  converters in the Render Pipeline Converter.
...
- SRP Core: Deprecated: Deprecated multiple `Texture2DAtlas` and `PowerOfTwoTextureAtlas` methods. Use the new version which takes `TextureIdentifier`s instead.

- SRP Core: Deprecated: Deprecated `RTHandle.GetInstanceID()`. Use `GetUniqueID()` instead.
...
- TextCore: Deprecated: Deprecated `TextAsset.instanceID`. Use `entityId` instead.

- uGUI: Deprecated: Deprecated TMP_Asset.instanceID, use entityId instead.

- uGUI: Deprecated: Deprecated `ITextElement.GetInstanceID()`, use `GetEntityId()` instead.

- uGUI: Deprecated: Deprecated `MaterialReferenceManager.AddMaterialReference` methods that take in instanceIds. Use the EntityId versions instead.
...
- URP: Deprecated: Deprecated `UniversalResources.AfterPostProcessColor`, which unused and had no purpose.

- Web: Removed: Removed Instant Games derived platform.

- XR: Added: Added `GetSubmeshClassifications` and associated bindings to allow provider classification of components of AR and MR meshes.
...
- Documentation: Update docs to reflect that Audio is imported parallel too
...
- iOS: Implemented UIScene lifecycle events for iOS, tvOS, and visionOS.
...
- Shadergraph: Disabled profiling during code generation because in some circumstances it would cause errors.
...
- Version Control: Added "clever" path truncation.

- Version Control: Added a progress indicator that overlays the view.

- Version Control: Added a real indeterminate progress bar.
...
- Version Control: Redesigned all views and dialogs.

- Version Control: Redesigned the main panel to include a top breadcrumb navigation.

- Version Control: Renamed the toolbar dropdown to comply with a 120px max width limit in Unity 6.5.
...
- 2D: Change the image used for as a warning icon in the Tile Palette to a higher resolution image so that it looks less blurry in the Editor.
...
- 2D: Fix BoxFill not updating Tiles when painting over a 4x4 or larger region
...
- 2D: Fixed an  issue with the Tile Palette window where a user can continue panning the Tile Palette window if the user's pointer leaves the Tile Palette window while panning and deactivates panning outside of the Tile Palette window.
...
- 2D: Fixed an issue where a `SpriteRenderer`'s `MaterialPropertyBlock` was reset when its serialized properties were changed, if the block contained exactly two properties.
...
- 2D: Fixed an issue where the Tile Palette moves in the forward axis when it is zoomed in or out while its swizzle is set to non-XY/YX values.
    (UUM-133308)

- 2D: Fixed an issue where the user paints with an empty brush at any position and clears the Tile at \(0, 0, 0\).
...
- Adaptive Performance: Fixed an issue where Adaptive Performance generated logs in non-development builds.
    (UUM-131941)
...
- Android: Fix gdb path in Linux/Mac for displayed warning
    (UUM-133333)
...
- Android: Fixed an exception "Didn't find class "com.unity3d.player.ReflectionHelper" and application crash when setting `AndroidJNIHelper.debug` to true.
...
- Android: Fixed an issue where the text input introduced previously deleted characters when using a Vietnamese keyboard on certain devices while the input field is hidden.
...
- Android: Fixed an issue with the visible icon artefact during the splash screen on Android XR.
    (UUM-126180)

- Android: Fixed and improved warning messages in the External Tools window when non-recommended tools are used.
...
- Android: Fixed the audio device selection on Android to prioritize USB headsets over the default device when connected.
    (UUM-130419)
...
- Android: Improve gradle dependency setup for merge_variant_JniLibFolders versus buildIl2Cpp.
    (UUM-128853)
...
- Android: Remove legacy @TargetApi\(Build.VERSION_CODES.M\) from code
    (UUM-131585)
...
- Animation: Fixed an issue when clicking the Play button immediately after selecting a clip in Animation Window. The Space shortcut now plays the clip as expected rather than opening the clip selection dropdown.
...
- Animation: Fixed an issue where animated UI Toolkit Property Fields in component inspectors failed to tint correctly when entering and exiting animation preview mode from the Animation window.
...
- Audio: Fixed an issue where an exception was thrown when allocating a native collection in scriptable generator control callbacks.
...
- Bug Reporter: Fix for values changing when scrolling while hovering over focused dropdown field
    (SUS-5725)
...
- Build System: Improved the build process to prevent it from accessing internal Unity repositories.
    (UUM-110562)
...
- DX12: Disabled tight alignment when running from the PIX debugging tool.
    (UUM-131326)
...
- DX12: Fixed native RenderPass validation errors in the Editor and Player.
    (UUM-112861)
...
- Editor: Add safeguards in the Linux Editor to mitigate potential crashes during project load.
...
- Editor: Added version information to the `UnityCrashHandler` executable.
    (UUM-132574)

- Editor: Adding a message in the console when trying to open a player.log or editor.log file that is not available.
...
- Editor: Change toolbar elements max-width to fix elements that are too small.
    (STO-3747)
...
- Editor: Clamped the `AutoSize` property for text elements to prevent potential errors from invalid size values.
...
- Editor: Cleared the text input field in the Inspector after adding a new element to a list.
    (UUM-103526)
...
- Editor: Enabled the Export report and Export CSV options for the `TableView`.
...
- Editor: Fix parsing of ScriptTemplates with negative priorities
...
- Editor: Fix water decal sampling in Sample Water Surface VFX Graph Node
    (UUM-132609)
...
- Editor: Fixed a file path length error that occurred when a Build Profile name contained a large number of special characters.
...
- Editor: Fixed a hang that occurred when loading or unloading AssetBundles canceled texture streaming requests.
...
- Editor: Fixed a Mac Editor crash during shutdown if ModalProgressBar is displayed.
    ([UUM-114938](https://issuetracker.unity3d.com/issues/crash-when-closing-the-editor-with-unsaved-vfx-graph-changes))

- Editor: Fixed a memory leak that occurred when baking a Signed Distance Field from multiple meshes.
...
- Editor: Fixed a perf regression in macOS Editor play mode.
    (UUM-120043)
...
- Editor: Fixed Advanced Text Generator `fontSize` to match TextCore.
    (UUM-114780)
...
- Editor: Fixed an issue where a warning is thrown unexpectedly when saving a layout.
...
- Editor: Fixed an issue where Explicit Null Checks and Explicit Array Bounds Checks were not being used during the Build Process when using a Build Profile.
    (UUM-116633)

- Editor: Fixed an issue where Find reference in Scene option did not find the selected object itself in the results, matching the behavior to Legacy hierarchy.
...
- Editor: Fixed an issue where long Player Tag names overlapped text in the Active Scenario window.
...
- Editor: Fixed an issue where new `EntityId` was not displaying in the Inspector in Debug mode.
...
- Editor: Fixed an issue where sliders in the main toolbar did not function correctly when their minimum value was greater than zero.
...
- Editor: Fixed an issue where the Cancel button was not correctly hidden when not needed.
...
- Editor: Fixed an issue where the Cancel button was not displayed when set from the searchable window API.
...
- Editor: Fixed an issue where the Frame Debugger disconnected when the Render Graph Viewer was closed.
...
- Editor: Fixed an issue where trying to open the Render Pipeline Converter window in playmode would cause an unrelated window to be opened.
...
- Editor: Fixed an issue where using the Inspector in debug mode would throw errors in the console.
...
- Editor: Fixed an issue with unicode truncation.
...
- Editor: Fixed an unwanted empty folder in VFX Learning Templates samples.
...
- Editor: Fixed crash in crash handler.
    (UUM-131184)
...
- Editor: Fixed creating `AnimationStateMachineBehaviour` to return `EntityId`.
...
- Editor: Fixed the Color fields in the UI Toolkit Debugger so they now update after the first click.
...
- Editor: Fixed the hierarchy layer column to have the same behavior as the GameObject inspector header.
...
- Editor: Fixed the ReoderableList to set the `GUI.changed` value when accepting a drag and drop onto its header in the Editor.
...
- Editor: Fixed the static column in new hierarchy to have a behavior closer to the static checkbox in the GameObject inspector.
...
- Editor: Fixed `Unwrapping.GenerateSecondaryUVSet` when used with meshes that have modified baseVertex values.
...
- Editor: Play Mode Status green checkmark is not light theme friendly.
...
- Editor: Removed placeholder when not in QueryBuilder mode since Tab is not supported.
...
- EmbeddedLinux: Fixed MultiDisplay size and position issue.
    (UUM-132410)

- EmbeddedLinux: Fixed MultiDisplay size and position issue.
    (UUM-132410)

- EmbeddedLinux: Fixed RaspiOS vulkan crash.
...
- Entities: IndexOutOfRangeException: Index -1 is out of range in container of '0' Length. in Unity.Entities.ComponentSystemSorter.FindExactCycleInSystemGraph when detecting system circular dependencies.
...
- GI: Fixed an issue where closed Subscenes did not open before APV baking started when "Generate Lighting" was pressed in the Lighting window.
    (UUM-104411)
...
- GI: Updated Adaptive Probe Volumes to set the active baking set when a user loads one.
...
- Graphics: Fixed a shadow artifact for point lights when soft shadows were enabled.
...
- Graphics: Fixed an issue in the Frame Debugger where the Levels value fields unpredictably changed size when switching between debug events on Windows.
...
- Graphics: Improved Skinned Mesh Renderer compatibility  in Optimize Game Objects mode by supporting nested or multiple Animator components in the hierarchy.
...
- Graphics: \[Android\] Fixed temporary setting the graphics API until Vulkan is supported.
    (PLAT-15366)
...
- GraphView: Added pointer events to handle edge connection and manipulation, enabling proper touch input support.
...
- HDRP: Fixed an issue that caused shadows to appear pixelated when cast far from a light source, even when using a high shadow resolution.
...
- HDRP: Fixed an issue where shadows did not render up to the full distance defined by a light's range.
...
- IL2CPP: Fix a rare crash of the il2cpp executable on Windows and Linux
    (UUM-127507)
...
- IL2CPP: Reduce startup time by improving internal hashing function for generic parameter types.
    (UUM-133424)
...
- iOS: Fixed an issue where input was reset when requesting an orientation change that matched the previous orientation.
    (UUM-114722)
...
- iOS: UI adjusted to better fit with liquid glass \(not yet fully\).
    (UUM-133464)
...
- Multiplayer: Fixed an issue where the Add and Remove buttons in the Multiplayer Player Tags window were inverted.
...
- Multiplayer: Fixed an `ArgumentNullException` that occurred in the Multiplayer Play Mode's 'Local Instances' list when the Android Build Support module was installed but the Android SDK was not configured in the Editor.
...
- Package Manager: Fixed an issue that was causing valid package signatures to be flagged as invalid if validated after the signing certificate expired.
...
- Package Manager: Fixed an issue where the progress indicator doesn't work when installing UPM packages on Asset Store.
    (UUM-127805)

- Package Manager: Fixed an issue where the progress indicator doesn't work when updating UPM packages on Asset Store.
    (UUM-115289)
...
- Package Manager: Move the update button outside of manage dropdown for better visibility.
    (UUM-129013)

- Package Manager: Package Manager: Resolved a bug causing valid package signatures to be flagged as invalid if validated after the signing certificate expired.
    (UUM-13300)
...
- Particles: Fixed a memory leak related to Particle System job fences.
    (UUM-113729)
...
- Physics 2D: Fix a crash when exiting play mode related to a bad read/write lock.
    ([UUM-133493](https://issuetracker.unity3d.com/issues/crash-on-dispatch-release-when-exiting-play-mode-in-a-specific-scene))
...
- Physics 2D: Fixed `PhysicsHingeJoint.motorSpeed` and `PhysicsWheelJoint.motorSpeed` to use degrees instead of radians for consistency with other API properties.
...
- QNX: Fixed MultiDisplay size and position issue.
    (UUM-132410)
...
- Shadergraph: Fix issue where modifying a Keyword Enum in dynamic branch mode could result in a compilation error.
...
- Shadergraph: Fixed an issue that caused a subgraph node to enter a drag state when double-clicked.
...
- Shadergraph: Fixed an issue where Subgraphs with an invalid type for their first output generated a shader compilation error in addition to a Shader Graph error.
...
- Shaders: Fixed a CPU-side performance regression when a shader has dynamic branch keywords.
    (UUM-114974)
...
- Shaders: Fixed an issue where the Material Inspector showed duplicate entries in the Shader dropdown.
...
- SRP Core: Render Pipeline Converter - Improve UX of the tool.
...
- Text: Add ATG support for the nobr tag
    (UUM-133007)
...
- Text: Added support for a rich text tag to apply color gradients to text.
    (UUM-130960)
...
- Text: Added support for the `<allcaps>` and `<smallcaps>` rich text tags.
    (UUM-130141)

- Text: Added support for the `<indent>` rich text tag, which allows for the indentation of text.
    (UUM-131288)
...
- TextMeshPro: Improve handling of improperly formatted &lt;a&gt; tag where the "href" part is missing. A properly formatted tag should be &lt;a href="link ID"&gt;text to be highlighted&lt;/a&gt;.
...
- UI Toolkit: Added UI Toolkit Basic Template for Shader Graph.
    (UUM-114233)
...
- UI Toolkit: Correctly handle freeing mesh when rendering is in progress.
...
- UI Toolkit: Fixed a `NullReferenceException` that occurred when docking the UI Builder window after deleting an element.
...
- UI Toolkit: Fixed an issue that prevented sprites from loading when referenced from a USS file.
...
- UI Toolkit: Fixed an issue where previews were incorrectly displayed in the Game view.
...
- UI Toolkit: Fixed the Extract inline style option in UI Builder.
...
- UI Toolkit: Improved search result messages in the UI Toolkit Layout Debugger.
...
- Undo System: Fixed an issue where modifications could be added during undo action generation.
...
- URP: Fixed an issue with depth priming where intermediate textures are not requested when needing a depth copy.
    (UUM-131236)
...
- VFX Graph: Fixed an issue where attached VisualEffect did not refresh when visual effect component changed.
...
- VFX Graph: Fixed an issue where ShaderGraph incorrectly handled scenarios where only one Scriptable Render Pipeline supports VFX but not the current one.
...
- VFX Graph: Fixed GPU Time Threshold in Heatmap Parameters to be clamped to positive values only.
...
- VFX Graph: Fixed padding on Sub Mesh Mask label for mesh outputs.
...
- VFX Graph: Fixed text cutoff when a context name is very long.
    ([UUM-114091](https://issuetracker.unity3d.com/issues/node-name-gets-cut-off-in-the-visual-effect-graph-when-the-name-is-long))

- VFX Graph: Fixed the Prewarm Time input field to fit 2 digits of precision.
...
- Video: Fixed a crash on `VideoPlayer::InvokeScriptCallbacks` when domain reloads while playing a video on Linux.
...
- Video: Fixed an issue where video recording was not created when a path contains Japanese characters.
...
- Web: Fix simulated mouse position by touch events in legacy input system\(Input.mousePosition\).
...
- Web: Fixed an issue that occurred when handling touchcancel events.
...
- WebGL: Fixed a web build issue when static libraries are included in the project.
    ([UUM-115822](https://issuetracker.unity3d.com/issues/static-libraries-cause-web-build-to-fail))

- WebGL: Fixed a WebGPU error when uploading compressed texture mip levels that are not block size aligned.
    ([UUM-116437](https://issuetracker.unity3d.com/issues/webgpu-errors-when-compressed-texture-has-non-aligned-mip-levels))

- WebGL: Fixed a WebGPU `depthBiasSlopeScale` error when rendering points.
...
- WebGL: WebGPU: Fixed issues with inconsistent handling of the texture_formats_tier2 extension, which enables read-write storage texture access for a number of texture formats.
    (UUM-131865)

- WebGL: WebGPU: Fixed maxComputeWorkGroupSize limit, which was previously set too high and could cause compute shaders to fail on some browsers.
...
#### Final 6000.4.0f1 Package changes
...
- com.unity.netcode: [1.7.0](https://docs.unity3d.com/Packages/com.unity.netcode@1.7//changelog/CHANGELOG.html) to [1.11.0](https://docs.unity3d.com/Packages/com.unity.netcode@1.11//changelog/CHANGELOG.html)
...
- com.unity.2d.animation: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@13.0//changelog/CHANGELOG.html) to [14.0.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html)
...
- com.unity.2d.psdimporter: [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@12.0//changelog/CHANGELOG.html) to [13.0.2](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@13.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@13.0//changelog/CHANGELOG.html) to [14.0.1](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@14.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [6.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@6.0//changelog/CHANGELOG.html) to [7.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@7.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [3.0.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@3.0//changelog/CHANGELOG.html) to [4.0.1](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@4.0//changelog/CHANGELOG.html)

- com.unity.2d.tooling: [1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.2d.tooling@1.0//changelog/CHANGELOG.html) to [2.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tooling@2.0//changelog/CHANGELOG.html)

- com.unity.addressables: [2.7.2](https://docs.unity3d.com/Packages/com.unity.addressables@2.7//changelog/CHANGELOG.html) to [2.9.1](https://docs.unity3d.com/Packages/com.unity.addressables@2.9//changelog/CHANGELOG.html)
...
- com.unity.animation.rigging: [1.3.0](https://docs.unity3d.com/Packages/com.unity.animation.rigging@1.3//changelog/CHANGELOG.html) to [1.4.1](https://docs.unity3d.com/Packages/com.unity.animation.rigging@1.4//changelog/CHANGELOG.html)
...
- com.unity.burst: [1.8.24](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html) to [1.8.28](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html)
...
- com.unity.collab-proxy: [2.9.2](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.9//changelog/CHANGELOG.html) to [2.11.4](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.11//changelog/CHANGELOG.html)
...
- com.unity.ide.rider: [3.0.36](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html) to [3.0.39](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html)

- com.unity.ide.visualstudio: [2.0.23](https://docs.unity3d.com/Packages/com.unity.ide.visualstudio@2.0//changelog/CHANGELOG.html) to [2.0.27](https://docs.unity3d.com/Packages/com.unity.ide.visualstudio@2.0//changelog/CHANGELOG.html)

- com.unity.inputsystem: [1.14.2](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.14//changelog/CHANGELOG.html) to [1.19.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.19//changelog/CHANGELOG.html)
...
- com.unity.mobile.android-logcat: [1.4.5](https://docs.unity3d.com/Packages/com.unity.mobile.android-logcat@1.4//changelog/CHANGELOG.html) to [1.4.7](https://docs.unity3d.com/Packages/com.unity.mobile.android-logcat@1.4//changelog/CHANGELOG.html)

- com.unity.mobile.notifications: [2.4.1](https://docs.unity3d.com/Packages/com.unity.mobile.notifications@2.4//changelog/CHANGELOG.html) to [2.4.3](https://docs.unity3d.com/Packages/com.unity.mobile.notifications@2.4//changelog/CHANGELOG.html)
...
- com.unity.performance.profile-analyzer: [1.2.3](https://docs.unity3d.com/Packages/com.unity.performance.profile-analyzer@1.2//changelog/CHANGELOG.html) to [1.3.2](https://docs.unity3d.com/Packages/com.unity.performance.profile-analyzer@1.3//changelog/CHANGELOG.html)
...
- com.unity.probuilder: [6.0.6](https://docs.unity3d.com/Packages/com.unity.probuilder@6.0//changelog/CHANGELOG.html) to [6.0.9](https://docs.unity3d.com/Packages/com.unity.probuilder@6.0//changelog/CHANGELOG.html)
...
- com.unity.purchasing: [4.12.2](https://docs.unity3d.com/Packages/com.unity.purchasing@4.12//changelog/CHANGELOG.html) to [4.14.2](https://docs.unity3d.com/Packages/com.unity.purchasing@4.14//changelog/CHANGELOG.html)

- com.unity.recorder: [5.1.2](https://docs.unity3d.com/Packages/com.unity.recorder@5.1//changelog/CHANGELOG.html) to [5.1.5](https://docs.unity3d.com/Packages/com.unity.recorder@5.1//changelog/CHANGELOG.html)
...
- com.unity.remote-config: [4.1.1](https://docs.unity3d.com/Packages/com.unity.remote-config@4.1//changelog/CHANGELOG.html) to [4.2.5](https://docs.unity3d.com/Packages/com.unity.remote-config@4.2//changelog/CHANGELOG.html)
...
- com.unity.scriptablebuildpipeline: [2.4.1](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.4//changelog/CHANGELOG.html) to [2.6.1](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.6//changelog/CHANGELOG.html)
...
- com.unity.services.analytics: [6.1.0](https://docs.unity3d.com/Packages/com.unity.services.analytics@6.1//changelog/CHANGELOG.html) to [6.3.0](https://docs.unity3d.com/Packages/com.unity.services.analytics@6.3//changelog/CHANGELOG.html)

- com.unity.services.authentication: [3.5.1](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.5//changelog/CHANGELOG.html) to [3.6.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.6//changelog/CHANGELOG.html)
...
- com.unity.services.cloud-build: [2.0.3](https://docs.unity3d.com/Packages/com.unity.services.cloud-build@2.0//changelog/CHANGELOG.html) to [2.0.7](https://docs.unity3d.com/Packages/com.unity.services.cloud-build@2.0//changelog/CHANGELOG.html)
...
- com.unity.services.vivox: [16.6.2](https://docs.unity3d.com/Packages/com.unity.services.vivox@16.6//changelog/CHANGELOG.html) to [16.9.0](https://docs.unity3d.com/Packages/com.unity.services.vivox@16.9//changelog/CHANGELOG.html)
...
- com.unity.splines: [2.8.1](https://docs.unity3d.com/Packages/com.unity.splines@2.8//changelog/CHANGELOG.html) to [2.8.3](https://docs.unity3d.com/Packages/com.unity.splines@2.8//changelog/CHANGELOG.html)
...
- com.unity.ui.test-framework: [1.0.0](https://docs.unity3d.com/Packages/com.unity.ui.test-framework@1.0//changelog/CHANGELOG.html) to [6.4.0](https://docs.unity3d.com/Packages/com.unity.ui.test-framework@6.4//changelog/CHANGELOG.html)
...
- com.unity.xr.arcore: [6.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.3//changelog/CHANGELOG.html) to [6.4.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.4//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.3//changelog/CHANGELOG.html) to [6.4.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.4//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.3//changelog/CHANGELOG.html) to [6.4.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.4//changelog/CHANGELOG.html)

- com.unity.xr.compositionlayers: [2.1.0](https://docs.unity3d.com/Packages/com.unity.xr.compositionlayers@2.1//changelog/CHANGELOG.html) to [2.3.0](https://docs.unity3d.com/Packages/com.unity.xr.compositionlayers@2.3//changelog/CHANGELOG.html)
...
- com.unity.xr.hands: [1.7.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.7//changelog/CHANGELOG.html) to [1.7.3](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.7//changelog/CHANGELOG.html)
...
- com.unity.xr.legacyinputhelpers: [2.1.12](https://docs.unity3d.com/Packages/com.unity.xr.legacyinputhelpers@2.1//changelog/CHANGELOG.html) to [3.0.1](https://docs.unity3d.com/Packages/com.unity.xr.legacyinputhelpers@3.0//changelog/CHANGELOG.html)
...
- com.unity.xr.meta-openxr: [2.2.0](https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.2//changelog/CHANGELOG.html) to [2.4.0](https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.4//changelog/CHANGELOG.html)
...
- com.unity.learn.iet-framework: [5.0.1](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@5.0//changelog/CHANGELOG.html) to [5.0.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@5.0//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.5.1](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.5//changelog/CHANGELOG.html) to [1.5.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.5//changelog/CHANGELOG.html)

- com.unity.terrain-tools: [5.3.0](https://docs.unity3d.com/Packages/com.unity.terrain-tools@5.3//changelog/CHANGELOG.html) to [5.3.2](https://docs.unity3d.com/Packages/com.unity.terrain-tools@5.3//changelog/CHANGELOG.html)

- com.unity.profiling.systemmetrics.mali: [1.0.3](https://docs.unity3d.com/Packages/com.unity.profiling.systemmetrics.mali@1.0//changelog/CHANGELOG.html) to [1.1.1](https://docs.unity3d.com/Packages/com.unity.profiling.systemmetrics.mali@1.1//changelog/CHANGELOG.html)
...
- com.unity.memoryprofiler: [1.1.8](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1//changelog/CHANGELOG.html) to [1.1.11](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1//changelog/CHANGELOG.html)

- com.unity.netcode.gameobjects: [2.4.4](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.4//changelog/CHANGELOG.html) to [2.10.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.10//changelog/CHANGELOG.html)
...
- com.unity.ai.navigation: [2.0.7](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html) to [2.0.11](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html)
...
- com.unity.services.deployment: [1.5.0](https://docs.unity3d.com/Packages/com.unity.services.deployment@1.5//changelog/CHANGELOG.html) to [1.7.2](https://docs.unity3d.com/Packages/com.unity.services.deployment@1.7//changelog/CHANGELOG.html)
...
- com.unity.services.tooling: [1.3.0](https://docs.unity3d.com/Packages/com.unity.services.tooling@1.3//changelog/CHANGELOG.html) to [1.4.1](https://docs.unity3d.com/Packages/com.unity.services.tooling@1.4//changelog/CHANGELOG.html)
...
- com.unity.addressables.android: [1.0.6](https://docs.unity3d.com/Packages/com.unity.addressables.android@1.0//changelog/CHANGELOG.html) to [1.0.10](https://docs.unity3d.com/Packages/com.unity.addressables.android@1.0//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial@2.3//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@2.3//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@2.3//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@2.3//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.1//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [2.3.1](https://docs.unity3d.com/Packages/com.unity.xr.visionos@2.3//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.1//changelog/CHANGELOG.html)
...
- com.unity.services.multiplayer: [1.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@1.2//changelog/CHANGELOG.html) to [2.1.3](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.1//changelog/CHANGELOG.html)

- com.unity.asset-manager-for-unity: [1.5.1](https://docs.unity3d.com/Packages/com.unity.asset-manager-for-unity@1.5//changelog/CHANGELOG.html) to [1.10.0](https://docs.unity3d.com/Packages/com.unity.asset-manager-for-unity@1.10//changelog/CHANGELOG.html)

- com.unity.web.stripping-tool: [1.1.0](https://docs.unity3d.com/Packages/com.unity.web.stripping-tool@1.1//changelog/CHANGELOG.html) to [1.2.1](https://docs.unity3d.com/Packages/com.unity.web.stripping-tool@1.2//changelog/CHANGELOG.html)

- com.unity.xr.androidxr-openxr: [1.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.1//changelog/CHANGELOG.html) to [1.2.0](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html)
