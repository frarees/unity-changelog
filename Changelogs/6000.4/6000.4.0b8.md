...
- DX12: Fixed crashes related to scratch memory allocation.
    ([UUM-131707](https://issuetracker.unity3d.com/issues/crash-with-multiple-stack-traces-when-using-dx12-and-selecting-all-spline-knots))    <br>*Fixed in 6000.4.0b9.*

- DX12: Fixed crashes related to scratch memory allocation.
    ([UUM-131824](https://issuetracker.unity3d.com/issues/crash-on-checkdevicestatus-when-moving-in-the-scene-view-on-a-specific-scene))    <br>*Fixed in 6000.4.0b9.*

- DX12: Fixed deadlock when maxQueuedFrames is 1 in the Editor when using D3D12.
    ([UUM-131962](https://issuetracker.unity3d.com/issues/editor-freezes-when-qualitysettings-dot-maxqueuedframes-is-set-to-1-and-dx12-is-used))    <br>*Fixed in 6000.4.0b9.*
...
- Editor: Fixed an issue where the Editor became unresponsive when a modal dialog box was displayed on Windows.
    ([UUM-132303](https://issuetracker.unity3d.com/issues/the-editor-freezes-and-leaks-memory-when-cancelling-the-switch-of-the-default-render-pipeline-while-using-the-advanced-object-selector))    <br>*Fixed in 6000.4.0b9.*
...
- iOS: Fixed unity view resizing in UaaL setup breaking rendering or crashing.
    ([UUM-130881](https://issuetracker.unity3d.com/issues/ios-rendering-freezes-and-unitygfxdeviceworker-crash-when-show-splash-screen-is-enabled-and-project-is-built-using-unity-as-a-library))    <br>*Fixed in 6000.4.0b9.*
...
- URP: Improved the warning message shown when running render pipeline converters in batch mode to better explain potential limitations and recommend the dedicated conversion UI for reliable results.
    ([UUM-131716](https://issuetracker.unity3d.com/issues/obsolete-warning-for-converters-dot-runinbatchmode-is-confusing-and-lacks-clarity))<br>
...
- 2D: Fix EditorPreview_FloodFill performance regression
    (UUM-133055)<br>
...
- Editor: Play Mode Scenarios with invalid names show up in the list when another scenario with a valid name is added afterward
    ([UUM-132554](https://issuetracker.unity3d.com/issues/play-mode-scenarios-with-invalid-names-show-up-in-the-list-when-another-scenario-with-a-valid-name-is-added-afterward))<br>
    *First seen in 6000.4.0a2.*

- Editor: Project Auditor: Register window to support reloading.
    ([UUM-127194](https://issuetracker.unity3d.com/issues/window-serialization-will-fail-for-unity-dot-projectauditor-dot-editor-dot-ui-dot-projectauditorwindow-error-is-thrown-when-enabling-the-ui-toolkit-live-reload-in-project-auditor))<br>
    *First seen in 6000.4.0a5.*

- Editor: Project Auditor: Register window to support reloading.
    ([UUM-127613](https://issuetracker.unity3d.com/issues/docked-project-auditor-window-disappears-when-another-editor-window-is-maximised))<br>
    *First seen in 6000.4.0a5.*
...
- Graphics: Fix NullReferenceException when Mesh LOD Slider is shown by an inspector but no scene view exists.
    ([UUM-132113](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-and-mesh-lod-foldout-is-empty-when-maximizing-inspector-with-mesh-lod-property))<br>
...
- Scripting: Fixed stack overflow in ScriptUpdater in some scenarios.
    ([UUM-130076](https://issuetracker.unity3d.com/issues/script-updater-for-dot-dot-dot-failed-with-exitcode-dot-dot-dot-and-stdout-stack-overflow-dot-errors-thrown-in-console-when-a-project-using-obsolete-api-is-opened))<br>
...
- Shadergraph: Addressed issue where capitalization in the swizzle node mask would sometimes result in improper results.
    ([UUM-132879](https://issuetracker.unity3d.com/issues/expected-color-is-changed-to-black-when-using-swizzle-node))<br>
...
- UI Toolkit: Fix TempJobAlloc 4 frames issues in worldspace rendering.
    ([UUM-132761](https://issuetracker.unity3d.com/issues/internal-deleting-an-allocation-that-is-older-than-its-permitted-lifetime-of-4-frames-age-equals-5-warning-when-editing-a-world-space-ui-document-in-ui-builder))<br>
    *First seen in 6000.4.0b5.*
...
### Preview of Final 6000.4.0b8 Release Notes
...
#### Preview of Final 6000.4.0b8 Package changes
...
- com.unity.ide.visualstudio: [2.0.23](https://docs.unity3d.com/Packages/com.unity.ide.visualstudio@2.0//changelog/CHANGELOG.html) to [2.0.26](https://docs.unity3d.com/Packages/com.unity.ide.visualstudio@2.0//changelog/CHANGELOG.html)
...
- com.unity.memoryprofiler: [1.1.8](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1//changelog/CHANGELOG.html) to [1.1.10](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1//changelog/CHANGELOG.html)
...
- com.unity.services.multiplayer: [1.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@1.2//changelog/CHANGELOG.html) to [2.0.0](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.0//changelog/CHANGELOG.html)
