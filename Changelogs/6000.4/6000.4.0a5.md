...
- 2D: Fix case where Sprites in Editor are showing artifacting when using Sprite Skin components when using Sprite Skin components
    ([DANB-1209](https://issuetracker.unity3d.com/issues/sprites-in-editor-are-showing-artifacting-when-using-sprite-skin-components))    <br>*Fixed in 6000.4.0a6.*

- Asset Pipeline: Fix for files disappearing in project browser, when doing reimport of folder
    (UUM-126423)    <br>*Fixed in 6000.4.0a6.*

- Editor: Fixed a bug where a Raycast hit would not be successful when using the default BoxcastCommand\(\) constructor.
    ([UUM-123124](https://issuetracker.unity3d.com/issues/no-valid-hits-are-returned-when-using-raycastcommand))    <br>*Fixed in 6000.4.0a6.*

- Editor: Hierarchy: fix CanStartDrag invocation
    (UUM-127480)<br>
    *First seen in 6000.4.0a4.*    <br>*Fixed in 6000.4.0a6.*
...
- Terrain: Terrain : Fixed crash that could occur when preventing instanced details from being added to detail texture atlas.
    ([UUM-122921](https://issuetracker.unity3d.com/issues/crash-on-detaildatabase-setuppreloadtextureatlasdata-when-building-a-specific-scene))    <br>*Fixed in 6000.4.0a6.*

- Terrain: Terrain : Fixed crash that could occur when preventing instanced details from being added to detail texture atlas.
    ([UUM-125363](https://issuetracker.unity3d.com/issues/crash-on-detaildatabase-setuppreloadtextureatlasdata-when-building-a-project-with-specific-addressables-data))    <br>*Fixed in 6000.4.0a6.*
...
- Test Framework: Fixed a stack overflow exception in the Test Runner UI that might happen with some assembly setups with precompiled assemblies.
    ([UUM-122047](https://issuetracker.unity3d.com/issues/stackoverflowexception-occurs-and-tests-fail-to-load-when-the-test-runner-window-is-opened-while-system-dot-windows-dot-forms-dot-dll-and-system-dot-deployment-dot-dll-are-present-in-the-project))    <br>*Fixed in 6000.4.0a6.*

- Test Framework: Fixed an issue where the test runner UI would repaint too often on some tests, causing performance issues.
    (UUM-119390)<br>
    *First seen in 6000.4.0a2.*    <br>*Fixed in 6000.4.0a6.*
...
- Graphics: Added a message to the Frame Debugger that appears when the Editor is waiting for a response from the Player.
    ([UUM-117114](https://issuetracker.unity3d.com/issues/framedebugger-webgl-frame-debugger-does-not-display-any-data-when-running-webgl-build))<br>
...
- Physics 2D: Added an overload for "Sprite.GetPhysicsShape\(\)" to return a "ReadOnlySpan&lt;Vector2&gt;" to remove the need for managed allocations.
    ([UUM-125266](https://issuetracker.unity3d.com/issues/no-way-to-retrieve-2d-sprite-physics-shapes-without-first-allocating-managed-memory))<br>
    *First seen in 6000.4.0a1.*
...
- VFX Graph: Detect and break cycles in the graph when doing a new connection.
    ([UUM-116899](https://issuetracker.unity3d.com/issues/editor-crashes-or-freezes-when-connecting-the-main-systems-update-context-to-the-gpu-event-of-that-system))<br>
    *First seen in 6000.4.0a1.*
...
- Web: Fixed regression that caused playback of audio clips to not work on the Web.
    ([UUM-123296](https://issuetracker.unity3d.com/issues/regression-in-web-audio-support-js-sound-getaudiocontextsamplerate-is-not-defined-setting-non-finite-value-for-loopstart))<br>
    *First seen in 6000.4.0a2.*
...
- com.unity.2d.animation: [14.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html) to [14.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html)

- com.unity.2d.psdimporter: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@13.0//changelog/CHANGELOG.html) to [13.0.1](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@13.0//changelog/CHANGELOG.html)
...
- com.unity.addressables.android: [1.0.7](https://docs.unity3d.com/Packages/com.unity.addressables.android@1.0//changelog/CHANGELOG.html) to [1.0.8](https://docs.unity3d.com/Packages/com.unity.addressables.android@1.0//changelog/CHANGELOG.html)

- com.unity.multiplayer.widgets: [1.0.3](https://docs.unity3d.com/Packages/com.unity.multiplayer.widgets@1.0//changelog/CHANGELOG.html) to [1.0.4](https://docs.unity3d.com/Packages/com.unity.multiplayer.widgets@1.0//changelog/CHANGELOG.html)
...
### Preview of Final 6000.4.0a5 Release Notes
...
- HDRP: Fixed exposure flickering in situations where the dynamic exposure changes quickly.
    (UUM-109528)
...
- Physics 2D: Fixed and issue when using default constructors in a Burst job where a Burst error will be shown in the console.
...
- UI Toolkit: Fixed Xbox performance regression in UI Toolkit.
    (UUM-120201)
...
#### Preview of Final 6000.4.0a5 Package changes
...
- com.unity.netcode: [1.7.0](https://docs.unity3d.com/Packages/com.unity.netcode@1.7//changelog/CHANGELOG.html) to [1.9.2](https://docs.unity3d.com/Packages/com.unity.netcode@1.9//changelog/CHANGELOG.html)
...
- com.unity.2d.animation: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@13.0//changelog/CHANGELOG.html) to [14.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html)

- com.unity.2d.common: [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@12.0//changelog/CHANGELOG.html) to [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@13.0//changelog/CHANGELOG.html)
...
- com.unity.purchasing: [4.12.2](https://docs.unity3d.com/Packages/com.unity.purchasing@4.12//changelog/CHANGELOG.html) to [4.13.2](https://docs.unity3d.com/Packages/com.unity.purchasing@4.13//changelog/CHANGELOG.html)
...
- com.unity.multiplayer.playmode: [2.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.multiplayer.playmode@2.0//changelog/CHANGELOG.html) to [2.0.0](https://docs.unity3d.com/Packages/com.unity.multiplayer.playmode@2.0//changelog/CHANGELOG.html)
...
- com.unity.dedicated-server: [2.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.dedicated-server@2.0//changelog/CHANGELOG.html) to [2.0.0](https://docs.unity3d.com/Packages/com.unity.dedicated-server@2.0//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.1//changelog/CHANGELOG.html) to [1.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html)
