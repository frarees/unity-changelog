...
- Editor: Ensure entries are correctly populated for querylistblock
    (UUM-125510)<br>
    *First seen in 6000.4.0a2.*    <br>*Fixed in 6000.4.0a5.*
...
- Editor: Fixed a race condition in the licensing client where the Editor would succeed to make the client acquire a floating license faster than it had finished loading licenses at startup, which would make it fail to pick up the new license.
    ([UUM-121408](https://issuetracker.unity3d.com/issues/file-watcher-does-not-trigger-after-the-acquirefloatinglease-and-before-the-entitlement-check))    <br>*Fixed in 6000.4.0a5.*

- Editor: Fixed false warning "BatchRendererGroups currently don't support override shaders".
    ([UUM-122367](https://issuetracker.unity3d.com/issues/warning-batchrenderergroups-currently-dont-support-override-shaders-is-spammed-in-play-mode-when-using-h-trace-wsgi-with-batchrendergroups))    <br>*Fixed in 6000.4.0a5.*
...
- Graphics: Disabled the CAMetalDisplayLink on iOS as using it might cause GPU hangs and rendering freeze. It will be enabled again once we find the underlying cause.
    ([UUM-123207](https://issuetracker.unity3d.com/issues/metal-game-freezes-after-command-buffer-timeout-error))    <br>*Fixed in 6000.4.0a5.*

- Graphics: Fixed editor freeze if Lens SRP asset references form a cyclic dependency.
    ([UUM-122934](https://issuetracker.unity3d.com/issues/the-editor-freezes-when-creating-a-new-lens-flare-srp-and-adding-itself-to-the-lens-flare-data-srp-type-element))    <br>*Fixed in 6000.4.0a5.*

- Graphics: Frame Debugger - Null exception when connection remotely to a player. And no Playmode Views were available.
    (UUM-122337)<br>
    *First seen in 6000.4.0a3.*    <br>*Fixed in 6000.4.0a5.*
...
- Multiplayer: Fixed Issue where a VP's running mode remains disabled after running and stopping a scenario.
    (UUM-123100)<br>
    *First seen in 6000.4.0a4.*    <br>*Fixed in 6000.4.0a5.*
...
- Editor: Disabled the Render Pipeline Converter while the Editor is in Play mode.
    ([UUM-121058](https://issuetracker.unity3d.com/issues/render-pipeline-converter-stuck-on-initialisation-when-in-play-mode))<br>
...
- DX12: Fixed memory leak in certain scenarios when using DX12 + Graphics Jobs \(split mode\).
    ([UUM-120637](https://issuetracker.unity3d.com/issues/dx12-playmode-memory-leak-and-eventual-crash-slash-freeze-on-urpsample-in-both-player-and-editor-with-graphics-jobs))<br>
    *First seen in 6000.4.0a2.*
...
- Editor: Ensure all valuable hidden properties are indexed.
    ([UUM-122528](https://issuetracker.unity3d.com/issues/sorting-group-properties-cannot-be-searched))<br>
    *First seen in 6000.4.0a2.*
...
- Editor: Fixed an issue on Windows where the content of an Editor window scaled incorrectly when the window was dragged between displays with different DPI settings.
    ([UUM-121700](https://issuetracker.unity3d.com/issues/editor-glitches-with-artifacts-slash-black-spots-when-editor-window-is-dragged-to-a-secondary-display-configured-to-the-left-of-the-primary-display))<br>
    *First seen in 6000.4.0a2.*
...
- Editor: Fixed an overflow in the annotation window hiding some options out of scope.
    ([UUM-121174](https://issuetracker.unity3d.com/issues/terrain-debug-warnings-text-doesnt-fit-in-general-section-in-scene-view-gizmo-dropdown))<br>
...
- Editor: Fixed Custom UI Scaling functionality broken during refactor of DPI handling.
    ([UUM-122498](https://issuetracker.unity3d.com/issues/ui-scaling-setting-is-incorrect-when-a-custom-scale-is-set-in-use-custom-scaling-value))<br>
    *First seen in 6000.4.0a3.*
...
- Editor: Fixed show packages filter.
    ([UUM-116162](https://issuetracker.unity3d.com/issues/show-packages-options-in-search-is-always-on))<br>
    *First seen in 6000.4.0a1.*
...
- Graphics: Project Settings - Graphics - Help button display on IRenderPipelineGraphicsSettings.
    ([UUM-120940](https://issuetracker.unity3d.com/issues/project-settings-volume-documentation-button-in-the-graphics-tab-does-nothing-when-pressed))<br>
    *First seen in 6000.4.0a1.*
...
- Graphics: Render Pipeline Converter -Fixes missing serialization attribute in converters.
    ([UUM-119645](https://issuetracker.unity3d.com/issues/the-type-dot-dot-dot-is-being-serialized-by-serializereference-but-is-missing-the-serializable-attribute-dot-warnings-are-thrown-after-entering-play-mode-after-initialising-converters-in-render-pipeline-converter))<br>
    *First seen in 6000.4.0a1.*
...
- UI Toolkit: Fixed a `NullReferenceException` that occurred when dragging objects into the UI Builder window.
    ([UUM-122248](https://issuetracker.unity3d.com/issues/ui-builder-constantly-throws-nullreferenceexception-when-dragging-objects-objects-into-the-window))<br>
    *First seen in 6000.4.0a3.*

- UI Toolkit: Fixed an issue in the UI Builder where the info text for creating a new Style Sheet did not wrap.
    ([UUM-121669](https://issuetracker.unity3d.com/issues/info-text-to-create-a-new-style-sheet-has-no-wrapping-in-ui-builder))<br>
    *First seen in 6000.4.0a2.*
...
- UI Toolkit: Fixed an issue that caused the Editor to freeze when selecting the `Default.tss` theme from the UI Toolkit Theme options.
    ([UUM-122610](https://issuetracker.unity3d.com/issues/argumentnullexception-value-cannot-be-null-dot-error-is-thrown-and-the-editor-freezes-when-editor-for-editor-extension-authoring-property-is-set-to-default-dot-tss-in-project-preview-theme-project-settings-and-the-project-settings-window-is-reopened))<br>
    *First seen in 6000.4.0a3.*
...
- UI Toolkit: Fixed an issue where an internal binding type was listed in the UI Builder.
    ([UUM-122118](https://issuetracker.unity3d.com/issues/ui-builder-setting-data-binding-type-to-unity-dot-uitoolkit-dot-editor-style-property-binding-starts-throwing-unclearable-errors-and-freezes-editor-windows))<br>
    *First seen in 6000.4.0a2.*
...
- UI Toolkit: Fixed an issue where the UI Toolkit Theme options dropdown displayed duplicate `Default.tss` options.
    ([UUM-122654](https://issuetracker.unity3d.com/issues/runtime-field-menu-in-ui-toolkit-project-settings-shows-duplicate-options-default-dot-tss-default-and-default-dot-tss))<br>
    *First seen in 6000.4.0a3.*
...
- VFX Graph: Fixed Deprecated UxmlTraits warning.
    ([UUM-122652](https://issuetracker.unity3d.com/issues/deprecated-uxmltraits-warning-is-thrown-when-adding-vfx-asset-to-hierarchy-window-and-vfx-asset-is-open))<br>
    *First seen in 6000.4.0a2.*
...
- com.unity.2d.animation: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@13.0//changelog/CHANGELOG.html) to [14.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@14.0//changelog/CHANGELOG.html)
...
- com.unity.2d.psdimporter: [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@12.0//changelog/CHANGELOG.html) to [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@13.0//changelog/CHANGELOG.html)
...
- com.unity.serialization: [3.1.2](https://docs.unity3d.com/Packages/com.unity.serialization@3.1//changelog/CHANGELOG.html) to [3.1.3](https://docs.unity3d.com/Packages/com.unity.serialization@3.1//changelog/CHANGELOG.html)

- com.unity.services.user-reporting: [2.0.12](https://docs.unity3d.com/Packages/com.unity.services.user-reporting@2.0//changelog/CHANGELOG.html) to [2.0.14](https://docs.unity3d.com/Packages/com.unity.services.user-reporting@2.0//changelog/CHANGELOG.html)
...
- com.unity.services.cloudcode: [2.10.1](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.10//changelog/CHANGELOG.html) to [2.10.2](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.10//changelog/CHANGELOG.html)
...
- com.unity.xr.arcore: [6.3.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.3//changelog/CHANGELOG.html) to [6.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.4//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.3.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.3//changelog/CHANGELOG.html) to [6.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.4//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.3.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.3//changelog/CHANGELOG.html) to [6.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.4//changelog/CHANGELOG.html)
...
- com.unity.xr.meta-openxr: [2.3.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.3//changelog/CHANGELOG.html) to [2.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.4//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [2.4.3](https://docs.unity3d.com/Packages/com.unity.polyspatial@2.4//changelog/CHANGELOG.html) to [3.0.3-pre.3](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.0//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [2.4.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@2.4//changelog/CHANGELOG.html) to [3.0.3-pre.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.0//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [2.4.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@2.4//changelog/CHANGELOG.html) to [3.0.3-pre.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.0//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [2.4.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@2.4//changelog/CHANGELOG.html) to [3.0.3-pre.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.0//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [2.4.3](https://docs.unity3d.com/Packages/com.unity.xr.visionos@2.4//changelog/CHANGELOG.html) to [3.0.3-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.0//changelog/CHANGELOG.html)
...
### Preview of Final 6000.4.0a4 Release Notes
...
#### Preview of Final 6000.4.0a4 Package changes
...
- com.unity.netcode: [1.7.0](https://docs.unity3d.com/Packages/com.unity.netcode@1.7//changelog/CHANGELOG.html) to [1.9.1](https://docs.unity3d.com/Packages/com.unity.netcode@1.9//changelog/CHANGELOG.html)
...
- com.unity.collab-proxy: [2.9.2](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.9//changelog/CHANGELOG.html) to [2.10.0](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.10//changelog/CHANGELOG.html)
...
- com.unity.netcode.gameobjects: [2.4.4](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.4//changelog/CHANGELOG.html) to [2.6.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.6//changelog/CHANGELOG.html)
