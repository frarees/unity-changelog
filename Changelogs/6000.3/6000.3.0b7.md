...
- Graphics: Fixed occasional crash when changing shader in the inspector to the one with GrabPass.
    ([UUM-121727](https://issuetracker.unity3d.com/issues/crash-on-mono-dump-native-crash-info-when-changing-a-particle-system-renderers-material-shader-to-standard-unlit))    <br>*Fixed in 6000.3.0b8.*
...
- Multiplayer: Fixed an issue where focusing on a Virtual Player does not bring its window to the front.
    ...
    *First seen in 6000.3.0b5.*    <br>*Fixed in 6000.3.0b8.*
...
### New 6000.3.0b7 Entries since 6000.3.0b6
...
- Editor: Ensure most of the MeshRenderer properties are not hidden in Inspector.
    ([UUM-121414](https://issuetracker.unity3d.com/issues/receivegi-meshrenderer-property-cannot-be-searched))<br>
...
- Editor: Fixed an issue causing the gameobjects to not be properly filtered in the scene when doing a search in the new hierarchy window.
    ([UUM-117222](https://issuetracker.unity3d.com/issues/hierarchy-v2-correctness-search-item-failed-to-frame-item-in-scene-and-black-out-the-rest-of-the-scene))<br>
    *First seen in 6000.3.0b2.*

- Editor: Fixed an issue on Windows where it was not possible to add toolbar elements in submenus.
    ([UUM-116278](https://issuetracker.unity3d.com/issues/windows-extra-empty-dropdown-menu-is-created-when-using-multi-level-nested-main-unity-toolbar-element-paths))<br>
...
- Editor: Fixed issue when dragging the editor launch window on Windows where it was possible for the window and mouse pointer to get out of sync.
    ([UUM-121173](https://issuetracker.unity3d.com/issues/the-editors-splash-screen-isnt-immediately-moved-when-dragging-with-a-cursor-on-windows))<br>
...
- Editor: Hierarchy: Fixed CreateEmptyParent not expanding the created gameobject.
    ([UUM-119243](https://issuetracker.unity3d.com/issues/hierarchy-v2-correctness-create-empty-parent-should-not-collapse-parent))<br>
    *First seen in 6000.3.0b3.*

- Editor: Hierarchy: Fixed unsupported keyboard shortcuts in new hierarchy.
    (UUM-115285)<br>
    *First seen in 6000.3.0b1.*
...
- GI: Editor closes and does not reopen after applying changes to GPU Baking Device in Lighting window. Only the hub is opened.
    ([UUM-117087](https://issuetracker.unity3d.com/issues/editor-closes-and-does-not-reopen-after-applying-changes-to-gpu-baking-device-in-lighting-window))<br>
    *First seen in 6000.3.0b1.*
...
- Package Manager: Clearing the 'Minimum Unity Version' field now properly leaves it empty \(and removes it from the manifest\) instead of defaulting to '0a1'.
    ([UUM-113483](https://issuetracker.unity3d.com/issues/release-field-of-minimum-unity-version-on-a-custom-package-can-be-left-empty))<br>
...
- Package Manager: Fixed an issue where running -upmPack produced a valid signed package but Unity Editor process exited with code 1.
    ([UUM-121729](https://issuetracker.unity3d.com/issues/upmpack-command-exits-with-code-1-on-successful-pack))<br>
...
- Package Manager: Fixed the signature pop-up windows style.
    (UUM-115284)<br>
    *First seen in 6000.3.0a5.*

- Physics 2D: Added missing "PhysicsShape.Intersect" method along with its counterpart "PhysicsQuery.ShapeAndShape" method.
    ([UUM-122002](https://issuetracker.unity3d.com/issues/missing-api-for-shape-vs-shape-intersection))<br>
    *First seen in 6000.3.0a5.*
...
- Physics 2D: CallbackTargets in Low-Level Physics should not be limited to the "MonoBehaviour" type but should allow "System.Object".
    ([UUM-121496](https://issuetracker.unity3d.com/issues/lowlevel-2d-physics-object-callback-targets-use-monobehaviour-rather-than-system-dot-object))<br>
    *First seen in 6000.3.0b5.*
...
- Physics 2D: Fixed for PhysicsBody and PhysicsShape "CreateShapeBatch" method which should use "ReadOnlySpan&lt;T&gt;" rather than "Span&lt;T&gt;" to indicate the inputs are not modified. The same applies to the ChainGeometry constructor .
    ([UUM-121877](https://issuetracker.unity3d.com/issues/span-used-rather-than-readonlyspan-used-for-low-level-physics-input))<br>
    *First seen in 6000.3.0a5.*
...
- Physics 2D: Fixed GC.Allocation during low-level physics transform writing in profiler entry "PhysicsWorld.WriteTransforms.PopulateWorldTransforms".
    ([UUM-121765](https://issuetracker.unity3d.com/issues/lowlevel-physics2d-allocating-452bytes-in-physicsworld-dot-writetransforms-dot-populateworldtransforms))<br>
    *First seen in 6000.3.0a5.*
...
- Physics 2D: Fixed incorrect validation for "PolygonGeometry.CreatePolygons" ReadOnlySpan&lt;Vector2&gt; vertices argument where it was incorrectly limited to 8 vertices. It should be unlimited.
    ([UUM-121963](https://issuetracker.unity3d.com/issues/polygongeometry-dot-createpolygons-limits-span-length-incorrectly))<br>
    *First seen in 6000.3.0a5.*
...
- Physics 2D: Fixed PhysicsComposer API to allow the maximum number of polygon vertices to be set \(PhysicsComposer.maxPolygonVertices\). Without this, it is fixed at 8.
    ([UUM-121878](https://issuetracker.unity3d.com/issues/missing-api-no-way-to-actually-set-the-maximum-number-of-polygon-vertices-used-in-a-physicscomposer))<br>
    *First seen in 6000.3.0a5.*

- Profiler: Fixed capture list warning tooltip background colour in light mode.
    ([UUM-114468](https://issuetracker.unity3d.com/issues/name-shouldnt-be-empty-tooltip-doesnt-have-light-theme-when-deleting-capture-title))<br>
    *First seen in 6000.3.0a5.*
...
- Profiler: Fixed profiler captures being treated as different to their loaded data if they were renamed after being loaded.
    ([UUM-116894](https://issuetracker.unity3d.com/issues/load-profiler-capture-warning-is-thrown-when-opening-the-same-capture-after-renaming-it))<br>
    *First seen in 6000.3.0b1.*

- Profiler: Fixed profiler captures section reappearing after domain reload if it was previously collapsed.
    ([UUM-117707](https://issuetracker.unity3d.com/issues/hidden-captures-list-section-in-profiler-window-reappears-after-domain-reload))<br>
    *First seen in 6000.3.0b2.*
...
- Search: Fixed crash in Search when a domain reload occurs while an index merge operation is in progress.
    ([UUM-116428](https://issuetracker.unity3d.com/issues/search-crash-in-lmdb-during-a-domain-reload-while-a-merge-operation-is-happening))<br>
    *First seen in 6000.3.0b2.*
...
#### New 6000.3.0b7 Package Changes since 6000.3.0b6

#### Packages updated

- com.unity.2d.animation: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@13.0//changelog/CHANGELOG.html) to [13.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@13.0//changelog/CHANGELOG.html)

- com.unity.2d.common: [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@12.0//changelog/CHANGELOG.html) to [12.0.1](https://docs.unity3d.com/Packages/com.unity.2d.common@12.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [6.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@6.0//changelog/CHANGELOG.html) to [6.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@6.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [3.0.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@3.0//changelog/CHANGELOG.html) to [3.0.1](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@3.0//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [2.4.3](https://docs.unity3d.com/Packages/com.unity.polyspatial@2.4//changelog/CHANGELOG.html) to [3.0.2](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.0//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [2.4.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@2.4//changelog/CHANGELOG.html) to [3.0.2](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.0//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [2.4.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@2.4//changelog/CHANGELOG.html) to [3.0.2](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.0//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [2.4.3](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@2.4//changelog/CHANGELOG.html) to [3.0.2](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.0//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [2.4.3](https://docs.unity3d.com/Packages/com.unity.xr.visionos@2.4//changelog/CHANGELOG.html) to [3.0.2](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.0//changelog/CHANGELOG.html)
...
- com.unity.project-auditor: [1.0.1](https://docs.unity3d.com/Packages/com.unity.project-auditor@1.0//changelog/CHANGELOG.html) to [1.0.2](https://docs.unity3d.com/Packages/com.unity.project-auditor@1.0//changelog/CHANGELOG.html)

- com.unity.2d.tooling: [1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.2d.tooling@1.0//changelog/CHANGELOG.html) to [1.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tooling@1.0//changelog/CHANGELOG.html)
...
### Preview of Final 6000.3.0b7 Release Notes
...
#### Preview of Final 6000.3.0b7 Package changes