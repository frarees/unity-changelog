### Known Issues in 6000.3.0b9

- 2D: Fixed issue where prefab game objects with Sort 3D as 2D could crash the editor.
    ([UUM-125154](https://issuetracker.unity3d.com/issues/crash-on-gameobject-querycomponentbytype-when-creating-a-prefab-containing-a-sorting-group-component-with-sort-3d-as-2d-enabled))<br>
    *First seen in 6000.3.0b8.*    <br>*Fixed in 6000.3.0b10.*
...
- Editor: Fixed a race condition in the licensing client where the Editor would succeed to make the client acquire a floating license faster than it had finished loading licenses at startup, which would make it fail to pick up the new license.
    ([UUM-121408](https://issuetracker.unity3d.com/issues/file-watcher-does-not-trigger-after-the-acquirefloatinglease-and-before-the-entitlement-check))    <br>*Fixed in 6000.3.0b10.*

- Editor: Fixed false warning that displayed *BatchRendererGroups currently don't support override shaders*.
    ([UUM-122367](https://issuetracker.unity3d.com/issues/warning-batchrenderergroups-currently-dont-support-override-shaders-is-spammed-in-play-mode-when-using-h-trace-wsgi-with-batchrendergroups))    <br>*Fixed in 6000.3.0b10.*
...
### New 6000.3.0b9 Entries since 6000.3.0b8
...
- Universal RP: Adjusted the maximum render scale value from 2.0 to 3.0.
    (UUM-121793)<br>
...
- Adaptive Performance: Fixed the Provider View Guide link going out of bounds when no providers are installed.
    ([UUM-121993](https://issuetracker.unity3d.com/issues/the-view-guide-link-in-adaptive-performance-settings-overflows-to-the-right-side-out-of-its-bounds-when-adaptive-performance-settings-are-added-to-a-build-profile))<br>
...
- Animation: Fixed a performance regression when selecting curves in the animation window.
    (UUM-121304)<br>
...
- DX12: Fixed a memory leak in certain scenarios when using DX12 with Graphics Jobs \(split mode\).
...
- Editor: Fixed an issue where a right click on another item in Hierarchy window should cancel current item's renaming.
    ([UUM-114997](https://issuetracker.unity3d.com/issues/the-rename-button-does-not-initiate-renaming-when-pressing-right-click-rename-while-another-gameobject-is-being-renamed-in-hierarchy-v2))<br>
...
- Editor: Fixed links with multiple paragraphs in ATG.
    ([UUM-122303](https://issuetracker.unity3d.com/issues/ui-builder-learn-more-link-for-advanced-text-generator-warning-in-project-settings-is-not-interactable))<br>
    *First seen in 6000.3.0b6.*
...
- Editor: Fixed Overlay Menu names not having a limit.
    ([UUM-114471](https://issuetracker.unity3d.com/issues/toolbar-preset-names-allow-long-strings))<br>
    *First seen in 6000.3.0a5.*

- Editor: Fixed Undocked Overlay Menu not having a max width.
    ([UUM-114577](https://issuetracker.unity3d.com/issues/undocked-overlay-menu-doesnt-shorten-the-custom-template-name-with-a-long-name))<br>
    *First seen in 6000.3.0a5.*

- Editor: Hierarchy: hide flags are now correctly driving gameobjects visibility in the new hierarchy
    ([UUM-122307](https://issuetracker.unity3d.com/issues/hide-flags-of-hierarchy-nodes-not-being-captured-properly))<br>
...
- Editor: Prevented logging session tokens in the Editor log.
    (UUM-121872)<br>
    *First seen in 6000.3.0b1.*
...
- GI: Ensured that infinite vertex UVs are passed to xAtlas.
    (UUM-122361)<br>
    *First seen in 6000.3.0b6.*

- GI: Fixed reflection probe keyword warnings when building Player.
    ([UUM-122571](https://issuetracker.unity3d.com/issues/xri-starter-assets-throws-shader-warning-on-quest-build))<br>
    *First seen in 6000.3.0b5.*
...
- Multiplayer: Fixed an issue where toggling the running mode of a Virtual Player failed after canceling a Scenario.
    (UUM-123292)<br>
...
- Physics 2D: Fixed an issue where creating a PhysicsShape using a CapsuleGeometry with a near-zero length resulted in a Circle shape type being created. Now a Capsule shape type is always created and the length is clamped to a minimum internally.
    ([UUM-124692](https://issuetracker.unity3d.com/issues/creating-a-physicsshape-using-capsulegeometry-with-small-slash-zero-length-creates-a-circle-instead))<br>
    *First seen in 6000.3.0a5.*
...
- Physics 2D: Fixed an issue where there is no way to return simple convex hulls using the PhysicsComposer. This can now be done with "PhysicsComposer.CreateConvexHull".
    ([UUM-124838](https://issuetracker.unity3d.com/issues/no-way-to-get-raw-non-validated-convex-hulls-from-the-physicscomposer))<br>
    *First seen in 6000.3.0a5.*
...
- SRP Core: Prevent Missing Additional Camera warning when the project build.
    ([UUM-121897](https://issuetracker.unity3d.com/issues/camera-main-camera-does-not-contain-an-additional-camera-data-component-dot-warning-is-thrown-when-building-a-project))<br>
    *First seen in 6000.3.0b6.*
...
- UI Toolkit: Fixed a gamma issue for worldspace shaders.
    ([UUM-122574](https://issuetracker.unity3d.com/issues/scene-or-game-view-may-render-world-space-ui-toolkit-solid-background-too-bright))<br>
    *First seen in 6000.3.0a2.*

- UI Toolkit: Fixed a performance regression on Xbox in UI Toolkit.
    (UUM-120201)<br>
    *First seen in 6000.3.0a5.*

- UI Toolkit: Fixed SVG importer glitches when paths fold on themselves.
    ([UUM-116897](https://issuetracker.unity3d.com/issues/svg-image-renders-with-visual-artifacts-when-initially-imported-as-ui-toolkit-vector-image))<br>
    *First seen in 6000.3.0b1.*
...
- VFX Graph: Change space in ShaderGraph Ouput Inspector is functional.
    ([UUM-114265](https://issuetracker.unity3d.com/issues/space-can-not-be-changed-in-shadergraph-output-inspector))<br>
    *First seen in 6000.3.0a6.*
...
- VFX Graph: Fixed an issue where existing GPU event links weren't disconnected when connecting to a different context.
    ([UUM-116901](https://issuetracker.unity3d.com/issues/connecting-a-gpu-event-to-multiple-systems-throws-an-error-and-stops-vfx-compilation))<br>
    *First seen in 6000.4.0a1.*
...
- VFX Graph: Fixed template window colors to match the Editor's design system.
    ([UUM-110463](https://issuetracker.unity3d.com/issues/foldout-background-appears-darker-button-order-is-incorrect-and-template-items-darker-than-window-background-in-template-window))<br>
    *First seen in 6000.3.0a2.*

- VFX Graph: Icon template is too bright with light skin in template browser.
    ([UUM-122633](https://issuetracker.unity3d.com/issues/vfx-learn-templates-icons-are-difficult-to-see-in-create-new-vfx-asset-window-when-editor-theme-is-set-to-light))<br>
    *First seen in 6000.3.0b6.*

- VFX Graph: In the template window, the description could overlap the title when the details panel is very small.
    ([UUM-111380](https://issuetracker.unity3d.com/issues/template-title-and-description-overlap-with-each-other-in-the-shader-graph-templates-window))<br>
    *First seen in 6000.3.0a2.*

- VFX Graph: Long template name in the template window's details panel is not truncated and goes out of the section.
    ([UUM-111611](https://issuetracker.unity3d.com/issues/template-title-in-shader-graph-breaks-layout-when-too-long))<br>
    *First seen in 6000.3.0a2.*
...
- VFX Graph: Shader Graph Template window header has incorrect naming when opened while the VFXGraph template window is already opened.
    ([UUM-111603](https://issuetracker.unity3d.com/issues/shader-graph-template-window-header-has-incorrect-naming))<br>
    *First seen in 6000.3.0a2.*
...
#### New 6000.3.0b9 Package Changes since 6000.3.0b8
...
- com.unity.xr.legacyinputhelpers: [2.1.12](https://docs.unity3d.com/Packages/com.unity.xr.legacyinputhelpers@2.1//changelog/CHANGELOG.html) to [2.1.13](https://docs.unity3d.com/Packages/com.unity.xr.legacyinputhelpers@2.1//changelog/CHANGELOG.html)
...
- com.unity.sysroot: [2.0.10](https://docs.unity3d.com/Packages/com.unity.sysroot@2.0//changelog/CHANGELOG.html) to [2.0.11](https://docs.unity3d.com/Packages/com.unity.sysroot@2.0//changelog/CHANGELOG.html)

- com.unity.sysroot.linux-x86_64: [2.0.9](https://docs.unity3d.com/Packages/com.unity.sysroot.linux-x86_64@2.0//changelog/CHANGELOG.html) to [2.0.10](https://docs.unity3d.com/Packages/com.unity.sysroot.linux-x86_64@2.0//changelog/CHANGELOG.html)

- com.unity.toolchain.linux-x86_64: [2.0.10](https://docs.unity3d.com/Packages/com.unity.toolchain.linux-x86_64@2.0//changelog/CHANGELOG.html) to [2.0.11](https://docs.unity3d.com/Packages/com.unity.toolchain.linux-x86_64@2.0//changelog/CHANGELOG.html)

- com.unity.toolchain.macos-x86_64-linux-x86_64: [2.0.10](https://docs.unity3d.com/Packages/com.unity.toolchain.macos-x86_64-linux-x86_64@2.0//changelog/CHANGELOG.html) to [2.0.11](https://docs.unity3d.com/Packages/com.unity.toolchain.macos-x86_64-linux-x86_64@2.0//changelog/CHANGELOG.html)

- com.unity.toolchain.macos-arm64-linux-x86_64: [2.0.4](https://docs.unity3d.com/Packages/com.unity.toolchain.macos-arm64-linux-x86_64@2.0//changelog/CHANGELOG.html) to [2.0.5](https://docs.unity3d.com/Packages/com.unity.toolchain.macos-arm64-linux-x86_64@2.0//changelog/CHANGELOG.html)

- com.unity.toolchain.win-x86_64-linux-x86_64: [2.0.10](https://docs.unity3d.com/Packages/com.unity.toolchain.win-x86_64-linux-x86_64@2.0//changelog/CHANGELOG.html) to [2.0.11](https://docs.unity3d.com/Packages/com.unity.toolchain.win-x86_64-linux-x86_64@2.0//changelog/CHANGELOG.html)

- com.unity.toolchain.win-arm64-linux-x86_64: [1.0.4](https://docs.unity3d.com/Packages/com.unity.toolchain.win-arm64-linux-x86_64@1.0//changelog/CHANGELOG.html) to [1.0.5](https://docs.unity3d.com/Packages/com.unity.toolchain.win-arm64-linux-x86_64@1.0//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.1//changelog/CHANGELOG.html) to [1.1.0](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.1//changelog/CHANGELOG.html)
...
### Preview of Final 6000.3.0b9 Release Notes
...
#### Preview of Final 6000.3.0b9 Package changes