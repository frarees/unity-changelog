...
- Editor: Fixed a crash in the macOS Editor during shutdown when ModalProgressBar was displayed.
    ...
    *First seen in 6000.3.0a6.*    <br>*Fixed in 6000.3.0b2.*
...
- Editor: Fixed an error where "InvalidCastException: Specified cast is not valid." was logged and Lightmap Parameters could not be changed in a Mesh Renderer component.
    ...
    *First seen in 6000.3.0b1.*    <br>*Fixed in 6000.3.0b2.*
...
- Engine Diagnostics: Fixed a crash on UnityEngine::Insights::Metric::Metric caused by a race condition
    ([UUM-113363](https://issuetracker.unity3d.com/issues/crash-on-unityengine-insights-metric-metric-when-refocusing-on-the-editor-after-it-has-been-idling-in-the-background))    <br>*Fixed in 6000.3.0b2.*
...
- iOS: Do not reset input if requested orientation change is the same as previous \(no actual change\).
    (UUM-114722)    <br>*Fixed in 6000.3.0b2.*
...
- macOS: Fixed flickering in the macOS player when using multisample antialiasing \(MSAA\).
    (UUM-114831)<br>
    *First seen in 6000.3.0a5.*    <br>*Fixed in 6000.3.0b2.*
...
- URP: Fixed depth backbuffer support with Gizmos in Game view, effectively removing the incorrect warning message "CommandBuffer: built-in render texture type 3 not found while executing."
    ([UUM-104383](https://issuetracker.unity3d.com/issues/gizmos-are-not-rendering-in-game-view))    <br>*Fixed in 6000.3.0b2.*
...
### New 6000.3.0b1 Entries since 6000.3.0a5
...
- Graphics: Added indentation to the Graphics Preferences.
    ([UUM-114178](https://issuetracker.unity3d.com/issues/missing-indentation-on-graphics-preferences))<br>
...
- URP: Added a new status message in the Render Pipeline Converter to indicate when no elements are found to convert.
    ([UUM-114942](https://issuetracker.unity3d.com/issues/render-pipeline-converter-no-visual-feedback-that-the-converter-is-initialized-but-did-not-found-elements))<br>
...
- 2D: Renable a disabled MacOS test
    (UUM-112932)<br>
    *First seen in 6000.3.0a1.*
...
- Animation: Re-enabled the `DirectorPaused_WhenTimeProgresses_PastDuration` and increased its time out window.
    (UUM-113639)<br>
...
- Build Pipeline: Fixed the content of ScriptingAssemblies.json when performing Player builds with the "clean build" option.
    (UUM-114582)<br>
    *First seen in 6000.3.0a5.*

- Build System: Bee verify jobs for compressors match the CI in their repos
    (UUM-114728)<br>
    *First seen in 6000.3.0a6.*

- Build System: Fix Bee CI which has been broken for a week
    (UUM-114278)<br>
    *First seen in 6000.3.0a6.*

- Build System: Fix Bee Toolchain ASAN tests
    (UUM-114192)<br>
    *First seen in 6000.3.0a6.*
...
- Editor: Build system tests are not built every time anything builds.
    (UUM-114403)<br>
    *First seen in 6000.3.0a6.*
...
- Editor: Do not index packages by default
    (UUM-114231)<br>
    *First seen in 6000.3.0a6.*

- Editor: Ensure Advanced Picker that are generated using a type name are properly nicified.
    (UUM-114698)<br>
    *First seen in 6000.3.0a6.*

- Editor: Ensure labels and values used in QueryBlocks are nicefied with no quote.
    (UUM-111313)<br>
    *First seen in 6000.3.0a1.*
...
- Editor: Fixed a check for re-entrant Paint operations that was mistakenly removed.
    ([UUM-114605](https://issuetracker.unity3d.com/issues/assertion-and-exception-errors-are-thrown-when-adding-the-component-to-the-gameobject-via-scene-view))<br>
    *First seen in 6000.3.0a5.*
...
- Editor: Fixed an issue which would cause the main Editor toolbar to disappear on Linux when the Editor window was reset, such as when the Tutorials tab is opened.
    ([UUM-112911](https://issuetracker.unity3d.com/issues/unity-editor-toolbar-is-missing-when-creating-a-project-using-the-get-started-with-unity-template))<br>
    *First seen in 6000.3.0a3.*

- Editor: Fixed an unexpected behaviour where the Overlay Menu applies a black background color to highlighted overlays when they are hovered in the menu.
    ([UUM-114584](https://issuetracker.unity3d.com/issues/hovering-on-the-overlays-in-the-overlay-menu-reverts-the-custom-panel-color-on-highlight))<br>
    *First seen in 6000.3.0a5.*
...
- Editor: Fixed Editor main menu bar disappearing when resetting Layouts.
    ([UUM-114285](https://issuetracker.unity3d.com/issues/editor-top-title-bar-disappears-when-resetting-all-layouts))<br>
    *First seen in 6000.3.0a3.*

- Editor: Fixed end of line for UITK text in the editor.
    (UUM-114408)<br>
    *First seen in 6000.3.0a5.*
...
- Editor: Fixed function definition for drawing Editor Launch Screen.
    (UUM-114419)<br>
    *First seen in 6000.3.0a6.*
...
- Editor: Fixed noParse tag for ATG
    (UUM-114498)<br>
    *First seen in 6000.3.0a6.*
...
- Editor: Fixed the Add Settings dropdown modal in the Build Profiles window from displaying a double border on Mac's using HiDPI setting.
    ([UUM-112231](https://issuetracker.unity3d.com/issues/modal-add-settings-is-displayed-in-double-borders))<br>
    *First seen in 6000.3.0a3.*

- Editor: Fixed the Add Settings dropdown modal in the Build Profiles window from displaying an unnecessary scrollbar.
    ([UUM-112241](https://issuetracker.unity3d.com/issues/redundant-scrollbar-appears-in-the-add-settings-modal))<br>
    *First seen in 6000.3.0a3.*
...
- Editor: Fixes an issue on macOS where the icon in the dock may still show a progress indicator after the editor has finished loading.
    (UUM-114068)<br>
    *First seen in 6000.3.0a3.*

- Editor: Fixes IMGUI error when opening Context menu for Animator Tab
    (UUM-113878)<br>
    *First seen in 6000.3.0a5.*

- Editor: Main menu bar is refreshed after adding or removing LevelPlay and IAP menu items.
    (UUM-113166)<br>
    *First seen in 6000.3.0a5.*
...
- Editor: Play Mode scenarios assets are not present when upgrading from previous version
    (UUM-114107)<br>
    *First seen in 6000.3.0a5.*

- Editor: Removing Experimental Multi-Process AssetBundle building API

- Editor: The Add Settings button in the Build Profile window is now contextually aware of the number of settings currently in use. The button will be disabled if no more settings are available for the selected profile.
    ([UUM-112240](https://issuetracker.unity3d.com/issues/add-settings-button-not-disabled-when-no-settings-can-be-added))<br>
    *First seen in 6000.3.0a3.*
...
- Editor: Updated the Package Manager Button in the Main Toolbar to use the MainToolbarAPI.
    ([UUM-114917](https://issuetracker.unity3d.com/issues/package-manager-button-does-not-have-the-hold-command-to-drag-and-move-tooltip))<br>
    *First seen in 6000.3.0a6.*
...
- EmbeddedLinux: Fixed Mouse/Touch input on up/down-scaled fullscreen window with multi-display.
    (UUM-112728)<br>
    *First seen in 6000.3.0a1.*
...
- GI: Introduced a project setting which enables the \(hidden\) compute backend.
...
- HDRP: Fixed spotlight intensity going to infinity when the angles are set to zero.
    (UUM-85162)<br>
    *First seen in 6000.3.0a1.*
...
- Input System: Input System: Fixed an issue with periodic sampling timers that caused the clock to drift over time, leading to inconsistent variable latency of asynchronously sampled input sources.
    (UUM-114434)<br>
    *First seen in 6000.3.0a6.*
...
- Linux: Fixed Mouse/Touch input on up/down-scaled fullscreen window with multi-display.
    (UUM-112728)<br>
    *First seen in 6000.3.0a1.*
...
- Package Manager: Fixed the color of the untrusted packages popup.
    (UUM-114012)<br>
    *First seen in 6000.3.0a5.*

- Package Manager: Fixed the issue where "Install and Reset" option doesn't work for features with packages that are custom.
    (UUM-111309)<br>
    *First seen in 6000.3.0a3.*

- Package Manager: Fixed the issue where package created in the UI doesn't pass name validation in the inspector.
    ([UUM-113370](https://issuetracker.unity3d.com/issues/data-validation-rules-for-package-name-are-different-between-package-creation-and-edit-views))<br>
...
- Package Manager: Fixed the issue where Test Framework package version is outdated in newly created packages.
    ([UUM-113476](https://issuetracker.unity3d.com/issues/custom-package-uses-a-random-old-test-framework-version-by-default))<br>
    *First seen in 6000.3.0a4.*

- Package Manager: Fixed the issue where the "Edit" button in the Package Selection Inspector becomes disabled after undo.
    ([UUM-113216](https://issuetracker.unity3d.com/issues/edit-package-manifest-button-in-the-inspector-becomes-disabled-after-an-undo-action))<br>
    *First seen in 6000.3.0a4.*

- Package Manager: Fixed the issue where the "Edit" button messed up the Package Selection Inspector when the inspector window is locked.
    ([UUM-113221](https://issuetracker.unity3d.com/issues/pressing-edit-package-manifest-button-in-a-locked-inspector-window-does-not-fully-refresh-the-window-preventing-edits))<br>
    *First seen in 6000.3.0a4.*

- Package Manager: Fixed the issue where UPM packages on Asset Store installation causes a reduandant "Install package" entry in project
    (UUM-114352)<br>
    *First seen in 6000.3.0a5.*

- Package Manager: Fixed the issue where UPM packages on Asset Store shows up as unsigned
    (UUM-114240)<br>
    *First seen in 6000.3.0a5.*

- Package Manager: Fixed the issue where warning messages are shown in the console when Package Manager window is not visible.
    ([UUM-113122](https://issuetracker.unity3d.com/issues/multiple-warnings-are-thrown-after-editing-package-manifest-via-inspector-while-package-manager-window-is-not-open))<br>
    *First seen in 6000.3.0a4.*

- Package Manager: Move the error section inside package details so it can scroll with it.
    ([UUM-112722](https://issuetracker.unity3d.com/issues/the-error-section-expands-excessively-completely-obscuring-or-displacing-the-package-details-section))<br>
    *First seen in 6000.3.0a3.*
...
- Physics 2D: "PhysicsShape.GetDensity\(\)" should return a float value however it was incorrectly declared as void return.
    ([UUM-115002](https://issuetracker.unity3d.com/issues/physicsshape-dot-getdensity-not-correctly-returning-the-density-value))<br>
    *First seen in 6000.3.0a5.*

- Physics 2D: Fixed a PhysicsDestructor.Slice bug when slicing extremely close to a polygon vertex resulting in the polygon not being correctly slice in half.
    (UUM-114849)<br>
    *First seen in 6000.3.0a5.*

- Physics 2D: Setting the PhysicsBody.bodyType to Static after creation now works identically as when specified in the PhysicsBodyDefinition as well as PhysicsWorld debug drawing now working with shapes with a category mask of zero.
    (UUM-114443)<br>
    *First seen in 6000.3.0a5.*

- Profiler: Fixed cases where renaming Profiler captures with overly long filenames/paths would throw exceptions.
    ([UUM-114431](https://issuetracker.unity3d.com/issues/changing-capture-name-has-no-character-limit))<br>
    *First seen in 6000.3.0a5.*

- Profiler: Fixed crash when game view is resized while the Profiler is active.
    ([UUM-114303](https://issuetracker.unity3d.com/issues/crash-on-formatargmaptypehelperbase-when-changing-free-aspect-ratio-while-profiling))<br>
    *First seen in 6000.3.0a5.*
...
- QNX: Fixed Mouse/Touch input on up/down-scaled fullscreen window with multi-display.
    (UUM-112728)<br>
    *First seen in 6000.3.0a1.*
...
- Shadergraph: Fixed corrupted terrain asset in production ready samples.
    (UUM-114346)<br>
...
- SRP Core: Fixed render graph pass culling corner case where resources are never deallocated when several passes using them are culled.
    (UUM-114242)<br>
    *First seen in 6000.3.0a6.*

- Terrain: Fixed player build errors for Terrain ShaderGraph shaders in the Meta pass. Subscripts uv1 and uv2 were accessed in light transport vertex function but these values of the AttributesMesh struct were not generated by the ShaderGraph Terrain target.
    (UUM-114543)<br>
    *First seen in 6000.3.0a6.*

- Terrain: Fixed player builds errors for Terrain ShaderGraph shaders for variants in URP where the Alpha subscript of the surface data structure is accessed without existing holes data and when alpha clipping is disabled in the Terrain ShaderGraph target settings, thus bypassing intended variant guards for alpha clipping in the generated Terrain shader.
    (UUM-114543)<br>
    *First seen in 6000.3.0a6.*
...
- Text: Fixed measure with empty text.
    (UUM-114578)<br>
    *First seen in 6000.3.0a5.*
...
- UI Toolkit: Fixed an issue preventing switching between light and dark editor themes.
    (UUM-114225)<br>
    *First seen in 6000.3.0a5.*
...
- UI Toolkit: Fixed the broken scroll when adding items to the ListView.
    ([UUM-113614](https://issuetracker.unity3d.com/issues/adding-property-or-attribute-breaks-scrolling-in-the-blackboard-window))<br>
    *First seen in 6000.3.0a4.*
...
- Universal RP: Fixed obsolete warnings in the script when creating new URP Post-process Volume Scripts.
    (UUM-114995)<br>
    *First seen in 6000.3.0b1.*
...
- URP: Render Pipeline Converter - ALL/NONE were not being selected.
    ([UUM-114935](https://issuetracker.unity3d.com/issues/render-pipeline-converter-all-slash-none-in-the-converter-page-does-not-work-properly))<br>
    *First seen in 6000.3.0b1.*

- URP: Render Pipeline Converter - Initialize button behavior.
    ([UUM-114937](https://issuetracker.unity3d.com/issues/render-pipeline-converter-initialize-button-is-hidden-slash-unhidden-wrong))<br>
    *First seen in 6000.3.0b1.*

- URP: Render Pipeline Converter - Properly update the status of the converter when selected.
    ([UUM-114940](https://issuetracker.unity3d.com/issues/render-pipeline-converter-converter-status-is-not-being-updated))<br>
    *First seen in 6000.3.0b1.*

- URP: Render Pipeline Converter - Settings Converter does not store a valid renderer.
    (UUM-114920)<br>
    *First seen in 6000.3.0a5.*
...
#### New 6000.3.0b1 Package Changes since 6000.3.0a5
...
- com.unity.xr.arcore: [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.2//changelog/CHANGELOG.html) to [6.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.3//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.2//changelog/CHANGELOG.html) to [6.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.3//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.2//changelog/CHANGELOG.html) to [6.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.3//changelog/CHANGELOG.html)

- com.unity.xr.interaction.toolkit: [3.2.0](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.2//changelog/CHANGELOG.html) to [3.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.3//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.15.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.15//changelog/CHANGELOG.html) to [1.16.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.16//changelog/CHANGELOG.html)
...
- com.unity.meta-instant-games-sdk: [1.2.0](https://docs.unity3d.com/Packages/com.unity.meta-instant-games-sdk@1.2//changelog/CHANGELOG.html) to [2.0.0](https://docs.unity3d.com/Packages/com.unity.meta-instant-games-sdk@2.0//changelog/CHANGELOG.html)

- com.unity.xr.androidxr-openxr: [1.0.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.0//changelog/CHANGELOG.html) to [1.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.1//changelog/CHANGELOG.html)

### Preview of Final 6000.3.0b1 Release Notes
...
#### Preview of Final 6000.3.0b1 Package changes