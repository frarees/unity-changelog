...
*   Camera: Camera resolution is set to default when opening the Editor ([1378321](https://issuetracker.unity3d.com/issues/camera-resolution-is-set-to-default-when-opening-the-editor))
    
*   Graphics: Consistent Gfx.WaitForPresentOnGfxThread 5-10ms spikes when using Metal API ([1378985](https://issuetracker.unity3d.com/issues/consistent-gfx-dot-waitforpresentongfxthread-5-10ms-spikes-when-using-metal-api))
    
*   Asset Import: Editor hangs on exit when importing Maya files and exiting the Editor ([1378586](https://issuetracker.unity3d.com/issues/editor-hangs-on-exit-when-importing-maya-files-and-exiting-the-editor))
...
### New 2022.1.0b1 Entries since 2022.1.0a16
...
*   Networking: UnityWebRequest will no longer warn when setting the Accept-Encoding header. ([1355007](https://issuetracker.unity3d.com/issues/warning-is-logged-when-using-unitywebrequest-to-set-the-header-to-accept-encoding))  
...
*   2D: Fixed an issue that Tilemap.SetTiles does not setting a default color of White for the set Tiles. (1380847)
...
*   Android: Fixed an issue that the soft keyboard does not open after scene was changed while keyboard was already open. ([1379407](https://issuetracker.unity3d.com/issues/android-inputfield-doesnt-open-keyboard-after-clicking-on-ugui-button-covered-with-imgui-scrollbar))  
...
*   DX12: Fixed an issue where setting RandomWriteTarget and drawing without needing it will no longer prevent subsequent draws to bound it if needed. ([1375746](https://issuetracker.unity3d.com/issues/directx12-objects-are-not-lighted-in-game-view-when-using-segi-system-with-graphics-api-for-windows-set-to-direct3d12))
    
*   Editor: Fixed an endless exception thrown when opening a project with a specified scene if the scene does not exist. ([1382843](https://issuetracker.unity3d.com/issues/scenetemplate-opening-unity-when-a-lastopenedscene-is-set-but-the-scene-does-not-exist-throws-an-exception))  
    _First seen in 2022.1.0a15._
    
*   Editor: Fixed an issue where Material does not show Specular texture when using Standard (Specular setup) Shader. ([1376325](https://issuetracker.unity3d.com/issues/material-doesnt-show-specular-texture-when-using-standard-specular-setup-shader))
...
*   Graphics: Fixed bug where mip map streaming did not work after setting a material with streamable textures on a renderer. ([1302707](https://issuetracker.unity3d.com/issues/materials-applied-to-gameobjects-at-runtime-from-resources-slash-addressables-are-low-resolution-when-texture-streaming-is-enabled))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Graphics: Fixed issues on vulkan library on initialization and on AMD gpus. (1373442)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   IL2CPP: Corrected indicate that blittable types nested in generic types are indeed blittable. ([1368711](https://issuetracker.unity3d.com/issues/computebuffer-dot-setdata-throws-an-error-when-scripting-backend-is-set-to-il2cpp))
    
*   IL2CPP: Fixed compiler error in unsafe code using generics. (1382279)
    
*   IL2CPP: Fixed crash in stack trace building code an when exception is thrown in async methods. ([1377750](https://issuetracker.unity3d.com/issues/player-crash-on-system-dot-net-dot-http-dot-httpclient-when-awaiting-network-response))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   IL2CPP: Fixed crash on Windows ARMv7 platform when parsing a GUID. (1371521)
...
*   IL2CPP: Fixed incorrect ordering of some field reads when Smaller (faster) builds is enabled. ([1378235](https://issuetracker.unity3d.com/issues/exception-in-input-system-ui-input-module-when-il2cpp-code-generation-is-set-to-faster-smaller-builds))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   iOS: Fixed crash on iPhone 13 series devices when attempting to enter portrait up side down orientation. ([1374229](https://issuetracker.unity3d.com/issues/application-crashes-when-switching-to-autorotation-with-the-only-available-option-being-a-reverse-portrait))
    
*   License: Forced a relaunch of the license client if a connection is refused on pipe.
    
*   Linux: Fixed crash on startup when GTK reports NULL for monitor information. ([1384643](https://issuetracker.unity3d.com/issues/linux-ubuntu-unity-crashes-during-new-project-creation))  
...
*   Package Manager: Fixed an issue where the locked icon in the package details pane of a dependency of a feature set did not refresh into an unlocked icon upon clicking the unlock button. (1382878)  
    _First seen in 2022.1.0._
    
*   Package Manager: Fixed an issue with the Asset Store package dependencies import. ([1377896](https://issuetracker.unity3d.com/issues/importing-a-project-from-the-asset-store-doesnt-import-packages-even-if-you-chose-yes-at-the-dialogue))  
...
*   Profiler: Fixed an issue in native profiler plugins to reduce overhead when platform profiler is attached. (1378190)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Scene/Game View: Fixed Gizmos Icons not showing. ([1377204](https://issuetracker.unity3d.com/issues/gameobject-icon-gizmos-are-only-shown-on-gameobjects-with-certain-components))  
...
*   Scene/Game View: Fixed SceneView Zoom across multiple tabs using mouse wheel. ([1377063](https://issuetracker.unity3d.com/issues/zoom-syncs-across-multiple-newly-added-sceneview-tabs))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Scripting: Fixed typo in EditorUserBuildSettings.il2CppCodeGeneration. ([1382864](https://issuetracker.unity3d.com/issues/editoruserbuildsettings-dot-il2cppcodegeneration-has-typo-making-it-editoruserbuildsettings-dot-il2cppcodegeneratione))  
    _First seen in 2022.1.0a15._
    
*   Search: Fixed search view item size slider and now it can drag all the way. (1379138)  
...
*   Shaders: Fixed a bug where compute shaders would incorrectly compile until re-imported after clearing the cache. ([1370660](https://issuetracker.unity3d.com/issues/shaders-compute-number-pragma-require-flags-dont-persist-after-shader-cache-clear-and-are-not-reparsed-until-shader-is-changed))
...
*   uGUI: Fixed an issue that the localPosition is not always valid each time an object is reset. ([1367658](https://issuetracker.unity3d.com/issues/reverting-prefab-overrides-in-prefab-instance-causes-unnecessary-changes-to-child-transform-values))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   UI Toolkit: Fixed USS variable resolution with ScalableImage url. (1383151)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Universal Windows Platform: Fixed an issue when building from Unity, now strong assembly names are no longer removed. ([1375938](https://issuetracker.unity3d.com/issues/uwp-sign-key-of-net-plugins-removed-when-built-on-uwp-platform))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Universal Windows Platform: Fixed CultureInfo.CurrentCulture setter crashing when calling it before ever querying the existing current culture. ([1375944](https://issuetracker.unity3d.com/issues/uwp-uwp-build-crashes-when-changing-the-thread-cultureinfo))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   URP: Fixed broken soft shadow filtering. ([1374960](https://issuetracker.unity3d.com/issues/shadow-quality-is-inconsistent-when-switching-platforms))
...
*   URP: Fixed decals to work with render scale. ([1353885](https://issuetracker.unity3d.com/issues/urp-builtin-to-urp-render-pipeline-converter-freezes-the-editor-when-converting-rendering-settings))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   URP: Fixed Lens Flare not accounting Render Scale setting. ([1376820](https://issuetracker.unity3d.com/issues/urp-lens-flare-do-not-account-for-render-scale-setting))  
    _First seen in 2022.1.0a12._
    
*   URP: Fixed performance regression for 2D shaders where alpha discard was disabled. (1335648)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   URP: Fixed shadow rendering correctly to work with shader stripping in WebGl. ([1381881](https://issuetracker.unity3d.com/issues/webgl-urp-mesh-is-not-rendered-in-the-scene-on-webgl-build))
...
*   VFX Graph: Removed extra nodes in Ribbon template. ([1355602](https://issuetracker.unity3d.com/issues/vfx-graph-extra-nodes-and-contexts-are-added-when-premade-ribbon-effect-to-the-graph))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   XR: Fixed issue where UnitySubsystemsManifest.json file was added to the app bundle instead of apk while building XR app for Android with Build App Bundle option. (1379905)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   XR: Fixed XRStats being disabled in SRP. (1380130)
    

### Preview of Final 2022.1.0b1 Release Notes
...
*   macOS: Fixed a bug where switching between development and release players could cause player builds to fail. ([1367944](https://issuetracker.unity3d.com/issues/macos-replacing-old-build-with-development-build-fails-with-buildfailedexception))
...
*   Particles: Fixed exception on WebGL builds when pre-allocating Particle System memory for systems using infinite lifetimes. (1320919)
    
*   Particles: Fixed prefab override tooltip for Particle Systems. (1267018)
    
*   Particles: Restore Trail material if module is toggled off then on again. ([1363211](https://issuetracker.unity3d.com/issues/material-isnt-assigned-back-on-particle-trails-when-disabling-and-enabling-trails))
...
*   Shaders: Fixed incorrect keyword state used for frame debugger when a shader is compiling asynchronously. (1375713)
...
*   UI Toolkit: Fixed alignment of custom property drawers and nested property fields. (1350566)
