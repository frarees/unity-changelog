...
-   Scripting: When switching to UWP it doesn\'t add NET_STANDARD_2_0 define, it adds NET_4_6 instead. ([1334636](https://issuetracker.unity3d.com/issues/uwp-not-adding-net-standard-2-0-define))
