...
### New 2022.1.0b12 Entries since 2022.1.0b11
...
*   Editor: Added missing adb provider for advanced object selector search engine. ([1398289](https://issuetracker.unity3d.com/issues/quicksearch-default-assets-are-not-appearing-in-the-object-picker-browser))
    
*   Editor: Added search result refresh when executing CTRL+Z to undo last block modifications. ([1394732](https://issuetracker.unity3d.com/issues/search-search-list-isnt-updated-when-performing-undo-after-removing-a-query-builders-query-block))
...
*   Editor: Use SearchViewState.group to initialize initial results tab when creating a new search window. (1400665)
...
*   Web: Added missing truthiness check for getSupportedProfiles(). ([1394392](https://issuetracker.unity3d.com/issues/webplatform-android-app-crashes-on-launch-on-some-devices-with-typeerror-ext-dot-getsupportedprofiles-is-not-a-function-error))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
#### New 2022.1.0b12 Package Changes since 2022.1.0b11

#### Packages updated

*   com.unity.ads: [4.0.0](https://docs.unity3d.com/Packages/com.unity.ads@4.0//changelog/CHANGELOG.html) → [4.0.1](https://docs.unity3d.com/Packages/com.unity.ads@4.0//changelog/CHANGELOG.html)
...
*   com.unity.splines: [1.0.0-pre.7](https://docs.unity3d.com/Packages/com.unity.splines@1.0//changelog/CHANGELOG.html) → [1.0.0](https://docs.unity3d.com/Packages/com.unity.splines@1.0//changelog/CHANGELOG.html)
...
*   com.unity.profiling.systemmetrics.mali: [1.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.profiling.systemmetrics.mali@1.0//changelog/CHANGELOG.html) → [1.0.0](https://docs.unity3d.com/Packages/com.unity.profiling.systemmetrics.mali@1.0//changelog/CHANGELOG.html)
    

### Preview of Final 2022.1.0b12 Release Notes
...
*   VFX Graph: Removed bool from the built-in list of blittable types for GraphicsBuffer.