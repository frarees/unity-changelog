...
*   Asset Import: Enables "Strip Bones" as the default for new assets. (1386538)  
    _Fixed in 2022.1.0b9._
...
*   Kernel: Fixes invalid "System is running out of memory" error on macOS M1 laptops ([1386242](https://issuetracker.unity3d.com/issues/system-is-running-out-of-memory-is-being-thrown-when-using-profiler-as-a-standalone-process-with-deep-profile-turned-on))  
    _Fixed in 2022.1.0b9._
...
*   Mono: \[M1\]\[WebGL\] Editor throws errors when building for WebGL on native Apple Silicon Editor ([1399524](https://issuetracker.unity3d.com/issues/m1-webgl-editor-throws-errors-when-building-for-webgl-on-native-apple-silicon-editor))
...
*   Serialization: Fix crash loading asset bundles containing assets with editor only fields in play mode. This was true only for asset bundles generated after an initial play mode session. ([1392141](https://issuetracker.unity3d.com/issues/crash-when-instantiate-the-addressable-prefab-with-textmesh-pro))  
    _Fixed in 2022.1.0b9._
...
### New 2022.1.0b8 Entries since 2022.1.0b7
...
*   Package: Updated com.unity.formats.alembic to 2.3.0.
...
*   Asset Pipeline: Deleting invalid asset paths don't throw ArgumentNullException when using Perforce as VCProvider. ([1333656](https://issuetracker.unity3d.com/issues/vcs-assetdatabase-assetdatabase-dot-deleteasset-throws-an-error-if-the-path-is-invalid-when-using-perforce-as-vcs))  
...
*   UI Toolkit: Fixed UI Builder viewport highlight that wasn't being clipped appropriately. (1387395)  
...
*   Windows: 32-bit Windows standalone player binaries are now signed with Unity certificate. ([1382876](https://issuetracker.unity3d.com/issues/32-bit-windows-standalone-player-binaries-are-not-signed))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   XR: Fixed flood warning when calling SetVerticalFieldOfView . (1393130)
    
*   XR: Updated XR Interaction Toolkit to 2.0.0-pre.7.
    

#### New 2022.1.0b8 Package Changes since 2022.1.0b7
...
*   com.unity.timeline: [1.7.0-pre.1](https://docs.unity3d.com/Packages/com.unity.timeline@1.7//changelog/CHANGELOG.html) → [1.7.0-pre.2](https://docs.unity3d.com/Packages/com.unity.timeline@1.7//changelog/CHANGELOG.html)
    
*   com.unity.xr.interaction.toolkit: [2.0.0-pre.6](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.0//changelog/CHANGELOG.html) → [2.0.0-pre.7](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.0//changelog/CHANGELOG.html)
    

### Preview of Final 2022.1.0b8 Release Notes
...
*   VFX Graph: Unexpected possible connection between GPUEvent and Spawn context. (1362739)
...
#### Preview of Final 2022.1.0b8 Package changes
...
*   com.unity.addressables: [1.18.4](https://docs.unity3d.com/Packages/com.unity.addressables@1.18//changelog/CHANGELOG.html) → [1.19.17](https://docs.unity3d.com/Packages/com.unity.addressables@1.19//changelog/CHANGELOG.html)
    
*   com.unity.ads: [3.7.1](https://docs.unity3d.com/Packages/com.unity.ads@3.7//changelog/CHANGELOG.html) → [4.0.0](https://docs.unity3d.com/Packages/com.unity.ads@4.0//changelog/CHANGELOG.html)
...
*   com.unity.collab-proxy: [1.5.7](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.5//changelog/CHANGELOG.html) → [1.15.12](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.15//changelog/CHANGELOG.html)
...
*   com.unity.ide.rider: [3.0.7](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html) → [3.0.12](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html)
...
*   com.unity.render-pipelines.core: [12.0.0](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@12.0//changelog/CHANGELOG.html) → [13.1.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition: [12.0.0](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@12.0//changelog/CHANGELOG.html) → [13.1.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition-config: [12.0.0](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@12.0//changelog/CHANGELOG.html) → [13.1.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.universal: [12.0.0](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@12.0//changelog/CHANGELOG.html) → [13.1.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@13.1//changelog/CHANGELOG.html)
...
*   com.unity.shadergraph: [12.0.0](https://docs.unity3d.com/Packages/com.unity.shadergraph@12.0//changelog/CHANGELOG.html) → [13.1.5](https://docs.unity3d.com/Packages/com.unity.shadergraph@13.1//changelog/CHANGELOG.html)
...
*   com.unity.test-framework: [1.1.26](https://docs.unity3d.com/Packages/com.unity.test-framework@1.1//changelog/CHANGELOG.html) → [1.1.30](https://docs.unity3d.com/Packages/com.unity.test-framework@1.1//changelog/CHANGELOG.html)
...
*   com.unity.timeline: [1.6.0-pre.5](https://docs.unity3d.com/Packages/com.unity.timeline@1.6//changelog/CHANGELOG.html) → [1.7.0-pre.2](https://docs.unity3d.com/Packages/com.unity.timeline@1.7//changelog/CHANGELOG.html)
    
*   com.unity.visualeffectgraph: [12.0.0](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@12.0//changelog/CHANGELOG.html) → [13.1.5](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@13.1//changelog/CHANGELOG.html)
...
*   com.unity.xr.legacyinputhelpers: [2.1.7](https://docs.unity3d.com/Packages/com.unity.xr.legacyinputhelpers@2.1//changelog/CHANGELOG.html) → [2.1.8](https://docs.unity3d.com/Packages/com.unity.xr.legacyinputhelpers@2.1//changelog/CHANGELOG.html)
...
*   com.unity.xr.oculus: [1.9.1](https://docs.unity3d.com/Packages/com.unity.xr.oculus@1.9//changelog/CHANGELOG.html) → [1.11.2](https://docs.unity3d.com/Packages/com.unity.xr.oculus@1.11//changelog/CHANGELOG.html)
    
*   com.unity.xr.openxr: [1.2.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.2//changelog/CHANGELOG.html) → [1.3.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.3//changelog/CHANGELOG.html)
