...
*   2D: "Cancelling DisplayDialog" errors are printed when opening "2D URP" Template project ([1378201](https://issuetracker.unity3d.com/issues/cancelling-displaydialog-errors-are-printed-when-opening-2d-urp-template-project))
...
*   Burst: Fixed issue with invalid gc handle release that could corrupt current domain and cause crashes ([1346442](https://issuetracker.unity3d.com/issues/crash-when-entering-play-mode-and-serializing-data-after-modifying-script))  
    ...
    _Fixed in 2022.1.0b5._
    
*   Customer QA Onboarding: Asset Bundle size incrementally increases when updating the Unity Editor and rebuilding the Asset Bundle ([1391542](https://issuetracker.unity3d.com/issues/asset-bundle-size-incrementally-increases-when-updating-the-unity-editor-and-rebuilding-the-asset-bundle))
    
*   Customer QA Onboarding: Prefab is glitchy while editing in Prefab Mode when parent Canvas Render Mode is set to Screen Space - Camera ([1394756](https://issuetracker.unity3d.com/issues/prefab-is-glitchy-when-editing-in-prefab-mode-in-a-custom-ui-environment))
...
*   Universal RP: Some lit Shaders are having huge count of variants which leads to project build prevention ([1378545](https://issuetracker.unity3d.com/issues/some-lit-shaders-are-having-huge-count-of-variants-which-leads-to-project-build-prevention))
...
### New 2022.1.0b4 Entries since 2022.1.0b3
...
*   Android: Prevented Unity icon overriding the user specified default icon. ([1339828](https://issuetracker.unity3d.com/issues/android-the-default-icon-does-not-get-successfully-changed-to-another-icon))
...
*   Asset Import: Added an additional import progress bar update prior to cache server download. ([1352678](https://issuetracker.unity3d.com/issues/import-progress-bar-doesnt-refreshing-when-downloading-from-cache))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Asset Pipeline: Fixed WorkerManagement.DesiredWorkerCount\_ForceChanged\_ChangesWorkerStats test instability. (1384938)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   DX12: Fixed crash when using GL render commands. (1387491)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Editor: Fixed crash on startup in the Custom Render Texture Manager for an old AVPro that's using Custom Render Texture for video interpolation. ([1362634](https://issuetracker.unity3d.com/issues/editor-crashes-after-assertion-failed-on-expression-input-end-equals-end-error-when-opening-game-view))
...
*   GI: Color temperature mode does not work with Enlighten realtime GI in player builds. ([1370438](https://issuetracker.unity3d.com/issues/color-temperature-mode-does-not-work-with-enlighten-realtime-gi-in-player-builds))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Graphics: Fixed AssetPreviews + texture preview window for ASTCnm/Plain normal maps.
    
*   Graphics: Fixed crash when using the Movie Recorder to capture 360 movies. ([1249348](https://issuetracker.unity3d.com/issues/unity-recorder-crash-in-shader-getsubshaderwithtagvalue-after-loading-a-scene-asynchronously-while-recording-a-360-view-movie))
...
*   Mobile: Fixed issue where UaaL analytics might get stripped if code stripping is enabled. (1380042)
...
#### New 2022.1.0b4 Package Changes since 2022.1.0b3
...
### Preview of Final 2022.1.0b4 Release Notes
...
*   Asset Pipeline: Fixed issue with prefabs reimporting on editor restart. (1382793)
...
*   Build Pipeline: Fixed an issue that when building generated IL2CPP C++ code with Visual Studio 2022, Unity now correctly recognize it as "Visual Studio 2022" instead of "Visual Studio \[Unknown\]". ([1378085](https://issuetracker.unity3d.com/issues/incremental-build-pipeline-recognizes-visual-studio-2022-as-vs-unknown))
    
*   Build Pipeline: Fixed Linux Dedicated Server build fail if Linux Standalone support is not installed. (1379582)
...
*   Editor: Fixed ReorderableList flicker when moving between multiple inspectors. ([1353819](https://issuetracker.unity3d.com/issues/moving-the-mouse-around-2-inspector-windows-which-show-arrays-of-different-levels-makes-the-elements-in-the-inspectors-flicker))
...
*   Shaders: Fixed for the frame debugger not properly displaying some types like integers with compute shaders. ([1345758](https://issuetracker.unity3d.com/issues/framedebugger-compute-shader-ints-showing-up-in-float-section-with-wrong-value))
...
#### Preview of Final 2022.1.0b4 Package changes

#### Packages updated

*   com.unity.2d.animation: [6.0.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@6.0//changelog/CHANGELOG.html) → [8.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@8.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.common: [6.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.common@6.0//changelog/CHANGELOG.html) → [7.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.common@7.0//changelog/CHANGELOG.html)
...
*   com.unity.2d.psdimporter: [6.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@6.0//changelog/CHANGELOG.html) → [7.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@7.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.spriteshape: [7.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@7.0//changelog/CHANGELOG.html) → [8.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@8.0//changelog/CHANGELOG.html)
...
*   com.unity.cinemachine: [2.8.0-pre.1](https://docs.unity3d.com/Packages/com.unity.cinemachine@2.8//changelog/CHANGELOG.html) → [2.8.3](https://docs.unity3d.com/Packages/com.unity.cinemachine@2.8//changelog/CHANGELOG.html)
...
*   com.unity.inputsystem: [1.1.0-pre.5](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.1//changelog/CHANGELOG.html) → [1.2.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.2//changelog/CHANGELOG.html)
...
*   com.unity.mobile.notifications: [1.4.1](https://docs.unity3d.com/Packages/com.unity.mobile.notifications@1.4//changelog/CHANGELOG.html) → [1.4.2](https://docs.unity3d.com/Packages/com.unity.mobile.notifications@1.4//changelog/CHANGELOG.html)
...
*   com.unity.nuget.newtonsoft-json: [2.0.0](https://docs.unity3d.com/Packages/com.unity.nuget.newtonsoft-json@2.0//changelog/CHANGELOG.html) → [2.0.2](https://docs.unity3d.com/Packages/com.unity.nuget.newtonsoft-json@2.0//changelog/CHANGELOG.html)
...
*   com.unity.profiling.core: [1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.profiling.core@1.0//changelog/CHANGELOG.html) → [1.0.0](https://docs.unity3d.com/Packages/com.unity.profiling.core@1.0//changelog/CHANGELOG.html)
    
*   com.unity.purchasing: [3.2.2](https://docs.unity3d.com/Packages/com.unity.purchasing@3.2//changelog/CHANGELOG.html) → [4.1.2](https://docs.unity3d.com/Packages/com.unity.purchasing@4.1//changelog/CHANGELOG.html)
...
*   com.unity.render-pipelines.core: [12.0.0](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@12.0//changelog/CHANGELOG.html) → [13.1.4](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition: [12.0.0](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@12.0//changelog/CHANGELOG.html) → [13.1.4](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition-config: [12.0.0](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@12.0//changelog/CHANGELOG.html) → [13.1.4](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.universal: [12.0.0](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@12.0//changelog/CHANGELOG.html) → [13.1.4](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@13.1//changelog/CHANGELOG.html)
    
*   com.unity.scriptablebuildpipeline: [1.18.0](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.18//changelog/CHANGELOG.html) → [1.19.5](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.19//changelog/CHANGELOG.html)
    
*   com.unity.searcher: [4.3.2](https://docs.unity3d.com/Packages/com.unity.searcher@4.3//changelog/CHANGELOG.html) → [4.9.1](https://docs.unity3d.com/Packages/com.unity.searcher@4.9//changelog/CHANGELOG.html)
