...
*   Editor: When building a release notes url, we support alpha version. ([1376245](https://issuetracker.unity3d.com/issues/links-are-not-working-when-opening-them-from-alpha-editor))  
    _First seen in 2022.1.0a1._  
    _Fixed in 2022.1.0b11._
...
*   macOS: Fixed crash when passing '-force-glcore' to Unity Editor on macOS. ([1374768](https://issuetracker.unity3d.com/issues/unity-crashes-when-entering-force-opengl-or-force-glcore-in-the-advanced-project-settings))  
    _This has already been backported to older releases and will not be mentioned in final notes._  
    _Fixed in 2022.1.0b10._
...
*   Scene Management: Newly created Scene is completely empty ([1397422](https://issuetracker.unity3d.com/issues/the-newly-created-scene-is-completely-empty))
...
*   Shader System: Editor crashes after deleting a material variant which has a child variant sometimes resulting in a large memory leak ([1403049](https://issuetracker.unity3d.com/issues/editor-crashes-after-deleting-a-material-variant-which-has-a-child-variant-sometimes-resulting-in-a-large-memory-leak))
...
### New 2022.1.0b9 Entries since 2022.1.0b8

#### Changes

*   Android: Stop trimming text input. ([1376463](https://issuetracker.unity3d.com/issues/spaces-before-text-in-the-input-field-are-being-deleted-when-closing-the-keyboard-by-pressing-the-ok-button-on-android-devices))

#### Fixes

*   AI: Fixed issue where the NavMesh obstacle carving caused narrow gaps in the NavMesh. ([1363972](https://issuetracker.unity3d.com/issues/nav-mesh-agent-gets-stuck-when-colliding-with-an-invisible-wall-created-by-nav-mesh-obstacles))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Asset Import: Enabled "Strip Bones" as the default for new assets. (1386538)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Asset Pipeline: Generating previews for scenes could sometimes block saving asset until finished. (1330504)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Core: Updated libcurl to 7.80 to address security vulnerabilities. (1383040)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Editor: Fixed crash when making very deep material variant hierarchy chains. (1378149)  
...
*   Graphics: Fixed shader compiler error when using InterlockedExchange with float texture. ([1383689](https://issuetracker.unity3d.com/issues/hlslcc-float-image-atomics-dont-work))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   IL2CPP: Android build when Windows Language is set to Turkish. ([1377516](https://issuetracker.unity3d.com/issues/windows-il2cpp-cant-build-on-windows-when-system-display-language-is-set-to-turkish))
...
*   Prefabs: Link parents to children before merge to allow merge code to unlink deleted transforms correctly. ([1385437](https://issuetracker.unity3d.com/issues/editor-crashes-on-transform-countnodesdeep-when-reimporting-assets))  
    _First seen in 2022.1.0._
...
*   Scripting: Fixed non generic method returning generic type parameter (from declaring type) being skipped. (1310558)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Scripting: Fixed potential AssemblyUpdater assembly corruption if the assembly referenced specific Texture.Resize() overloads. ([1374188](https://issuetracker.unity3d.com/issues/failed-to-resolve-type-system-dot-int32-error-is-thrown-when-assemblyupdater-is-called))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Serialization: Fixed crash loading asset bundles containing assets with editor only fields in play mode. This was true only for asset bundles generated after an initial play mode session. ([1392141](https://issuetracker.unity3d.com/issues/crash-when-instantiate-the-addressable-prefab-with-textmesh-pro))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Serialization: Fixed crash when setting an instance containing an empty list field in SerializedProperty.managedReferenceValue and then using SerializedObject.ApplyModifiedProperties. (1398729)
...
*   Shaders: Added subshader and pass information to shader errror message details. ([1389061](https://issuetracker.unity3d.com/issues/shader-errors-do-not-have-info-about-originating-subshader-slash-pass))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Shaders: Fixed compute shader serialization to use relative paths to avoid issues with cache server. ([1396974](https://issuetracker.unity3d.com/issues/couldnt-open-include-file-error-is-thrown-when-compiling-a-shader-and-unity-accelerator-is-being-used))
    
*   Shaders: Fixed unintended errors complaining about failed shader cache entry moves. ([1372561](https://issuetracker.unity3d.com/issues/cancelling-displaydialog-because-it-was-run-from-a-thread-that-is-not-the-main-thread-error-when-opening-nested-vfxs))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Universal Windows Platform: Unity generated UWP project uses hardcoded <defaultLanguage> value of en-US. ([1342532](https://issuetracker.unity3d.com/issues/unity-generated-uwp-project-defaults-to-en-us-language))
    
*   Visual Scripting: 1.8.0 pre-release version is no longer available.
    
*   WebGL: Added escape of special characters in canvas html id. ([1369101](https://issuetracker.unity3d.com/issues/webgl-build-fails-to-execute-queryselector-if-the-canvas-id-starts-with-a-number-in-unity-play))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    

#### New 2022.1.0b9 Package Changes since 2022.1.0b8
...
### Preview of Final 2022.1.0b9 Release Notes
...
#### Preview of Final 2022.1.0b9 Package changes
