...
### New 2022.1.0b3 Entries since 2022.1.0b2
...
*   GI: Fixed warning in editor warning "The referenced script (Unknown) on this Behaviour is missing!" which can occur aften opening the Environments Tab of the Lighting Window. ([1367809](https://issuetracker.unity3d.com/issues/warnings-in-the-console-when-live-recompiling-scripts-after-editing-the-scenes-lighting-properties))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   HDRP: Fixed AO dissapearing when DRS would be turned off through a camera, while hardware drs is active in DX12 or Vulkan. (1383093)
...
*   IL2CPP: Avoid a miscompile with MSVC 2017 and later in release builds when a using statement is inside a try block followed by two or more catch blocks with identical code. ([1376197](https://issuetracker.unity3d.com/issues/player-crashes-when-calling-file-dot-openread-and-catching-exception-in-async-methods))
...
*   Linux: Fixed mouse scroll wheel inputs are ignored when providing inputs through RDP. ([1372701](https://issuetracker.unity3d.com/issues/linux-editor-ignores-mouse-scroll-wheel-input-when-providing-inputs-through-rdp))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Package Manager: BuiltIn documentation link opens the right editor version url. (1376379)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Package Manager: Read More info box link for Experimental package versions now opens the correct documentation URL. ([1385105](https://issuetracker.unity3d.com/issues/package-manager-read-more-link-for-experimental-packages-points-to-wrong-url))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Physics: Fixed a case where multi-selecting Articulation Bodies would set some properties to the same value. ([1379145](https://issuetracker.unity3d.com/issues/anchors-rotation-value-becomes-the-same-when-selecting-multiple-game-objects-with-the-articulation-body-component))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Shaders: Counting variants based on usage will no longer make UI unusable for shaders with many variants. ([1378555](https://issuetracker.unity3d.com/issues/shader-graph-editor-performance-is-slow-when-skip-unused-shader-features-is-selected-in-the-shader-variant-dropdown))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   UI Toolkit: Fixed Enter not working in the new selector field of the UI Builder Stylesheets panel. (1381959)  
...
*   UI Toolkit: Fixed wrong warning about PanelSettings not having Theme Style Sheet set when project is loading. (1382287)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Universal Windows Platform: Fixed Japanese IME not switching to Hiragana when editing an InputField UI. (1381378)  
...
*   VFX Graph: Fixed null reference exception when opening another VFX and a debug mode is enabled. ([1347420](https://issuetracker.unity3d.com/issues/vfx-graph-nullreferenceexception-is-thrown-to-the-console-when-switching-to-another-graph))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
### Preview of Final 2022.1.0b3 Release Notes
