...
### New 2022.1.0b10 Entries since 2022.1.0b9
...
*   2D: Fixed Sprite Skin's help button now leads to the correct documentation page. (1383765)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Android: Warning 'IAdaptivePerformanceSettings.k\_AssetVersion' when building the project. ([1373192](https://issuetracker.unity3d.com/issues/adaptiveperformance-adaptive-performance-warning-iadaptiveperformancesettings-dot-k-assetversion-when-building-the-project))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Asset Bundles: Ensure that if you copy file and meta on disk, rename them the asset bundle name is preserved. ([1385129](https://issuetracker.unity3d.com/issues/assetbundle-assets-will-not-appear-in-the-assetbundles-when-the-guids-are-the-same))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Editor: ContextMenuItems added to Lists will now also show up in the List label context menu as well as the items. ([1360138](https://issuetracker.unity3d.com/issues/contextmenuitem-not-working-for-list-and-reorderablelist-when-included-by-script))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   GI: \[Vulkan\] Editor crashes in Optix when Generating Lighting multiple times. ([1358477](https://issuetracker.unity3d.com/issues/vulkan-editor-crashes-when-generating-lighting-multiple-times))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Graphics: Fixed undo in for `DebugUI.EnumFields` on the rendering debugger. (1386964)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   HDRP: Fixed errors spamming when in player mode due to ray tracing light cluster debug view. ([1390471](https://issuetracker.unity3d.com/issues/player-dot-log-spammed-when-tracing-is-set-to-ray-tracing))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   IL2CPP: Allow \[Preserve\] in assemblies whose name starts with Microsoft. ([1397381](https://issuetracker.unity3d.com/issues/preserveattribute-is-ignored-in-core-assemblies-like-system-or-microsoft))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   IL2CPP: Fixed data corruption when unboxing to a Nullable<System.Decimal>. ([1385813](https://issuetracker.unity3d.com/issues/indexoutofrangeexception-is-being-thrown-when-using-json-dot-net-deserializer-to-convert-decimal-numbers-to-float))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   IL2CPP: Windows - Fixed error message when Windows 10 SDK is missing. ([1387186](https://issuetracker.unity3d.com/issues/building-il2cpp-fails-with-message-about-failed-stevedore-download))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   iOS: Allow picking up a background scene if no foreground scenes were found. (1400794)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   iOS: Stop UnityEngine.SystemInfo.processorFrequency returning 0 on Apple Silicon. ([1396529](https://issuetracker.unity3d.com/issues/unityengine-dot-systeminfo-dot-processorfrequency-logs-a-value-of-0-on-m1-macs))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Scene/Game View: Fixed Hierarchy's picking icons not refreshing when picking toggled via shortcut. ([1386629](https://issuetracker.unity3d.com/issues/hierarchy-is-not-repainted-when-pressing-the-toggle-picking-shortcut))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   uGUI: Fixed the slider's min and max values being the overwritten when selecting multiple slider GameObjects in the Hierarchy window. ([1388196](https://issuetracker.unity3d.com/issues/slider-min-and-max-values-become-the-same-as-the-other-slider-when-selecting-multiple-sliders-in-the-hierarchy-window))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   VFX Graph: Blackboard "Add" button for output could be hidden when the panel is too small. ([1389927](https://issuetracker.unity3d.com/issues/vfx-graph-output-add-button-cropped-in-subgraph-blackboard))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   VFX Graph: Fixed when a collision with zero scale leads to undefined behavior. ([1381562](https://issuetracker.unity3d.com/issues/vfxgraph-collide-with-a-sphere-of-radius-0-breaks-all-particles))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   VFX Graph: Forbid pasting a subgraph in the same subgraph. ([1364480](https://issuetracker.unity3d.com/issues/crash-when-copy-pasting-a-subgraph-block))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   VFX Graph: Particle Strip without lifetime does not die when Alive is set to false. ([1376278](https://issuetracker.unity3d.com/issues/particlestrip-quad-doesnt-get-killed-when-explicitly-setting-alive-attribute-to-false))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
#### New 2022.1.0b10 Package Changes since 2022.1.0b9

#### Packages updated

*   com.unity.2d.animation: [8.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.2d.animation@8.0//changelog/CHANGELOG.html) → [8.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@8.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.common: [7.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.2d.common@7.0//changelog/CHANGELOG.html) → [7.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@7.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.psdimporter: [7.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@7.0//changelog/CHANGELOG.html) → [7.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@7.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.spriteshape: [8.0.0-pre.5](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@8.0//changelog/CHANGELOG.html) → [8.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@8.0//changelog/CHANGELOG.html)
...
*   com.unity.render-pipelines.core: [13.1.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@13.1//changelog/CHANGELOG.html) → [13.1.6](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition: [13.1.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@13.1//changelog/CHANGELOG.html) → [13.1.6](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition-config: [13.1.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@13.1//changelog/CHANGELOG.html) → [13.1.6](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.universal: [13.1.5](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@13.1//changelog/CHANGELOG.html) → [13.1.6](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@13.1//changelog/CHANGELOG.html)
...
*   com.unity.shadergraph: [13.1.5](https://docs.unity3d.com/Packages/com.unity.shadergraph@13.1//changelog/CHANGELOG.html) → [13.1.6](https://docs.unity3d.com/Packages/com.unity.shadergraph@13.1//changelog/CHANGELOG.html)
...
*   com.unity.visualeffectgraph: [13.1.5](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@13.1//changelog/CHANGELOG.html) → [13.1.6](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@13.1//changelog/CHANGELOG.html)
    

### Preview of Final 2022.1.0b10 Release Notes
