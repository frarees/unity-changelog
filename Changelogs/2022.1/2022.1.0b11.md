...
*   macOS: fixed rare crash in GameView pointing to BufferMetal::IsBusy ([1405248](https://issuetracker.unity3d.com/issues/editor-crashes-on-buffermetal-isbusy-after-opening-a-scene))  
    _Fixed in 2022.1.0b12._
...
*   Settings Window: The Splash Screen settings are missing when using MacOS ([1404018](https://issuetracker.unity3d.com/issues/the-splash-screen-settings-are-missing-when-using-macos))
...
### New 2022.1.0b11 Entries since 2022.1.0b10
...
*   HDRP: Fixed issue with detail normals when scale is null. (1399548)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   HDRP: Fixed null reference issue in CollectLightsForRayTracing. (1398381)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Scripting: Fixed an IPCStream reference counting issue causing Unity to crash on shutdown. ([1382810](https://issuetracker.unity3d.com/issues/editor-crashes-on-runtimestatic-packagemanager-api-0-staticdestroy-when-closing-the-editor))  
    _First seen in 2022.1.0a14._
    
*   Scripting: Fixed issue where Unity would not print to console all user assemblies which reference UnityEngine_/UnityEditor_ dll's, where the file name didn't match the assembly name. ([1345099](https://issuetracker.unity3d.com/issues/only-some-assemblies-fail-to-be-loaded-when-assembly-name-does-not-match-the-file-name))
    
*   UI Toolkit: This PR fixed the display of prefab override blue bars in a uitk inspector. (1368005)  
...
*   URP: Fixed Light2D Sprite Light not updating when Sprite properties are modified. ([1396418](https://issuetracker.unity3d.com/issues/2d-urp-sprite-light-2d-doesnt-update-when-sprite-ppu-is-changed), [1396422](https://issuetracker.unity3d.com/issues/2d-urp-sprite-light-2d-visuals-dont-update-when-sprite-texture-is-modified-in-transparent-areas))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   VFX Graph: Fixed an exception when setting when changing the space of a shape to world. ([1389076](https://issuetracker.unity3d.com/issues/vfx-graph-gizmos-of-the-shape-disappear-when-connecting-any-node-to-the-transform-shape-block-and-changing-its-space-to-world))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   VFX Graph: Fixed picking and Selection passes. ([1382788](https://issuetracker.unity3d.com/issues/vulkan-shader-requires-vertex-data-and-is-not-compatible-with-drawindexednullgeometry))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   WebGL: Fixed playback of wrong audio clip. ([1365565](https://issuetracker.unity3d.com/issues/webgl-audio-in-player-gets-distorted-plays-wrong-tracks))
    
*   XR: Updated XR Interaction Toolkit to 2.0.0.  
    XR Updated XR Core Utilities to 2.0.0.
    

#### New 2022.1.0b11 Package Changes since 2022.1.0b10
...
*   com.unity.render-pipelines.core: [13.1.6](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@13.1//changelog/CHANGELOG.html) → [13.1.7](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition: [13.1.6](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@13.1//changelog/CHANGELOG.html) → [13.1.7](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition-config: [13.1.6](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@13.1//changelog/CHANGELOG.html) → [13.1.7](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@13.1//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.universal: [13.1.6](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@13.1//changelog/CHANGELOG.html) → [13.1.7](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@13.1//changelog/CHANGELOG.html)
    
*   com.unity.shadergraph: [13.1.6](https://docs.unity3d.com/Packages/com.unity.shadergraph@13.1//changelog/CHANGELOG.html) → [13.1.7](https://docs.unity3d.com/Packages/com.unity.shadergraph@13.1//changelog/CHANGELOG.html)
    
*   com.unity.visualeffectgraph: [13.1.6](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@13.1//changelog/CHANGELOG.html) → [13.1.7](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@13.1//changelog/CHANGELOG.html)
    
*   com.unity.xr.core-utils: [2.0.0-pre.6](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.0//changelog/CHANGELOG.html) → [2.0.0](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.0//changelog/CHANGELOG.html)
    
*   com.unity.xr.interaction.toolkit: [2.0.0-pre.7](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.0//changelog/CHANGELOG.html) → [2.0.0](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.0//changelog/CHANGELOG.html)
...
### Preview of Final 2022.1.0b11 Release Notes
...
*   Package: Com.unity.purchasing version updated to 4.1.3.
...
*   2D: Fixed case where control point selection flickers when drag and multi-select points in scene. ([1382695](https://issuetracker.unity3d.com/issues/2d-spriteshape-control-point-selection-flickers-when-drag-and-multi-select-points-in-scene))
...
*   2D: Fixed null exception when importing files with masks. ([1388820](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-when-attempting-to-make-changes-to-a-psd-file))
...
*   Mono: Fixed hang on shutdown specific to windows where the debugger thread's blocking accept call wasn't being cancelled. ([1374958](https://issuetracker.unity3d.com/issues/after-launching-renderdoc-from-unity-cannot-close-unity-until-renderdoc-is-closed))
...
#### Preview of Final 2022.1.0b11 Package changes

#### Packages updated

*   com.unity.2d.animation: [6.0.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@6.0//changelog/CHANGELOG.html) → [8.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@8.0//changelog/CHANGELOG.html)
...
*   com.unity.addressables: [1.18.4](https://docs.unity3d.com/Packages/com.unity.addressables@1.18//changelog/CHANGELOG.html) → [1.19.18](https://docs.unity3d.com/Packages/com.unity.addressables@1.19//changelog/CHANGELOG.html)
...
*   com.unity.collab-proxy: [1.5.7](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.5//changelog/CHANGELOG.html) → [1.15.13](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.15//changelog/CHANGELOG.html)
