### Known Issues in 6000.0.0b11

- 2D: Fixed imported assets initialized with incorrect default materials
    (UUM-60651)<br>
    *First seen in 6000.0.0b1.*    <br>*Fixed in 6000.0.0b12.*
...
- DX12: Fix an editor freeze in Playmode on DX12.
    (UUM-55121)    <br>*Fixed in 6000.0.0b12.*

- Editor: Fixed a bug where the inspector preview will not be visible after the inspector is loaded.
    ([UUM-65172](https://issuetracker.unity3d.com/issues/the-curve-editor-window-is-not-shown-when-attempting-to-open-it-in-the-timeline-window))    <br>*Fixed in 6000.0.0b12.*

- Editor: Fixed issue with OS fallback not working for IMGUI in the Player
    (UUM-44595)    <br>*Fixed in 6000.0.0b12.*
...
- Linux: In our Linux Pulse audio driver, make sure to select the correct default output device. Previously, on some systems and some versions of Linux, we could end up with no audio output or audio output being routed to an unexpected device.
    ([UUM-53143](https://issuetracker.unity3d.com/issues/linux-no-audio-output-when-playing-audio))    <br>*Fixed in 6000.0.0b12.*
...
- VFX Graph: Fixed FloatField reduced to 1px height
    (UUM-65786)    <br>*Fixed in 6000.0.0b12.*
...
### New 6000.0.0b11 Entries since 2023.3.0b10

#### Features

- Version Control: A new tab view has been added to list and manage locks.
...
- Universal RP: Exposing additional depth formats for CameraDepthAttachment and CameraDepthTexture.

- VFX Graph: Merge some VFX Graph buffers to lower to amount of buffer used in the shaders and increase platform reach.
...
- Editor: \[Build Profile Window \] Fixed for being able to switch to server profile even when its module is not installed.
    ([UUM-62263](https://issuetracker.unity3d.com/issues/user-can-build-server-builds-without-having-the-module-installed-if-a-build-profile-for-a-server-build-is-created))
...
#### New 6000.0.0b11 Package Changes since 2023.3.0b10
...
- com.unity.dt.app-ui: [1.0.1](https://docs.unity3d.com/Packages/com.unity.dt.app-ui@1.0//changelog/CHANGELOG.html) &#x2192; [1.0.3](https://docs.unity3d.com/Packages/com.unity.dt.app-ui@1.0//changelog/CHANGELOG.html)

### Preview of Final 6000.0.0b11 Release Notes
...
- Android: Upgraded the Android Gradle Plugin version to 8.1.3.

- Android: Upgraded the Gradle version to 8.4.

- Android: Upgraded the Java Development Kit \(JDK\) version for building Android apps to 17.

- Android: Upgraded the `targetSdkVersion` and `compileSdkVersion` to 34 by default.
...
- Package Manager: Fixed an issue during a 'My Assets' download, in light mode, 'Resume' and 'Cancel' button background colors are off.
    (UUM-36664)
...
#### Preview of Final 6000.0.0b11 Package changes
...
- com.unity.services.core: [1.10.1](https://docs.unity3d.com/Packages/com.unity.services.core@1.10//changelog/CHANGELOG.html) &#x2192; [1.12.2](https://docs.unity3d.com/Packages/com.unity.services.core@1.12//changelog/CHANGELOG.html)
