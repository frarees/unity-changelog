...
*   Shaders: Fixed Metal Editor in some cases wrongly thinking it supports DX11 SM5.0 shaders. [(869021)](https://issuetracker.unity3d.com/issues/metaleditor-gameview-rendering-broken-and-gl-dot-end-requires-material-dot-setpass-before-errors-in-console-with-depthoffield)
*   VR: Editor crashes entering playmode if paused [(869130)](https://issuetracker.unity3d.com/issues/editor-crashes-entering-playmode-if-paused)
