...
*   UI: Fixed memory leak due to keeping a reference to UI shared mesh ([940588](https://issuetracker.unity3d.com/issues/ui-leaks-memory-when-it-is-being-animated))
