...
- 6000.3.16f1: Player crashes with use-after-free when a Shader is unloaded immediately after ShaderWarmup.WarmupShaderFromCollection() on D3D12
...
- Asset Bundles: Fixed a player hang or crash with heap corruption on application quit when Engine Diagnostics \("Build Diagnostics Data"\) is enabled and an AssetBundle has been loaded.
    ([UUM-147746](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147746))    <br>*Fixed in 6000.6.0b9.*
...
- Editor: Fixed an issue where Shift+clicking a prefab child in the Scene view selected the child object instead of the prefab instance root.
    ([UUM-148884](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148884))    <br>*Fixed in 6000.6.0b9.*
...
- Editor: Fixed Select All in the hierarchy not being reflected in the inspector
    ...
    *First seen in 6000.6.0b2.*    <br>*Fixed in 6000.6.0b9.*

- Entities: Fix leaked world nodes in SchedulePacking_WithInitialChanges_LinearOperationMode
    ([UUM-148849](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148849))    <br>*Fixed in 6000.6.0b9.*
...
- GI: Fixed a crash and long packing times when switching the Lighting Visualization overlay's Lighting Data to Preview in a scene with a large terrain.
    ([UUM-149471](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-149471))    <br>*Fixed in 6000.6.0b9.*
...
- Graphics: Fixed a `NullReferenceException` thrown by `DynamicLightController` in the URP sample template Garden scene when the component's `Awake()` ran in the Editor before the runtime-only light manager list was initialized.
    ([UUM-145743](https://issuetracker.unity3d.com/issues/universal-3d-sample-nullreferenceexception-is-thrown-when-opening-gardenscene-in-urp-17-dot-3-0-sample))    <br>*Fixed in 6000.6.0b9.*

- HDRP: Fixed the Game view flickering when changing HDRP settings while the Game view is focused.
    ([UUM-147685](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147685))    <br>*Fixed in 6000.6.0b9.*
...
- Scripting: Fixed assembly resolutions errors in IL post processors that referenced assemblies with names starting with "Mono.Cecil".
    ...
    *First seen in 6000.6.0b3.*    <br>*Fixed in 6000.6.0b9.*
...
### New 6000.6.0b8 Entries since 6000.6.0b7
...
- Burst: Fixed a window serialization error being logged when enabling or disabling UI Toolkit Live Reload on the Burst Inspector window.
    ([UUM-148278](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148278))<br>
...
- Editor: Fixed a bug where Visual Element nodes with no name were not able to be renamed via double-click in the hierarchy.
    ([UUM-143826](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-143826))<br>
...
- Editor: Fixed problem with serialization of single byte Dictionary&lt;byte, byte&gt;.
    (UUM-148493)<br>
...
- Editor: Fixed view state restoration when entering Prefab Stage in Context from the Hierarchy.
    ([UUM-144907](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144907))<br>
...
- Graphics: Fixed a GPU hang on Metal when dispatching a compute kernel whose declared threadgroup size exceeds the device's per-pipeline maximum, such as HDRP High Quality Line Rendering on Intel Macs.
    (UUM-147457)<br>
...
- Package Manager: Fix the issue where samples are not discoverable for locally installed UPM packages that are also available on the Asset Store
    (UUM-147778)<br>
    *First seen in 6000.6.0b4.*
...
- Timeline: Updated the Timeline Customization Samples `Timeline_CustomTracks` scene to use the new Input System component.
    ([UUM-142488](https://issuetracker.unity3d.com/issues/invalidoperationexception-errors-are-thrown-when-entering-play-mode-in-the-timelines-customization-samples))<br>
    *First seen in 6000.6.0a5.*

- UI Toolkit: Add support for custom filter functions in backdrop-filter.
    ([UUM-148086](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148086))<br>
...
- UI Toolkit: Fixed "Invalid image specified" warnings when clearing an element's background image in the inspector.
    ([UUM-148342](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148342))<br>
    *First seen in 6000.6.0b6.*
...
- UI Toolkit: Fixed selection outline and picking pass with custom vertex shader.
    ([UUM-146911](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146911))<br>
    *First seen in 6000.6.0b4.*
...
- UI Toolkit: Fixed the Package Manager package list scrolling immediately when navigating with the arrow keys instead of only when the newly selected package is off-screen.
    ([UUM-147017](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147017))<br>
    *First seen in 6000.6.0b4.*

- UI Toolkit: Fixed undo related error after undoing a Style Sheet selector drag operation.
    ([UUM-145619](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-145619))<br>
    *First seen in 6000.6.0b1.*

- UI Toolkit: Fixed VisualTreeAsset preview texture from appearing black.
    ([UUM-148154](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148154))<br>
    *First seen in 6000.6.0b6.*
...
- UI Toolkit: Selecting "Custom Function" in the Backdrop Filter section of the Inspector no longer logs "Custom filters are not supported for backdrop-filter" warnings; the custom filter is now applied.
    ([UUM-148347](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148347))<br>
    *First seen in 6000.6.0b6.*
...
- UI Toolkit: Selection highlight no longer remains in the UI Viewport after deleting the hovered element or style rule from the Hierarchy.
    ([UUM-144573](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144573))<br>
    *First seen in 6000.6.0a7.*
...
- VFX Graph: Canceling a Blackboard attribute, parameter, or category rename with the ESC key no longer applies the new name.
    ([UUM-144957](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144957))<br>
    *First seen in 6000.6.0a7.*
...
- VFX Graph: Fixed templates not appearing immediately when pressing the "New..." button in the Shader Graph Output context after entering Play Mode.
    ([UUM-143681](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-143681))<br>
...
#### New 6000.6.0b8 Package Changes since 6000.6.0b7
...
### Preview of Final 6000.6.0b8 Release Notes
...
#### Preview of Final 6000.6.0b8 Package changes
...
- com.unity.collab-proxy: [2.11.3](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.11//changelog/CHANGELOG.html) to [2.13.5](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.13//changelog/CHANGELOG.html)
