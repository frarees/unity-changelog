...
- 6000.6.0a3: Project is created with errors when using the “Get Started With Unity” template
    ([UUM-142732](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-142732))
...
- Burst: Burst compilation was skipped for jobs discovered via \[JobProducerType\] \(such as IJobChunk\) in Player builds using the High Managed Stripping Level, causing them to silently fall back to managed code. \(\)
    ...
    *First seen in 6000.6.0b4.*    <br>*Fixed in 6000.6.0b7.*
...
- HDRP: Fixed console errors, broken rendering, and a potential crash when entering Play Mode with Reload Domain disabled in the Enter Play Mode Options.
    ...
    *First seen in 6000.6.0b5.*    <br>*Fixed in 6000.6.0b7.*

- iOS: Fixed a bug where pulling down the iOS Control Center could cause a Unity app to stop playing back audio.
    ([UUM-145522](https://issuetracker.unity3d.com/issues/ios-audio-is-cut-out-when-accessing-ios-control-center))    <br>*Fixed in 6000.6.0b7.*
...
- Multiplayer: Editor window layouts loads a broken "Failed to load" Multiplayer Play Mode window and throws a NullReferenceException when docking around it in projects where Multiplayer Play Mode is not enabled or its package is not installed.
    ([UUM-146870](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146870))    <br>*Fixed in 6000.6.0b7.*

- Scripting: Fixed ~2 KB size increase in empty WebGL Player builds and removed `editor/coreclr` only functions.
    (UUM-147728)<br>
    *First seen in 6000.6.0a8.*    <br>*Fixed in 6000.6.0b7.*
...
### New 6000.6.0b6 Entries since 6000.6.0b5
...
- Android: Fixed a crash in LoadFontFamilyNamesFromFontFile on Android 10 devices when querying OS font fallbacks.
    ([UUM-147144](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147144))<br>
...
- Animation: Fixed flickering of area filter in the search bar.
    ([UUM-144937](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144937))<br>
...
- Asset Pipeline: Fixed an allocation crash that could occur under heavy import loads.
    ([UUM-146671](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146671))<br>
    *First seen in 6000.6.0b3.*
...
- Editor: Editor: Fix Project Auditor sections not refreshing until analysis is completed.
    ([UUM-144826](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144826))<br>
    *First seen in 6000.6.0a8.*
...
- Editor: Fixed ellipsis Begin and Middle for ATG.
    ([UUM-144958](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144958))<br>
    *First seen in 6000.6.0a7.*
...
- Entities: Fixed a memory leak in the EntityNameStorage by properly disposing NameStoreAccess.
    ([UUM-147280](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147280))<br>
    *First seen in 6000.6.0b4.*
...
- Entities: Fixed an error "Failed to find Entity child node" in the New Hierarchy when removing child status from a GameObject that was added to an existing parent inside a Sub Scene.
    ([UUM-146762](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146762))<br>
    *First seen in 6000.6.0b3.*
...
- Entities: Fixed NullReferenceException in the HierarchyEntityHandler when leaving the VisualElementEditingStage from the new Hierarchy.
    ([UUM-146747](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146747))<br>
    *First seen in 6000.6.0b3.*
...
- IL2CPP: Fixed C++ linker error on a generic method marked for Reverse P/Invoke generation and AggressiveInlining.
    (UUM-144962)<br>
    *First seen in 6000.6.0a8.*
...
- Physics: Fixed compilation warnings and runtime errors in `ModifyJointLimitsAuthoring`.
    ([UUM-145822](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-145822))<br>
...
- Timeline: Added mipmap Warning Icon to the Editor and update Timeline Track warning icon to the standard Warning Icon.
    ([UUM-131155](https://issuetracker.unity3d.com/issues/timeline-activation-track-warning-icon-is-hard-to-see-in-light-editor-theme))<br>
    *First seen in 6000.6.0a6.*
...
- UI Toolkit: Fixed an AssertionException thrown when editing UxmlObject attributes \(such as SortColumnDescription properties on MultiColumnListView\) in the UI Toolkit Authoring inspector.
    ([UUM-146716](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146716))<br>
    *First seen in 6000.6.0b3.*
...
- UI Toolkit: Fixed editor crashing when trying to undo a VisualTreeAsset or StyleSheet change past the last import.
    ([UUM-146454](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146454))<br>
    *First seen in 6000.6.0b3.*
...
#### New 6000.6.0b6 Package Changes since 6000.6.0b5
...
### Preview of Final 6000.6.0b6 Release Notes
...
#### Preview of Final 6000.6.0b6 Package changes
...
- com.unity.services.multiplayer: [2.1.2](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.1//changelog/CHANGELOG.html) to [2.2.4](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.2//changelog/CHANGELOG.html)
