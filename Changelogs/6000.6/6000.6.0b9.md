...
- Audio: Fix crash when pausing AudioRandomContainer containing streaming clips that are still loading
    (UUM-148440)    <br>*Fixed in 6000.6.0b10.*
...
- Editor: Awaitable.NextFrameAsync now resumes in edit mode, including when the Editor runs in batch mode, instead of waiting indefinitely for an unrelated scene update.
    (UUM-148723)<br>
    *First seen in 6000.6.0b8.*    <br>*Fixed in 6000.6.0b10.*

- GI: Fixed crash when baking lighting for a scene placed in StreamingAssets
    ([UUM-149240](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-149240))    <br>*Fixed in 6000.6.0b10.*
...
- GI: Fixed the Windows Editor failing to start when the Microsoft Visual C++ 2010 runtime is not installed; the CPU Progressive Lightmapper now reports that it is unavailable instead.
    (UUM-149122)    <br>*Fixed in 6000.6.0b10.*
...
- UI Toolkit: Fixed UI failing to render on OpenGL ES and WebGL 2.0 devices when the UI shader exceeded the platform's vertex uniform limit.
    (UUM-149277)<br>
    *First seen in 6000.6.0b9.*    <br>*Fixed in 6000.6.0b10.*
...
### New 6000.6.0b9 Entries since 6000.6.0b8

#### Improvements

- Burst: The Burst compiler server now starts asynchronously during editor initialization, reducing editor startup time.
    ([UUM-146006](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146006))<br>
    *First seen in 6000.6.0b1.*

- Scripting: Improve our Lifecycle system to allocate less memory on hot paths.
    (UUM-148725)<br>
...
- Animation: Fixed search field overflowing vertically when EnableQueryBuilder is disabled.
    ([UUM-148577](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148577))<br>
...
- Cinemachine: Added missing CinemachineImpulseFixedSignals documentation
    ([UUM-141604](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-141604))<br>
...
- Cinemachine: Fixed invalid obsolete InvalidPathCache call in CinemachineConfiner.
    ([UUM-147086](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147086))<br>
    *First seen in 6000.6.0b4.*
...
- Editor: Fixed an issue where entering Play Mode, using Search, or opening the Inspector logged a false "Cross scene references are not supported" warning for objects that weren't being saved.
    ([UUM-146260](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146260))<br>
...
- Editor: Fixed cursor position when renaming a build profile with an invalid character at the end of the name.
    ([UUM-146677](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146677))<br>
    *First seen in 6000.6.0b3.*

- Editor: Fixed dragging child prefab nodes that failed silently.
    ([UUM-144246](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144246))<br>
    *First seen in 6000.6.0a8.*
...
- Editor: Fixed mouse lag when performing a drag-and-drop operation during a Domain Reload.
    ([UUM-148331](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148331))<br>
    *First seen in 6000.6.0b6.*
...
- Editor: Fixed Organization and Cloud project dropdowns in Project Settings &gt; Services opening detached from their fields, in the middle of the screen.
    ([UUM-146182](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146182))<br>
    *First seen in 6000.6.0a7.*

- Editor: Fixed Select All in the hierarchy not being reflected in the inspector.
    ([UUM-146225](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146225))<br>
    *First seen in 6000.6.0b2.*

- Editor: Fixed the Build Analysis window missing its tab header icon.
    ([UUM-143888](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-143888))<br>
    *First seen in 6000.6.0a6.*
...
- Entities: Fixed subscene reimport so that it no longer creates entities that are never removed.
    ([UUM-148293](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148293))<br>
    *First seen in 6000.6.0b6.*
...
- Particles: Fixed "'SafeNormalize': implicit truncation of vector type" warning coming from Particles shaders.
    ([UUM-147453](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147453))<br>
    *First seen in 6000.6.0b4.*
...
- Scripting: Fixed assembly resolutions errors in IL post processors that referenced assemblies with names starting with "Mono.Cecil".
    ([UUM-147560](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147560))<br>
    *First seen in 6000.6.0b3.*
...
- UI Toolkit: Fixed a "No script asset for TempSerializedData" warning when selecting a child element in the Hierarchy while in Play mode.
    ([UUM-144577](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144577))<br>
    *First seen in 6000.6.0a7.*
...
- UI Toolkit: Fixed unset attributes on Multi Column List View and Multi Column Tree View reverting to type default values when the .uxml is saved in in-scene UI Authoring.
    ([UUM-148774](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148774))<br>
    *First seen in 6000.6.0b7.*
...
#### New 6000.6.0b9 Package Changes since 6000.6.0b8
...
### Preview of Final 6000.6.0b9 Release Notes
...
- Documentation: Add additional resources for info about using components
...
- Kernel: Fixee a potential deadlock in the job system involving many external threads and manual jobs.
    (UUM-143073)
...
- Test Framework: Fixed an issue where TestFinished messages were not sent correctly when using retry/repeat with test using Domain Reload.
    (UUM-113610)
...
#### Preview of Final 6000.6.0b9 Package changes
...
- com.unity.services.authentication: [3.6.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.6//changelog/CHANGELOG.html) to [3.7.3](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.7//changelog/CHANGELOG.html)
