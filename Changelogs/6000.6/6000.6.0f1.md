...
- 6000.5.0a1: Crash on mono_log_write_logfile when opening specific project
...
### New 6000.6.0f1 Entries since 6000.6.0b10
...
- Burst: Fixed the Burst Inspector disassembly search bar requiring a second Ctrl/CMD + F press to reopen after being closed.
    ([UUM-144286](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144286))<br>
    *First seen in 6000.6.0b9.*
...
- Editor: Fix bug in scripting defines where reverting an un-applied change when a build profile loses focus should not cause a domain reload.
    ([UUM-149532](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-149532))

- Editor: Fix HDRP contact shadows quantizing to 2x2 pixel blocks at full resolution
...
- Editor: Fixed an issue in Visual Effect Graph where identically named exposed properties could be created, causing errors and preventing drag-and-drop of those properties onto the workspace. Made exposed-name and category uniqueness case-insensitive, and sanitized graphs containing case-only-duplicate or reserved-named categories on load.
    ([UUM-144001](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144001))<br>
...
- Editor: Fixed an issue where selecting multiple ranges of items in the **Hierarchy** window wasn't possible.
    ([UUM-142974](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-142974))<br>
...
- Editor: Fixed Audio Source playback so that a source using an Audio Random Container now remains audible when a Rigidbody is attached to the same GameObject or a parent GameObject.
    ([UUM-147844](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147844))<br>
    *First seen in 6000.6.0b5.*

- Editor: Fixed blue focus highlight sometimes doesn't disappear when unfocusing the messages in the Build Analysis.
    ([UUM-143897](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-143897))<br>
    *First seen in 6000.6.0a6.*
...
- Editor: Fixed the stylesheet leak from the UI Toolkit project settings page.
    ([UUM-149777](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-149777))<br>
    *First seen in 6000.6.0b8.*

- Editor: Fixing an issue where accessing the rootVisualElement of an Overlay's container could cause recursive calls and crash the Editor.
...
- Editor: Improved keyboard navigation in the Build Analysis window.
    ([UUM-143847](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-143847))<br>
    *First seen in 6000.6.0a6.*
...
- GraphView: Addressed issue in Template Browser where the tab keyboard shortcut sometimes caused keyboard navigation to go out of sync with selections.
    ([UUM-144972](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144972))<br>
    *First seen in 6000.6.0a7.*
...
- GraphView: Fixed the Template Browser displaying errors when creating an asset from a deleted template.
    ([UUM-143138](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-143138))<br>
    *First seen in 6000.6.0a6.*
...
- GraphView: Search focus in the Template Browser is now preserved after the first match.
    ([UUM-144963](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144963))<br>
    *First seen in 6000.6.0a7.*
...
- Physics 2D: Reading `PhysicsWorld.counters`, or other queries, after restoring a world from a corrupted or truncated `Snapshot` could crash the Editor or Player.
    ([UUM-150072](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-150072))<br>
    *First seen in 6000.6.0b6.*
...
- Shaders: Fixed incorrect prompting of apply shader build settings window on removal of empty keywords override settings.
    ([UUM-148993](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148993))<br>
    *First seen in 6000.6.0b7.*
...
- Text: Add a migration mechanism for Static FontAsset.
    (UUM-149974)
...
- Text: Remove vertex padding on whitespace quads.
...
- uGUI: Fixed `NullReferenceException` errors when selecting an InputField \(TMP\) Placeholder before importing the TMP Essential Package.
    ([UUM-143965](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-143965))<br>
    *First seen in 6000.6.0a7.*

- uGUI: Layout Element inspector now shows mixed values when multiediting and stays in sync across Inspector windows.
    ([UUM-145408](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-145408))<br>
    *First seen in 6000.6.0a7.*
...
- UI Toolkit: Add Vertex Interpolation API.
    (UUM-150384)<br>
    *First seen in 6000.6.0f1.*

- UI Toolkit: Fixed "Invalid image specified" warnings when clearing the Cursor Image field of an in-scene UI Toolkit element.
    ([UUM-149384](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-149384))<br>
    *First seen in 6000.6.0b8.*
...
- UI Toolkit: Fixed nested Panel Renderers throwing exceptions and not rendering after their parent's UXML was saved.
    ([UUM-148452](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148452))<br>
    *First seen in 6000.6.0b6.*

- UI Toolkit: Fixed Panel Renderer content disappearing when its GameObject is unparented from another Panel Renderer.
    ([UUM-147941](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147941))<br>
    *First seen in 6000.6.0b9.*
...
- UI Toolkit: Fixed the MultiColumn control's argument exception when increasing the column and descriptor count.
    ([UUM-148746](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148746))<br>
    *First seen in 6000.6.0b7.*

- UI Toolkit: Fixed the `DropdownField` element ignoring the `index` attribute set in UXML.
    ([UUM-150530](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-150530))<br>
    *First seen in 6000.6.0b10.*
...
- Unity Physics: Regenerated some sample meta files to fix serialized versioning warnings when the 'Advanced Game Physics Sample - Chain and Gears' sample was imported
    ([UUM-149515](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-149515))<br>
    *First seen in 6000.6.0b7.*
...
- VFX Graph: Addressed issue where NaNs could perpetually keep a graph in a dirty state.
...
#### New 6000.6.0f1 Package Changes since 6000.6.0b10
...
- com.unity.addressables: [2.11.1](https://docs.unity3d.com/Packages/com.unity.addressables@2.11//changelog/CHANGELOG.html) to [2.11.2](https://docs.unity3d.com/Packages/com.unity.addressables@2.11//changelog/CHANGELOG.html)

- com.unity.scriptablebuildpipeline: [3.0.2](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@3.0//changelog/CHANGELOG.html) to [3.0.3](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@3.0//changelog/CHANGELOG.html)
...
- com.unity.services.levelplay: [9.5.0](https://docs.unity3d.com/Packages/com.unity.services.levelplay@9.5//changelog/CHANGELOG.html) to [9.5.1](https://docs.unity3d.com/Packages/com.unity.services.levelplay@9.5//changelog/CHANGELOG.html)
...
### Final 6000.6.0f1 Release Notes
...
- Asset Pipeline: Added clarification detail the differences between the various 'preview' type helper functions that exist to fetch an image to represent an asset in some way.<br>
    AssetDatabase.GetCachedIcon<br>
    AssetPreview.GetAssetPreview<br>
    AssetPreview.GetMiniThumbnail<br>
    AssetPreview.GetMiniTypeThumbnail<br>
    Also added the EntityID overload for AssetPreview.IsLoadingAssetPreview, so we're not linking to a function signature that is marked obsolete.
...
- Graphics: Added shadow map caching for Quad Views in XR to skip redundant shadow work in the inner view pass.
...
- IL2CPP: Reduced generated code size when accessing generic sharing data from a non-generic method on a generic type.
...
- Scripting: Improved the error message when a player build fails due to assemblies referencing 'UnityEditor.dll'. The output includes offending assembly list.
...
- Adaptive Performance: Added: Added `CpuUtilization` and `GpuUtilization` APIs for CPU and GPU utilization.
...
- Entities: Added: Introduced IDebugOnAdded and IDebugOnRemoved, which can be added to an IComponentData to receive callbacks when the component has been added/removed to/from an Entity.
...
- HDRP: Added: Added an Editor-only graphics validation function to enable warnings for specific platforms.
...
- Package Manager: Changed: Moved the Export/Import Package API from AssetDatabase to AssetPackage.
...
- UI Toolkit: Added: Added an allocation-free way for users to change the text in a `TextElement`.
...
- HDRP: Added optimization warnings for various HDRP features on specific platforms.
...
- 2D: Fix metal shader errors for RenderingLayerMask pass
    (D2D-8206)
...
- Build Pipeline: Fix for non-deterministic manifest file in Content Directory builds
...
- Documentation: Add more context and detail to the UITK popup example code and steps.
...
- Editor: Add explicit padding in DrawCommandSettings to avoid garbage data when calculating hash value.
...
- Editor: Disable advanced font features for UITK editor text
...
- Editor: Fixed a crash with multiple stack traces that could occur during domain reload when stale GC handles from a previous domain were still cached on native objects.
...
- Editor: Fixed an issue where clicking "Revert" in the prompt that appears when a build profile loses focus after adding a scripting define value in the scripting defines settings list does NOT result in removing the newly added value.
...
- Editor: Fixed an issue where reordering GameObjects showed the "+" \(add\) icon instead of the arrow icon.
...
- Editor: Fixed an issue where the Lights explorer/2D Lights tab search string did not render.
    ([UUM-144579](https://issuetracker.unity3d.com/issues/light-explorer-2d-lights-search-bar-does-not-display-text-when-typed-into))
...
- Editor: Fixed issue where hierarchy selection highlight would disappear and global selection not update when right-clicking on an empty space in HierarchyView.
...
- Editor: Fixed managed binary deserialization allocating a new List on every deserialization read instead of reusing the existing instance.
...
- Editor: Fixed rare hang in BuildContentDirectory.
...
- Editor: Fixed the Object Picker scrolling to the wrong position in grid view when reopened with a selection.
    ([UUM-143327](https://issuetracker.unity3d.com/issues/object-picker-scrolls-incorrectly-depending-on-which-asset-was-selected-previously-when-in-grid-view))
...
- Editor: Project Auditor: Fixed invalid window layout message.
...
- Editor: Removed help icons from inspecting user scripts, redirecting to 404 documentation.
    ([UUM-143986](https://issuetracker.unity3d.com/issues/animation-behaviour-help-icon-leads-to-broken-404-documentation-page))
...
- Editor: Update Stats window to use M suffix for triangle and vertex counts 1 million or greater.
    ([UUM-146878](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146878))

- Editor: Update WinEditor's warning dialog text when running Unity with elevated privileges
...
- Editor: Updated the default offline templates project.
...
- Entities: Fix stale entity subscene nodes in the new Hierarchy when using the AutoLoadScene property on subscenes
    ([UUM-143057](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-143057))

- Entities: Fix WeakReference fields showing "None" when assigned by GUID from code.
...
- GI: Fixed an issue where "Refresh Virtual Offset Debug" throws an exception if the last bake didn't have Virtual Offset enabled.
...
- Graphics: Fixed Quality Levels accepting special characters which caused undesirable effects.
    ([UUM-143956](https://issuetracker.unity3d.com/issues/quality-levels-accept-special-characters-which-cause-undesireable-effects))
...
- Linux: Fixed an issue when building Windows Players and creating Visual Studio Solutions from Linux Editors.
...
- Multiplayer: Install buttons no longer display "Installing package\(s\)..." after the user cancels the install dialog.
...
- Multiplayer: Scrolling now works correctly when the cursor hovers over the Complexity bar.
...
- Physics 2D: "PhysicsEvents.TransformTweenWriteEvent.transfomPlaneCustom" is now "PhysicsEvents.TransformTweenWriteEvent.transformPlaneCustom".
    (UUM-143279)
...
- Profiler: Prevent pasting into the CPU profiler's sample stack window.
...
- Serialization: Fixed crash where WeakReferences were being destroyed off of the main thread, which contended with Mono's GC assumptions about WeakReferences only being freed from the main thread. This fixes an eventual crash inside the Garbage Collector
    (UUM-143324)
...
- Shadergraph: Address issue where gradient picker would not respond to undo/redo commands.
...
- Shadergraph: Address issue where gradient picker's color picker would misbehave during undo/redo.
...
- Shadergraph: Address issue where NRE could result from renaming a subgraph dropdown.
    ([UUM-148866](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148866))

- Shadergraph: Addressed issue where custom render target preview on linux did not render correctly in some cases.
...
- Text: Add glyph-to-character mapping to PostProcessTextVertices.
    (UUM-147627)
...
- Text: Added new SpaceWarp compatible shaders for TextMeshPro.
...
- Timeline: Fixed and `Invalid GUILayout state` errors thrown when clicking the key selection area at the position of a key from a previously displayed property curve in the Timeline curves view.
...
- UI Toolkit: Address some performance regressions in reading/writing some VisualElement properties and manipulating its hierarchy.
...
- UI Toolkit: Fixed an issue when handling changes to UxmlAttribute list values.
    (UUM-143275)
...
- UI Toolkit: Fixed an issue where exporting variables with a value of zero didn't preserve the unit.
    ([UUM-148099](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148099))
...
- Video: Fixed an issue which resulted in the following warning:<br>
...
- WebGL: Added WebGPU Compatibility Mode support for older devices that support webgpu but may not support the full core features. Runtime now automatically falls back to compatibility mode when a Core WebGPU adapter is unavailable.
...
- WebGL: WebGPU: Fixed error on some mobile devices due to the lack of the float32-blendable WebGPU extension.
    ([UUM-145735](https://issuetracker.unity3d.com/issues/webgpu-urp-errors-when-float32-blendable-isnt-available))

- WebGL: \[WebGPU\] Fixed crash that can occur when destroying and creating shaders.
...
- XR: Remove AABB boundary expansion from SplitCullObjectsWithoutUmbra.




#### Final 6000.6.0f1 Package changes

#### Packages updated

- com.unity.collections: [6.5.0](https://docs.unity3d.com/Packages/com.unity.collections@6.5//changelog/CHANGELOG.html) to [6.6.0](https://docs.unity3d.com/Packages/com.unity.collections@6.6//changelog/CHANGELOG.html)

- com.unity.entities: [6.5.0](https://docs.unity3d.com/Packages/com.unity.entities@6.5//changelog/CHANGELOG.html) to [6.6.0](https://docs.unity3d.com/Packages/com.unity.entities@6.6//changelog/CHANGELOG.html)
...
- com.unity.physics: [6.5.0](https://docs.unity3d.com/Packages/com.unity.physics@6.5//changelog/CHANGELOG.html) to [6.6.0](https://docs.unity3d.com/Packages/com.unity.physics@6.6//changelog/CHANGELOG.html)

- com.unity.entities.graphics: [6.5.0](https://docs.unity3d.com/Packages/com.unity.entities.graphics@6.5//changelog/CHANGELOG.html) to [6.6.0](https://docs.unity3d.com/Packages/com.unity.entities.graphics@6.6//changelog/CHANGELOG.html)
...
- com.unity.addressables: [2.9.0](https://docs.unity3d.com/Packages/com.unity.addressables@2.9//changelog/CHANGELOG.html) to [2.11.2](https://docs.unity3d.com/Packages/com.unity.addressables@2.11//changelog/CHANGELOG.html)
...
- com.unity.collab-proxy: [2.11.3](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.11//changelog/CHANGELOG.html) to [2.13.6](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.13//changelog/CHANGELOG.html)
...
- com.unity.formats.alembic: [2.4.4](https://docs.unity3d.com/Packages/com.unity.formats.alembic@2.4//changelog/CHANGELOG.html) to [2.4.7](https://docs.unity3d.com/Packages/com.unity.formats.alembic@2.4//changelog/CHANGELOG.html)

- com.unity.inputsystem: [1.18.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.18//changelog/CHANGELOG.html) to [1.20.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.20//changelog/CHANGELOG.html)
...
- com.unity.ml-agents: [2.0.2](https://docs.unity3d.com/Packages/com.unity.ml-agents@2.0//changelog/CHANGELOG.html) to [4.1.0](https://docs.unity3d.com/Packages/com.unity.ml-agents@4.1//changelog/CHANGELOG.html)
...
- com.unity.recorder: [5.1.5](https://docs.unity3d.com/Packages/com.unity.recorder@5.1//changelog/CHANGELOG.html) to [5.1.7](https://docs.unity3d.com/Packages/com.unity.recorder@5.1//changelog/CHANGELOG.html)
...
- com.unity.scriptablebuildpipeline: [2.6.0](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.6//changelog/CHANGELOG.html) to [3.0.3](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@3.0//changelog/CHANGELOG.html)
...
- com.unity.services.authentication: [3.6.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.6//changelog/CHANGELOG.html) to [3.7.4](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.7//changelog/CHANGELOG.html)
...
- com.unity.services.wire: [1.4.1](https://docs.unity3d.com/Packages/com.unity.services.wire@1.4//changelog/CHANGELOG.html) to [1.5.0](https://docs.unity3d.com/Packages/com.unity.services.wire@1.5//changelog/CHANGELOG.html)
...
- com.unity.visualscripting: [1.9.9](https://docs.unity3d.com/Packages/com.unity.visualscripting@1.9//changelog/CHANGELOG.html) to [1.9.12](https://docs.unity3d.com/Packages/com.unity.visualscripting@1.9//changelog/CHANGELOG.html)
...
- com.unity.xr.compositionlayers: [2.3.0](https://docs.unity3d.com/Packages/com.unity.xr.compositionlayers@2.3//changelog/CHANGELOG.html) to [2.5.0](https://docs.unity3d.com/Packages/com.unity.xr.compositionlayers@2.5//changelog/CHANGELOG.html)
...
- com.unity.xr.hands: [1.7.3](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.7//changelog/CHANGELOG.html) to [1.9.0](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.9//changelog/CHANGELOG.html)

- com.unity.xr.interaction.toolkit: [3.4.0](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.4//changelog/CHANGELOG.html) to [3.6.0](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.6//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.17.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.17//changelog/CHANGELOG.html) to [1.18.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.18//changelog/CHANGELOG.html)
...
- com.unity.learn.iet-framework: [5.0.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@5.0//changelog/CHANGELOG.html) to [6.0.7](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@6.0//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.5.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.5//changelog/CHANGELOG.html) to [2.0.7](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@2.0//changelog/CHANGELOG.html)
...
- com.unity.netcode.gameobjects: [2.9.1](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.9//changelog/CHANGELOG.html) to [2.13.2](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.13//changelog/CHANGELOG.html)

- com.unity.multiplayer.tools: [2.2.8](https://docs.unity3d.com/Packages/com.unity.multiplayer.tools@2.2//changelog/CHANGELOG.html) to [2.2.10](https://docs.unity3d.com/Packages/com.unity.multiplayer.tools@2.2//changelog/CHANGELOG.html)

- com.unity.ai.navigation: [2.0.10](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html) to [2.0.14](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html)
...
- com.unity.microsoft.gdk: [1.5.1](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk@1.5//changelog/CHANGELOG.html) to [1.7.0](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk@1.7//changelog/CHANGELOG.html)

- com.unity.microsoft.gdk.tools: [1.5.1](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.tools@1.5//changelog/CHANGELOG.html) to [1.7.0](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.tools@1.7//changelog/CHANGELOG.html)
...
- com.unity.services.levelplay: [8.10.2](https://docs.unity3d.com/Packages/com.unity.services.levelplay@8.10//changelog/CHANGELOG.html) to [9.5.1](https://docs.unity3d.com/Packages/com.unity.services.levelplay@9.5//changelog/CHANGELOG.html)

- com.unity.multiplayer.center: [1.0.1](https://docs.unity3d.com/Packages/com.unity.multiplayer.center@1.0//changelog/CHANGELOG.html) to [2.0.1](https://docs.unity3d.com/Packages/com.unity.multiplayer.center@2.0//changelog/CHANGELOG.html)

- com.unity.polyspatial: [3.0.5](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.0//changelog/CHANGELOG.html) to [3.2.2](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.2//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [3.0.5](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.0//changelog/CHANGELOG.html) to [3.2.2](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.2//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [3.0.5](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.0//changelog/CHANGELOG.html) to [3.2.2](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.2//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [3.0.5](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.0//changelog/CHANGELOG.html) to [3.2.2](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.2//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [3.0.5](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.0//changelog/CHANGELOG.html) to [3.2.2](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.2//changelog/CHANGELOG.html)

- com.unity.services.multiplayer: [2.1.2](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.1//changelog/CHANGELOG.html) to [2.3.1](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.3//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.2.0](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html) to [1.4.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.4//changelog/CHANGELOG.html)
...
- [com.unity.microsoft.gdk.intelligent-delivery@1.0.1](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.intelligent-delivery@1.0//changelog/CHANGELOG.html)
