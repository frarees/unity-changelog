...
- Asset Pipeline: Fixed an issue where small artifact data types could be incorrectly garbage collected, leading to leaks and even corruption
    (UUM-146807)<br>
    *First seen in 6000.6.0b3.*    <br>*Fixed in 6000.6.0b5.*
...
- Editor: Asset Import Workers no longer crash and Player builds no longer fail when building after deleting and recreating an active Build Profile.
    ([UUM-141610](https://issuetracker.unity3d.com/issues/build-fails-and-asset-importers-crash-or-player-crashes-when-building-player-without-graphics-api-in-player-apis-list-after-recreating-build-profile))    <br>*Fixed in 6000.6.0b5.*
...
- IL2CPP: Fixed crash on startup with the deep profiling support enabled.
    ...
    *First seen in 6000.6.0b1.*    <br>*Fixed in 6000.6.0b5.*
...
- SRP Core: BatchPackedCullingViewID::GetEntityID generates the EntityID using the ulong handle directly instead of an int mask
    ([UUM-146214](https://issuetracker.unity3d.com/issues/gpu-occlusion-culling-fails-to-cull-obstructed-instances-when-gpu-resident-drawer-is-enabled))    <br>*Fixed in 6000.6.0b5.*
...
### New 6000.6.0b4 Entries since 6000.6.0b3
...
- 2D: Fix exception when creating new Tile asset when doing a drag and drop on a Tile Palette that is open for edit
...
- 2D: Move filter field outside of scroll area in Tile Palette Active Targets dropdown
    ([UUM-143328](https://issuetracker.unity3d.com/issues/tilemap-dropdown-scrollbar-does-not-update-after-filtering-and-overlaps-dropdown-search-field))<br>
...
- Editor: Fixed the Hierarchy renaming the wrong game object after creation.
    ([UUM-143590](https://issuetracker.unity3d.com/issues/hierarchy-v2-renaming-wrong-object-after-go-creation))<br>
...
- Entities: Fixed an issue in the editor when every subscene load used to leak a duplicate of each loaded GameObject until domain reload; only the intended instances are now created.
    (UUM-145926)<br>
...
- Entities: Fixed Entities Memory Profiler showing duplicate components when multiple worlds share the same archetype.
    ([UUM-146419](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146419))<br>
...
- GI: Fix buffer-capacity int overflow on Metal in UnifiedRayTracing
    (UUM-145383)<br>
...
- Graph Toolkit: Fixed bug where opening a subgraph for the first time would not always frame its contents.
    ([UUM-131387](https://issuetracker.unity3d.com/issues/graph-view-is-not-centered-when-opening-a-local-subgraph-for-the-first-time))<br>
    *First seen in 6000.6.0a7.*

- Graph Toolkit: If a port is connected to a variable of the wrong Type an error will now be displayed on the port.
    ([UUM-131401](https://issuetracker.unity3d.com/issues/when-changing-a-variable-data-type-its-capsules-are-still-wired-with-no-error-indication-despite-mismatching-types))<br>
    *First seen in 6000.6.0a8.*
...
- Physics 2D: Fix "PhysicsShape.ShapeProxy.polygonGeometry" potential for returning a corrupted PolygonGeometry.
    (UUM-146227)
...
- Profiler: Fixed black bars and missing section titles in the Memory module's details view.
    ([UUM-145754](https://issuetracker.unity3d.com/issues/bars-in-profilers-memory-module-are-colored-black))<br>
    *First seen in 6000.6.0b1.*
...
- uGUI: Fixed the Layout Element component, which accepted negative values in its Min/Max \(and other\) fields
    ([UUM-144440](https://issuetracker.unity3d.com/issues/layout-element-components-min-slash-max-fields-can-be-set-to-the-negative-values-which-silently-changes-the-property-source-to-the-default-one))<br>
    *First seen in 6000.6.0a7.*
...
- UI Toolkit: Fixed rendering issues when multiple drop-shadow filters are present.
    ([UUM-144927](https://issuetracker.unity3d.com/issues/drop-shadow-filter-display-only-one-shadow-when-multiple-shadow-filters-are-present))<br>
    *First seen in 6000.6.0a7.*
...
- UI Toolkit: Fixed World Space UI not rendering in the Scene view immediately after changing a Panel Settings Render Mode.
    ([UUM-144940](https://issuetracker.unity3d.com/issues/ui-toolkit-fails-to-render-when-any-property-is-modified-prior-to-changing-the-render-mode))<br>
    *First seen in 6000.6.0a7.*
...
#### New 6000.6.0b4 Package Changes since 6000.6.0b3

#### Packages updated

- com.unity.services.authentication: [3.7.1](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.7//changelog/CHANGELOG.html) to [3.7.2](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.7//changelog/CHANGELOG.html)
...
### Preview of Final 6000.6.0b4 Release Notes
...
#### Preview of Final 6000.6.0b4 Package changes
...
- com.unity.services.authentication: [3.6.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.6//changelog/CHANGELOG.html) to [3.7.2](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.7//changelog/CHANGELOG.html)
