...
- Editor: Fixed a crash \(ProfilerMutexLock / assertion gPersistentManager \!= NULL\) that occurred when a managed DomainUnload handler performed a UnityEngine.Object null-check during editor shutdown.
    ([UUM-144371](https://issuetracker.unity3d.com/issues/crash-on-profilermutexlock-when-closing-a-project-with-specific-assets))    <br>*Fixed in 6000.6.0b2.*
...
- Editor: Multiplayer: An issue where installing the Multiplayer Play Mode package did not enable the feature until the Editor was restarted.
    ...
    *First seen in 6000.6.0a7.*    <br>*Fixed in 6000.6.0b2.*

- Profiler: Fixed crash in ProfilerSymbolsDelayedDeletion::AddCloneObject.
    ([UUM-144194](https://issuetracker.unity3d.com/issues/crash-on-profilersymbolsdelayeddeletion-addcloneobject-when-deserializing-an-object-instantiate-marker-with-a-dangling-slash-corrupt-name-string))    <br>*Fixed in 6000.6.0b2.*
...
### New 6000.6.0b1 Entries since 6000.6.0a7
...
- Editor: Added: Added `onValidateValue` and `SetValueWithoutValidation` to `BaseField`. This runs before the `ChangeEvent` and replaces the value, so code can clamp, sanitize, or reject input,
    ([UUM-134907](https://issuetracker.unity3d.com/issues/the-editor-freezes-and-a-outofmemoryexceotion-error-is-thrown-when-entering-a-big-number-into-the-auto-tiles-used-textures-list-element-count-input-field))<br>
...
- Android: Fixed Safe Area calculation on app initialisation when system bars are set to visible.
    (UUM-142692)<br>
...
- Animation: Added padding in animation onboarding screen.
    ([UUM-143958](https://issuetracker.unity3d.com/issues/animation-window-text-overflows-and-clips-container-bounds))<br>
...
- Animation: Fixed copy &amp; paste of the animation event after a change of frame rate.
    (UUM-141134)<br>
...
- Asset Pipeline: Fixed an issue where inspecting the same artifact more than once in the import activity window could raise an error.
    (UUM-144565)<br>
    *First seen in 6000.6.0a8.*
...
- Cinemachine: Fixed jitter in cinemachine mixer sample.
    (UUM-143150)<br>
    *First seen in 6000.6.0a7.*
...
- DX12: Add missing index buffer transitions.
    (UUM-144468)<br>
    *First seen in 6000.6.0a8.*

- DX12: Clear dangling swapchain backbuffer pointer.
    (UUM-141152)<br>
    *First seen in 6000.6.0a5.*

- DX12: Do not leave attachments in `PRESERVE_LOCAL_*` state after render pass suspension.
    (UUM-144469)<br>
    *First seen in 6000.6.0a8.*
...
- DX12: Use correct size for BLAS scratch buffer allocation.
    (UUM-141182)<br>
    *First seen in 6000.6.0a5.*
...
- Editor: Build now successfully fails if an error is thrown during a pre or post process step while strict mode building enabled.
    (UUM-143728)<br>
    *First seen in 6000.6.0a7.*

- Editor: Fix severity toggles/search field hidden when the build analysis window is narrow.
    ([UUM-143789](https://issuetracker.unity3d.com/issues/message-toggle-button-gets-hidden-when-resizing-the-build-analysis-window-narrower))<br>
    *First seen in 6000.6.0a6.*
...
- Editor: Fixed ArgumentException when editing composite-value UXML attribute sub-field.
    ([UUM-144464](https://issuetracker.unity3d.com/issues/argumentexception-is-thrown-in-the-console-when-modifying-the-uv-attribute-values-of-an-image-element-in-the-inspector-window))<br>
    *First seen in 6000.6.0a7.*
...
- Editor: Fixed bug where dragging groups in the blackboard sometimes collapsed the group during the drag operation.
    ([UUM-131405](https://issuetracker.unity3d.com/issues/dragging-an-expanded-group-in-the-blackboard-collpases-it-until-releasing))<br>
    *First seen in 6000.6.0a6.*

- Editor: Fixed clipped helpbox in shader dropdown.
    ([UUM-144377](https://issuetracker.unity3d.com/issues/text-is-clipped-in-the-built-in-deprecated-deprecation-warning-box-of-the-material-shader-dropdown))<br>
    *First seen in 6000.6.0a7.*
...
- Editor: Fixed customizable icons samples broken by Component icons
    (UUM-143291)<br>
    *First seen in 6000.6.0a5.*

- Editor: Fixed empty Tree Views in Import Activity window overview.
    ([UUM-140184](https://issuetracker.unity3d.com/issues/show-overview-gives-empty-tree-views-in-import-activity-window))<br>
...
- Editor: Fixed the URP blank template to default to DX12 on Windows instead of DX11.
    (UUM-144623)<br>
    *First seen in 6000.6.0a8.*

- Editor: Fixed `NullReferenceException` when un-maximizing the build analysis window.
    ([UUM-143769](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-in-the-console-when-un-maximizing-the-build-analysis-window-docked-next-to-the-game-tab))<br>
    *First seen in 6000.6.0a6.*
...
- Editor: Hide FirstCustomCategory from the Project Auditor search window.
    ([UUM-142048](https://issuetracker.unity3d.com/issues/project-auditors-search-contains-a-leftover-category-block-entry))<br>
    *First seen in 6000.6.0a5.*

- Editor: If there is only 1 top-level Background Progress item, display it, instead of "Multiple tasks".
    (UUM-143752)<br>
    *First seen in 6000.6.0a7.*
...
- Editor: Project Auditor: Fixed documentation links so they go to the correct version.
    ([UUM-143402](https://issuetracker.unity3d.com/issues/project-auditor-documentation-link-in-asset-issues-filters-details-opens-unity-6-dot-4-docs-when-running-unity-6-dot-6))<br>
    *First seen in 6000.6.0a6.*
...
- Editor: Project Auditor: Show a progress bar whilst applying Quick Fixes, so the user knows what the Editor is doing.
    (UUM-143296)<br>
    *First seen in 6000.6.0a7.*
...
- Editor: Project Auditor: When grouping issues, show Severity + Areas for group headers.
    (UUM-143295)<br>
    *First seen in 6000.6.0a7.*
...
- Graph Toolkit: Fixed issue where the Paste option in the context menu would be enabled even if the clipboard's contents were not valid for the paste target.
    (UUM-131414)<br>
    *First seen in 6000.6.0a6.*
...
- Graphics: Fixed a crash when passing an invalid ray tracing instance handle to `RayTracingAccelerationStructure.UpdateInstanceTransform`. \(\[144207\]\(https://issuetracker.unity3d.com/issues/crash-on-raytracingaccelerationstructure-geometry-ismesh-when-applying-fbx-import-changes\)\).
    ([UUM-144207](https://issuetracker.unity3d.com/issues/crash-on-raytracingaccelerationstructure-geometry-ismesh-when-applying-fbx-import-changes))<br>
    *First seen in 6000.6.0a7.*
...
- HDRP: Fixed incompatible cbuffer layouts in HDRP generated shaders.
    (UUM-144236)<br>
    *First seen in 6000.6.0a8.*
...
- Timeline: Fixed an issue where Timeline context menus would not handle '/' characters correctly when they were present in DisplayName attributes on tracks.
    ([UUM-144597](https://issuetracker.unity3d.com/issues/clone-tracks-have-an-add-prefix-in-the-track-group-right-click-menu-when-their-name-contains-a-slash))<br>
    *First seen in 6000.6.0a8.*

- Timeline: Fixed an issue where Timeline context menus would not handle DisplayName attributes that started with a '/' correctly.
    ([UUM-144599](https://issuetracker.unity3d.com/issues/timeline-core-tracks-are-not-shown-in-the-add-tracks-dropdown-when-their-name-begins-with-a-slash))<br>
    *First seen in 6000.6.0a8.*
...
- UI Toolkit: Added confirmation popup when resizing a large list that was bound in the Editor. This matches the IMGUI behaviour.
    ([UUM-134907](https://issuetracker.unity3d.com/issues/the-editor-freezes-and-a-outofmemoryexceotion-error-is-thrown-when-entering-a-big-number-into-the-auto-tiles-used-textures-list-element-count-input-field))<br>
    *First seen in 6000.6.0a8.*
...
- UI Toolkit: Fixed ArgumentNullException errors thrown in Console when creating an Angle Style Field element from UI Library window.
    ([UUM-144482](https://issuetracker.unity3d.com/issues/argumentnullexception-errors-thrown-in-console-when-creating-an-angle-style-field-element-from-ui-library-window))<br>
    *First seen in 6000.6.0a7.*

- UI Toolkit: Fixed ArgumentOutOfRangeException errors thrown in the Console when editing the Imports count field for a Style Sheet in the Inspector.
    ([UUM-144476](https://issuetracker.unity3d.com/issues/argumentoutofrangeexception-errors-thrown-in-the-console-when-editing-the-imports-count-field-for-a-style-sheet-in-the-inspector))<br>
    *First seen in 6000.6.0a7.*
...
- UI Toolkit: Fixed class list not refreshed after deleting a class and variable not added when there is no inline rule.
    ([UUM-144475](https://issuetracker.unity3d.com/issues/cannot-change-certain-visual-element-properties-when-the-visual-element-was-saved-and-changing-properties-in-the-inspector-window))<br>
    *First seen in 6000.6.0a7.*
...
- UI Toolkit: Fixed infinite errors when assigning built-in resource image as background on VE.
    (UUM-144417)<br>
    *First seen in 6000.6.0a8.*

- UI Toolkit: Fixed NullReferenceException is thrown in the Console when creating an Animation Play State Style Enum Field from UI Library.
    ([UUM-144561](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-in-the-console-when-creating-an-animation-play-state-style-enum-field-from-ui-library))<br>
    *First seen in 6000.6.0a7.*
...
- UI Toolkit: Fixed TextField placeholder styling remaining applied after setting a value with SetValueWithoutNotify.
    (UUM-138211)<br>
...
- VFX Graph: Fixed a null reference exception that was thrown when exiting Play mode with a deleted VFX asset.
    ([UUM-143600](https://issuetracker.unity3d.com/issues/error-nullreferenceexception-object-reference-not-set-to-an-instance-of-an-object-is-logged-when-exiting-play-mode-after-deleting-a-visual-graph-asset-that-has-its-visual-effect-graph-editor-open))<br>
    *First seen in 6000.6.0a6.*
...
- WebGL: Fixed draws being dropped on WebGPU when a shader declared a constant buffer that was not bound for the draw.
    (UUM-144173)<br>
    *First seen in 6000.6.0a8.*
...
- XR: Reset static variables for CoreCLR and Fast Enter Play Mode compatibility in XR rendering classes.
    (UUM-138313)<br>
...
#### New 6000.6.0b1 Package Changes since 6000.6.0a7

#### Packages updated

- com.unity.2d.animation: [15.0.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@15.0//changelog/CHANGELOG.html) to [16.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@16.0//changelog/CHANGELOG.html)
...
- com.unity.2d.psdimporter: [14.0.2](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@14.0//changelog/CHANGELOG.html) to [15.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@15.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [15.0.2](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@15.0//changelog/CHANGELOG.html) to [16.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@16.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [8.0.2](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@8.0//changelog/CHANGELOG.html) to [9.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@9.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [5.0.2](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@5.0//changelog/CHANGELOG.html) to [6.0.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@6.0//changelog/CHANGELOG.html)
...
- com.unity.burst: [1.8.29](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html) to [2.0.0](https://docs.unity3d.com/Packages/com.unity.burst@2.0//changelog/CHANGELOG.html)
...
- com.unity.test-framework.performance: [3.4.0](https://docs.unity3d.com/Packages/com.unity.test-framework.performance@3.4//changelog/CHANGELOG.html) to [6.6.0](https://docs.unity3d.com/Packages/com.unity.test-framework.performance@6.6//changelog/CHANGELOG.html)

- com.unity.xr.arcore: [6.6.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.6//changelog/CHANGELOG.html) to [6.6.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.6//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.6.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.6//changelog/CHANGELOG.html) to [6.6.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.6//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.6.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.6//changelog/CHANGELOG.html) to [6.6.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.6//changelog/CHANGELOG.html)
...
- com.unity.dt.app-ui: [2.1.10](https://docs.unity3d.com/Packages/com.unity.dt.app-ui@2.1//changelog/CHANGELOG.html) to [2.1.11](https://docs.unity3d.com/Packages/com.unity.dt.app-ui@2.1//changelog/CHANGELOG.html)
...
- com.unity.services.levelplay: [9.3.0](https://docs.unity3d.com/Packages/com.unity.services.levelplay@9.3//changelog/CHANGELOG.html) to [9.4.1](https://docs.unity3d.com/Packages/com.unity.services.levelplay@9.4//changelog/CHANGELOG.html)
...
### Preview of Final 6000.6.0b1 Release Notes
...
#### Preview of Final 6000.6.0b1 Package changes
...
- com.unity.services.authentication: [3.6.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.6//changelog/CHANGELOG.html) to [3.7.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.7//changelog/CHANGELOG.html)
...
- com.unity.xr.interaction.toolkit: [3.4.0](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.4//changelog/CHANGELOG.html) to [3.5.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.5//changelog/CHANGELOG.html)
