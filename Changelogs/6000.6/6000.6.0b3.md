...
- Editor: Fixed a crash that would sometimes happening when opening the gizmo menu in the scene view.
    ([UUM-144488](https://issuetracker.unity3d.com/issues/crash-on-annotationmanager-canhidelodlabels-when-opening-the-gizmos-dropdown-menu))    <br>*Fixed in 6000.6.0b4.*

- Editor: Fixed text overflowing inconsistently.
    (UUM-145644)    <br>*Fixed in 6000.6.0b4.*
...
- Editor: Fixed the Hierarchy renaming the wrong game object after creation.
    ...
    *First seen in 6000.6.0a7.*    <br>*Fixed in 6000.6.0b4.*
...
### New 6000.6.0b3 Entries since 6000.6.0b2
...
- Editor: Disable Open Frame Debugger from the UITK profiler Toolbar when running a standalone profiler.
    ([UUM-144370](https://issuetracker.unity3d.com/issues/frame-debugger-cannot-be-enabled-when-opened-from-ui-toolkit-details-module-of-standalone-profiler))<br>
...
- GI: Fixed an gradient-in-loop shader warning that would occur in SSR bilateral upscale.
    ([UUM-144964](https://issuetracker.unity3d.com/issues/gradient-instruction-used-in-a-loop-with-varying-iteration-at-declarenormalstexture-shader-warning-is-thrown-after-building-urp-template-project))<br>
    *First seen in 6000.6.0a7.*
...
- UI Toolkit: Fixed an issue where adding a TwoPaneSplitView would not automatically create two children when added through the UI Library.
    ([UUM-144568](https://issuetracker.unity3d.com/issues/twopanesplitview-needs-exactly-2-children-errors-are-thrown-in-the-console-when-creating-a-two-pane-split-view-from-ui-library))<br>
    *First seen in 6000.6.0a7.*

- UI Toolkit: Fixed an issue where controls would be missing their default configuration when added through the UI Library.
    ([UUM-144495](https://issuetracker.unity3d.com/issues/button-label-text-missing-on-button-element-created-via-hierarchy-window-in-ui-viewport-and-game-view))<br>
    *First seen in 6000.6.0a7.*

- UI Toolkit: Fixed error when trying to use Element Texture UV node in a vertex shader.
    ([UUM-145401](https://issuetracker.unity3d.com/issues/error-when-using-elementtextureuv-in-vertex-shader))<br>
    *First seen in 6000.6.0b2.*

- UI Toolkit: Fixed missing element tint and opacity. Added dedicated nodes.
    ([UUM-145402](https://issuetracker.unity3d.com/issues/ui-toolkit-default-nodes-in-shader-graph-have-tint-input-but-we-cant-read-that-value))<br>
    *First seen in 6000.6.0b2.*
...
- UI Toolkit: Fixed RenderType and SampleElementTexture nodes which didn't work in vertex stage.
    ([UUM-145625](https://issuetracker.unity3d.com/issues/rendertype-node-outputs-incorrect-value-in-vertex-shader))<br>
    *First seen in 6000.6.0b2.*
...
- UI Toolkit: Fixed the inability to read/write the local vertex position. Using the position node in object/world-space modes doesn't give an error anymore.
    ([UUM-145403](https://issuetracker.unity3d.com/issues/cant-modify-vertex-position-in-ui-vertex-shader))<br>
    *First seen in 6000.6.0b2.*

- UI Toolkit: Fixed the Style Sheets window so that it now displays all of its content when it loads.
    ([UUM-145634](https://issuetracker.unity3d.com/issues/newly-added-selectors-are-not-displayed-in-the-docked-style-sheets-window-when-re-entering-in-context-uxml-editing-until-the-cursor-hovers-over-the-window))<br>
    *First seen in 6000.6.0b1.*
...
#### New 6000.6.0b3 Package Changes since 6000.6.0b2
...
### Preview of Final 6000.6.0b3 Release Notes
...
#### Preview of Final 6000.6.0b3 Package changes
