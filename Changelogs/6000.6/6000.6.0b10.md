...
- Build Pipeline: Fixed an issue where VideoClips referenced by Content Directory builds failed to load at runtime on macOS.
    (UUM-147430)<br>
    *First seen in 6000.6.0b3.*    <br>*Fixed in 6000.6.0f1.*
...
- DX12: Start tracking d3d12 resources using D3D12Object class on remaining D3D12 platforms similarly to how desktop does this.
    (UUM-147469)    <br>*Fixed in 6000.6.0f1.*
...
- Netcode for Entities: Fixed a predicted ghost divergence caused by running at very high framerates with very low SimulationTickRate, which meant that the client to not even fully predict one tick ahead of the latest snapshot arrival, causing the snapshot to be applied on a partial tick, which in turn resulted in the prediction-history backup failing to write, so it would constantly be stale.
    (UUM-147343)    <br>*Fixed in 6000.6.0f1.*
...
- uGUI: Layout Element inspector now shows mixed values when multiediting and stays in sync across Inspector windows.
    ...
    *First seen in 6000.6.0a7.*    <br>*Fixed in 6000.6.0f1.*
...
### New 6000.6.0b10 Entries since 6000.6.0b9
...
- Animation: Fixed GUIStyle warnings when clicking on \\"Add Properties\\" in Animation Window.
    ([UUM-148497](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148497))<br>
...
- Editor: Fixed ObjectDisposedException "SerializedProperty ...dict has disappeared\!" error when deleting a selection of rows in a list of dictionaries.
    ([UUM-148592](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148592))<br>
    *First seen in 6000.6.0b7.*

- Editor: Fixed regression where some classes with many fields could not be serialized.
    (UUM-149546)<br>
...
- Editor: Project Auditor - Category shows an empty list instead of the analysis-in-progress panel while its module is still running.
    (UUM-147586)<br>
...
- Entities: Fixed an `ArgumentOutOfRangeException` thrown when clicking items in the Systems window after domain reload.
    ([UUM-148748](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-148748))<br>
    *First seen in 6000.6.0b7.*
...
- Timeline: Fixed an issue where a long group track name label gets drawn over the button making them unclickable.
    ([UUM-146266](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146266))<br>
    *First seen in 6000.6.0b2.*
...
- UI Toolkit: Fixed the IMGUI dictionary drawer scrolling short of its last rows in a window that cannot scroll.
    ([UUM-149490](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-149490))<br>
    *First seen in 6000.6.0b7.*
...
- VFX Graph: Address exception when enabling template toggle.
    ([UUM-149239](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-149239))<br>
    *First seen in 6000.6.0b8.*
...
#### New 6000.6.0b10 Package Changes since 6000.6.0b9
...
### Preview of Final 6000.6.0b10 Release Notes
...
#### Preview of Final 6000.6.0b10 Package changes
...
- com.unity.learn.iet-framework: [5.0.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@5.0//changelog/CHANGELOG.html) to [6.0.6](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@6.0//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.5.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.5//changelog/CHANGELOG.html) to [2.0.6](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@2.0//changelog/CHANGELOG.html)
...
- com.unity.netcode.gameobjects: [2.9.1](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.9//changelog/CHANGELOG.html) to [2.13.1](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.13//changelog/CHANGELOG.html)
...
- com.unity.services.levelplay: [8.10.2](https://docs.unity3d.com/Packages/com.unity.services.levelplay@8.10//changelog/CHANGELOG.html) to [9.5.0](https://docs.unity3d.com/Packages/com.unity.services.levelplay@9.5//changelog/CHANGELOG.html)
...
- com.unity.services.multiplayer: [2.1.2](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.1//changelog/CHANGELOG.html) to [2.3.0](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.3//changelog/CHANGELOG.html)
