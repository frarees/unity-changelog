...
- 2D: Fixed a case where in In 3D Editor mode, textures did not generate Sprite subassets when imported as SpriteSprite Generation.
    (UUM-142920)    <br>*Fixed in 6000.6.0b6.*
...
- Android: Fixed a crash in LoadFontFamilyNamesFromFontFile on Android 10 devices when querying OS font fallbacks.
    (UUM-146922)<br>
    *First seen in 6000.6.0b5.*    <br>*Fixed in 6000.6.0b6.*

- Android: Fixed a crash in LoadFontFamilyNamesFromFontFile on Android 10 devices when querying OS font fallbacks.
    (UUM-147085)<br>
    *First seen in 6000.6.0b3.*    <br>*Fixed in 6000.6.0b6.*

- Android: Fixed a crash in LoadFontFamilyNamesFromFontFile on Android 10 devices when querying OS font fallbacks.
    ([UUM-147144](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147144))<br>
    *First seen in 6000.6.0b4.*    <br>*Fixed in 6000.6.0b6.*

- Animation: Reworked Animation Playable Output bind and unbind validation to prevent potential crashes.
    ([UUM-146750](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146750))    <br>*Fixed in 6000.6.0b6.*
...
- Editor: Fixed a memory leak caused by an undisposed `CancellationTokenSource` object in `AsyncInstantiateOperation`.
    ([UUM-147016](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147016))    <br>*Fixed in 6000.6.0b6.*

- Editor: Support for the SpeedTreeWindAsset created in the 2022 Editor
    ([UUM-147077](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147077))    <br>*Fixed in 6000.6.0b6.*
...
- IL2CPP: Fixed C++ linker error on a generic method marked for Reverse P/Invoke generation and AggressiveInlining.
    (UUM-144962)<br>
    *First seen in 6000.6.0a8.*    <br>*Fixed in 6000.6.0b6.*

- Package Manager: Package Manager related errors are thrown for Play Mode Scenarios additional editors when activated
    ([UUM-147009](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147009))    <br>*Fixed in 6000.6.0b6.*

- UI Toolkit: Fixed an issue where some type converters would be ignored in the UI Builder binding window.
    ([UUM-147357](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-147357))    <br>*Fixed in 6000.6.0b6.*
...
### New 6000.6.0b5 Entries since 6000.6.0b4
...
- Xbox: Improved performance on loading archive files with DirectStorage enabled.
...
- Animation: Fixed a missing link to the Timeline documentation.
    ([UUM-146127](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146127))<br>
...
- Editor: Fixed the Hierarchy expand/collapse toggles not working after the first click.
    ([UUM-146806](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146806))<br>
...
- Entities: Fixed Ignoring invalid \[UpdateAfterAttribute\] warning on the ExplicitFilterSystem when disposing the Hierarchy World Handler.
    ([UUM-146672](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146672))<br>
    *First seen in 6000.6.0b3.*

- Graph Toolkit: Fixed options and ports TrySetValue with Enum.
    ([UUM-146236](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-146236))<br>
    *First seen in 6000.6.0b2.*
...
- IL2CPP: Fixed crash on startup with the deep profiling support enabled.
    ([UUM-145576](https://issuetracker.unity3d.com/issues/editor-profiler-application-crashes-immediately-after-launch-when-autoconnect-profiler-and-deep-profiling-support-are-enabled-in-build-settings))<br>
    *First seen in 6000.6.0b1.*
...
- UI Toolkit: Disable backdrop-filter on world-space UI Toolkit panels.
    (UUM-144865)<br>
    *First seen in 6000.6.0a8.*
...
- UI Toolkit: Hid internal UIToolkit Authoring controls from UI Library.
    ([UUM-144560](https://issuetracker.unity.com/api/v1.0/redirects/guid/UUM-144560))<br>
    *First seen in 6000.6.0a7.*
...
#### New 6000.6.0b5 Package Changes since 6000.6.0b4
...
- com.unity.services.authentication: [3.7.2](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.7//changelog/CHANGELOG.html) to [3.7.3](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.7//changelog/CHANGELOG.html)
...
### Preview of Final 6000.6.0b5 Release Notes
...
- Xbox: Improved performance of issuing async reads with DirectStorage
...
#### Preview of Final 6000.6.0b5 Package changes
