...
*   Editor: Fix temp memory error message (1225050)  
...
*   Scene/Game View: Entering Scene View in Play Mode crashes with UnityEngine.GUI:CallWindowDelegate ([1230441](https://issuetracker.unity3d.com/issues/entering-scene-view-in-play-mode-crashes-with-unityengine-dot-gui-callwindowdelegate))
...
### New 2020.1.0b3 Entries since 2020.1.0b2
...
*   Build Pipeline: Fixed an issue where upon BuildPipeline functions cause a re-execution of the last Async task when called in an Async function. ([1213602](https://issuetracker.unity3d.com/issues/build-pipeline-functions-cause-a-re-execution-of-the-last-async-task-when-called-in-an-async-function))
...
*   Editor: Fixed the bold system fonts (for example, Verdana) used by Prefabs. ([1215960](https://issuetracker.unity3d.com/issues/text-of-changes-prefab-variant-values-is-blurry-when-using-verdana-editor-font-and-having-the-display-scaling-set-to-100-percent))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Graphics: Fixed sorting issue with multiple viewport. ([1225129](https://issuetracker.unity3d.com/issues/vfx-sorting-issue-with-multiple-viewport))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Particles: Fixed memory leak when using shadow casting lights in the Particle System Lights module. ([1217809](https://issuetracker.unity3d.com/issues/editor-crashes-when-particle-system-is-emitting-shadow-casting-lights))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Serialization: Fixed undo/prefab diff behavior with \[SerializeReference\] fields. ([1198546](https://issuetracker.unity3d.com/issues/serializedproperty-undo-does-not-work-properly-when-the-parent-serializedobject-is-a-script-with-managed-references))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   UI Elements: Fixed NullReferenceException in some Editor Windows when entering Play mode after redocking. ([1223048](https://issuetracker.unity3d.com/issues/nullreferenceexception-on-entering-in-play-mode-when-editor-window-calls-this-dot-wantmousemove-on-disable))  
    _This is a change to a 2020.1.0a25 change, not seen in any released version, and will not be mentioned in final notes._
    
*   Windows: Fixed issue where some pop up windows don't close reliably. ([1219023](https://issuetracker.unity3d.com/issues/framedebugger-preview-of-textures-inside-framedebugger-do-not-close-on-selecting-other-gameobjects))  
...
### Preview of Final 2020.1.0b3 Release Notes
