...
- Networking: Addressed a performance regression with UnityWebRequest when connecting to many HTTPS resources at the same time.
    ([UUM-49389](https://issuetracker.unity3d.com/issues/unitywebrequestexception-cannot-resolve-destination-host-errors-appear-when-making-multiple-http-get-requests-using-unitywebrequest-and-the-cysharp-dot-threading-dot-tasks))    <br>*Fixed in 2023.3.0a15.*
...
- Shadergraph: Fixed an issue where an open asset inspector for subgraphs may mangle the json serialized representation for that subgraph asset.
    (UUM-56145)    <br>*Fixed in 2023.3.0a16.*

- uGUI: Fixed issue with Buttons triggering a different Button when using multiple Canvas instances in multiple windows
    ([UUM-36255](https://issuetracker.unity3d.com/issues/button-triggers-another-button-when-multiple-canvases-are-used-in-multiple-windows))    <br>*Fixed in 2023.3.0a15.*

- VFX Graph: Fix issue with null value in slots preventing it to be changed
    (UUM-55313)    <br>*Fixed in 2023.3.0a15.*



### New 2023.3.0a14 Entries since 2023.3.0a13

#### Features

- DX12: Added support for indirect Dispatch Rays \(part of DXR 1.1\). The method is similar to RayTracingShader.Dispatch but the 3 dispatch dimensions are retrieve from a GraphicsBuffer. Added RayTracingShader.DispatchIndirect and a new CommandBuffer.DispatchRays signature. Added SystemInfo.supportsIndirectDispatchRays capability status.
...
#### New 2023.3.0a14 Package Changes since 2023.3.0a13
...
- com.unity.services.authentication: [3.0.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.0//changelog/CHANGELOG.html) &#x2192; [3.1.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.1//changelog/CHANGELOG.html)

- com.unity.services.cloudcode: [2.5.0](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.5//changelog/CHANGELOG.html) &#x2192; [2.5.1](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.5//changelog/CHANGELOG.html)

- com.unity.services.economy: [3.2.1](https://docs.unity3d.com/Packages/com.unity.services.economy@3.2//changelog/CHANGELOG.html) &#x2192; [3.3.0](https://docs.unity3d.com/Packages/com.unity.services.economy@3.3//changelog/CHANGELOG.html)
...
- com.unity.xr.arcore: [6.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.0//changelog/CHANGELOG.html) &#x2192; [6.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.0//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.0//changelog/CHANGELOG.html) &#x2192; [6.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.0//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.0//changelog/CHANGELOG.html) &#x2192; [6.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.0//changelog/CHANGELOG.html)
...
### Preview of Final 2023.3.0a14 Release Notes
...
- HDRP: Added sky occlusion feature to APV allowing time of day with static probe volumes.
...
#### Preview of Final 2023.3.0a14 Package changes
