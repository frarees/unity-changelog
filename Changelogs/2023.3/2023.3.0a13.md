...
- Audio: Fixed a bug that caused the clip volume in the Audio Random Container window to appear as if it is magically synchronised with the main volume.
    (UUM-54716)    <br>*Fixed in 2023.3.0a14.*

- Audio: Fixed a bug that occurred when selecting a game object with an audio source that points to an audio random container. The issue would throw an UI error in the editor console.
    (UUM-54810)    <br>*Fixed in 2023.3.0a14.*

- Core: Fixes a data race inside the job system where weak memory systems could hang when waiting and attempting to steal parallel work submitted from another thread.
    ([UUM-41806](https://issuetracker.unity3d.com/issues/android-player-freezes-on-unityclassic-baselib-systemfutex-wait-or-silently-crashes))    <br>*Fixed in 2023.3.0a14.*

- DX12: Fix performance regression in the editor with the multi-threaded mode.
    (UUM-55172)<br>
    *First seen in 2023.3.0a12.*    <br>*Fixed in 2023.3.0a14.*

- Graphics: Fixed an issue when Mesh Renderers are attempted to be drawn without a vertex position stream.
    (UUM-48570)    <br>*Fixed in 2023.3.0a14.*

- HDRP: Fix performance issue with reflection probe inspector
    ([UUM-53681](https://issuetracker.unity3d.com/issues/editor-performance-drops-when-a-reflection-probe-is-selected-in-the-hierarchy-window))    <br>*Fixed in 2023.3.0a14.*
...
- Scripting: Fixed race condition that could cause crashes on startup when native code called into managed code.
    ([UUM-49357](https://issuetracker.unity3d.com/issues/android-crash-on-android-when-androidjavaproxy-is-calling-from-multiple-threads))    <br>*Fixed in 2023.3.0a14.*
...
- Windows: Fixes unreliable `Cursor.SetCursor` behaviour.
    ([UUM-46718](https://issuetracker.unity3d.com/issues/sometimes-the-wrong-image-is-displayed-when-using-cursor-dot-setcursor-in-software-mode))    <br>*Fixed in 2023.3.0a14.*



### New 2023.3.0a13 Entries since 2023.3.0a12
...
- Editor: Frame Debugger: Fixed an issue where depth or shadow textures were rendered red/black instead of white/black in the Frame Debugger window.
    ([UUM-54822](https://issuetracker.unity3d.com/issues/frame-debugger-depth-texture-is-rendered-differently-in-the-game-window-and-frame-debugger-window))<br>
    *First seen in 2023.3.0a13.*

- Editor: Frame Debugger: Fixed an issue where list of meshes were missing in the Details foldout.
    ([UUM-54821](https://issuetracker.unity3d.com/issues/frame-debugger-missing-list-of-meshes-in-the-details-window))<br>
    *First seen in 2023.3.0a13.*

- Editor: Improved how string properties are indexed.
    ([UUM-54321](https://issuetracker.unity3d.com/issues/string-property-indexing-is-inconsistent))<br>
...
- VFX Graph: Fixed custom attribute broke compilation if name was starting with a capital letter.
    ([UUM-49725](https://issuetracker.unity3d.com/issues/blackboard-attributes-custom-attribute-block-breaks-compilation))<br>
    *First seen in 2023.3.0a8.*

- VFX Graph: Fixed property not visible in blackboard with creating using ALT+Drag shortcut.
    ([UUM-51652](https://issuetracker.unity3d.com/issues/vfxg-exposed-properties-can-no-longer-be-added-via-alt-plus-drag))<br>
    *First seen in 2023.3.0a8.*

- VFX Graph: Fixed shader compilation error when using a Custom HLSL node.
    ([UUM-49770](https://issuetracker.unity3d.com/issues/hlsl-node-breaks-compilation))<br>
    *First seen in 2023.3.0a7.*
...
#### New 2023.3.0a13 Package Changes since 2023.3.0a12
...
### Preview of Final 2023.3.0a13 Release Notes
...
#### Preview of Final 2023.3.0a13 Package changes
