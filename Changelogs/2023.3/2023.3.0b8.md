...
- GI: Changed: Only one of ignoreDirectEnvironment and ignoreIndirectEnvironment is relevant in each of the IntegrateRadiance methods in IProbeIntegrator.<br>
    ...
    ([UUM-61353](https://issuetracker.unity3d.com/issues/only-one-of-ignoredirectenvironment-and-ignoreindirectenvironment-are-relevant-in-api-signature))<br>
...
- Android: Remove UTF BOM from SDK tools commands.
    ([UUM-60488](https://issuetracker.unity3d.com/issues/the-error-commandinvokationfailure-unable-to-list-keys-in-the-keystore-is-thrown-when-setting-a-password-or-doing-anything-related-to-the-keystore))<br>
...
- Editor: Build Profiles - Fixed for Build Profile Window top buttons that were leaving blue edges after user clicked on them and labels were not centered.
    ([UUM-61621](https://issuetracker.unity3d.com/issues/build-profiles-window-top-buttons-leave-blue-edges-after-user-clicks-on-them-and-labels-are-not-centered))<br>
    *First seen in 2023.3.0b4.*
...
- Package Manager: Fixed a Package Manager issue where experimental packages weren't showing up in the list of available packages.
    ([UUM-62031](https://issuetracker.unity3d.com/issues/package-manager-does-not-show-experimental-package-when-there-is-experimental-packages-in-use-warning))<br>
    *First seen in 2023.3.0b3.*
...
- Universal RP: Fixed Depth of Field for URP RenderGraph.
    ([UUM-62801](https://issuetracker.unity3d.com/issues/the-blur-effect-is-applied-regardless-of-the-distance-when-depth-of-field-is-used))<br>
    *First seen in 2023.3.0b4.*

- URP: Fixed a warning in Lens flare shader for URP.
    ([UUM-62715](https://issuetracker.unity3d.com/issues/urp-windows-editor-throws-an-error-when-building))<br>
    *First seen in 2023.3.0b1.*
...
- com.unity.addressables: [2.0.6](https://docs.unity3d.com/Packages/com.unity.addressables@2.0//changelog/CHANGELOG.html) to [2.0.8](https://docs.unity3d.com/Packages/com.unity.addressables@2.0//changelog/CHANGELOG.html)

- com.unity.inputsystem: [1.8.0-pre.2](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.8//changelog/CHANGELOG.html) to [1.7.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.7//changelog/CHANGELOG.html)

- com.unity.scriptablebuildpipeline: [2.1.0](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.1//changelog/CHANGELOG.html) to [2.1.2](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.1//changelog/CHANGELOG.html)

- com.unity.xr.oculus: [4.1.2](https://docs.unity3d.com/Packages/com.unity.xr.oculus@4.1//changelog/CHANGELOG.html) to [4.2.0](https://docs.unity3d.com/Packages/com.unity.xr.oculus@4.2//changelog/CHANGELOG.html)
...
- com.unity.inputsystem: [1.6.1](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.6//changelog/CHANGELOG.html) to [1.7.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.7//changelog/CHANGELOG.html)
