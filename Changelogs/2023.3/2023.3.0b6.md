...
- DX12: fixed crash during rearranging docked windows in Editor
    (UUM-60697)<br>
    *First seen in 2023.3.0b3.*    <br>*Fixed in 2023.3.0b7.*

- Editor: Fix issue with WebGL and Android subtarget being incorrect when activating build profiles.
    (UUM-61956)<br>
...
- Graphics: Fix assert and potential crash with 0 length parallel copy job when a mesh renderer has 0 materials in GPU Driven Rendering
    ([UUM-62028](https://issuetracker.unity3d.com/issues/the-editor-crashes-when-removing-material-from-mesh-renderer))<br>
    *First seen in 2023.3.0b4.*    <br>*Fixed in 2023.3.0b7.*
...
- HDRP: Fix a performance regression in area light evaluation code
...
- Search: Re-enabled search providers priority sorting.
    ([UUM-60991](https://issuetracker.unity3d.com/issues/unity-search-results-order-does-not-take-into-account-provider-settings-priority-order))    <br>*Fixed in 2023.3.0b7.*
...
- UI Toolkit: Fixed an issue where the ListView would not display serialized values correctly when the list items were being reused.
    (UUM-56957)    <br>*Fixed in 2023.3.0b7.*
...
- VFX Graph: Fix some sanitation failures with new merged Position and Collision blocks
    (UUM-61948)<br>
    *First seen in 2023.3.0b5.*    <br>*Fixed in 2023.3.0b7.*
...
### New 2023.3.0b6 Entries since 2023.3.0b5
...
- VFX Graph: Fixed a build failure on HDRP Linux using Sphere Output.
    ([UUM-61566](https://issuetracker.unity3d.com/issues/build-failure-on-linux))<br>
    *First seen in 2023.3.0b5.*
...
#### New 2023.3.0b6 Package Changes since 2023.3.0b5

### Preview of Final 2023.3.0b6 Release Notes
...
#### Preview of Final 2023.3.0b6 Package changes
