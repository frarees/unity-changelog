...
### New 2023.3.0a7 Entries since 2023.3.0a5
...
- Editor: Upgrading the com.unity.services.push-notifications to version 4.0.0-pre.1<br>
    Bug fixes added ,upgraded dependencies<br>
    Full changelog \[here\]\(https://github.cds.internal.unity3d.com/unity/operate-services-sdk/tree/push/release/4.x/Packages/Public/com.unity.services.push-notifications/CHANGELOG.md\)
...
- Android: Fixed URP FinalBlit on Adreno 3XX GPUs.
    ([UUM-41795](https://issuetracker.unity3d.com/issues/android-screen-tearing-occurs-in-a-urp-player))<br>
...
- Editor: Fix Input.mousePosition reporting invalid values when using multiple displays \(Display C\# API\) on Windows.
...
- Graphics: When changing the stripping of a setting in consecutive builds, the player was not having the latest state of the RenderPipelineGlobalSettings asset.
    (XPIPELINE-804)
...
- Package Manager: Making the Leaderboards Package visible in the Package Manager Service tab.
...
- Shaders: Fixed preprocessor issue parsing nested define when they were under a keyword.
...
- UI Toolkit: Improved error message when a UxmlObjectReference field type is not a UxmlObject.
    ([UUM-48264](https://issuetracker.unity3d.com/issues/adding-uxmlobjectreference-to-incompatible-type-causes-compilation-errors-from-source-generator))<br>
...
- VFX Graph: Unexpected generated shader with invalid ShaderGraph.
    (UUM-48670)<br>
...
### Preview of Final 2023.3.0a7 Release Notes
