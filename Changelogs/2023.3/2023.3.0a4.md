...
- DX12: Fixing "ReleaseDynamicVBOFrame: Unexpected frame".<br>
    ...
    ([UUM-28962](https://issuetracker.unity3d.com/issues/releasedynamicvboframe-unexpected-frame-errors-thrown-in-the-console-window-when-creating-a-project-using-3d-sample-scene-hdrp-template))    <br>*Fixed in 2023.3.0a5.*

- Editor: Fixed offset of camera position when using the light placement tool.
    (UUM-47863)<br>
    *First seen in 2023.3.0a1.*    <br>*Fixed in 2023.3.0a5.*
...
- IL2CPP: Fix UnsafeUtililty.IsUnmanaged/UnsafeUtililty.IsBlittable returning incorrect results
    (UUM-43422)    <br>*Fixed in 2023.3.0a5.*
...
- Package Manager: Fixed bug where Editor would crash when a project manifest is saved with UTF-8 with BOM encoding or project manifest begins with a special character.
    (UUM-46806)<br>
    *First seen in 2023.3.0a2.*    <br>*Fixed in 2023.3.0a5.*
...
- Shadergraph: Fixed a regression where adding nodes in large graphs caused a major slowdown.
    (UUM-46770)    <br>*Fixed in 2023.3.0a5.*
...
- Universal RP: Fixed shader stripping when using APV.
    ([UUM-42601](https://issuetracker.unity3d.com/issues/baked-lightmaps-are-not-applied-in-the-player))    <br>*Fixed in 2023.3.0a5.*
...
### New 2023.3.0a4 Entries since 2023.3.0a3
...
### Preview of Final 2023.3.0a4 Release Notes
