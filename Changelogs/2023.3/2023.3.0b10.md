...
- Editor: Add more robustness to Inspector and SerializedObject
    (UUM-65070)    <br>*Fixed in 2023.3.0b11.*
...
- Editor: Don't allow the editor to name the window based on the tab while static tabs are on
    ([UUM-65309](https://issuetracker.unity3d.com/issues/editor-modes-dont-allow-the-editor-to-name-the-window-based-on-the-tab-while-static-tabs-are-on))<br>
    *First seen in 2023.3.0a17.*    <br>*Fixed in 2023.3.0b11.*
...
- Editor: Fixed inspector elements from being culled in secondary inspector window and avoid unexpected behavioral errors been thrown when selecting an Asset then selecting another type of asset and deselecting it.
    ([UUM-35998](https://issuetracker.unity3d.com/issues/textureimporterinspector-dot-oninspectorgui-must-call-applyrevertgui-to-avoid-unexpected-behaviour-dot-thrown-when-selecting-asset-then-selecting-and-deselecting-texture-2d))    <br>*Fixed in 2023.3.0b11.*

- Graphics: Fix an crash on Linux when using the OpenGL backend with URP, Native Render Passes, and required depth
    ([UUM-49240](https://issuetracker.unity3d.com/issues/linux-urp-crash-on-gfxframebuffergles-clear-when-entering-the-play-mode-when-all-renderer-features-are-disabled-native-renderpass-and-maincameras-depth-texture-is-enabled))    <br>*Fixed in 2023.3.0b11.*
...
- Scene/Game View: Fixed an issue where zooming in/out the SceneView by scrolling with a trackpad would result in inconsistent zooming direction.
    ([UUM-63356](https://issuetracker.unity3d.com/issues/scrolling-up-or-down-sometimes-scrolls-in-the-wrong-direction))<br>
    *First seen in 2023.3.0b5.*    <br>*Fixed in 2023.3.0b11.*
...
### New 2023.3.0b10 Entries since 2023.3.0b9
...
- Editor: Fixed Search Sort type is nicified.
    ([UUM-63888](https://issuetracker.unity3d.com/issues/search-window-has-inconsistent-naming-for-sort-options))<br>
...
- HDRP: Fixed interaction between on demand shadow rendering and enable/disable of the light source.
    ([UUM-61098](https://issuetracker.unity3d.com/issues/hdrp-subsequent-calls-to-hdadditionallightdata-dot-requestshadowmaprendering-or-requestsubshadowmaprendering-remain-inactive-for-on-demand-shadow-requests-when-directional-light-is-disabled-and-re-enabled))<br>
    *First seen in 2023.3.0b4.*
...
- Scene/Game View: Fixed the ToolSettings popup location to be at the mouse position.
    ([UUM-62764](https://issuetracker.unity3d.com/issues/overlays-toolsettings-overlay-spawned-position-doesnt-follow-mouse-position))<br>
    *First seen in 2023.3.0b5.*
...
- SRP Core: Added CreateSkyboxRendererList in Render Graph API.
    ([UUM-60100](https://issuetracker.unity3d.com/issues/createskyboxrendererlist-missing-in-rendergraph-api))<br>
    *First seen in 2023.3.0a1.*

- SRP Core: Rendering Debugger - Fixed Render Graph Debug Display Reset behaviour.
    ([UUM-62760](https://issuetracker.unity3d.com/issues/rendering-debugger-reset-button-behaviour))<br>
...
- UI Toolkit: Fixed USS variable property inspector does not stay open when holding on a USS variablen.
    ([UUM-60502](https://issuetracker.unity3d.com/issues/ui-builder-uss-variable-property-inspector-does-not-stay-open-when-holding-on-a-uss-variable))<br>
...
- VFX Graph: Fixed an exception that could be raised when deleting all graph nodes in some specific cases.
    ([UUM-61929](https://issuetracker.unity3d.com/issues/vfx-nullreferenceexception-errors-are-thrown-when-deleted-graph-contains-attribute-block-in-update-particles-block))<br>
...
- com.unity.probuilder: [6.0.1-pre.1](https://docs.unity3d.com/Packages/com.unity.probuilder@6.0//changelog/CHANGELOG.html) &#x2192; [6.0.1-pre.2](https://docs.unity3d.com/Packages/com.unity.probuilder@6.0//changelog/CHANGELOG.html)

### Preview of Final 2023.3.0b10 Release Notes
...
#### Preview of Final 2023.3.0b10 Package changes
...
- com.unity.2d.animation: [10.0.2](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.0//changelog/CHANGELOG.html) &#x2192; [10.1.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.1//changelog/CHANGELOG.html)

- com.unity.2d.common: [9.0.1](https://docs.unity3d.com/Packages/com.unity.2d.common@9.0//changelog/CHANGELOG.html) &#x2192; [9.0.3](https://docs.unity3d.com/Packages/com.unity.2d.common@9.0//changelog/CHANGELOG.html)
...
- com.unity.ide.rider: [3.0.24](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html) &#x2192; [3.0.27](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html)
