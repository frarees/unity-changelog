...
- Audio Random Container: [Error] ARC window is broken when deleting an ARC
    ([UUM-58881](https://issuetracker.unity3d.com/issues/error-arc-window-is-broken-when-deleting-an-arc))
...
- Editor: Fix unresponsive editor when baking a large APV with terrain
    ([UUM-58017](https://issuetracker.unity3d.com/issues/the-editor-becomes-unresponsive-and-memory-allocation-errors-are-spammed-in-the-console-when-generating-lightning))    <br>*Fixed in 2023.3.0b1.*
...
- Editor (Linux): [Linux] Crash on burst_signal_handler when creating a new 3D HDRP (Sample Scene) Template
    ([UUM-56485](https://issuetracker.unity3d.com/issues/linux-crash-on-burst-signal-handler-when-creating-a-new-3d-hdrp-sample-scene-template))
...
- UI Toolkit: Fixed issue with ListView items being rebound to the parent SerializedObject when hierarchy traversal kicks in, instead of keeping the binding from `bindItem`
    ([UUM-54716](https://issuetracker.unity3d.com/issues/arc-volume-value-is-synced-with-audio-clip-list-item-volume))    <br>*Fixed in 2023.3.0b1.*
...
- HDRP: Added "Include for Path Tracing" checkbox on lights, ensured "Include for Ray Tracing" checkbox is visible on supported lights.
    ([UUM-51531](https://issuetracker.unity3d.com/issues/hdrp-disk-light-has-an-unnecessary-raytracing-checkbox))<br>
    *First seen in 2023.3.0a6.*

- HDRP: Fixed autoregistered diffusion profiles not getting applied immediately.
    ([UUM-55806](https://issuetracker.unity3d.com/issues/diffusion-profiles-are-automatically-assigned-on-first-creation-but-dont-affect-rendering))<br>
...
- HDRP: Fixed visible light clamping in the path tracer when using very low exposure settings and neutral tone mapping.
    ([UUM-56515](https://issuetracker.unity3d.com/issues/light-intensity-is-clamped-to-a-visible-sphere-volume-with-hdrp-path-tracer))<br>
...
- Universal RP: Making sure the new renderer feature template sets up a render target
    ([UUM-57144](https://issuetracker.unity3d.com/issues/custom-renderer-feature-plus-opaque-downsampling-throws-error-when-using-render-graph))<br>
    *First seen in 2023.3.0a17.*
...
- com.unity.localization: [1.5.0-pre.1](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html) &#x2192; [1.5.0-pre.3](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html)
...
- com.unity.test-framework: [1.4.0](https://docs.unity3d.com/Packages/com.unity.test-framework@1.4//changelog/CHANGELOG.html) &#x2192; [1.4.1](https://docs.unity3d.com/Packages/com.unity.test-framework@1.4//changelog/CHANGELOG.html)
...
- Graphics: Fixed multiple RayTracingAccelerationStructures bindings not working in ray generation shaders.
...
- Physics 2D: Fixed an issue when using CustomCollider2D.SetCustomShapes using a NativeArray, allow the shape vertices to be non-contiguous i.e each redundant vertex unused by shapes are allowed.
...
- com.unity.localization: [1.4.4](https://docs.unity3d.com/Packages/com.unity.localization@1.4//changelog/CHANGELOG.html) &#x2192; [1.5.0-pre.3](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html)
...
- com.unity.test-framework: [1.3.7](https://docs.unity3d.com/Packages/com.unity.test-framework@1.3//changelog/CHANGELOG.html) &#x2192; [1.4.1](https://docs.unity3d.com/Packages/com.unity.test-framework@1.4//changelog/CHANGELOG.html)
...
- com.unity.xr.arcore: [5.1.0-pre.8](https://docs.unity3d.com/Packages/com.unity.xr.arcore@5.1//changelog/CHANGELOG.html) &#x2192; [6.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.0//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [5.1.0-pre.8](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@5.1//changelog/CHANGELOG.html) &#x2192; [6.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.0//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [5.1.0-pre.8](https://docs.unity3d.com/Packages/com.unity.xr.arkit@5.1//changelog/CHANGELOG.html) &#x2192; [6.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.0//changelog/CHANGELOG.html)
...
- com.unity.services.deployment: [1.1.0](https://docs.unity3d.com/Packages/com.unity.services.deployment@1.1//changelog/CHANGELOG.html) &#x2192; [1.2.1](https://docs.unity3d.com/Packages/com.unity.services.deployment@1.2//changelog/CHANGELOG.html)
