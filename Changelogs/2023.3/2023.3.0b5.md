...
- Editor: Fix saving a scene causing bloom to become disabled
    (UUM-60867)<br>
    *First seen in 2023.3.0b5.*    <br>*Fixed in 2023.3.0b7.*

- Editor: Fixed incorrect color sample results with the eyedropper tool Color Picker on macOS.
    (UUM-60339)    <br>*Fixed in 2023.3.0b6.*

- Editor: The Editor no longer crashes with a callstack resulting in validateMenuItem
    ([UUM-33727](https://issuetracker.unity3d.com/issues/crash-on-cocoamainmenu-validatemenuitem-when-pressing-slash-searching-in-help))    <br>*Fixed in 2023.3.0b7.*

- HDRP: Fixing artifacts on low resolution SSGI when dynamic resolution values are low.
    (UUM-57785)    <br>*Fixed in 2023.3.0b6.*
...
- Input: [Linux/Mac] Crash on BackupState::MemoryIDToFileID::operator() when creating a new project from “3D Sample Scene (HDRP)” template
    ([UUM-61003](https://issuetracker.unity3d.com/issues/linux-crash-on-backupstate-memoryidtofileid-operator-when-creating-a-new-project-from-3d-sample-scene-hdrp-template))
...
- SRP Core: Screen Space UI Overlay will now be rendered again without a camera in URP/HDRP
    (UUM-58403)<br>
    *First seen in 2023.3.0a16.*    <br>*Fixed in 2023.3.0b6.*

- Terrain: Fixed motion blur for terrain with non-default transform.
    ([PPB-52](https://issuetracker.unity3d.com/issues/motion-blur-affects-a-terrain-when-its-transform-position-is-not-zero-and-is-stationary))    <br>*Fixed in 2023.3.0b6.*
...
- Universal RP: Added logic to enforce consistent hardware dynamic resolution settings during rendering to avoid issues when external code changes the global setting.
    ([UUM-58686](https://issuetracker.unity3d.com/issues/using-both-rthandle-and-dynamic-resolution-outputs-argumentnullexception-eventually-causing-a-crash))    <br>*Fixed in 2023.3.0b6.*
...
- Universal RP: Fixed an issue where cameras flickered when using deferred rendering, rendering layers and two cameras.
    ...
    *First seen in 2023.3.0b3.*    <br>*Fixed in 2023.3.0b6.*
...
### New 2023.3.0b5 Entries since 2023.3.0b4
...
- Editor: Create Menu "Animation" item has been renamed to "Animation Clip".
    (UUM-60811)<br>
    *First seen in 2023.3.0f1.*

- Editor: Create Menu now contains a Script Template for an Empty C\# Script and a Scriptable Object Script. "C\# Script" has been renamed to MonoBehaviour Script.
    (UUM-60811)<br>
    *First seen in 2023.3.0f1.*

- Editor: Unused System namespaces are no longer added to new scripts.
    (UUM-60811)<br>
    *First seen in 2023.3.0f1.*
...
- Editor: Fixed issue with text with styling \(bold/italic\) sometimes disappearing.
    ([UUM-60919](https://issuetracker.unity3d.com/issues/ui-toolkit-label-value-is-not-displayed-when-font-style-is-applied))<br>
...
- Editor: Fixed the theme selection not applying the correct theme unless the Editor is unfocused and refocused.
    ([UUM-59313](https://issuetracker.unity3d.com/issues/the-editor-theme-is-changed-only-when-the-editor-is-refocused))<br>
    *First seen in 2023.3.0b1.*
...
- HDRP: Fixed an issue that caused warnings for uninitialized variables in pathtracinglight.hlsl.
    ([UUM-58364](https://issuetracker.unity3d.com/issues/path-tracing-pathtracingmain-warnings-in-the-console))<br>
...
- UI Toolkit: Fixed an issue where a Unity.UI.Builder.UnityUIBuilderSelectionMarker would be cloned in play mode and in builds.
    ([UUM-60883](https://issuetracker.unity3d.com/issues/unknown-type-unity-dot-ui-dot-builder-dot-unityuibuilderselectionmarker-when-setting-background-color-of-a-canvas))<br>
    *First seen in 2023.3.0b3.*
...
- com.unity.services.analytics: [5.0.0](https://docs.unity3d.com/Packages/com.unity.services.analytics@5.0//changelog/CHANGELOG.html) &#x2192; [5.1.0](https://docs.unity3d.com/Packages/com.unity.services.analytics@5.1//changelog/CHANGELOG.html)

- com.unity.services.lobby: [1.1.0](https://docs.unity3d.com/Packages/com.unity.services.lobby@1.1//changelog/CHANGELOG.html) &#x2192; [1.2.0](https://docs.unity3d.com/Packages/com.unity.services.lobby@1.2//changelog/CHANGELOG.html)

- com.unity.test-framework: [1.4.2](https://docs.unity3d.com/Packages/com.unity.test-framework@1.4//changelog/CHANGELOG.html) &#x2192; [1.4.3](https://docs.unity3d.com/Packages/com.unity.test-framework@1.4//changelog/CHANGELOG.html)

- com.unity.xr.core-utils: [2.3.0-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.3//changelog/CHANGELOG.html) &#x2192; [2.3.0](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.3//changelog/CHANGELOG.html)
...
### Preview of Final 2023.3.0b5 Release Notes
...
#### Preview of Final 2023.3.0b5 Package changes
...
- com.unity.addressables: [1.21.12](https://docs.unity3d.com/Packages/com.unity.addressables@1.21//changelog/CHANGELOG.html) &#x2192; [2.0.6](https://docs.unity3d.com/Packages/com.unity.addressables@2.0//changelog/CHANGELOG.html)
...
- com.unity.inputsystem: [1.6.1](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.6//changelog/CHANGELOG.html) &#x2192; [1.8.0-pre.2](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.8//changelog/CHANGELOG.html)
...
- com.unity.mobile.notifications: [2.2.0](https://docs.unity3d.com/Packages/com.unity.mobile.notifications@2.2//changelog/CHANGELOG.html) &#x2192; [2.3.1](https://docs.unity3d.com/Packages/com.unity.mobile.notifications@2.3//changelog/CHANGELOG.html)
...
- com.unity.probuilder: [5.1.0](https://docs.unity3d.com/Packages/com.unity.probuilder@5.1//changelog/CHANGELOG.html) &#x2192; [6.0.1-pre.1](https://docs.unity3d.com/Packages/com.unity.probuilder@6.0//changelog/CHANGELOG.html)
...
- com.unity.scriptablebuildpipeline: [1.21.5](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.21//changelog/CHANGELOG.html) &#x2192; [2.1.0](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.1//changelog/CHANGELOG.html)
...
- com.unity.xr.oculus: [4.0.0](https://docs.unity3d.com/Packages/com.unity.xr.oculus@4.0//changelog/CHANGELOG.html) &#x2192; [4.1.2](https://docs.unity3d.com/Packages/com.unity.xr.oculus@4.1//changelog/CHANGELOG.html)

- com.unity.xr.openxr: [1.8.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.8//changelog/CHANGELOG.html) &#x2192; [1.9.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.9//changelog/CHANGELOG.html)
...
- com.unity.netcode.gameobjects: [1.5.1](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@1.5//changelog/CHANGELOG.html) &#x2192; [1.8.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@1.8//changelog/CHANGELOG.html)
