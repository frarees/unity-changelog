...
### New 2023.3.0a16 Entries since 2023.3.0a15
...
- Editor: Improve visibility on Volume component when Profile Instance used.
...
- SRP Core: Added icons &amp; fixed bugs in Render Graph Viewer.
...
- AI: Deprecated OffMeshLink component no longer appears in the Add Component Menu under any circumstances.
...
- 2D: Changes to material color don't reset when exiting the animation.
    ([UUM-41892](https://issuetracker.unity3d.com/issues/changes-to-material-color-dont-reset-when-exiting-the-animation-preview))<br>
    *First seen in 2023.3.0a10.*

- 2D: Fix case where URP Converter does not upgrade material of PSB characters to Sprite-Lit-Default.
    ([UUM-1952](https://issuetracker.unity3d.com/issues/2d-urp-urp-converter-does-not-upgrade-material-of-psb-characters-to-sprite-lit-default))<br>
...
- GI: Move "Generate Lighting" to the Edit menu.
    ([UUM-52065](https://issuetracker.unity3d.com/issues/generate-lighting-shown-in-project-menus-but-only-affects-scene))<br>
...
- Package Manager: Fixed "Cannot read properties of undefined \(reading shasum\)" error that could prevent installing some packages.
...
#### New 2023.3.0a16 Package Changes since 2023.3.0a15

#### Packages updated

- com.unity.addressables: [1.21.17](https://docs.unity3d.com/Packages/com.unity.addressables@1.21//changelog/CHANGELOG.html) &#x2192; [2.0.6](https://docs.unity3d.com/Packages/com.unity.addressables@2.0//changelog/CHANGELOG.html)

- com.unity.recorder: [5.0.0](https://docs.unity3d.com/Packages/com.unity.recorder@5.0//changelog/CHANGELOG.html) &#x2192; [5.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.recorder@5.1//changelog/CHANGELOG.html)

- com.unity.scriptablebuildpipeline: [1.21.9](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.21//changelog/CHANGELOG.html) &#x2192; [2.1.0](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@2.1//changelog/CHANGELOG.html)

- com.unity.test-framework: [1.3.9](https://docs.unity3d.com/Packages/com.unity.test-framework@1.3//changelog/CHANGELOG.html) &#x2192; [1.4.0](https://docs.unity3d.com/Packages/com.unity.test-framework@1.4//changelog/CHANGELOG.html)
...
### Preview of Final 2023.3.0a16 Release Notes
...
- Accessibility: Improved multiple API documentation contents for the Screen Reader API.
...
- Editor: Modified the overlay menu to make it an actual overlay. This allows us to use the new Overlay Popup feature and to remove the need to maintain 2 code paths for very similar behaviors.
...
- HDRP: Improved user feedback when a framesetting was disabled.
...
- Package: Alembic: Prevent a NullReferenceException when upgrading a project with URP and Alembic to Unity 2023.3.
...
- Profiler: Released Memory Profiler version 1.1.0. See https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1/manual/index.html for more information

- Scene/Game View: Update the Cameras Overlay with an icon that is more descriptive.
...
- UI Toolkit: Unity tracks which fields are overridden in UXML in the UxmlSerializedData, during the deserialize process we only apply the overridden fields instead of all of them.
...
- Universal RP: Improved performance for creating shadow data.
...
- Asset Bundles: AssetBundle hash now depends only on the respective Multiplayer Role settings it targets.

- Build Pipeline: "Player Settings &gt; Dedicated Server optimizations" option, that strips all shaders and fonts, is now enabled by default.
...
- Burst: Remove all code specific to DOTS Runtime.
...
- Editor: Modified the overlay's ghost behavior.
...
- Package Manager: `Client.AddAndRemove` no longer throws an error if the same packages are specified in `packagesToAdd` and/or `packagesToRemove`.
...
- Editor: Fixed an issue where printing the physical file path when Unity would not finds a corrupted artifact file.
...
- Editor: Fixed not being able to paste text into package manager popups
    (UUM-42932)
...
- Editor: When the build profile workflow diagnostic flag is enabled, on PS4 and PS5 platforms, the platform build settings forward to the respective setting in PS4/PS5 classic build profiles and vice-versa.
...
- Undo System: Undo documentation update to clarify the RecordObject operation
    ([UUM-44001](https://issuetracker.unity3d.com/issues/scriptreference-slash-undo-default))
...
#### Preview of Final 2023.3.0a16 Package changes
...
- com.unity.burst: [1.8.7](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html) &#x2192; [1.8.10](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html)
...
- com.unity.services.authentication: [2.6.1](https://docs.unity3d.com/Packages/com.unity.services.authentication@2.6//changelog/CHANGELOG.html) &#x2192; [3.1.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.1//changelog/CHANGELOG.html)
...
- com.unity.services.core: [1.10.1](https://docs.unity3d.com/Packages/com.unity.services.core@1.10//changelog/CHANGELOG.html) &#x2192; [1.12.0](https://docs.unity3d.com/Packages/com.unity.services.core@1.12//changelog/CHANGELOG.html)
...
- com.unity.test-framework: [1.3.7](https://docs.unity3d.com/Packages/com.unity.test-framework@1.3//changelog/CHANGELOG.html) &#x2192; [1.4.0](https://docs.unity3d.com/Packages/com.unity.test-framework@1.4//changelog/CHANGELOG.html)
...
- com.unity.netcode.gameobjects: [1.5.1](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@1.5//changelog/CHANGELOG.html) &#x2192; [1.7.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@1.7//changelog/CHANGELOG.html)
