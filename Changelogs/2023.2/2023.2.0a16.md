...
- Contextual Menu: [Mac][Contextual Menus] Editor crashes during the scrolling through the menu when Context Menu Auto Expand Delay is set to 0
...
- Editor: fix resize minimum size on undocked window
...
- Editor: Fixed a VisualElement scheduler that may not run tasks in order when throttling.
    (UUM-35882)    <br>*Fixed in 2023.2.0a17.*
...
- VFX Graph: Fix error when trying to open a VFX asset without using an SRP. Note that this does not make VFX Graph supported on BiRP.
...
- Visual Effects: [macOS M1]Opening VFX Graph assets causes flickering of Editor windows
    ([UUM-35022](https://issuetracker.unity3d.com/issues/macos-m1-opening-vfx-graph-assets-causes-flickering-of-editor-windows))

- Visual Effects - Legacy: Crash on ParticleSystemUpdateData::Release() when opening or playing a Particle System prefab
...
- Build System: Added a .NET 6 runtime package on Windows ARM64 platform.
...
- Editor: Updated the warning within Undo system to correctly reference `RegisterCreatedObjectUndo` when encountering unregistered objects.
    (UUM-32693)<br>
...
- Package Manager: Fixed an issue so that the correct error message is now shown to the user for purchased packages.
    (UUM-33514)<br>
...
- Universal RP: Fixed an issue with reference images for Decal tests and lowered the threshold to catch issues better.
    (UUM-28837)<br>
...
- WebGL: Moved BrowserifyJSTool to the WebGL section since it's only used by the WebGL build. Updated the version of the node that BrowserifyJSTool uses.
    (UUM-34020)<br>
    *First seen in 2023.2.0a12.*




#### New 2023.2.0a16 Package Changes since 2023.2.0a15
...
- com.unity.xr.magicleap: [7.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.magicleap@7.0//changelog/CHANGELOG.html) &#x2192; [7.0.0](https://docs.unity3d.com/Packages/com.unity.xr.magicleap@7.0//changelog/CHANGELOG.html)
...
### Preview of Final 2023.2.0a16 Release Notes
