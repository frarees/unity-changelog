### Known Issues in 2023.2.0a10

- Asset Pipeline: Disabled script re-compilation when **Recompile after playmode** and **Auto-refresh** are set.
    ([UUM-20409](https://issuetracker.unity3d.com/issues/script-recompiles-in-play-mode-when-script-changes-while-playing-option-is-set-to-recompile-after-finished-playing-and-auto-refresh-is-set-to-enabled))    <br>*Fixed in 2023.2.0a11.*
...
- GI: Fixed editor crash on Intel GPUs when using the OpenGL API.
    ([UUM-30370](https://issuetracker.unity3d.com/issues/urp-crash-in-gtpin-init-when-switching-urp-template-to-openglcore-on-win-11))    <br>*Fixed in 2023.2.0a11.*
...
- macOS: Fixed a deadlock when using Entities Graphics on M1 Macs.
    (UUM-13783)    <br>*Fixed in 2023.2.0a11.*
...
- Package Manager: Fixed an issue where null exception is thrown when going to `My Assets` page in the Package Manager Window.
    ...
    *First seen in 2023.2.0a10.*    <br>*Fixed in 2023.2.0a11.*
...
- Package Manager: Fixed performance issues on asset import, move, or delete, resulting from the introduction of asset origin tracking in the Package Manager window.
    (UUM-21372)    <br>*Fixed in 2023.2.0a11.*
...
- URP: Fixed URP and core package leaking materials when entering and exiting Play Mode.
    ([UUM-27587](https://issuetracker.unity3d.com/issues/resources-dot-findobjectsoftypeall-typeof-material-dot-length-increases-every-time-when-entering-slash-exiting-play-mode))    <br>*Fixed in 2023.2.0a11.*
...
- Video: Internal texture queue populated by asynchronous decoding was sometimes being drained from 2 threads. Now serializing access.
    ([UUM-21948](https://issuetracker.unity3d.com/issues/crash-on-windowsvideomedia-getfirstreadytexturetime-when-focusing-gameobject-in-tutorial))    <br>*Fixed in 2023.2.0a11.*
...
### New 2023.2.0a10 Entries since 2023.2.0a9
...
- Editor: Added: EditorGUI.LargeSplitButtonWithDropdownList, which lets you draw a large button that consists of a regular button section and a dropdown section, with a divider between the two.
    ([UUM-30780](https://issuetracker.unity3d.com/issues/generate-lighting-button-is-not-properly-sized-in-the-probe-volumes-tab))<br>
...
- GI: Fixed **Generate Lighting** button in **Probe Volumes** tab of the Lighting Window using inconsistent styling.
    ([UUM-30780](https://issuetracker.unity3d.com/issues/generate-lighting-button-is-not-properly-sized-in-the-probe-volumes-tab))<br>
    *First seen in 2023.2.0a8.*
...
- HDRP: Fixed an issue where the mouse pixel coordinates in the tile debug view were not clamped.
    (UUM-27776)<br>
...
#### New 2023.2.0a10 Package Changes since 2023.2.0a9
...
- com.unity.xr.hands: [1.1.0-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.1//changelog/CHANGELOG.html) &#x2192; [1.1.0](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.1//changelog/CHANGELOG.html)
...
### Preview of Final 2023.2.0a10 Release Notes
