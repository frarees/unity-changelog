...
- Progressive Lightmapper: [URP] Crash in Intel driver when switching URP template to OpenGLCore on Win 11
...
- UI Toolkit: Fixed items going slightly out of bounds in ListViews.
    ([UUM-28519](https://issuetracker.unity3d.com/issues/last-listview-element-size-is-calculated-incorrectly-when-creating-it-through-a-script))    <br>*Fixed in 2023.2.0a9.*

- UI Toolkit: Fixed items in animated lists sometimes disappearing.
    ([UUM-25833](https://issuetracker.unity3d.com/issues/element-ui-disappears-and-nullreferenceexception-is-thrown-when-dragging-off-the-last-or-first-element-from-the-list-in-the-inspector))    <br>*Fixed in 2023.2.0a9.*

- Universal RP: Fixed color and depth mismatch when scaling is on.
    ([UUM-29397](https://issuetracker.unity3d.com/issues/combining-copy-depth-render-scale-and-off-screen-target-throws-error))    <br>*Fixed in 2023.2.0a9.*
...
### New 2023.2.0a8 Entries since 2023.2.0a7
...
- HDRP: Added an option to disable tessellation on water surfaces.
    (UUM-21788)<br>
...
- GI: Deprecated: Deprecated LightProbes.cellCount, LightProbes.count and LightProbes.positions.
...
- VFX Graph: Fixed incorrect MotionVectors in XR with Stereo Instancing.
    (UUM-25505)<br>
    *First seen in 2023.2.0a1.*

- VFX Graph: Fixed incorrect MotionVectors when using multiple camera or multi pass stereo.
    (UUM-25504)<br>
    *First seen in 2023.2.0a1.*
...
#### New 2023.2.0a8 Package Changes since 2023.2.0a7
...
- com.unity.2d.aseprite: [1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.0//changelog/CHANGELOG.html) &#x2192; [1.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.0//changelog/CHANGELOG.html)
...
### Preview of Final 2023.2.0a8 Release Notes
