### Known Issues in 2023.2.0a7

- Editor: Fixed an issue where scripted importer override could cause infinite imports.
    ([UUM-26859](https://issuetracker.unity3d.com/issues/editor-hangs-opening-a-project-when-the-2d-animation-package-is-removed))    <br>*Fixed in 2023.2.0a8.*

- Editor: Fixed `PlayerSettings.SetAdditionalIl2CppArgs` not being respected.
    ([UUM-25446](https://issuetracker.unity3d.com/issues/il2cpp-build-argument-doesnt-get-passed-when-exporting-the-project))    <br>*Fixed in 2023.2.0a8.*
...
- Graphics: Enabled the lifetime of temporary pointers in BatchRendererGroup to be tied to frame completion.
    (UUM-27302)    <br>*Fixed in 2023.2.0a8.*
...
- SRP Core: Fixed Decal Projector Editor fields so they are now saved when editing a prefab.
    ([UUM-29105](https://issuetracker.unity3d.com/issues/changes-made-to-decal-project-prefab-in-the-inspector-are-not-saved))    <br>*Fixed in 2023.2.0a8.*
...
- URP: Fixed a null exception when adding a sorting layer.
    ([UUM-29492](https://issuetracker.unity3d.com/issues/error-in-console-when-creating-a-new-sorting-layer))    <br>*Fixed in 2023.2.0a8.*
...
### New 2023.2.0a7 Entries since 2023.2.0a6
...
- Android: Fixed a frame debugger crash when using mono scripting on Android.
    ([UUM-14632](https://issuetracker.unity3d.com/issues/android-application-crashes-after-pressing-renderforward-dot-renderloopjob-in-frame-debugger-when-scripting-backend-is-set-to-mono))<br>
...
- GI: Fixed an Editor crash inside OpenCL when baking with GPU lightmapper using an AMD RX6800 GPU.
...
- Graphics: Fixed a crash when switching color space in Vulkan Editor.
    ([UUM-28649](https://issuetracker.unity3d.com/issues/vulkan-editor-crash-when-switching-color-space))<br>
    *First seen in 2023.2.0a6.*
...
- URP: Fixed an issue with releasing when it was releasing unnecessary Render Targets when using multiple cameras with different Renderer Assets.
    ([UUM-25186](https://issuetracker.unity3d.com/issues/custom-renderer-feature-doesnt-work-and-errors-are-thrown-when-using-the-official-imported-urp-samples))<br>
    *First seen in 2023.2.0a1.*
...
#### New 2023.2.0a7 Package Changes since 2023.2.0a6
...
### Preview of Final 2023.2.0a7 Release Notes
