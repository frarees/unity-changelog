...
- Editor: Fixed a crash on the Windows platform that could occur when modifying a prefab.
    ([UUM-36776](https://issuetracker.unity3d.com/issues/crash-on-core-join-core-basic-string-char-core-stringstoragedefault-and-ptr64-char-const-and-ptr64-2-core-basic-string-ref-when-the-editor-runs-out-of-memory-saving-an-invalid-override))    <br>*Fixed in 2023.2.0b8.*

- Editor: Fixed an issue where the Editor crashed when a new script was deleted before the domain reload.
    (UUM-43297)<br>
    *First seen in 2023.2.0b1.*    <br>*Fixed in 2023.2.0b8.*
...
- GI: Fixed an issue when modifying the built-in default Lighting Data Asset when baking Reflection Probes from the Inspector was not avoided.
    (UUM-46158)<br>
    *First seen in 2023.2.0b4.*    <br>*Fixed in 2023.2.0b8.*
...
- Graphics: Fixed a crash that would occur when enabling shadows in a scene that used Built-In render pipeline and Scriptable Render Pipeline materials.
    ([UUM-46685](https://issuetracker.unity3d.com/issues/crash-on-gfxdevice-executeasync-when-light-source-shadows-are-enabled-with-builtin-and-srp-materials-in-the-scene-with-the-default-scriptable-render-pipeline))    <br>*Fixed in 2023.2.0b8.*
...
- Shaders: Fixed `WarmupAllShaders` to actually warm up all variants instead of using a single variant per pass.
    (UUM-45992)    <br>*Fixed in 2023.2.0b8.*
...
- Universal RP: Fixed a memory leak in the `RenderTexture` method that would occur when rtHandle realloc failed to add resources to the render texture resource pool.
    ([UUM-46882](https://issuetracker.unity3d.com/issues/regression-render-texture-memory-leak))    <br>*Fixed in 2023.2.0b8.*
...
- VFX Graph: Fixed an issue where creating a new Visual Effect Graph instance to overwrite another instance that's already open would open the same view twice and could corrupt related data.
    ...
    *First seen in 2023.2.0a20.*    <br>*Fixed in 2023.2.0b8.*
...
### New 2023.2.0b7 Entries since 2023.2.0b6
...
- Editor: Fixed a bug in the Editor window so it now minimizes correctly after being clicked on in the Windows taskbar.
    ([UUM-44284](https://issuetracker.unity3d.com/issues/unity-editor-minimizes-for-a-moment-and-returns-to-its-initial-state-when-clicking-on-it-in-the-windows-taskbar))<br>
...
- Editor: Fixed an issue where rich text was not rendering in `EditorGUILayout.HelpBox`.
    (UUM-44245)<br>
...
- com.unity.inputsystem: [1.6.3](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.6//changelog/CHANGELOG.html) &#x2192; [1.7.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.7//changelog/CHANGELOG.html)
...
### Preview of Final 2023.2.0b7 Release Notes
