...
- Core: Fixed leak in Job Debugger that would occur when using a NativeContainer's async `Dispose(JobHandle)` method.
    (UUM-27552)    <br>*Fixed in 2023.2.0a15.*
...
- Editor: Fix instabilities on DeleteMultipleAssets
    (UUM-33221)    <br>*Fixed in 2023.2.0a15.*
...
- IL2CPP: Fixed possible GC corruption when using the job system on PS4/PS5 platforms.<br>
    ...
    (UUM-33034)    <br>*Fixed in 2023.2.0a15.*
...
- Mono: Fixed crash when opening a scene with missing references
    ([UUM-33830](https://issuetracker.unity3d.com/issues/crash-on-object-getcachedscriptingobject-when-entering-play-mode-after-missing-a-reference-variable))    <br>*Fixed in 2023.2.0a15.*
...
- uGUI: Fixed memory leak when textures get reparented from one scene to another
    ([UUM-33852](https://issuetracker.unity3d.com/issues/memory-leaks-stop-textures-from-getting-unloaded-from-memory-when-the-textures-gets-reparented-from-one-scene-to-another))    <br>*Fixed in 2023.2.0a15.*
...
### New 2023.2.0a14 Entries since 2023.2.0a13
...
- Scene/Game View: A new Cameras Overlay replaces the former Camera preview. It's global to the SceneView and it is now possible work in the SceneView through the lens of a camera. Press ~ in the SceneView to access the Overlays menu.
...
- DX12: Enabled integrating an AMD PIX extension to fix GPU profiling scopes not being visible in DX12 RGP traces.
    (UUM-34299)<br>
...
- Editor: Fixed an Editor freeze on macOS.<br>
...
- SRP Core: Rendering Debugger - Foldouts - Left click on context menu collapsed/expand the foldout.
    ([UUM-33093](https://issuetracker.unity3d.com/issues/urp-rendering-debugger-foldout-headers-context-menu-is-not-consistent-with-the-rest-of-the-editors-functionality))<br>
...
- SRP Core: Rendering Debugger - HotKeys- Fixed regression to open the Rendering Debugger with Ctrl + Backspace on standalone/player modes.
    (UUM-33873)<br>
...
#### New 2023.2.0a14 Package Changes since 2023.2.0a13
...
### Preview of Final 2023.2.0a14 Release Notes
