...
- Documentation: Fixed a bug where the Editor is running DX11 incorrectly, when DX12 is selected.
    ...
    *First seen in 2023.2.0a18.*    <br>*Fixed in 2023.2.0a20.*
...
- Particles: Fixed a subemitter crash if the effect is referenced more than once in effect hierarchy.
    ([UUM-36485](https://issuetracker.unity3d.com/issues/crash-on-particlesystemupdatedata-release-when-opening-or-playing-a-particle-system-prefab))    <br>*Fixed in 2023.2.0a20.*
...
- UI Toolkit: Fixed the TextElement **text** field not supporting multiline in the UI Builder.
    (UUM-36803)<br>
    *First seen in 2023.2.0a18.*    <br>*Fixed in 2023.2.0a20.*
...
### New 2023.2.0a19 Entries since 2023.2.0a18
...
- Universal RP: Changed: The UniversalRenderPipeline Asset Renderer and RendererData lists have now public visibility, via property.
    (UUM-37537)<br>
...
- Android: Enabled native signals to be correctly handled when installing multiple crash handlers from within `libil2cpp.so`. Previously, if multiple crash handlers were installed from within `libil2cpp.so`, the signal forwarding was working incorrectly and could enter infinite recursion. This is now fixed on the following architectures: ARM64, x86, and x86_64. The issue still persists on ARMv7 and cannot be fixed without introducing regressions, but it only happens when installing multiple signals handlers from within `libil2cpp.so`.
    (UUM-26142)<br>
...
- Editor: Fixed an issue where closing the HDR color picker quickly could cause a crash.
    (UUM-33808)<br>
...
- Editor: Fixed an unresolved pointer reference Issue with menu controller.
    (UUM-36517)<br>
...
- Editor: Fixed the node search window not opening in VFX Graph.
    ([UUM-35072](https://issuetracker.unity3d.com/issues/node-search-cannot-be-opened-via-context-menu-in-vfx-graph))<br>
...
- Graphics: Fixed a performance regression caused by warning spam related to a depth-stencil format fallback. This was caused by the RenderTextureDescriptor's `colorFormat` setter applying the fallback prematurely.
    (UUM-36078)<br>
    *First seen in 2023.2.0a16.*
...
- HDRP: Fixed incorrect bounds calculation for decals in the HDRP path tracer.
    (UUM-35071)<br>
...
- Mono: Changed FileInfo's CopyTo so it now has the same behavior on all platforms when a folder is passed as a destination, and throws an UnauthorizedAccessException as per https://learn.microsoft.com/en-us/dotnet/api/System.IO.FileInfo.CopyTo?view=net-7.0.
    (UUM-32218)<br>
...
- Package Manager: Added a missing border to the sidebar and centered the download icon in the toolbar.
    (UUM-37685)<br>
    *First seen in 2023.2.0a16.*

- Package Manager: Enabled caching extra information locally to improve asset tracking experience.
    (UUM-36251)<br>
    *First seen in 2023.2.0a15.*

- Package Manager: Enabled showing the correct error message when a package is inaccessible.
    (UUM-37216)<br>
...
- Package Manager: Fixed an issue where an extension item's tooltip doesn't show in the extension dropdown.
    (UUM-37019)<br>
    *First seen in 2023.2.0a16.*
...
- SRP Core: Fixed HDRP FrameSettings object changes getting lost during editing.
    (UUM-37363)<br>
    *First seen in 2023.2.0a16.*
...
- UI Toolkit: Fixed button UXML traits for icon-image.
    (UUM-36895)<br>
...
- UI Toolkit: Fixed showing mixed values in ToggleButtonGroup.
    (UUM-36541)<br>
    *First seen in 2023.2.0a17.*
...
- VFX Graph: Removed lock capabilities while editing material stored in VisualEffectAsset.
    (UUM-32487)<br>
...
#### New 2023.2.0a19 Package Changes since 2023.2.0a18

#### Packages updated

- com.unity.2d.animation: [10.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.0//changelog/CHANGELOG.html) &#x2192; [10.0.2](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.0//changelog/CHANGELOG.html)

- com.unity.2d.common: [9.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@9.0//changelog/CHANGELOG.html) &#x2192; [9.0.1](https://docs.unity3d.com/Packages/com.unity.2d.common@9.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [10.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@10.0//changelog/CHANGELOG.html) &#x2192; [10.0.1](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@10.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [4.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@4.0//changelog/CHANGELOG.html) &#x2192; [4.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@4.0//changelog/CHANGELOG.html)

- com.unity.ide.rider: [3.0.21](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html) &#x2192; [3.0.22](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html)
...
- com.unity.timeline: [1.8.2](https://docs.unity3d.com/Packages/com.unity.timeline@1.8//changelog/CHANGELOG.html) &#x2192; [1.8.3](https://docs.unity3d.com/Packages/com.unity.timeline@1.8//changelog/CHANGELOG.html)
...
- com.unity.ai.navigation: [1.1.3](https://docs.unity3d.com/Packages/com.unity.ai.navigation@1.1//changelog/CHANGELOG.html) &#x2192; [2.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html)
...
### Preview of Final 2023.2.0a19 Release Notes
...
- DX12: Removed unnecessary warnings about upload buffer being full from log files.
