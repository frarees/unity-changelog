...
- Editor: Improve temp atomic safety handle by temp allocator owns the safety nodes
    (UUM-41241, UUM-41907)    <br>*Fixed in 2023.2.0b14.*
...
- HDRP: Fixes missing shadergraph include on HDRP
    (UUM-51851)    <br>*Fixed in 2023.2.0b13.*

- Input: Button triggers another Button when multiple Canvases are used in multiple windows
...
- Particles: Improve batching performance of Particle Systems that use Sprites.
    (UUM-52114)    <br>*Fixed in 2023.2.0b14.*
...
- Serialization: The fix makes sure that a rebuild is performed after the rename of the scriptable object and the scriptable object is updated accordingly, so that the editor doesn't crash.
    ([UUM-41704](https://issuetracker.unity3d.com/issues/crash-on-serializedproperty-custom-getstringvalueinternal-when-renaming-a-scriptableobject-asset))    <br>*Fixed in 2023.2.0b13.*
...
### New 2023.2.0b12 Entries since 2023.2.0b11
...
- Animation: Fix potential editor hang when previewing transitions to states set with an extremely large speed multiplier.
...
- Core: Fixed an error that made APV cells load twice.
    (UUM-49469)<br>
    *First seen in 2023.2.0b9.*

- Editor: Editor: "UnityException: Could not find the requested Platform Texture Settings" error is thrown when selecting a texture when the Dedicated Server Build Support module is installed and the Build Target is missing from the texture's metadata
...
- Editor: Fix CPU architecture in the plugin inspector resetting after applying changes
    (UUM-45756)<br>
...
- Scene/Game View: Fixed a bug where a custom collapsed overlay would not opened in collapsed mode.
    ([UUM-49330](https://issuetracker.unity3d.com/issues/docked-custom-overlay-does-not-display-content-when-it-is-clicked-in-a-custom-editor-window-toolbar))<br>
    *First seen in 2023.2.0b10.*

- Serialization: Fix calling JsonUtility.FromJson&lt;T&gt;\(json\) in parallel task
...
- UI Toolkit: Fixed UI Toolkit PropertyFields are missing labels if not set explicitly
    ([UUM-44045](https://issuetracker.unity3d.com/issues/ui-toolkit-panel-settings-are-missing-labels))<br>
...
- Universal RP: Fixed missing padding at the bottom of URP's Global Settings
    ([UUM-49319](https://issuetracker.unity3d.com/issues/urp-global-settings-have-no-padding-on-the-bottom))<br>
    *First seen in 2023.2.0b10.*

- URP: Fixed visible outline when composited ShadowCaster2Ds with transparency overlap
    ([UUM-38076](https://issuetracker.unity3d.com/issues/the-sprite-leaves-artifacts-on-the-other-overlapping-sprites-when-adding-compositeshadowcaster2d))<br>
    *First seen in 2023.2.0a18.*

- VFX Graph: Fixed a performance issue with parameters gizmos
    (UUM-41329)

- VFX Graph: Fixed issue when overwriting an opened VFX asset with a VFX that contains different systems than original file
    ([UUM-42188](https://issuetracker.unity3d.com/issues/vfx-rewriting-vfx-assets-that-contain-multiple-systems-results-in-errors))<br>
    *First seen in 2023.2.0a23.*

- VFX Graph: Fixed missing gizmo for Position exposed property
    ([UUM-41199](https://issuetracker.unity3d.com/issues/vfx-incorrect-behaviour-of-property-gizmos))<br>
    *First seen in 2023.2.0a22.*

- VFX Graph: Keep the built-in templates category always visible when there's no user defined category
    ([UUM-47192](https://issuetracker.unity3d.com/issues/vfx-templates-window-is-displayed-almost-blank-with-only-a-few-hanging-words))<br>
    *First seen in 2023.2.0a14.*

- VFX Graph: Template items could have uneven width when the left panel is too small
    ([UUM-47453](https://issuetracker.unity3d.com/issues/vfx-templates-template-tiles-minimisation-become-uneven-during-window-resizing))<br>
    *First seen in 2023.2.0a14.*

- VFX Graph: The right panel \(details panel\) could be resize to as small as zero width, leading to messy layout. Now it has a minimum width of 200px \(like the left panel\).
    ([UUM-47506](https://issuetracker.unity3d.com/issues/details-section-minimization-in-vfx-graph-wizard-causes-ui-issues))<br>
    *First seen in 2023.2.0b7.*

- VFX Graph: The template item hit box was slightly bigger than its visual representation, now it perfectly match.
    ([UUM-47505](https://issuetracker.unity3d.com/issues/vfx-graph-templates-can-be-selected-in-wizard-when-mouse-is-outside-of-their-ui-elements-bounds))<br>
    *First seen in 2023.2.0b7.*
...
- com.unity.xr.arcore: [5.1.0-pre.10](https://docs.unity3d.com/Packages/com.unity.xr.arcore@5.1//changelog/CHANGELOG.html) &#x2192; [5.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@5.1//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [5.1.0-pre.10](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@5.1//changelog/CHANGELOG.html) &#x2192; [5.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@5.1//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [5.1.0-pre.10](https://docs.unity3d.com/Packages/com.unity.xr.arkit@5.1//changelog/CHANGELOG.html) &#x2192; [5.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@5.1//changelog/CHANGELOG.html)

### Preview of Final 2023.2.0b12 Release Notes
...
- Android: Fixed an issue with `APP_CMD_WINDOW_INSETS_CHANGED` not correctly reporting for GameActivity when soft keyboard was opened/closed.
    (UUM-47094)
...
- Audio: Fixed an issue by adding lazy `loopEnd` evaluation to avoid keeping a value of 0. Downloaded audio files were were not updating this, causing a division by zero in the playback process.
...
- Editor: Fixed an issue where static batching with transparent shadow was rendering incorrectly.
    (UUM-36082)
...
- Editor: Fixed an issue where the Undo buffer maximum size was not large enough and caused 'Failed to create Object Undo, because the action is too large' error in console.
...
- HDRP: Fixed mixed tracing mode for transparent screenspace reflections now mixes both tracing modes as expected, instead of only using ray traced reflections.
...
- macOS: Fixed a driver issue when enabling the water system.
    (UUM-47762)
...
- UI Toolkit: The unit and ulong data types can now use the new UnsignedIntegerField and UnsignedLongField controls to hold values.
...
- VFX Graph: Fixed an issue where VFX material indices were not itialized an were invalid if used on Awake.
...
- VFX Graph: Fixed Picking Overlay when the rotation was applied on VisualEffect component.
...
#### Preview of Final 2023.2.0b12 Package changes

#### Packages updated

- com.unity.2d.animation: [10.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.0//changelog/CHANGELOG.html) &#x2192; [10.0.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.0//changelog/CHANGELOG.html)

- com.unity.2d.common: [9.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.common@9.0//changelog/CHANGELOG.html) &#x2192; [9.0.2](https://docs.unity3d.com/Packages/com.unity.2d.common@9.0//changelog/CHANGELOG.html)

- com.unity.2d.psdimporter: [9.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@9.0//changelog/CHANGELOG.html) &#x2192; [9.0.1](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@9.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [10.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@10.0//changelog/CHANGELOG.html) &#x2192; [10.0.2](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@10.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [4.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@4.0//changelog/CHANGELOG.html) &#x2192; [4.0.2](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@4.0//changelog/CHANGELOG.html)

- com.unity.adaptiveperformance: [5.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance@5.0//changelog/CHANGELOG.html) &#x2192; [5.0.1](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance@5.0//changelog/CHANGELOG.html)

- com.unity.adaptiveperformance.google.android: [1.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance.google.android@1.0//changelog/CHANGELOG.html) &#x2192; [1.1.2](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance.google.android@1.1//changelog/CHANGELOG.html)

- com.unity.adaptiveperformance.samsung.android: [5.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance.samsung.android@5.0//changelog/CHANGELOG.html) &#x2192; [5.0.0](https://docs.unity3d.com/Packages/com.unity.adaptiveperformance.samsung.android@5.0//changelog/CHANGELOG.html)

- com.unity.addressables: [1.21.1](https://docs.unity3d.com/Packages/com.unity.addressables@1.21//changelog/CHANGELOG.html) &#x2192; [1.21.17](https://docs.unity3d.com/Packages/com.unity.addressables@1.21//changelog/CHANGELOG.html)
...
- com.unity.animation.rigging: [1.2.1](https://docs.unity3d.com/Packages/com.unity.animation.rigging@1.2//changelog/CHANGELOG.html) &#x2192; [1.3.0](https://docs.unity3d.com/Packages/com.unity.animation.rigging@1.3//changelog/CHANGELOG.html)

- com.unity.burst: [1.8.2](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html) &#x2192; [1.8.8](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html)
...
- com.unity.collab-proxy: [1.17.6](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.17//changelog/CHANGELOG.html) &#x2192; [2.1.0](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.1//changelog/CHANGELOG.html)

- com.unity.ext.nunit: [2.0.3](https://docs.unity3d.com/Packages/com.unity.ext.nunit@2.0//changelog/CHANGELOG.html) &#x2192; [2.0.5](https://docs.unity3d.com/Packages/com.unity.ext.nunit@2.0//changelog/CHANGELOG.html)
...
- com.unity.ide.rider: [3.0.18](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html) &#x2192; [3.0.25](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html)

- com.unity.ide.visualstudio: [2.0.17](https://docs.unity3d.com/Packages/com.unity.ide.visualstudio@2.0//changelog/CHANGELOG.html) &#x2192; [2.0.21](https://docs.unity3d.com/Packages/com.unity.ide.visualstudio@2.0//changelog/CHANGELOG.html)

- com.unity.inputsystem: [1.4.4](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.4//changelog/CHANGELOG.html) &#x2192; [1.7.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.7//changelog/CHANGELOG.html)

- com.unity.live-capture: [3.0.0](https://docs.unity3d.com/Packages/com.unity.live-capture@3.0//changelog/CHANGELOG.html) &#x2192; [4.0.0](https://docs.unity3d.com/Packages/com.unity.live-capture@4.0//changelog/CHANGELOG.html)

- com.unity.localization: [1.4.2](https://docs.unity3d.com/Packages/com.unity.localization@1.4//changelog/CHANGELOG.html) &#x2192; [1.4.4](https://docs.unity3d.com/Packages/com.unity.localization@1.4//changelog/CHANGELOG.html)

- com.unity.mobile.notifications: [2.1.1](https://docs.unity3d.com/Packages/com.unity.mobile.notifications@2.1//changelog/CHANGELOG.html) &#x2192; [2.2.2](https://docs.unity3d.com/Packages/com.unity.mobile.notifications@2.2//changelog/CHANGELOG.html)
...
- com.unity.probuilder: [5.0.6](https://docs.unity3d.com/Packages/com.unity.probuilder@5.0//changelog/CHANGELOG.html) &#x2192; [5.1.0](https://docs.unity3d.com/Packages/com.unity.probuilder@5.1//changelog/CHANGELOG.html)
...
- com.unity.purchasing: [4.5.2](https://docs.unity3d.com/Packages/com.unity.purchasing@4.5//changelog/CHANGELOG.html) &#x2192; [4.9.4](https://docs.unity3d.com/Packages/com.unity.purchasing@4.9//changelog/CHANGELOG.html)
...
- com.unity.remote-config-runtime: [3.1.3](https://docs.unity3d.com/Packages/com.unity.remote-config-runtime@3.1//changelog/CHANGELOG.html) &#x2192; [4.0.1](https://docs.unity3d.com/Packages/com.unity.remote-config-runtime@4.0//changelog/CHANGELOG.html)

- com.unity.render-pipelines.core: [15.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@15.0//changelog/CHANGELOG.html) &#x2192; [16.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@16.0//changelog/CHANGELOG.html)

- com.unity.render-pipelines.high-definition: [15.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@15.0//changelog/CHANGELOG.html) &#x2192; [16.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@16.0//changelog/CHANGELOG.html)

- com.unity.render-pipelines.high-definition-config: [15.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@15.0//changelog/CHANGELOG.html) &#x2192; [16.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@16.0//changelog/CHANGELOG.html)

- com.unity.render-pipelines.universal: [15.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@15.0//changelog/CHANGELOG.html) &#x2192; [16.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@16.0//changelog/CHANGELOG.html)
...
- com.unity.scriptablebuildpipeline: [1.21.0](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.21//changelog/CHANGELOG.html) &#x2192; [1.21.9](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.21//changelog/CHANGELOG.html)
...
- com.unity.services.authentication: [2.4.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@2.4//changelog/CHANGELOG.html) &#x2192; [3.0.0](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.0//changelog/CHANGELOG.html)
...
- com.unity.services.cloudcode: [2.2.1](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.2//changelog/CHANGELOG.html) &#x2192; [2.5.0](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.5//changelog/CHANGELOG.html)
...
- com.unity.services.core: [1.7.0](https://docs.unity3d.com/Packages/com.unity.services.core@1.7//changelog/CHANGELOG.html) &#x2192; [1.11.0](https://docs.unity3d.com/Packages/com.unity.services.core@1.11//changelog/CHANGELOG.html)

- com.unity.services.economy: [3.0.0](https://docs.unity3d.com/Packages/com.unity.services.economy@3.0//changelog/CHANGELOG.html) &#x2192; [3.2.1](https://docs.unity3d.com/Packages/com.unity.services.economy@3.2//changelog/CHANGELOG.html)

- com.unity.services.lobby: [1.0.1](https://docs.unity3d.com/Packages/com.unity.services.lobby@1.0//changelog/CHANGELOG.html) &#x2192; [1.1.0](https://docs.unity3d.com/Packages/com.unity.services.lobby@1.1//changelog/CHANGELOG.html)
...
- com.unity.services.wire: [1.1.0](https://docs.unity3d.com/Packages/com.unity.services.wire@1.1//changelog/CHANGELOG.html) &#x2192; [1.1.8](https://docs.unity3d.com/Packages/com.unity.services.wire@1.1//changelog/CHANGELOG.html)

- com.unity.shadergraph: [15.0.3](https://docs.unity3d.com/Packages/com.unity.shadergraph@15.0//changelog/CHANGELOG.html) &#x2192; [16.0.3](https://docs.unity3d.com/Packages/com.unity.shadergraph@16.0//changelog/CHANGELOG.html)

- com.unity.splines: [2.1.0](https://docs.unity3d.com/Packages/com.unity.splines@2.1//changelog/CHANGELOG.html) &#x2192; [2.4.0](https://docs.unity3d.com/Packages/com.unity.splines@2.4//changelog/CHANGELOG.html)

- com.unity.test-framework: [1.3.2](https://docs.unity3d.com/Packages/com.unity.test-framework@1.3//changelog/CHANGELOG.html) &#x2192; [1.3.9](https://docs.unity3d.com/Packages/com.unity.test-framework@1.3//changelog/CHANGELOG.html)

- com.unity.testtools.codecoverage: [1.2.2](https://docs.unity3d.com/Packages/com.unity.testtools.codecoverage@1.2//changelog/CHANGELOG.html) &#x2192; [1.2.4](https://docs.unity3d.com/Packages/com.unity.testtools.codecoverage@1.2//changelog/CHANGELOG.html)

- com.unity.timeline: [1.8.0](https://docs.unity3d.com/Packages/com.unity.timeline@1.8//changelog/CHANGELOG.html) &#x2192; [1.8.4](https://docs.unity3d.com/Packages/com.unity.timeline@1.8//changelog/CHANGELOG.html)

- com.unity.ugui: [1.0.0](https://docs.unity3d.com/Packages/com.unity.ugui@1.0//changelog/CHANGELOG.html) &#x2192; [2.0.0](https://docs.unity3d.com/Packages/com.unity.ugui@2.0//changelog/CHANGELOG.html)

- com.unity.visualeffectgraph: [15.0.3](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@15.0//changelog/CHANGELOG.html) &#x2192; [16.0.3](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@16.0//changelog/CHANGELOG.html)

- com.unity.xr.arcore: [5.0.3](https://docs.unity3d.com/Packages/com.unity.xr.arcore@5.0//changelog/CHANGELOG.html) &#x2192; [5.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@5.1//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [5.0.3](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@5.0//changelog/CHANGELOG.html) &#x2192; [5.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@5.1//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [5.0.3](https://docs.unity3d.com/Packages/com.unity.xr.arkit@5.0//changelog/CHANGELOG.html) &#x2192; [5.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@5.1//changelog/CHANGELOG.html)

- com.unity.xr.core-utils: [2.2.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.2//changelog/CHANGELOG.html) &#x2192; [2.2.3](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.2//changelog/CHANGELOG.html)

- com.unity.xr.hands: [1.1.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.1//changelog/CHANGELOG.html) &#x2192; [1.3.0](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.3//changelog/CHANGELOG.html)

- com.unity.xr.interaction.toolkit: [2.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.3//changelog/CHANGELOG.html) &#x2192; [2.5.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.5//changelog/CHANGELOG.html)
...
- com.unity.xr.management: [4.2.0](https://docs.unity3d.com/Packages/com.unity.xr.management@4.2//changelog/CHANGELOG.html) &#x2192; [4.4.0](https://docs.unity3d.com/Packages/com.unity.xr.management@4.4//changelog/CHANGELOG.html)

- com.unity.xr.oculus: [3.2.2](https://docs.unity3d.com/Packages/com.unity.xr.oculus@3.2//changelog/CHANGELOG.html) &#x2192; [4.1.1](https://docs.unity3d.com/Packages/com.unity.xr.oculus@4.1//changelog/CHANGELOG.html)

- com.unity.xr.openxr: [1.6.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.6//changelog/CHANGELOG.html) &#x2192; [1.8.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.8//changelog/CHANGELOG.html)

- com.unity.formats.fbx: [5.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.formats.fbx@5.0//changelog/CHANGELOG.html) &#x2192; [5.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.formats.fbx@5.1//changelog/CHANGELOG.html)

- com.autodesk.fbx: 5.0.0-pre.1 &#x2192; 5.1.0-pre.1
...
- com.unity.sequences: [2.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.sequences@2.1//changelog/CHANGELOG.html) &#x2192; [2.1.0](https://docs.unity3d.com/Packages/com.unity.sequences@2.1//changelog/CHANGELOG.html)
...
- com.unity.scripting.python: [7.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.scripting.python@7.0//changelog/CHANGELOG.html) &#x2192; [7.0.1](https://docs.unity3d.com/Packages/com.unity.scripting.python@7.0//changelog/CHANGELOG.html)

- com.unity.scripting.python.windows: [1.3.0-pre.2](https://docs.unity3d.com/Packages/com.unity.scripting.python.windows@1.3//changelog/CHANGELOG.html) &#x2192; [1.3.0](https://docs.unity3d.com/Packages/com.unity.scripting.python.windows@1.3//changelog/CHANGELOG.html)

- com.unity.scripting.python.macos: [1.3.0-pre.2](https://docs.unity3d.com/Packages/com.unity.scripting.python.macos@1.3//changelog/CHANGELOG.html) &#x2192; [1.3.0](https://docs.unity3d.com/Packages/com.unity.scripting.python.macos@1.3//changelog/CHANGELOG.html)

- com.unity.scripting.python.linux: [1.3.0-pre.2](https://docs.unity3d.com/Packages/com.unity.scripting.python.linux@1.3//changelog/CHANGELOG.html) &#x2192; [1.3.0](https://docs.unity3d.com/Packages/com.unity.scripting.python.linux@1.3//changelog/CHANGELOG.html)

- com.unity.transport: [1.3.1](https://docs.unity3d.com/Packages/com.unity.transport@1.3//changelog/CHANGELOG.html) &#x2192; [1.4.0](https://docs.unity3d.com/Packages/com.unity.transport@1.4//changelog/CHANGELOG.html)

- com.unity.netcode.gameobjects: [1.2.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@1.2//changelog/CHANGELOG.html) &#x2192; [1.6.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@1.6//changelog/CHANGELOG.html)

- com.unity.ai.navigation: [1.1.1](https://docs.unity3d.com/Packages/com.unity.ai.navigation@1.1//changelog/CHANGELOG.html) &#x2192; [2.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html)

**Packages added**

- [com.unity.2d.aseprite@1.0.1](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.0//changelog/CHANGELOG.html)
...
- [com.unity.services.matchmaker@1.1.1](https://docs.unity3d.com/Packages/com.unity.services.matchmaker@1.1//changelog/CHANGELOG.html)
...
- [com.unity.zivart-player@2.0.0](https://docs.unity3d.com/Packages/com.unity.zivart-player@2.0//changelog/CHANGELOG.html)

**Packages deprecated**

- com.unity.subsystemregistration - "This package is no longer supported on this editor version."

- com.unity.textmeshpro - "This package is no longer supported on this editor version."
...
- [com.unity.memoryprofiler@1.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1//changelog/CHANGELOG.html)
...
- [com.unity.services.ugc@1.0.0-pre.10](https://docs.unity3d.com/Packages/com.unity.services.ugc@1.0//changelog/CHANGELOG.html)