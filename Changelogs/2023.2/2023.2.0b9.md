...
- Editor: Fixed offset of camera position when using the light placement tool.
    (UUM-47863)<br>
    *First seen in 2023.2.0b8.*    <br>*Fixed in 2023.2.0b10.*

- Graphics: Backport: Fix CustomRenderTexture artifact on sphere game object and material preview
    ([UUM-43540](https://issuetracker.unity3d.com/issues/rendering-artifacts-using-custom-render-texture-shader-on-sphere-game-object-on-macos-metal-api))    <br>*Fixed in 2023.2.0b10.*

- Graphics: Fix a BatchRendererGroup thread race condition under special circumstances
    (UUM-46934)    <br>*Fixed in 2023.2.0b10.*
...
- UI Toolkit: Added a workaround for a Intel Graphics 3000 driver bug that would cause textures rendered by UI Toolkit to show incorrectly.
    ([UUM-13134](https://issuetracker.unity3d.com/issues/unity-editor-is-rendered-without-the-toolbar-icons-when-using-it-on-old-hardware-with-integrated-gpu))    <br>*Fixed in 2023.2.0b10.*
...
### New 2023.2.0b9 Entries since 2023.2.0b8
...
- Package Manager: Fixed an issue where the warning icons were not removed when the asset store download was aborted.
    (UUM-47319)<br>
...
### Preview of Final 2023.2.0b9 Release Notes
