...
- Editor: Added EditorSceneManager event for RestoreSceneManagerSetup so systems can get notified about it.
    (UUM-19655)
...
- Universal RP: Fixed releasing render targets when using multiple renderers.
    (UUM-16481)
