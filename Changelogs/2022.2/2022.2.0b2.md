...
*   Graphics: Fixed an issue where Mesh.GetBlendShapeBuffer would cause stalls when called with PerVertex layout. (UUM-9078)  
    ...
    _Fixed in 2022.2.0b3._
    
*   HDRP: Fixed crash on standalone profiler executing the HDRP Upgrader  
    
    *   URP: Fixed crash on standalone profiler executing the URP Upgrader ([UUM-2429](https://issuetracker.unity3d.com/issues/hdrp-standalone-profiler-throws-hdrp-material-upgrade-pop-up-and-crashes-after-pressing-ok-1))  
...
*   Quality of Life: Scene window stuck in orbit after context menu click from Hierarchy ([UUM-6908](https://issuetracker.unity3d.com/issues/scene-window-stuck-in-orbit-after-context-menu-click-from-hierarchy))
    
*   Scene Hierarchy: Additional GameObjects and a Console error after Undoing and Redoing a Paste As Child (UUM-9278)
    
*   Scene Management: Error "Destroying a GameObject inside a Prefab instance is not allowed" shown when destroying runtime-instantiated GameObject ([UUM-8917](https://issuetracker.unity3d.com/issues/error-destroying-a-gameobject-inside-a-prefab-instance-is-not-allowed-shown-when-destroying-runtime-instantiated-gameobject))
...
*   Shaders: Fixed a crash in ShaderLab when switching rendering pipelines ([UUM-1249](https://issuetracker.unity3d.com/issues/crash-on-shaderlab-pass-computepassvalueshash-when-uninstalling-the-urp-package))  
...
*   Text: Caret in UI Builder Text Field with high Reference DPI does not always appear when typing ([UUM-5118](https://issuetracker.unity3d.com/issues/caret-in-ui-builder-text-field-with-high-reference-dpi-does-not-always-appear-when-typing-1))
...
### New 2022.2.0b2 Entries since 2022.2.0b1
...
*   Graphics: Fixed an issue with Crunched textures appearing too bright in projects with linear color space. ([UUM-3200](https://issuetracker.unity3d.com/issues/crunched-asset-bundle-sprites-are-too-bright-when-loaded-from-file-in-play-mode))  
    _First seen in 2022.2.0a13._
    
*   IL2CPP: Avoid a stack overflow during code conversion when an attribute constructor uses the attribute itself. ([UUM-3907](https://issuetracker.unity3d.com/issues/il2cpp-project-with-nhibernate-library-fails-to-build-when-using-il2cpp-scripting-backend))  
...
### Preview of Final 2022.2.0b2 Release Notes
...
*   URP: Fixed a y-flip regression for multipass XR. (URP-1417)
...
#### Preview of Final 2022.2.0b2 Package changes

#### Packages updated

*   com.unity.2d.animation: [8.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@8.0//changelog/CHANGELOG.html) → [9.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@9.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.common: [7.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.common@7.0//changelog/CHANGELOG.html) → [8.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.2d.common@8.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.psdimporter: [7.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@7.0//changelog/CHANGELOG.html) → [8.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@8.0//changelog/CHANGELOG.html)
...
*   [com.unity.services.cloudcode@2.0.1](https://docs.unity3d.com/Packages/com.unity.services.cloudcode@2.0//changelog/CHANGELOG.html)
