...
*   Asset - Database: Standalone Profiler crash on CleanUpAssetDatabaseV2 when closing Standalone Profiler ([1413954](https://issuetracker.unity3d.com/issues/standalone-profiler-crash-on-cleanupassetdatabasev2-when-closing-standalone-profiler))
    
*   Editor: Spaces and symbols of the Project name are changed to hyphens causing "Invalid characters" warning in the Bundle Identifier ([1412412](https://issuetracker.unity3d.com/issues/spaces-and-symbols-of-the-project-name-are-changed-to-hyphens-causing-warnings-in-the-bundle-identifier))
...
*   Linux: Trying to switch to Scene from Game Window while in Play Mode instead maximizes the Game Window on CentOS ([1407426](https://issuetracker.unity3d.com/issues/linux-trying-to-switch-to-scene-from-game-window-while-in-play-mode-instead-maximizes-the-game-window-on-centos))
    
*   macOS: Missing splash screen settings. ([1404018](https://issuetracker.unity3d.com/issues/the-splash-screen-settings-are-missing-when-using-macos))  
    _Fixed in 2022.2.0a10._
    
*   Metal: Consistent EditorLoop 5-10ms spikes when using Metal API ([1378985](https://issuetracker.unity3d.com/issues/consistent-gfx-dot-waitforpresentongfxthread-5-10ms-spikes-when-using-metal-api))
    
*   Metal: Editor crash after using GrabPixels to write to a render texture multiple times ([1409778](https://issuetracker.unity3d.com/issues/editor-crash-after-using-grabpixels-to-write-to-a-render-texture-multiple-times))
...
*   Progressive Lightmapper: CPU Total Allocated Memory is 500MB higher while baking with the Progressive Lightmapper ([1413145](https://issuetracker.unity3d.com/issues/cpu-total-allocated-memory-is-500mb-higher-while-baking-with-the-progressive-lightmapper))
...
*   Web Platform: Build fails with error "Emscripten SDK for this platform is not present at.." ([1415952](https://issuetracker.unity3d.com/issues/web-platform-build-fails-with-error-emscripten-sdk-for-this-platform-is-not-present-at-dot))
...
*   Web Platform: \[WebGL\] Constant il2cpp build error after OSX 12.3 Upgrade ([1412113](https://issuetracker.unity3d.com/issues/webgl-builderror-constant-il2cpp-build-error-after-osx-12-dot-3-upgrade))
    

### Preview of Final 2022.2.0a9 Release Notes
...
*   Physics: Allow a Collider2D to control Send and Receive forces per-layer upon contact with another Collider2D.
...
*   Android: Fixed build failure when you had .androidlib plugin in a package. ([1394476](https://issuetracker.unity3d.com/issues/android-build-fails-when-upm-package-dependency-contains-custom-androidlib))
...
*   Asset Pipeline: Fixed so folder case-renaming is properly detected by Perforce on a case-sensitive server (Linux). ([1337143](https://issuetracker.unity3d.com/issues/perforce-folder-renaming-with-letter-case-changes-are-not-properly-detected))
...
*   Editor: Fixed mouse move events not properly being recieved by the game view when not in maximize mode. (1381985)
...
*   Input: Fixing keyboard not working on iOS 15. ([1376970](https://issuetracker.unity3d.com/issues/keyboard-input-is-not-working-when-using-an-external-keyboard-in-ios-15))
    
*   Input System: Fixed alignment and overrun issues with input event buffering. (1383365)
...
*   Scripting: Fixed crash in AssemblyUpdater when the Unity path contains spaces. ([1393230](https://issuetracker.unity3d.com/issues/analytics-library-package-throws-errors-when-there-are-spaces-in-the-unity-editor-path))
...
*   UI Toolkit: Fixed the SVG 9-slice visual artefact. ([1354273](https://issuetracker.unity3d.com/issues/ui-toolkit-9-slice-scaling-is-wrong-on-vector-images))
...
*   Universal Windows Platform: Fixed SystemInfo.operatingSystem returning wrong Windows version on some versions of Windows. ([1400786](https://issuetracker.unity3d.com/issues/uwp-os-version-detection-is-wrong-on-some-windows-versions))
    
*   Universal Windows Platform: Fixed the Application.identifier so it returns the identity name specified in the application manifest. ([1399538](https://issuetracker.unity3d.com/issues/unityengine-dot-application-dot-identifier-returns-an-empty-string-when-called-in-uwp-build))
...
#### Preview of Final 2022.2.0a9 Package changes
