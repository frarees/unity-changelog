...
*   Asset - Importers: Empty "StreamingAssets" folder gets created after building an empty project ([1423325](https://issuetracker.unity3d.com/issues/empty-streamingassets-folder-gets-created-after-building-an-empty-project))
...
*   Editor: Fixed Alt+Mouse2 not invoking Pan shortcut in SceneView (1423361)  
    _First seen in 2022.2.0a12._  
    _Fixed in 2022.2.0a13._
    
*   Editor: Fixed not being able to invoke the context menu in GameView (1423359)  
...
*   IL2CPP: \[Mobile\] Build fails when using custom script and target architecture ARM64 is selected ([1420369](https://issuetracker.unity3d.com/issues/mobile-il2cpp-build-fails-when-using-custom-script-and-target-architecture-arm64-is-selected))
...
*   Scene Management: Arrow keys in the Hierarchy window and shortcuts that uses "Shift + Command" are not registered when using Unity 2022.2.0a12 ([1424057](https://issuetracker.unity3d.com/issues/command-plus-shift-plus-z-redo-action-shortcut-doesnt-work-when-using-unity-2022-dot-2-0a12))
    
*   Scene Management: Editor crashes after redoing root GameObject deletion ([1423738](https://issuetracker.unity3d.com/issues/editor-crashes-after-redoing-root-gameobject-deletion))
...
*   Scripting: API updater fails to update all instances of obsolete types after package import ([1423317](https://issuetracker.unity3d.com/issues/api-updater-fails-to-update-all-instances-of-obsolete-types-after-package-import))
    
*   Scripting: Fix issues with isOverridable no longer was working (1423498)  
...
*   Scripting: Wrong Scriptable Objects are created when creating through MenuItem ([1423028](https://issuetracker.unity3d.com/issues/wrong-scriptable-objects-are-created-when-creating-through-menuitem))
...
*   UI Toolkit: Inspector bindings no longer try to access invalid properties. ([1377648](https://issuetracker.unity3d.com/issues/serializedproperty-m-converterstates-console-error-appears-when-trying-to-convert-project-from-built-in-to-urp))  
    _Fixed in 2022.2.0a13._
...
*   Web Platform: WebGL build crashes every time when using Unity Editor on Linux ([1411380](https://issuetracker.unity3d.com/issues/linux-webgl-build-crashes-every-time-when-using-unity-editor-on-linux))
...
### New 2022.2.0a12 Entries since 2022.2.0a11

#### Features

*   Package: Updated recorder to 4.0.0-pre.4.
...
*   Android: Fixed a bug with Unity UGUI and UI Elements input fields, so that switching languages dynamically and IME functionality works. ([1395812](https://issuetracker.unity3d.com/issues/android-bluetooth-keyboard-can-only-type-in-english-when-keyboard-language-is-changed-to-any-other-language))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   DX12: Disabled offset binding support for cbuffers from SystemInfo on DX12 as it has never been supported, full implementation is upcoming. ([1381731](https://issuetracker.unity3d.com/issues/painting-terrain-details-result-in-a-crash-when-using-directx12))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Editor: Fixed the Apply context menu to only show applicable options. ([1416383](https://issuetracker.unity3d.com/issues/inconsistent-state-of-menu-items-related-to-prefab-instance))  
    _First seen in 2022.2.0a10._
    
*   Editor: Fixed the default label width in material inspectors. ([1405121](https://issuetracker.unity3d.com/issues/property-fields-have-become-narrower-when-using-materialeditor-dot-setdefaultguiwidths))
    
*   Editor: Fixed width problem for longer text in Prefab override window. (1418475)  
    _First seen in 2022.2.0._
...
*   GI: Fixed assert being triggered when calling `Lightmapping.Clear()`. (1404254)  
    _First seen in 2022.2.0._
...
*   Graphics: Fixed mipmap streaming issue that could happen in projects where Quality Setting "Texture Quality" specifies a texture mipmap level of lower resolution that the one set in Quality Setting _Texture Streaming / Max Level Reduction_ . (1410879)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Graphics: Unified the Undo label for Rendering Debugger fields. ([1416291](https://issuetracker.unity3d.com/issues/hdrp-sliders-and-draggable-edit-fields-in-rendering-debugger-incorrectly-create-undo-actions))  
    _First seen in 2022.2.0a10._
...
*   HDRP: Fixed an issue so you can build and run a HDRP Project for the first time without an error. ([1417508](https://issuetracker.unity3d.com/issues/hdrp-editor-crashes-when-building-project-using-build-and-run-for-the-second-time))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   HDRP: Fixed errors when cancelling an APV bake and trigger a bake right after. (1411670)  
...
*   Physics: Fixed an crash in the Cloth component due to incorrect offsetting during degenerate triangle removal. ([1418139](https://issuetracker.unity3d.com/issues/crash-related-to-prefabs-when-doing-reimport-all-of-this-project))  
...
*   Prefabs: Fixed so overrides with propertyPaths such as `m_Materials.Array.data[1]` are detected as unused overrides if their index is found to overshoot the current size of their parent array. ([1409785](https://issuetracker.unity3d.com/issues/adding-an-item-to-reorderable-list-produces-unused-override-for-prefab-instance))  
    _First seen in 2022.2.0a8._
    
*   Prefabs: Fixed so the connection with assets in the StreamingAssets folder isn't made. ([1392968](https://issuetracker.unity3d.com/issues/saving-prefabs-into-streamingassets-should-be-prevented))  
...
*   Search: Fixed a failure when you load a search index concurrently. ([1417609](https://issuetracker.unity3d.com/issues/search-fail-to-load-the-search-index-concurrently))
...
*   Search: Fixed so the Advanced Object Picker does not persist settings in context menu. ([1417074](https://issuetracker.unity3d.com/issues/advanced-object-picker-does-not-persist-settings-in-context-menu))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   UI: Fixed an issue where Drag & Drop in the canvas fails often. (1415819)  
    _First seen in 2022.2.0a9._
    
*   UI: Fixed selector duplication on file save. (1403724)  
...
*   UI Toolkit: Fixed AssetDatabase.Refresh error when saving uss file in UI Builder. (1419557)  
    _First seen in 2022.2.0a11._
    
*   UI Toolkit: Fixed disabled ObjectFields reacting to drag and drop as if they were not disabled. (1410558)
    
*   UI Toolkit: Fixed listView array size field. ([1413090](https://issuetracker.unity3d.com/issues/array-property-names-are-not-shown-for-script-components-in-inspector-and-rendered-differently-from-regular-components))  
    _First seen in 2022.2.0a9._
...
#### New 2022.2.0a12 Package Changes since 2022.2.0a11
...
### Preview of Final 2022.2.0a12 Release Notes
...
*   IL2CPP: Added support for marshaling of blittable generic instances in delegates and P/Invokes. (1411841)
...
#### Preview of Final 2022.2.0a12 Package changes

#### Packages updated

*   com.unity.2d.animation: [8.0.0-pre.3](https://docs.unity3d.com/Packages/com.unity.2d.animation@8.0//changelog/CHANGELOG.html) → [8.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@8.0//changelog/CHANGELOG.html)
