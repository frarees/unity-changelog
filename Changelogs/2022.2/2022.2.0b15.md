...
*   Editor: Re-introduce the recompile-after-finished-playing option ([UUM-16168](https://issuetracker.unity3d.com/issues/recompile-after-finish-playmode-option-is-gone))  
    _Fixed in 2022.2.0b16._
    
*   Editor: This reimplements the original fix for case 1393058 ([UUM-9278](https://issuetracker.unity3d.com/issues/additional-gameobjects-and-a-console-error-after-undoing-and-redoing-a-paste-as-child))  
...
*   Scripting: Editor now able to recognise script when it contains classes that share the same name, one templated and the other not templated (UUM-14041)  
...
*   Universal RP: Material is not rendered when changing the Rendering Path from "Forward" to "Deferred" ([UUM-18063](https://issuetracker.unity3d.com/issues/material-is-not-rendered-when-changing-the-rendering-path-from-forward-to-deferred))
...
### New 2022.2.0b15 Entries since 2022.2.0b14
...
*   Editor: Ensure that when switching mode we keep the current view size unless the mode file ask for it explicitly. ([UUM-16428](https://issuetracker.unity3d.com/issues/editor-window-is-resized-when-switching-between-editor-modes))  
    _First seen in 2022.2.0b9._
...
*   Editor: Fixed cloud layer so it now matches with ambient lighting. ([UUM-16954](https://issuetracker.unity3d.com/issues/hdrp-cloud-layer-doesnt-match-with-ambient-lighting))  
...
*   Graphics: Fixed shader compilation in Metal when using LOAD\_TEXTURE2D\_LOD() to read from a depth texture. (UUM-3144)  
    _First seen in 2022.2.0a13._
    
*   HDRP: Fixed migration of diffusion profiles on read only packages. (UUM-14818)  
    _First seen in 2022.2.0b8._
    
*   IMGUI: Fixed various issues with Canvas. ([UUM-12998](https://issuetracker.unity3d.com/issues/sendmessage-cannot-be-called-during-awake-warning-appears-when-entering-play-mode-if-having-canvas-nested-in-canvas-and-the-enter-play-mode-options-enabled))  
    _First seen in 2022.2.0b5._
...
*   Web: Allowed "Name Files As Hashes" option for WebGL Development builds. ([UUM-1133](https://issuetracker.unity3d.com/issues/name-files-as-hashes-doesnt-work-when-building-a-development-build-player-on-the-webgl-platform))  
    _First seen in 2023.1.0a6._
    
*   Web: Use glGetBufferSubData in AsyncGPUReadback Request for WebGL builds. ([UUM-7112](https://issuetracker.unity3d.com/issues/webgl-runtime-error-appeared-when-asyncgpureadback-dot-request-dot-dot-dot-is-called))  
    _First seen in 2022.2.0b1._
...
*   WebGL: Fixed an issue where WebGL would run in low power mode in some browsers. ([UUM-7962](https://issuetracker.unity3d.com/issues/webgl-context-powerpreference-should-default-to-high-performance))  
...
*   com.unity.2d.animation: [9.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@9.0//changelog/CHANGELOG.html) → [9.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@9.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.common: [8.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@8.0//changelog/CHANGELOG.html) → [8.0.1](https://docs.unity3d.com/Packages/com.unity.2d.common@8.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.psdimporter: [8.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@8.0//changelog/CHANGELOG.html) → [8.0.1](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@8.0//changelog/CHANGELOG.html)
    
*   com.unity.2d.spriteshape: [9.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@9.0//changelog/CHANGELOG.html) → [9.0.1](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@9.0//changelog/CHANGELOG.html)
    
*   com.unity.cinemachine: [2.9.0-pre.6](https://docs.unity3d.com/Packages/com.unity.cinemachine@2.9//changelog/CHANGELOG.html) → [2.9.2](https://docs.unity3d.com/Packages/com.unity.cinemachine@2.9//changelog/CHANGELOG.html)
...
*   com.unity.services.economy: [2.0.2](https://docs.unity3d.com/Packages/com.unity.services.economy@2.0//changelog/CHANGELOG.html) → [3.0.0](https://docs.unity3d.com/Packages/com.unity.services.economy@3.0//changelog/CHANGELOG.html)
    
*   com.unity.splines: [2.0.0](https://docs.unity3d.com/Packages/com.unity.splines@2.0//changelog/CHANGELOG.html) → [2.1.0](https://docs.unity3d.com/Packages/com.unity.splines@2.1//changelog/CHANGELOG.html)
...
*   com.unity.ai.navigation: [1.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.ai.navigation@1.1//changelog/CHANGELOG.html) → [1.1.1](https://docs.unity3d.com/Packages/com.unity.ai.navigation@1.1//changelog/CHANGELOG.html)
...
### Preview of Final 2022.2.0b15 Release Notes
