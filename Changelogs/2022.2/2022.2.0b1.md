...
*   UI Toolkit Controls: \[Inspector\] Cannot drag-and-drop to populate an array that is a Public Variable ([UUM-7948](https://issuetracker.unity3d.com/issues/inspector-cannot-drag-and-drop-to-populate-an-array-that-is-a-public-variable))
...
### New 2022.2.0b1 Entries since 2022.2.0a18
...
*   2D: Fix case where Sprite Atlas shows only first page in Preview within Inspector (UUM-7855)  
    _First seen in 2022.2.0a14._
    
*   Android: Fix Patch (/And Run) failing on some Android 12 devices with "Permission Denied" or "No such file or directory" (UUM-2445)  
    _First seen in 2022.2.0a16._
    
*   Android: Fix regression where TouchScreenKeyboard.Open() was not opening ([UUM-2112](https://issuetracker.unity3d.com/issues/tmp-android-keyboard-doesnt-show-up-when-touchscreenkeyboard-dot-open-function-is-called-on-an-android-device))
...
*   Burst: Fix some ARM branch instructions not being processed as such.
...
*   Graphics: Fix sync readback in batch mode when using Vulkan ([UUM-4594](https://issuetracker.unity3d.com/issues/game-view-appears-corrupted-when-running-tests-in-batch-mode))  
...
*   IL2CPP: Fix for a crash bug. (UUM-4708)  
    _First seen in 2022.2.0a12._
...
*   Prefabs: Fixed UI error when using graphics volume context menu (UUM-3911)  
    _First seen in 2022.2.0a16._
...
*   Scripting: Changes to rulesetfile not triggering compilation ([UUM-3560](https://issuetracker.unity3d.com/issues/roslyn-analyzers-analysis-is-not-performed-when-a-ruleset-file-is-modified))  
...
*   UI Toolkit: \[Properties\] Fixed an issue where converting from object to UnityEngine.Object could cause a stack overflow. (UUM-5954)  
    _First seen in 2022.2.0a17._
    
*   URP: Fix Light2D upgrading issue with m\_AlphaBlendOnOverlap property ([UUM-1845](https://issuetracker.unity3d.com/issues/light-2d-alpha-blend-on-overlap-setting-does-not-update-when-upgrading-project-to-urp-11))
    
*   URP: Fixed incorrect output when post process is enabled in URP 2D (UUM-5871)  
    _First seen in 2022.2.0a16._
    
*   URP: Fixes vertex color for sprite shapes in URP 2D ([UUM-1921](https://issuetracker.unity3d.com/issues/2d-sprite-shape-urp-spriteshape-alpha-value-of-color-not-working-when-using-urp-and-sprite-lit-default-mat))
...
*   XR: XR: Improve GLES3 multiview rendering performance. (UUM-7008)  
    _First seen in 2022.2.0a17._
    

#### New 2022.2.0b1 Package Changes since 2022.2.0a18
...
### Preview of Final 2022.2.0b1 Release Notes
...
*   Editor: Unity Default layout opens the Unity Editor maximized. (1350212)
...
*   HDRP: Fixed accumulation when shutter interval is zero.  
    ...
    *   Added a mechanism in HDRP to strip `FragInputs`, to strip some interpolators in the pixel shader for shader graphs. ([1399841](https://issuetracker.unity3d.com/issues/hdrp-path-tracing-samples-are-not-captured-with-recorder-when-shutter-interval-is-set-to-0))
...
#### Preview of Final 2022.2.0b1 Package changes
...
*   com.unity.addressables: [1.19.11](https://docs.unity3d.com/Packages/com.unity.addressables@1.19//changelog/CHANGELOG.html) → [1.20.3](https://docs.unity3d.com/Packages/com.unity.addressables@1.20//changelog/CHANGELOG.html)
...
*   com.unity.ide.rider: [3.0.7](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html) → [3.0.15](https://docs.unity3d.com/Packages/com.unity.ide.rider@3.0//changelog/CHANGELOG.html)
...
*   com.unity.purchasing: [4.1.1](https://docs.unity3d.com/Packages/com.unity.purchasing@4.1//changelog/CHANGELOG.html) → [4.2.1](https://docs.unity3d.com/Packages/com.unity.purchasing@4.2//changelog/CHANGELOG.html)
...
*   com.unity.remote-config: [2.1.2](https://docs.unity3d.com/Packages/com.unity.remote-config@2.1//changelog/CHANGELOG.html) → [3.1.3](https://docs.unity3d.com/Packages/com.unity.remote-config@3.1//changelog/CHANGELOG.html)
...
*   com.unity.scriptablebuildpipeline: [1.19.3](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.19//changelog/CHANGELOG.html) → [1.20.2](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.20//changelog/CHANGELOG.html)
...
*   com.unity.services.core: [1.0.1](https://docs.unity3d.com/Packages/com.unity.services.core@1.0//changelog/CHANGELOG.html) → [1.4.2](https://docs.unity3d.com/Packages/com.unity.services.core@1.4//changelog/CHANGELOG.html)
...
*   com.unity.xr.oculus: [1.11.0](https://docs.unity3d.com/Packages/com.unity.xr.oculus@1.11//changelog/CHANGELOG.html) → [3.0.2](https://docs.unity3d.com/Packages/com.unity.xr.oculus@3.0//changelog/CHANGELOG.html)
...
*   [com.unity.services.authentication@2.1.1](https://docs.unity3d.com/Packages/com.unity.services.authentication@2.1//changelog/CHANGELOG.html)
...
*   [com.unity.transport@1.1.0](https://docs.unity3d.com/Packages/com.unity.transport@1.1//changelog/CHANGELOG.html)
