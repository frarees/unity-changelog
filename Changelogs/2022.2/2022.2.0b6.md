### Known Issues in 2022.2.0b6

*   2D: Changing values of "Platform Effector 2D" Component fields crashes the Editor when before the "Used By Effector" field value had been changed (UUM-12859)
...
*   Editor: Fixed not being able to summon context menu when SceneView is active ([UUM-6142](https://issuetracker.unity3d.com/issues/right-click-on-a-scene-tab-stops-working-after-resetting-layouts))  
    _First seen in 2022.2.0a17._  
    _Fixed in 2022.2.0b7._
    
*   Graphics: Fix for updated XR Display headers breaking Oculus App Spacewarp (ASW) due to error in back-compat code path (UUM-7369)  
...
*   Scene/Game View: Fix crash in particular cases when trying to render BRG objects selection outline. (UUM-11676)  
    _First seen in 2022.2.0a17._  
    _Fixed in 2022.2.0b7._
...
*   UI Toolkit Framework: NullReferenceException: Object reference not set to an instance of an object errors whenever anything is done in UI Builder ([UUM-11315](https://issuetracker.unity3d.com/issues/nullreferenceexception-object-reference-not-set-to-an-instance-of-an-object-errors-whenever-anything-is-done-in-ui-builder))
    

### New 2022.2.0b6 Entries since 2022.2.0b5
...
*   Scripting: LoadAsync and Instantiate with missing prefabs should no longer cause a deadlock. ([UUM-2374](https://issuetracker.unity3d.com/issues/editor-produces-a-deadlock-when-instantiating-a-prefab-with-missing-scripts-and-loading-other-prefabs-with-resources-dot-loadasync))  
...
#### New 2022.2.0b6 Package Changes since 2022.2.0b5

### Preview of Final 2022.2.0b6 Release Notes
...
#### Preview of Final 2022.2.0b6 Package changes
...
*   com.unity.collab-proxy: [1.15.4](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.15//changelog/CHANGELOG.html) → [1.17.2](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.17//changelog/CHANGELOG.html)
...
*   com.unity.purchasing: [4.1.1](https://docs.unity3d.com/Packages/com.unity.purchasing@4.1//changelog/CHANGELOG.html) → [4.3.0](https://docs.unity3d.com/Packages/com.unity.purchasing@4.3//changelog/CHANGELOG.html)
