...
*   Build Pipeline: \[Android\] Failed to deploy application to device errors is thrown when trying to Patch Pixel devices ([1422895](https://issuetracker.unity3d.com/issues/android-incremental-build-pipeline-failed-to-deploy-application-to-device-errors-is-thrown-when-trying-to-patch-pixel-devices))
    
*   Graphics: "Compiling shader variants" takes too much time when building the project ([1408905](https://issuetracker.unity3d.com/issues/compiling-shader-variants-takes-too-much-time-when-building-the-project))
...
*   Physics: Overlap queries are not consistent when used against convex Mesh Colliders with a very small scale ([1377578](https://issuetracker.unity3d.com/issues/physics-dot-computepenetration-does-not-detect-overlap-consistently-when-using-convex-mesh-colliders))
...
*   Shadows/Lights: Crash in LightProbesManager::GetLightProbesJobDataFromStaged after exiting Play mode with additive scenes baked in auto-mode ([1428411](https://issuetracker.unity3d.com/issues/crash-in-lightprobesmanager-getlightprobesjobdatafromstaged-after-exiting-play-mode-with-additive-scenes-baked-in-auto-mode))
...
*   UI Toolkit: Editor crashes when a GameObject is drag and dropped into a Script field ([1416878](https://issuetracker.unity3d.com/issues/unity-crashes-when-a-gameobject-is-drag-and-dropped-into-script-field))
...
### New 2022.2.0a16 Entries since 2022.2.0a13
...
*   Web: Introduced a new WebGL player setting to display diagnostics information (currently limited to memory usage) in WebGL applications. When this setting is enabled, an icon appears on the build that displays an overlay with Javascript and WASM heap memory diagnostics about the WebGL build.
...
*   Core: Applied safety disabling attributes recursively into marked fields.
...
*   Android: Allowed two segment package names. ([1425979](https://issuetracker.unity3d.com/issues/android-the-build-fails-when-identification-package-name-has-two-segments-one-dot))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Android: Fixed a potential crash on shutdown when using Vulkan on Android. (1423459)
    
*   Android: Fixed build errors on macOS with Armv9 security features and engine code stripping enabled. (1427050)  
...
*   Android: Fixed the app so it doesn't freeze when you change an application into multi-window (split-screen) on Chrome OS tablet mode. (1361131)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Editor: Backed out a change to avoid regressions. ([1388532](https://issuetracker.unity3d.com/issues/core-render-pipeline-argumentexception-cant-save-an-immutable-prefab))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Editor: Fixed an issue where the Editor crashes when you clsoe it via the **Alt+F4** shortcut. ([1425361](https://issuetracker.unity3d.com/issues/editor-crashes-in-guiview-activatechosencursor-when-closing-it-with-alt-f4))  
    _First seen in 2022.2.0a10._
    
*   Editor: Fixed index out of range exceptions when you add to an empty icon list in the Mobile Notifications package. ([1402247](https://issuetracker.unity3d.com/issues/imgui-indexoutofrangeexceptions-thrown-when-trying-to-add-the-first-item-in-empty-icon-list))  
...
*   Editor: Fixed the Composition Direction/Position Blend mode so it doesn't have multiple sliders for Position for the VFX Graph. ([1420092](https://issuetracker.unity3d.com/issues/vfx-graph-error-is-thrown-when-changing-composition-direction-from-overwrite-to-blend-in-position-mesh-block))  
    _First seen in 2022.2.0._
...
*   Editor: Fixed the package manager _Import by git_ dropdown size to be consistent. ([1394785](https://issuetracker.unity3d.com/issues/linux-packman-options-to-add-package-from-git-url-or-by-name-contains-empty-space-on-the-produced-sub-window))
    
*   Editor: Fixed `CreateAsset` menu item so it executes the correct method. ([1423028](https://issuetracker.unity3d.com/issues/wrong-scriptable-objects-are-created-when-creating-through-menuitem))  
...
*   Graphics: Fixed a Vulkan validation error thrown when you resize Game View due to an out of bound clear region. (1422693)  
    _First seen in 2022.2.0a11._
...
*   Graphics: Fixed fthe particle system so it doesn't flicker when you use Vulkan. (1417289)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Graphics: Fixed the incorrect clear size when you use Load/Store Action debug mode. ([1422676](https://issuetracker.unity3d.com/issues/when-using-load-slash-store-action-debug-mode-with-scaled-resolution-vulkan-validation-layer-errors-are-thrown))  
    _First seen in 2022.2.0a11._
    
*   Graphics: Fixed the Metal shader code generated when `uint` and `float3` outputs are coalesced into one register. (1419450)
    
*   Graphics: Fixed the occasional warning about rendering to discarded RT so it's shown correctly. (1428588)  
    _First seen in 2022.2.0._
...
*   HDRP: Fixed errors when you switch to SMAA. ([1401225](https://issuetracker.unity3d.com/issues/hdrp-switching-to-smaa-throws-errors))  
    _First seen in 2022.2.0a4._
...
*   IL2CPP: Avoided incorrect behavior of the `Array::Set` method when the faster builds IL2CPP code generation option is used. ([1411185](https://issuetracker.unity3d.com/issues/il2cpp-2d-vector3-array-converted-to-2d-vector4-array-has-zeroed-vectors-in-player-whose-code-generation-is-for-faster-runtime))
...
*   IL2CPP: Fixed build failures when you do .NET Framework API builds and referencing types in `System.Drawing`. ([1413051](https://issuetracker.unity3d.com/issues/il2cpp-build-fails-when-using-net-framework-api-compatibility))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   IL2CPP: Fixed potential cash when calling MemberInfo.GetCustomAttributes(Type, bool). (1425605)  
    _First seen in 2022.2.0._
    
*   iOS: Fixed an issue so that MGUI or old Input System events generate when Active Input Handling is set to new Input System. ([1419664](https://issuetracker.unity3d.com/issues/ios-input-is-not-registered-when-using-arfoundation))  
...
*   Linux: Fixed so you can resize the player window when the player is started in full screen mode. ([1372700](https://issuetracker.unity3d.com/issues/linux-player-window-cant-be-resized-when-the-player-is-started-in-fullscreen-mode-and-then-changed-to-windowed))
    
*   Linux: Fixed so your PC can go to sleep even when the editor is open. ([1418023](https://issuetracker.unity3d.com/issues/linux-pc-doesnt-sleep-when-the-editor-is-open))
...
*   macOS: Fixed an issue to clear `drawableProxy` surfaces when recreated to avoid visual corruption due to undefined contents. ([1327755](https://issuetracker.unity3d.com/issues/macos-resizing-build-window-causes-red-background-colour-to-appear))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   macOS: Fixed the Editor so it responds to control keys in MacOS. ([1423917](https://issuetracker.unity3d.com/issues/macos-keyboard-arrows-dont-work-when-navigating-the-editor))  
...
*   Mono: Fixed a random crash on exit or domain reload. ([1418292](https://issuetracker.unity3d.com/issues/editor-crashes-intermittently-on-mono-object-isinst-when-closing-it-in-batch-mode-or-when-building))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Mono: Fixed an issue so `FileSystemEventArgs.FullPath` has the correct path when the `FileWatcher` event is on a file in a subdirectory. ([1397564](https://issuetracker.unity3d.com/issues/filesystemwatcher-returns-bad-file-path))
    
*   Package Manager: Fix Failure in Unity.IntegrationTests.EditorUI.EditorCrashOnBroadcastMessageAny.Crash (1428882)
...
*   Physics 2D: Fixed an issue in the `CustomCollider2D` so shapes bounds update when you replace existing shapes with different vertices only. ([1425289](https://issuetracker.unity3d.com/issues/customcollidier2d-does-not-update-properly-after-call-to-setcustomshape-s))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Prefabs: Fixed an editor crash when you redo root GameObject deletion. ([1423738](https://issuetracker.unity3d.com/issues/editor-crashes-after-redoing-root-gameobject-deletion))  
    _First seen in 2022.2.0a11._
...
*   Profiler: Fixed memory usage on Linux memory reported. (1383173)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Profiler: Fixed the deadlock in Memory Profiler gfx resources tracking code when you enable the profiler. (1424623)
    
*   Profiler: Fixed untracked memory allocated via `AsyncUploadManager` when you browse **Addressables**. ([1410384](https://issuetracker.unity3d.com/issues/allocated-memory-block-with-no-root-area-cannot-be-tracked-when-loading-asset-bundles))
...
*   Scripting: Fixed the type of generic fields inside generic classes so they resolve when you build the project. (1415422)  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Shaders: Fixed a crash when you warm up a shader variant collection that had a shader with `UsePass`. ([1407692](https://issuetracker.unity3d.com/issues/crash-on-shaderlab-program-getmatchingsubprogram-after-entering-play-mode))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Shaders: Fixed include dependencies so they're reported correctly when guarded by defines that depend on keywords. ([1401580](https://issuetracker.unity3d.com/issues/editing-shader-includes-does-not-guarantee-shaders-being-updated-when-changes-are-made-in-script))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   Shaders: Fixed `ShaderKeywordSet.Disable` so it disables keywords. ([1417644](https://issuetracker.unity3d.com/issues/shader-keyword-is-not-disabled-when-calling-shaderkeywordset-dot-disable))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
*   UI Toolkit: Fixed a `Painter2D.Arc()` rendering error when the curve inflexion is very small. (1421790)  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   UI Toolkit: Fixed align items and align self icons in canvas for the UI builder. (1423922)  
    _First seen in 2022.2.0a12._
...
*   UI Toolkit: Fixed the slider property so it's not inverted after you save uxml in UI Builder. ([1421223](https://issuetracker.unity3d.com/issues/changes-done-on-gradients-with-gradientusage-attribute-arent-saved-when-unfocusing-the-corresponding-gameobject))  
...
*   WebGL: Fixed the WebGL build in the Linux editor so it includes default resources. ([1411380](https://issuetracker.unity3d.com/issues/linux-webgl-build-crashes-every-time-when-using-unity-editor-on-linux))  
    _This has already been backported to older releases and will not be mentioned in final notes._
...
#### New 2022.2.0a16 Package Changes since 2022.2.0a13
...
*   com.unity.collab-proxy: [1.15.16](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.15//changelog/CHANGELOG.html) → [1.15.18](https://docs.unity3d.com/Packages/com.unity.collab-proxy@1.15//changelog/CHANGELOG.html)
    
*   com.unity.live-capture: [2.0.1](https://docs.unity3d.com/Packages/com.unity.live-capture@2.0//changelog/CHANGELOG.html) → [3.0.0-pre.5](https://docs.unity3d.com/Packages/com.unity.live-capture@3.0//changelog/CHANGELOG.html)
    
*   com.unity.localization: [1.2.1](https://docs.unity3d.com/Packages/com.unity.localization@1.2//changelog/CHANGELOG.html) → [1.3.1](https://docs.unity3d.com/Packages/com.unity.localization@1.3//changelog/CHANGELOG.html)
...
*   com.unity.render-pipelines.core: [14.0.2](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@14.0//changelog/CHANGELOG.html) → [14.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.core@14.0//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition: [14.0.2](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@14.0//changelog/CHANGELOG.html) → [14.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@14.0//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.high-definition-config: [14.0.2](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@14.0//changelog/CHANGELOG.html) → [14.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition-config@14.0//changelog/CHANGELOG.html)
    
*   com.unity.render-pipelines.universal: [14.0.2](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@14.0//changelog/CHANGELOG.html) → [14.0.3](https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@14.0//changelog/CHANGELOG.html)
...
*   com.unity.shadergraph: [14.0.2](https://docs.unity3d.com/Packages/com.unity.shadergraph@14.0//changelog/CHANGELOG.html) → [14.0.3](https://docs.unity3d.com/Packages/com.unity.shadergraph@14.0//changelog/CHANGELOG.html)
    
*   com.unity.splines: [1.0.1](https://docs.unity3d.com/Packages/com.unity.splines@1.0//changelog/CHANGELOG.html) → [2.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.splines@2.0//changelog/CHANGELOG.html)
    
*   com.unity.visualeffectgraph: [14.0.2](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@14.0//changelog/CHANGELOG.html) → [14.0.3](https://docs.unity3d.com/Packages/com.unity.visualeffectgraph@14.0//changelog/CHANGELOG.html)
...
*   com.unity.xr.core-utils: [2.0.0](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.0//changelog/CHANGELOG.html) → [2.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.1//changelog/CHANGELOG.html)
    
*   com.unity.xr.interaction.toolkit: [2.0.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.0//changelog/CHANGELOG.html) → [2.1.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@2.1//changelog/CHANGELOG.html)
...
*   com.unity.sequences: [2.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.sequences@2.0//changelog/CHANGELOG.html) → [2.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.sequences@2.0//changelog/CHANGELOG.html)
...
*   [com.unity.burst@1.8.0-pre.1](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html)
...
### Preview of Final 2022.2.0a16 Release Notes
...
*   Physics: Made the values in the _Info_ tab of the Physics Debugger copyable.
...
*   Asset Pipeline: Refactored the load asset management sub-system to fix a scalability issue that was causing import time to increase when a large scene with many objects was loaded. ([1371439](https://issuetracker.unity3d.com/issues/performance-possible-preformance-regression-between-2021-dot-1-and-2021-dot-2), 1410544)
...
*   Editor: Blocked the instantiation of variants witha broken or missing prefab parent. ([1395769](https://issuetracker.unity3d.com/issues/prefab-copies-are-generated-every-frame-and-exceptions-are-thrown-when-its-dragged-into-the-scene-view))
...
*   GI: Fixed so the Editor-only shader variant with EDITOR\_VISUALIZATION keyword enabled is stripped when building the player. (1342117)
...
*   IL2CPP: Fixed an issue where assemblies that have an instance method and a static method with the same name, parameters, and a return type caused the build to fail. ([1411168](https://issuetracker.unity3d.com/issues/build-fails-with-error-unity-dot-il2cpp-dot-hashcodecollisionexception-when-opc-dot-uafx-dot-client-dot-dll-is-included-in-the-project))
...
*   UI Toolkit: Fixed NullReferenceException when hovering with any Object over the Object Field. ([1407422](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-when-dragging-and-hovering-anything-over-object-field-in-the-ui-toolkit-samples-window))
...
*   UI Toolkit: Made the layout engine consider the max-width property on an element with an absolute position and a measure method. ([1379062](https://issuetracker.unity3d.com/issues/the-height-of-the-label-isnt-the-same-size-as-content-of-the-label-when-using-max-width))
...
*   UI Toolkit: Optimized layout computation with absolute positioned elements. ([1401339](https://issuetracker.unity3d.com/issues/ui-toolkit-update-layout-cpu-usage-is-huge-even-when-only-one-element-is-changed))
...
*   VFX Graph: The VFX asset preview is not animated by default anymore to save CPU usage. ([1367447](https://issuetracker.unity3d.com/issues/editor-has-unstable-fps-when-vfx-graph-is-open))
...
#### Preview of Final 2022.2.0a16 Package changes
...
*   com.unity.burst: [1.6.0](https://docs.unity3d.com/Packages/com.unity.burst@1.6//changelog/CHANGELOG.html) → [1.7.1](https://docs.unity3d.com/Packages/com.unity.burst@1.7//changelog/CHANGELOG.html)
...
*   com.unity.recorder: [3.0.3](https://docs.unity3d.com/Packages/com.unity.recorder@3.0//changelog/CHANGELOG.html) → [4.0.0-pre.4](https://docs.unity3d.com/Packages/com.unity.recorder@4.0//changelog/CHANGELOG.html)
...
*   com.unity.services.core: [1.0.1](https://docs.unity3d.com/Packages/com.unity.services.core@1.0//changelog/CHANGELOG.html) → [1.4.0](https://docs.unity3d.com/Packages/com.unity.services.core@1.4//changelog/CHANGELOG.html)
...
*   com.unity.xr.arcore: [4.2.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@4.2//changelog/CHANGELOG.html) → [4.2.3](https://docs.unity3d.com/Packages/com.unity.xr.arcore@4.2//changelog/CHANGELOG.html)
    
*   com.unity.xr.arfoundation: [4.2.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@4.2//changelog/CHANGELOG.html) → [4.2.3](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@4.2//changelog/CHANGELOG.html)
    
*   com.unity.xr.arkit: [4.2.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@4.2//changelog/CHANGELOG.html) → [4.2.3](https://docs.unity3d.com/Packages/com.unity.xr.arkit@4.2//changelog/CHANGELOG.html)
    
*   com.unity.xr.arkit-face-tracking: [4.2.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit-face-tracking@4.2//changelog/CHANGELOG.html) → [4.2.3](https://docs.unity3d.com/Packages/com.unity.xr.arkit-face-tracking@4.2//changelog/CHANGELOG.html)
    
*   com.unity.xr.arsubsystems: [4.2.1](https://docs.unity3d.com/Packages/com.unity.xr.arsubsystems@4.2//changelog/CHANGELOG.html) → [4.2.3](https://docs.unity3d.com/Packages/com.unity.xr.arsubsystems@4.2//changelog/CHANGELOG.html)
...
*   [com.unity.services.ccd.management@2.0.4](https://docs.unity3d.com/Packages/com.unity.services.ccd.management@2.0//changelog/CHANGELOG.html)
