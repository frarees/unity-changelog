...
### New 2022.2.0b13 Entries since 2022.2.0b12
...
*   Editor: Changing the Name of a Renderer Feature in a URP renderer setting does not throw errors anymore. ([UUM-10175](https://issuetracker.unity3d.com/issues/urp-changing-the-name-field-of-a-renderer-feature-causes-argumentnullexception-to-be-thrown))  
...
*   Editor: Fixed Camera.stereoEnabled when SRP is used and fixed the Camera.stereoSeparation value. ([UUM-13940](https://issuetracker.unity3d.com/issues/openxr-camera-dot-stereoenabled-outputs-false-as-long-as-srp-is-enabled))  
    _First seen in 2022.2.0b6._
...
*   Scene/Game View: Fix for set as first/last sibling menu items not working for prefab instances. ([UUM-16193](https://issuetracker.unity3d.com/issues/set-as-first-slash-last-sibling-is-not-working-when-using-menu-bar))  
    _First seen in 2022.2.0b8._
    
*   Scene/Game View: Fixed the ScaleHandle not dimming the uniform scale handle when disabled. ([UUM-15752](https://issuetracker.unity3d.com/issues/transform-tools-constrained-scale-gizmo-does-not-change-opacity-despite-being-disabled-in-prefab-mode))  
...
*   Universal RP: Fixed missing Depth Copy texture in Scene view. ([UUM-16000](https://issuetracker.unity3d.com/issues/camera-depth-texture-missing-in-the-scene-view-when-the-rendering-path-is-set-to-deferred-in-the-urp-settings))  
    _First seen in 2022.2.0b9._
...
*   com.unity.addressables: [1.20.5](https://docs.unity3d.com/Packages/com.unity.addressables@1.20//changelog/CHANGELOG.html) → [1.21.1](https://docs.unity3d.com/Packages/com.unity.addressables@1.21//changelog/CHANGELOG.html)
...
*   com.unity.scriptablebuildpipeline: [1.20.2](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.20//changelog/CHANGELOG.html) → [1.21.0](https://docs.unity3d.com/Packages/com.unity.scriptablebuildpipeline@1.21//changelog/CHANGELOG.html)
...
### Preview of Final 2022.2.0b13 Release Notes
...
#### Preview of Final 2022.2.0b13 Package changes
...
*   com.unity.inputsystem: [1.2.0](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.2//changelog/CHANGELOG.html) → [1.4.3](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.4//changelog/CHANGELOG.html)
...
*   com.unity.splines: [1.0.0-pre.5](https://docs.unity3d.com/Packages/com.unity.splines@1.0//changelog/CHANGELOG.html) → [2.0.0](https://docs.unity3d.com/Packages/com.unity.splines@2.0//changelog/CHANGELOG.html)
