...
*   Android/IL2CPP: Fixed issue whereby Android/IL2CPP builds on Windows would fail, due to an incorrect path to the C++ compiler in the NDK directory. [(830617)](https://issuetracker.unity3d.com/issues/exception-il2cpp-compilation-failed-when-building-a-project-for-android-platform)
*   Animation: Fixed ArgumentNullException in Animation Window when drag&dropping sprites. [(829544)](https://issuetracker.unity3d.com/issues/animationwindow-argumentnullexception-in-curves-tab)
*   Canvas: Fixed regression where non-native fullscreen player appeared darker when Canvas was present, in Linear color space. [(834100, 833996)](https://issuetracker.unity3d.com/issues/dx11-linear-canvas-view-is-darker-when-build-is-running-in-non-native-fullscreen-and-canvas-are-present-in-the-scene)
*   Graphics: Fixed an issue that caused duplicate GUI elements to appear in the Texture Importer upon domain reload. [(831314)](https://issuetracker.unity3d.com/issues/texture-importer-inspector-some-settings-get-duplicated-after-scripts-recompile)
...
*   UI: Fixed regression where GUI.DrawTexture & GUI.DrawTextureWithTexCoords appeared lighter in Linear color space. [(832155)](https://issuetracker.unity3d.com/issues/buttons-in-backgrounds-appear-darker-than-gui-dot-drawtexture-on-linear-mode-rendering)
*   Windows: Fixed case of Unity crashing when initializing UnityEngine.Windows.Speech.KeywordRecognizer with an array that contains a null string as one of its items. [(833091)](https://issuetracker.unity3d.com/issues/unity-crashes-on-initializing-speech-recognition)

* * *

5.5.0b6 Release Notes (Full)
----------------------------
...
*   Scripting: Fixed crash involving construction of a generic Dictionary via reflection. [(829757)](https://issuetracker.unity3d.com/issues/crash-in-mono-class-init-using-reflection-to-get-an-item-from-a-dictionary-with-string-as-key-and-another-collection-as-a-value)
