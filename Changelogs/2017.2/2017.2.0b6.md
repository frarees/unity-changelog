...
*   OSX: Fixed crash seen when WebCamTexture is used. [(917133)](https://issuetracker.unity3d.com/issues/os-x-checkdisalowallocation-allocating-memory-when-it-is-not-allowed-to-allocate-memory)
