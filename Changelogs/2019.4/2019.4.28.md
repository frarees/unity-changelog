...
-   Windows: Fixed an issue whereby X86_64 is now the default Windows architecture. ([1283651](https://issuetracker.unity3d.com/issues/default-architecture-in-build-settings-is-x86-instead-of-x64))
