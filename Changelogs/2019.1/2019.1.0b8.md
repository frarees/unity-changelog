...
*   GI: Fixed crash when using experimental custom bake API. ([1127812](https://issuetracker.unity3d.com/issues/unity-editor-crashes-when-trying-to-bake-light-using-custom-bake-api), 1136107)
