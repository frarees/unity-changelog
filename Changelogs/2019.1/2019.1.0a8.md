...
*   Graphics: Made the Wind Module optional for Particles and Terrains, so they don't get disabled if wind is disabled. ([1085664](https://issuetracker.unity3d.com/issues/particles-removing-the-wind-module-disables-particles))
...
*   Android: Fixed instancing not working in some situations on Adreno GPUs ([1053324](https://issuetracker.unity3d.com/issues/lwrp-android-model-materials-disappear-but-the-shadows-remain-on-adreno-630-gpu))
...
*   Graphics: Fixed memory leak when using both custom render properties and changed material keywords ([1090901](https://issuetracker.unity3d.com/issues/memory-leak-when-using-setpropertyblock-and-enablekeyword-in-onrenderobject))
...
*   Linux: Fixed player defaulting to a 1x1 resolution rather than using the default native resolution ([1091258](https://issuetracker.unity3d.com/issues/linux-player-if-screen-selector-is-disabled-slash-doesnt-run-and-default-is-fullscreen-windowed-it-defaults-to-1x1-resolution))
