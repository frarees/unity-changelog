### Known Issues in 2019.1.0b9 under investigation
...
*   Editor: Fixed issue where the editor windows go blank under certain circumstances with D3D11 ([1111604](https://issuetracker.unity3d.com/issues/editor-goes-blank-when-setting-cameras-clear-flags-to-depth-only-or-dont-clear), 1136273)
...
*   Timeline: Inspector Add Key & Undo in Timeline Curves un-selects & collapses curve properties ([1125443](https://issuetracker.unity3d.com/issues/inspector-add-key-and-undo-in-timeline-curves-un-selects-and-collapses-curve-properties), 1133955)
...
*   Particles: Fixed Editor crash on adding item to a Particle System's External Forces list ([1126275](https://issuetracker.unity3d.com/issues/editor-crashes-on-adding-item-to-a-particle-systems-external-forces-list), 1127016)
...
*   Particles: Particle trails could be culled incorrectly when using the World Space trails option. ([1089679](https://issuetracker.unity3d.com/issues/particle-system-trails-are-culled-while-still-within-camera-bounds), 1116283)
...
*   Scripting: Improved performance when calling GameObject.AddComponent for a nested MonoBehaviour class inside a namespace ([1085304](https://issuetracker.unity3d.com/issues/gameobject-dot-addcomponent-performance-severely-degrades-in-execution-time-with-each-call-when-the-call-is-inside-a-namespace), 1118040)
    
*   Scripting: Remove allocation in every frame from ScriptableRuntimeReflectionSystemWrapper.TickRealtimeProbes ([1097039](https://issuetracker.unity3d.com/issues/scriptableruntimereflection-allocates-17-bytes-of-gc-per-frame), 1126219)
...
*   Timeline: Fixed a crash on IL2CPP platforms when the VideoPlayer component is not used. (1129572, 1133959)
...
*   UI: Fixing API inconsistency with no support of uv2 and uv3 inside the VertexHelper class ([1117237](https://issuetracker.unity3d.com/issues/helper-methods-in-vertexhelper-are-not-updated-to-accept-uv2-and-uv3), 1134457)
...
Revision: f1481f10a935  
Generated: 2019-03-26 17:36