### Known Issues in 2019.1.0b6 under investigation
...
### New 2019.1.0b6 Entries since 2019.1.0b5
...
*   Android: Fix null exception on GC when Java class is not found. ([1120132](https://issuetracker.unity3d.com/issues/android-calling-androidjavaclass-for-a-non-existent-class-causes-a-crash-in-player-when-cloud-diagnostics-is-enabled), 1128658)
...
*   Asset Import: Fixed local fileID upgrade of FBX files that were not upgraded correctly between 2019.1.0a3 and 2019.1.0a8 releases. ([1124003](https://issuetracker.unity3d.com/issues/prefab-skinnedmeshrenderer-components-mesh-references-are-missing-after-upgrading-the-project), 1129471)
...
*   Editor: Fixed crash where building while having some hidden objects would crash ([1122807](https://issuetracker.unity3d.com/issues/editor-crashes-with-transform-gettransformaccess-after-building-scene-with-disabled-visibility-objects-in-hierarchy), 1128621)
    
*   Editor: Fixed generic menu issue related to incorrect grouping of child menu item's when parent menu item contains space(" ") as its last character. ([1116792](https://issuetracker.unity3d.com/issues/guicontent-items-in-genericmenu-containing-spaces-before-the-slash-symbol-are-not-grouped-correctly))
    
*   Editor: Fixed hidden object count not refreshing properly when deleting hidden GameObjects ([1102437](https://issuetracker.unity3d.com/issues/deleting-a-gameobject-hidden-via-hierarchy-wont-update-visibility-window-in-the-scene-view), [1104749](https://issuetracker.unity3d.com/issues/editor-hidden-objects-count-doesnt-update-in-scene-view-on-deleting-a-hidden-gameobject-in-hierarchy), 1123905, 1123910)
    
*   Editor: Fixed Hierarchy view hover issues (1131031)
    
*   Editor: Fixed Isolate shortcut not toggling Isolation (1127373)
    
*   Editor: Fixed issue related to label control not showing full script file names in search execution Order editor. ([1122059](https://issuetracker.unity3d.com/issues/script-execution-order-dialog-doesnt-show-complete-class-names-for-long-class-names), 1129942)
    
*   Editor: Fixed the issue with the order of items in the Edit Menu on OSX. ([1110914](https://issuetracker.unity3d.com/issues/macos-undo-and-redo-arent-the-first-two-items-delete-is-not-in-right-section-in-the-edit-menu))
    
*   Editor: Logging Setting layout breaks on shrinking the window ([1113248](https://issuetracker.unity3d.com/issues/player-settings-logging-setting-layout-breaks-on-shrinking-the-window), 1131479)
...
*   GI: Fixes missing bounce off transmissive surfaces ([1061354](https://issuetracker.unity3d.com/issues/plm-color-from-the-transmissive-shadow-is-not-rendered), 1126302)
...
*   Graphics: Fixed Set rendertarget before setting viewport in GrabIntoRenderTexture. ([1126248](https://issuetracker.unity3d.com/issues/xbox-one-background-with-noise-is-shown-when-there-are-two-cameras-in-the-scene-and-one-of-clear-flags-are-set-to-only-depth))
...
*   Linux: Fixed Mouse position is inconsistent with the Old Input. ([1114148](https://issuetracker.unity3d.com/issues/linux-mouse-editor-mouse-position-is-inconsistent-with-the-old-input), 1126307)
    
*   Package Manager: Fix packages sorting in Package Manager UI ([1130315](https://issuetracker.unity3d.com/issues/package-sorting-is-wrong-for-some-packages), 1130316)
...
*   Prefabs: Fixed an issue where edits in prefab mode might not persist after returning to the scene ([1124967](https://issuetracker.unity3d.com/issues/improved-prefab-nesting-changes-made-in-prefab-mode-are-not-saved-on-switching-back-to-the-main-scene), 1124992)
...
*   UI Elements: Fixed the layout struggling when selecting an object in the window hierarchy ([1106900](https://issuetracker.unity3d.com/issues/layout-update-is-struggling-to-process-current-layout-errors-when-selecting-gameobject-in-hierarchy-window), 1129981)
...
*   WebGL: WebGL: Fix build&run with wasm streaming enabled. ([1104514](https://issuetracker.unity3d.com/issues/wasm-streaming-doesnt-work-using-build-and-run))
    

### Preview of Final 2019.1.0b6 Release Notes
...
Revision: e3cf6cb42b7c  
Generated: 2019-03-08 17:55