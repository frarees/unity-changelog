...
*   Editor: `PostLayoutEvent`s are now only sent when the element size or position changes. (995315)
...
*   2D: Sprite Editor Window: Outline and Physics Shape module changes:
    ...
    *   the TextureImporter Inspector now has an option to enable default Physics Shape for Sprites. ([986540](https://issuetracker.unity3d.com/issues/2d-polygon-collider-bounds-are-not-updating-when-texture-is-changed), 1000215)
...
*   Editor: Fixed assert when removing RectTransform required by a MonoBehaviour. ([995904](https://issuetracker.unity3d.com/issues/scripting-class-is-subclass-of-replacementclass-getmonomanager-dot-typetoscriptingclass-typeof-assert))
...
*   IL2CPP: Corrected a possible build failure with IL2CPP when an attribute constructor has two arguments of type object. ([993422](https://issuetracker.unity3d.com/issues/il2cpp-exe-fails-during-building-because-of-generated-duplicated-fields))
    
*   IL2CPP: Fixed crash in UnityLinker that would occur on OSX if an assembly had native or embedded pdbs. (990003)
    
*   IL2CPP: Improved the startup performance of Unity players built with IL2CPP. ([989476](https://issuetracker.unity3d.com/issues/ios-monomanager-getscriptingclass-takes-a-lot-of-unity-loading-time))
...
*   XR: Vuforia: fixed case of Android laggy camera after using input field. ([843460](https://issuetracker.unity3d.com/issues/android-camera-lags-when-using-vuforia-plugin-and-input-field), [960864](https://issuetracker.unity3d.com/issues/android-vuforia-camera-in-the-background-is-laggy-after-using-input-field))
    

2018.1.0b8 Release Notes (Full)
-------------------------------
