...
- Editor: Removed extraneous modular build files from MacStandaloneSupport installer.
    (UUM-112650)<br>
    *First seen in 6000.2.0b1.*    <br>*Fixed in 6000.2.0b13.*
...
- GI: Fixed a failure to load default lightmap parameters at startup.
    ...
    *First seen in 6000.2.0b8.*    <br>*Fixed in 6000.2.0b13.*

- Graphics: Fixed crashes that occurred when reading Texture2D subassets with a data payload larger than expected.
    ([UUM-101784](https://issuetracker.unity3d.com/issues/crash-on-persistentmanager-getserializedfileifobjectavailable-when-opening-a-specific-project))    <br>*Fixed in 6000.2.0b13.*
...
- iOS: Fixed a build failure that occurred when using the beta version of Xcode 26 with the Metal toolchain installed.
    ...
    *First seen in 6000.2.0a1.*    <br>*Fixed in 6000.2.0b13.*
...
- SRP Core: Added a graphics setting container warning for Rendering Debugger resources.
    ...
    *First seen in 6000.2.0b10.*    <br>*Fixed in 6000.2.0b13.*
...
### New 6000.2.0b12 Entries since 6000.2.0b11
...
- Editor: Fixed an issue where the Project browser did not displays correct icons when an item is selected.
    ([UUM-107996](https://issuetracker.unity3d.com/issues/prefab-icon-blends-in-when-selected-in-project-window-with-the-light-editor-theme-enabled))<br>
    *First seen in 6000.2.0b4.*

- Editor: Fixed COPPA dropdown in "Project Settings &gt; Services" has been resized.
    (UUM-109948)<br>
...
- Graphics: Fixed a crash that occured when calling `Mesh.GetIndices` with a list and passing -1 to ignore mesh LODs.
    (UUM-111792)<br>
    *First seen in 6000.2.0a7.*

- Graphics: Fixed an issue where *Shader Preloaded* was  not modifiable in *Project Settings &gt; Graphics*.
    ([UUM-111435](https://issuetracker.unity3d.com/issues/value-of-the-size-field-in-the-preload-shaders-property-is-reverted-when-attempting-to-change-the-value))<br>
    *First seen in 6000.2.0b10.*

- Graphics: Fixed an issue where Mesh.GetIndexStart and Mesh.GetIndexCount always returned values for sub-mesh 0 in meshes with multiple LODs.
    (UUM-111791)<br>
    *First seen in 6000.2.0a7.*
...
- UI Toolkit: Fixed an issue where data binding was updated twice per frame in runtime panels.
    (UUM-110054)<br>
...
#### New 6000.2.0b12 Package Changes since 6000.2.0b11

### Preview of Final 6000.2.0b12 Release Notes
...
#### Preview of Final 6000.2.0b12 Package changes