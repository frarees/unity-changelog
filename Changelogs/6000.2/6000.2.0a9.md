### Known Issues in 6000.2.0a9

- 2D: Crash on TextureGenerator::GenerateSprites when changing Layer Mapping option in the PSD Importer
    ([UUM-100913](https://issuetracker.unity3d.com/issues/crash-on-texturegenerator-generatesprites-when-changing-layer-mapping-option-in-the-psd-importer))
...
- Editor: Crash on TypeContainer&lt;int&gt;::rtti when deleting a Render Texture that is used by the Main Camera
...
- Editor: Ensure System Font is supported with TMP installed in the project.
...
- Editor: Fixed performance regression that doubled import times.
    (UUM-102842)<br>
    *First seen in 6000.2.0a9.*    <br>*Fixed in 6000.2.0a10.*

- Editor: Fixes Editor displaying incorrectly when using Custom UI Scale setting
    (UUM-102644)<br>
    *First seen in 6000.2.0a9.*    <br>*Fixed in 6000.2.0a10.*

- Editor: Fixes Upload button on Facebook Instant Games build profile is missing
    (UUM-102327)<br>
    *First seen in 6000.2.0a9.*    <br>*Fixed in 6000.2.0a10.*
...
- UI Toolkit: Fixed overlay tools getting clipped when resizing the SceneView.
    (UUM-91413)<br>
    *First seen in 6000.2.0a7.*    <br>*Fixed in 6000.2.0a10.*
...
### New 6000.2.0a9 Entries since 6000.2.0a8
...
- 2D: Fixed crash when using generating Sprite outside of Texture from ScriptedImporter.
...
- Build System: Removed build.pl prepare from docs &amp; dev facing menu option.
    (UUM-101251)<br>
...
- Documentation: The Graphics.RenderMeshIndirect and Graphics.RenderPrimitivesIndirect APIs have their GraphicsBuffer typed argument "commandBuffer" renamed to "argsBuffer" to reduce confusion about the object type.
    ([UUM-97986](https://issuetracker.unity3d.com/issues/documentation-graphics-dot-rendermeshindirect-arguments-naming-is-misleading))<br>
    *First seen in 6000.2.0a1.*
...
- GI: Fixed a situation where baking, then deleting the baking set asset, then rebaking causes an exception \(APV\).
    (UUM-73654)<br>
    *First seen in 6000.2.0a7.*
...
- GI: Fixed the compiler stripping a branch away in CubemapProcessor due to a comparison that is always false; the double constant version of PI cannot be represented exactly in type 'float'.
    (UUM-101334)<br>
...
- Graphics: Fixed end background color of Additional Property animation to adapt to any background.
    (UUM-92737)<br>
...
- HDRP: Fixed Full Screen Debug Mode throwing console errors related to invalid AddRenderPass when set to RayTracingAccelerationStructure.
    ([UUM-101593](https://issuetracker.unity3d.com/issues/hdrp-rtas-debug-mode-throws-render-graph-errors-in-console))<br>
    *First seen in 6000.2.0a1.*
...
- Physics 2D: Fixed a bad link in the Scripting Reference docs for "PolygonCollider2D.CreateFromSprite" so it correctly refers to the Texture.isReadable property.
    (UUM-101168)<br>
    *First seen in 6000.2.0a1.*
...
- Scripting: Avoided some allocations when working with managed strings internally.
    (UUM-98944)<br>
    *First seen in 6000.2.0a7.*
...
- SRP Core: Improved Render Graph debug logging options.
    (UUM-98449)<br>
    *First seen in 6000.2.0a1.*
...
- Tests: Re-enabled UIElements Performance tests.
    (UUM-98357)<br>
    *First seen in 6000.2.0a6.*
...
- Text: Fixed usage of GUIUtility.pixelsPerPoint when finding the character at the beginning of the line.
    (UUM-101086)<br>
    *First seen in 6000.2.0a8.*
...
- UI Toolkit: Fixed the occasional builder inspector scroll when removing bindings.
    ([UUM-77376](https://issuetracker.unity3d.com/issues/ui-builders-inspector-sometimes-scrolls-up-after-removing-a-binding))
...
- VFX Graph: Disabled Indirect Draw checkbox if the system does not have an update context.
    ([UUM-100962](https://issuetracker.unity3d.com/issues/vfx-graph-particles-disapear-with-indirectdraw-on-and-without-update-context))<br>
    *First seen in 6000.2.0a8.*
...
- VFX Graph: Fixed "Error assigning 2D texture to 3D texture property" errors being thrown when no Texture3D is assigned to a Texture3D property in ShaderGraph outputs.
    ([UUM-101749](https://issuetracker.unity3d.com/issues/vfxg-having-texture3d-property-in-sg-throws-console-errors-when-vfx-output-has-no-texture-asset-assigned))<br>
...
- Web: Implemented computation of the actual screen refresh rate for the Web platform. This enables support for refresh rates above 60 Hz.
    (UUM-98212)<br>
    *First seen in 6000.2.0a6.*
...
- Windows: Fixed an issue relating to gaining focus of window during game start-up.
    (UUM-101164)<br>
    *First seen in 6000.2.0a6.*
...
#### New 6000.2.0a9 Package Changes since 6000.2.0a8
...
- com.unity.learn.iet-framework: [4.1.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.1//changelog/CHANGELOG.html) to [4.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.2//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.3.1](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.3//changelog/CHANGELOG.html) to [1.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.4//changelog/CHANGELOG.html)
...
### Preview of Final 6000.2.0a9 Release Notes
...
#### Preview of Final 6000.2.0a9 Package changes
...
- com.unity.xr.arcore: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html) to [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html) to [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html) to [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.14.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.14//changelog/CHANGELOG.html) to [1.14.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.14//changelog/CHANGELOG.html)
