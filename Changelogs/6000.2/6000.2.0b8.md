...
- Engine Diagnostics: Fixed crash occurring when sending diagnostics data in the background
    (UUM-110101)<br>
    *First seen in 6000.2.0b7.*    <br>*Fixed in 6000.2.0b9.*
...
- Video: \[Windows\] Editor no longer crashes when listing webcams whose name is missing or empty. Such cameras are now skipped safely \(with a warning in the Editor\).
    ([UUM-105563](https://issuetracker.unity3d.com/issues/editor-crashes-with-platformwebcamtexture-getdevicenames-when-a-virtual-camera-is-present-and-friendlyname-property-is-deleted-from-registry))    <br>*Fixed in 6000.2.0b9.*
...
### New 6000.2.0b8 Entries since 6000.2.0b7

#### Improvements

- 2D: Added functionality to the Sprite Editor that allows users to copy and paste pivot values when using a custom pivot.
    (UUM-107958)<br>
    *First seen in 6000.3.0a1.*

- 2D: Users can now set a Sprite's pivot using pixels instead of a normalized value when doing Sprite slicing.
    (UUM-107958)<br>
    *First seen in 6000.3.0a1.*
...
- Editor: Optimized XR rendering by stripping unnecessary XR render passes when they're not needed.
    (UUM-108351)<br>
...
- Graphics: Fixed a Vulkan validation error related to a semaphore that had not been waited on in XR workflows.
    (UUM-107963)<br>
    *First seen in 6000.3.0a1.*
...
- iOS: Fixed a Metal validation error that occurred during startup when a second monitor was connected.
    (UUM-109476)<br>
    *First seen in 6000.3.0a1.*

- iOS: Fixed occasional rotation issues with Metal display link.
    (UUM-101570)<br>
...
- UI Toolkit: Fixed an issue where the Preview tab did not expand correctly in certain Editor windows.
    ([UUM-107475](https://issuetracker.unity3d.com/issues/preview-tab-in-the-select-texture-2d-window-does-not-expand-when-the-window-is-minimized))<br>
    *First seen in 6000.2.0b3.*

- UI Toolkit: Fixed hover state update on world-space documents when the mouse wasn't moving.
    (UUM-108595)<br>
    *First seen in 6000.2.0a9.*
...
#### New 6000.2.0b8 Package Changes since 6000.2.0b7

#### Packages updated

- com.unity.2d.animation: [10.2.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.2//changelog/CHANGELOG.html) to [12.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@12.0//changelog/CHANGELOG.html)

- com.unity.2d.common: [11.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@11.0//changelog/CHANGELOG.html) to [11.0.1](https://docs.unity3d.com/Packages/com.unity.2d.common@11.0//changelog/CHANGELOG.html)

- com.unity.2d.psdimporter: [10.1.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@10.1//changelog/CHANGELOG.html) to [11.0.1](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@11.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [10.1.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@10.1//changelog/CHANGELOG.html) to [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@12.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [4.3.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@4.3//changelog/CHANGELOG.html) to [5.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@5.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [1.2.4](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.2//changelog/CHANGELOG.html) to [2.0.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@2.0//changelog/CHANGELOG.html)
...
- com.unity.learn.iet-framework: [4.2.0-pre.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.2//changelog/CHANGELOG.html) to [4.2.0-pre.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.2//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.4.0-pre.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.4//changelog/CHANGELOG.html) to [1.4.0-pre.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.4//changelog/CHANGELOG.html)
...
### Preview of Final 6000.2.0b8 Release Notes
...
#### Preview of Final 6000.2.0b8 Package changes
...
- com.unity.2d.animation: [10.1.4](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.1//changelog/CHANGELOG.html) to [12.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@12.0//changelog/CHANGELOG.html)
...
- com.unity.2d.spriteshape: [10.0.7](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@10.0//changelog/CHANGELOG.html) to [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@12.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [4.2.1](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@4.2//changelog/CHANGELOG.html) to [5.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@5.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [1.2.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.2//changelog/CHANGELOG.html) to [2.0.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@2.0//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.14.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.14//changelog/CHANGELOG.html) to [1.15.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.15//changelog/CHANGELOG.html)
