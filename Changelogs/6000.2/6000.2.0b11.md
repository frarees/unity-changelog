...
- Editor: Fixed a crash in the Editor that occurred when calling `AssetBundle.UnloadAsync(...)` followed immediately by `AssetBundle.LoadFromFileAsync(...)` for the same AssetBundle.
    (UUM-108651)    <br>*Fixed in 6000.2.0b12.*

- Editor: Fixed a crash on macOS that could occur in specific situations when entering Play Mode.
    ([UUM-109764](https://issuetracker.unity3d.com/issues/crash-on-nsapplication-endmodalsession-when-entering-play-mode-in-a-specific-project))    <br>*Fixed in 6000.2.0b12.*
...
- Graphics: Fix 'Shader Preloaded' being unmodifiable in Projectsettings &gt; Graphics.
    ...
    *First seen in 6000.2.0b10.*    <br>*Fixed in 6000.2.0b12.*
...
- Lighting: Crash on InputExtraction::ExtractOOTSSnapshot when opening a specific Scene
...
### New 6000.2.0b11 Entries since 6000.2.0b10
...
- Editor: Fixed an issue where VFX instances were not repainted immediately when modifying certain asset properties.
    ([UUM-99917](https://issuetracker.unity3d.com/issues/vfx-are-not-reinit-immediatly-when-changing-properties-in-asset-inspector))<br>
...
- Editor: Remove unused worldSpaceLayer from Panel and PanelSettings.
    ([UUM-111325](https://issuetracker.unity3d.com/issues/world-space-sorting-layer-has-no-effect))<br>
...
- UI Toolkit: Fixed an issue when selected Style Fields in the UI Builder did not have their label highlighted.
    (UUM-107584)<br>
...
#### New 6000.2.0b11 Package Changes since 6000.2.0b10
...
- com.unity.learn.iet-framework: [4.2.0-pre.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.2//changelog/CHANGELOG.html) to [5.0.0](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@5.0//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.4.0-pre.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.4//changelog/CHANGELOG.html) to [1.5.0](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.5//changelog/CHANGELOG.html)
...
### Preview of Final 6000.2.0b11 Release Notes
...
#### Preview of Final 6000.2.0b11 Package changes