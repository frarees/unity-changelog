### Known Issues in 6000.2.0b6

- Android: Fix issue where Vulkan is preferred over GLES even though the drivers were detected as incompatible
    ([UUM-109250](https://issuetracker.unity3d.com/issues/androidplayer-selects-vulkan-graphics-api-over-gles-even-on-devices-with-limited-support))    <br>*Fixed in 6000.2.0b8.*
...
- DX12: Fixed performance regression on some devices on DX12.
    (UUM-105545)    <br>*Fixed in 6000.2.0b7.*
...
- Universal RP: Fixed an issue to handle case where a main light was disabled in the URP Asset.
    ([UUM-104391](https://issuetracker.unity3d.com/issues/lights-are-being-culled-and-appear-pixelated-when-the-main-light-property-is-disabled-and-forward-plus-or-deferred-plus-rendering-paths-are-used))    <br>*Fixed in 6000.2.0b7.*
...
### New 6000.2.0b6 Entries since 6000.2.0b5
...
- Editor: Reverted the previous behavior of the prompt window in the shortcut manager.
    ([UUM-105308](https://issuetracker.unity3d.com/issues/data-in-the-create-new-profile-modal-appears-later-than-the-modal-itself))<br>
...
- N/A \(internal\): Reverted fields to properties back to fix compatibility for precompiled assemblies.
    (UUM-107276)<br>
    *First seen in 6000.2.0b2.*
...
- UI Toolkit: Fixed an exceptions thrown when opening a file and renaming its first element.
    ([UUM-107900](https://issuetracker.unity3d.com/issues/notsupportedexception-error-is-thrown-when-renaming-components-in-ui-builder))<br>
    *First seen in 6000.2.0b4.*
...
- UI Toolkit: Improved memory layout of UxmlSerializedData to reduce padding.
    ([UUM-108363](https://issuetracker.unity3d.com/issues/improve-uxmlserializeddata-generation-to-reduce-padding))<br>
    *First seen in 6000.2.0b3.*




#### New 6000.2.0b6 Package Changes since 6000.2.0b5
...
### Preview of Final 6000.2.0b6 Release Notes
...
#### Preview of Final 6000.2.0b6 Package changes
