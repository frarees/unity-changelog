### Known Issues in 6000.2.0a10

- Editor: Fixed a case where hyperlinks won't open to the correct code line when scrolling in the console.
    ([UUM-101694](https://issuetracker.unity3d.com/issues/code-links-open-incorrect-line-on-code-editor-or-are-unclickable-when-the-log-is-around-100-lines))    <br>*Fixed in 6000.2.0a11.*
...
- Serialization: Fixed an issue with migrating projects from versions after 2021.3 that could cause severe performance impacts by importing the Fixed Timestep in the Time Project Settings as 0.0001.
    ([UUM-103516](https://issuetracker.unity3d.com/issues/performance-drops-significantly-when-many-tilemap-modifications-are-made))    <br>*Fixed in 6000.2.0a11.*
...
- Windows: Player window is frozen when running a built project until you resize the window
    ([UUM-102927](https://issuetracker.unity3d.com/issues/player-window-is-frozen-when-running-a-built-project-until-you-resize-the-window))

- 



### New 6000.2.0a10 Entries since 6000.2.0a9
...
- Android: Fixed new `Gradle.path` breaking XR package.
    (UUM-103565)<br>
...
- Audio: Fixed audio parameters not being applied soon enough when AudioSource is in fixed update mode due to RigidBody component in the same hierarchy.
    ([UUM-102166](https://issuetracker.unity3d.com/issues/audiorandomcontainer-distorts-when-heirarchy-contains-rigid-body-and-spatial-blend-is-set-to-3d))<br>
...
- Editor: Fixed crash with corrupted/malformed `.asset` files that have missing header lines.
    ([UUM-102411](https://issuetracker.unity3d.com/issues/crash-on-serializedfile-indextextfile-when-importing-a-specific-asset))<br>
    *First seen in 6000.2.0a8.*
...
- Editor: Fixed Editor displaying incorrectly when using Custom UI Scale setting.
    (UUM-102644)<br>
    *First seen in 6000.2.0a9.*
...
- Editor: Fixed performance regression that doubled import times.
    (UUM-102842)<br>
    *First seen in 6000.2.0a9.*
...
- Game Core: Fixed troubleshooting window with clickable links and new feedback icons.
    ([UUM-101125](https://issuetracker.unity3d.com/issues/make-text-in-troubleshooter-selectable-and-links-clickable))
...
- UI Toolkit: Fixed Build Profile window not clipping the content at the bottom of the window.
    ([UUM-99657](https://issuetracker.unity3d.com/issues/build-profiles-windows-bottom-buttons-overlapping-with-the-existing-ui))<br>
...
- UI Toolkit: Fixed overlay tools getting clipped when resizing the SceneView.
    (UUM-91413)<br>
    *First seen in 6000.2.0a7.*

- UI Toolkit: Fixed ScrollViews, now users can set the --unity-metrics-single_line-height in USS :root selectors for runtime.
...
- UI Toolkit: Fixed the UI Builder library pane not able to scroll when foldouts are collapsed and Editor Extension Authoring is turned on.
    ([UUM-102886](https://issuetracker.unity3d.com/issues/scrolling-stops-working-in-the-library-then-editor-extension-authoring-becomes-checked))<br>
    *First seen in 6000.2.0a9.*
...
- VFX Graph: Unrestrict CanSupportVFX expect on UniversalDecalSubTarget.
    (UUM-102652)<br>
    *First seen in 6000.2.0a9.*
...
#### New 6000.2.0a10 Package Changes since 6000.2.0a9

#### Packages updated

- com.unity.addressables: [2.4.1](https://docs.unity3d.com/Packages/com.unity.addressables@2.4//changelog/CHANGELOG.html) to [2.4.3](https://docs.unity3d.com/Packages/com.unity.addressables@2.4//changelog/CHANGELOG.html)
...
- com.unity.xr.arcore: [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html) to [6.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.2//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html) to [6.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.2//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.1.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html) to [6.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.2//changelog/CHANGELOG.html)
...
- com.unity.multiplayer.playmode: [1.4.0](https://docs.unity3d.com/Packages/com.unity.multiplayer.playmode@1.4//changelog/CHANGELOG.html) to [1.4.2](https://docs.unity3d.com/Packages/com.unity.multiplayer.playmode@1.4//changelog/CHANGELOG.html)

- com.unity.dedicated-server: [1.4.0](https://docs.unity3d.com/Packages/com.unity.dedicated-server@1.4//changelog/CHANGELOG.html) to [1.4.2](https://docs.unity3d.com/Packages/com.unity.dedicated-server@1.4//changelog/CHANGELOG.html)
...
### Preview of Final 6000.2.0a10 Release Notes

#### Features

- 2D: Added previews in the Scene view for Sprite Rect size and pviot changes that are made in the Sprite Editor window.
...
- Shadergraph: Added a new Append node to shadergraph that can combine two float or vector inputs of different types into a single new vector of variable dimensions.
...
- UI Toolkit: Users can now define the origin point for positioning and transformation, such as rotation and scaling, of the UI Document in world space.
...
- Android: Unity will show a message in console when obb is deployed.
...
- Editor: Better error message when \[ResourcePath\] attribute used on a IRenderPipelineResource's field point to an asset where there is no compatible asset type at the given path with the hosting field type.
...
- Kepler: Set persistent and temporary pathes.
...
- PS5: Improved MRT output format selection when some render targets have been masked off for color write.
    (UUM-101235)
...
- URP: Improved URP ScriptableRendererFeature template.
...
- Editor: Moves the AfterRendering injection point so it is consistent in the pipeline.
    (UUM-85377)
...
- Game Core: Unity Web Request support for asset load.
    (UUM-101495)
...
#### Preview of Final 6000.2.0a10 Package changes
...
- com.unity.xr.arcore: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html) to [6.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.2//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html) to [6.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.2//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html) to [6.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.2//changelog/CHANGELOG.html)
...
- com.unity.web.stripping-tool: [1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.web.stripping-tool@1.0//changelog/CHANGELOG.html) to [1.0.0](https://docs.unity3d.com/Packages/com.unity.web.stripping-tool@1.0//changelog/CHANGELOG.html)
