...
- Editor: Strip unneeded xr render passes if they are not needed.
    (UUM-108351)<br>
    *First seen in 6000.2.0a9.*    <br>*Fixed in 6000.2.0b8.*
...
- Playables: Fixed an issue where `PlayableOutput.SetSourcePlayable` performed slowly on `PlayableGraph` instances with many outputs.
    (UUM-108822)    <br>*Fixed in 6000.2.0b8.*
...
### New 6000.2.0b7 Entries since 6000.2.0b6
...
#### New 6000.2.0b7 Package Changes since 6000.2.0b6
...
### Preview of Final 6000.2.0b7 Release Notes
...
#### Preview of Final 6000.2.0b7 Package changes
