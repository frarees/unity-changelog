...
- Web Platform: Scene from a specific project is stuck loading in the Web Player with the "Uncaught (in promise) TypeError" error thrown in the browser console
    ([UUM-97841](https://issuetracker.unity3d.com/issues/scene-from-a-specific-project-is-stuck-loading-in-the-web-player-with-the-uncaught-in-promise-typeerror-error-thrown-in-the-browser-console))
