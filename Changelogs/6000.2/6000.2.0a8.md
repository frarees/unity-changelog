...
- Editor: Fixed Android Cloud diagnostics to not force internet permission and change settings implicitly.
    (UUM-97032)<br>
...
- Playables: Fixed an issue where setting the time of a PlayableDirector with no extrapolation past its duration would cause it to never leave a Playing state.
...
- com.unity.2d.aseprite: [1.2.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.2//changelog/CHANGELOG.html) to [1.2.3](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.2//changelog/CHANGELOG.html)
...
- com.unity.learn.iet-framework: [4.0.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.0//changelog/CHANGELOG.html) to [4.1.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.1//changelog/CHANGELOG.html)
