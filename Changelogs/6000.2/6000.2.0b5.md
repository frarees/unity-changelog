...
- Animation: Fixed an issue where disabling an Animator would stop the Animator from evaluating.
    ([UUM-107650](https://issuetracker.unity3d.com/issues/animator-does-not-continue-animation-indefinitely-when-toggling-animator-dot-enabled-through-code))    <br>*Fixed in 6000.2.0b6.*
...
- DX12: Fixed by making sure we don't do anything with invalid input attachment indices.
    ([UUM-105412](https://issuetracker.unity3d.com/issues/crash-on-d3d12commonshader-applygpuprogram-when-attaching-material-which-samples-unityfbinput0-to-full-screen-pass-renderer-feature-component))    <br>*Fixed in 6000.2.0b6.*
...
- Mono: Fixed GC Handle leak that would happen every time a new function pointer was returned for a managed delegate.
    ([UUM-105139](https://issuetracker.unity3d.com/issues/unmanagedreadorwrite-objects-are-not-disposed-off-when-gzipstream-is-used-in-the-using-statement))    <br>*Fixed in 6000.2.0b6.*

- SRP Settings: Reverted fields to properties back to fix compatibility for precompiled assemblies
    (UUM-107276)<br>
    *First seen in 6000.2.0b2.*    <br>*Fixed in 6000.2.0b6.*
...
- UI Toolkit: Fixed USS preview not updated on deletion of selector.
    ([UUM-104904](https://issuetracker.unity3d.com/issues/uss-code-is-not-updated-when-a-selector-is-deleted-or-is-moved-to-a-new-uss-file))    <br>*Fixed in 6000.2.0b6.*
...
### New 6000.2.0b5 Entries since 6000.2.0b4

#### Changes

- Editor: Preferences menu: rename "Diagnostics" section to "Editor Diagnostics".
...
- Editor: Fixed an issue where additional actions button no longer erroneously shows in the footer of the build profile window when multiple build profiles are selected.
    ([UUM-104535](https://issuetracker.unity3d.com/issues/publish-to-play-button-becomes-visible-after-the-build-profiles-duplication))<br>
    *First seen in 6000.2.0a10.*

- Editor: Fixed an issue where additional actions button no longer erroneously shows in the footer of the build profile window when switching from build profiles to classic platforms.
    ([UUM-105397](https://issuetracker.unity3d.com/issues/upload-button-is-not-hidden-in-the-build-profiles-window-when-user-switches-from-build-profile-to-a-platform))<br>
...
- Editor: Restored proper ordering of buttons in the footer of the build profile window.
    ([UUM-105431](https://issuetracker.unity3d.com/issues/buttons-cloud-build-and-switch-profile-changed-their-positions))<br>
    *First seen in 6000.2.0b2.*
...
- Undo System: Fixed a crash by blocking all calls to Undo during Asset Import.
    (UUM-100918)<br>
...
#### New 6000.2.0b5 Package Changes since 6000.2.0b4
...
- com.unity.learn.iet-framework: [4.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.2//changelog/CHANGELOG.html) to [4.2.0-pre.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.2//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.4//changelog/CHANGELOG.html) to [1.4.0-pre.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.4//changelog/CHANGELOG.html)
...
### Preview of Final 6000.2.0b5 Release Notes
...
#### Preview of Final 6000.2.0b5 Package changes
...
- com.unity.learn.iet-framework: [4.0.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.0//changelog/CHANGELOG.html) to [4.2.0-pre.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.2//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.2.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.2//changelog/CHANGELOG.html) to [1.4.0-pre.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.4//changelog/CHANGELOG.html)
...
- com.unity.multiplayer.playmode: [1.3.3](https://docs.unity3d.com/Packages/com.unity.multiplayer.playmode@1.3//changelog/CHANGELOG.html) to [1.4.3](https://docs.unity3d.com/Packages/com.unity.multiplayer.playmode@1.4//changelog/CHANGELOG.html)
...
- com.unity.dedicated-server: [1.3.3](https://docs.unity3d.com/Packages/com.unity.dedicated-server@1.3//changelog/CHANGELOG.html) to [1.4.3](https://docs.unity3d.com/Packages/com.unity.dedicated-server@1.4//changelog/CHANGELOG.html)
