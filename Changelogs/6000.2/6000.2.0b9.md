...
- Asset Import: Fixed indeterminism of artifact ids which could occur when importers set dependencies to other assets
    (UUM-107448)    <br>*Fixed in 6000.2.0b10.*
...
- Editor: Fixed an issue causing issues with keywords in material variants to not change when reverting a property override.
    (UUM-109470)<br>
    *First seen in 6000.2.0b7.*    <br>*Fixed in 6000.2.0b10.*
...
- IL2CPP: Runtime of il2cpp reduced on macOS Arm64 but building il2cpp for nativeaot.
    (UUM-108129)<br>
    *First seen in 6000.2.0b2.*    <br>*Fixed in 6000.2.0b10.*
...
### New 6000.2.0b9 Entries since 6000.2.0b8
...
- Editor: Fixed an issue where the *Enable Platform* button was not selected after enabling the platform.
    (UUM-101667)<br>
    *First seen in 6000.3.0a1.*

- Editor: Fixed an issue where the global scene list did not update while a custom build profile was active.
    (UUM-104738)<br>
...
- Editor: Fixed an issue where the Unity logo in the main toolbar would shrink when the toolbar width was reduced.
    ([UUM-110070](https://issuetracker.unity3d.com/issues/unity-logo-becomes-deformed-when-the-editor-is-resized-horizontally))<br>
...
- Engine Diagnostics: Fixed crash that occurred when sending diagnostics data in the background.
    (UUM-110101)<br>
    *First seen in 6000.2.0b7.*

- GI: Enabled Adaptive Probe Volumes \(APV\) to work with Subscenes in the Universal Render Pipeline \(URP\).
    (UUM-104165)<br>
...
- Text: Exposed `PostProcessTextVertices` to enable text animation without the need for reflection.
    (UUM-108065)<br>
...
- UI Toolkit: Fixed an issue where the PanelInputConfiguration component was incorrectly disabled when part of a Prefab being edited.
    ([UUM-108797](https://issuetracker.unity3d.com/issues/inputconfigurationpanel-component-in-a-prefabs-hierarchy-is-considered-as-a-duplicate))<br>
    *First seen in 6000.2.0b4.*
...
#### New 6000.2.0b9 Package Changes since 6000.2.0b8

#### Packages updated

- com.unity.2d.animation: [12.0.1](https://docs.unity3d.com/Packages/com.unity.2d.animation@12.0//changelog/CHANGELOG.html) to [12.0.2](https://docs.unity3d.com/Packages/com.unity.2d.animation@12.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@12.0//changelog/CHANGELOG.html) to [12.0.1](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@12.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [5.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@5.0//changelog/CHANGELOG.html) to [5.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@5.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [2.0.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@2.0//changelog/CHANGELOG.html) to [2.0.1](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@2.0//changelog/CHANGELOG.html)
...
- com.unity.xr.arcore: [6.2.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.2//changelog/CHANGELOG.html) to [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.2//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.2.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.2//changelog/CHANGELOG.html) to [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.2//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.2.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.2//changelog/CHANGELOG.html) to [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.2//changelog/CHANGELOG.html)

- com.unity.xr.openxr: [1.15.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.15//changelog/CHANGELOG.html) to [1.15.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.15//changelog/CHANGELOG.html)

**Pre-release packages added**

- [com.unity.ai.assistant@1.0.0-pre.7](https://docs.unity3d.com/Packages/com.unity.ai.assistant@1.0//changelog/CHANGELOG.html)

### Preview of Final 6000.2.0b9 Release Notes
...
- Engine Diagnostics: - Added options in Project Settings and Build Profile to enable or disable engine diagnostics data collection. This feature is enabled by default in new Unity 6.2 projects.<br>
    Scripting:<br>
...
#### Preview of Final 6000.2.0b9 Package changes
...
- com.unity.netcode: [1.3.6](https://docs.unity3d.com/Packages/com.unity.netcode@1.3//changelog/CHANGELOG.html) to [1.6.1](https://docs.unity3d.com/Packages/com.unity.netcode@1.6//changelog/CHANGELOG.html)
...
- com.unity.2d.animation: [10.1.4](https://docs.unity3d.com/Packages/com.unity.2d.animation@10.1//changelog/CHANGELOG.html) to [12.0.2](https://docs.unity3d.com/Packages/com.unity.2d.animation@12.0//changelog/CHANGELOG.html)

- com.unity.2d.common: [9.0.7](https://docs.unity3d.com/Packages/com.unity.2d.common@9.0//changelog/CHANGELOG.html) to [11.0.1](https://docs.unity3d.com/Packages/com.unity.2d.common@11.0//changelog/CHANGELOG.html)
...
- com.unity.2d.psdimporter: [10.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@10.0//changelog/CHANGELOG.html) to [11.0.1](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@11.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [10.0.7](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@10.0//changelog/CHANGELOG.html) to [12.0.1](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@12.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [4.2.1](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@4.2//changelog/CHANGELOG.html) to [5.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@5.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [1.2.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@1.2//changelog/CHANGELOG.html) to [2.0.1](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@2.0//changelog/CHANGELOG.html)
...
- com.unity.addressables: [2.2.2](https://docs.unity3d.com/Packages/com.unity.addressables@2.2//changelog/CHANGELOG.html) to [2.6.0](https://docs.unity3d.com/Packages/com.unity.addressables@2.6//changelog/CHANGELOG.html)

- com.unity.burst: [1.8.18](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html) to [1.8.23](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html)
...
- com.unity.services.vivox: [16.5.0](https://docs.unity3d.com/Packages/com.unity.services.vivox@16.5//changelog/CHANGELOG.html) to [16.6.2](https://docs.unity3d.com/Packages/com.unity.services.vivox@16.6//changelog/CHANGELOG.html)
...
- com.unity.visualscripting: [1.9.5](https://docs.unity3d.com/Packages/com.unity.visualscripting@1.9//changelog/CHANGELOG.html) to [1.9.7](https://docs.unity3d.com/Packages/com.unity.visualscripting@1.9//changelog/CHANGELOG.html)

- com.unity.xr.arcore: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.1//changelog/CHANGELOG.html) to [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.2//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.1//changelog/CHANGELOG.html) to [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.2//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.1.0-pre.4](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.1//changelog/CHANGELOG.html) to [6.2.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.2//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.14.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.14//changelog/CHANGELOG.html) to [1.15.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.15//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework: [4.0.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.0//changelog/CHANGELOG.html) to [4.2.0-pre.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework@4.2//changelog/CHANGELOG.html)

- com.unity.learn.iet-framework.authoring: [1.2.2](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.2//changelog/CHANGELOG.html) to [1.4.0-pre.3](https://docs.unity3d.com/Packages/com.unity.learn.iet-framework.authoring@1.4//changelog/CHANGELOG.html)

- com.unity.terrain-tools: [5.1.2](https://docs.unity3d.com/Packages/com.unity.terrain-tools@5.1//changelog/CHANGELOG.html) to [5.3.0](https://docs.unity3d.com/Packages/com.unity.terrain-tools@5.3//changelog/CHANGELOG.html)
...
- com.unity.ai.navigation: [2.0.5](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html) to [2.0.8](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [2.0.4](https://docs.unity3d.com/Packages/com.unity.polyspatial@2.0//changelog/CHANGELOG.html) to [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial@2.3//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [2.0.4](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@2.0//changelog/CHANGELOG.html) to [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@2.3//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [2.0.4](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@2.0//changelog/CHANGELOG.html) to [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@2.3//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [2.0.4](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@2.0//changelog/CHANGELOG.html) to [2.3.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@2.3//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [2.0.4](https://docs.unity3d.com/Packages/com.unity.xr.visionos@2.0//changelog/CHANGELOG.html) to [2.3.1](https://docs.unity3d.com/Packages/com.unity.xr.visionos@2.3//changelog/CHANGELOG.html)
...
- [com.unity.2d.enhancers@1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.2d.enhancers@1.0//changelog/CHANGELOG.html)
...
- [com.unity.ai.inference@2.2.1](https://docs.unity3d.com/Packages/com.unity.ai.inference@2.2//changelog/CHANGELOG.html)
