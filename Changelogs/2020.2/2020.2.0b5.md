...
*   GI: Fixes regression to denoising quality when using the OIDN denoiser with the GPU Lightmapper. ([1272954](https://issuetracker.unity3d.com/issues/gpu-plm-oidn-produces-noisy-results))  
    _Fixed in 2020.2.0b6._
