...
-   Physics: A hard stack overflow happens when raycasting vs a dense mesh in BV4_ProcessStreamKajiyaOrderedQ ([1297721](https://issuetracker.unity3d.com/issues/editor-crashes-when-raycasting-a-mesh-with-a-lot-of-triangles-located-very-close-to-each-other-or-opening-the-physics-debugger))
