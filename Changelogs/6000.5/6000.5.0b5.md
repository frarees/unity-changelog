...
- 2D: Fix case where Sprite with SpriteSkin is invisible in Editor Play Mode when using Addressables SpriteAtlas loading via "SpriteAtlasManager.atlasRequested" with Sprite Atlas V2 packing enabled
    (UUM-137123)    <br>*Fixed in 6000.5.0b7.*
...
- Asset Pipeline: Fixed EntityId parse to account for larger EntityId type in PresetnManager UI
    ([UUM-139706](https://issuetracker.unity3d.com/issues/overflowexception-is-thrown-and-add-default-preset-dropdown-menu-does-not-open-when-clicking-add-default-preset-in-preset-manager-project-settings))<br>
    *First seen in 6000.5.0b4.*    <br>*Fixed in 6000.5.0b6.*

- Editor: Fixed an out of range exception when using Underline with TextCore.
    ([UUM-137906](https://issuetracker.unity3d.com/issues/ui-builder-windows-text-rendering-breaks-when-using-rich-text-combined-with-an-underlined-emoji))    <br>*Fixed in 6000.5.0b6.*

- Editor: Fixed the Layout and Substitution Tables leaking between domain reloads.
    ([UUM-138000](https://issuetracker.unity3d.com/issues/editor-memory-leak-in-visualelement-when-recompiling-in-a-blank-urp-project))    <br>*Fixed in 6000.5.0b7.*

- Editor: Fixed `DrawText` not drawing in the color provided
    ([UUM-137907](https://issuetracker.unity3d.com/issues/color-parameter-is-ignored-when-creating-dynamic-text-in-a-ui-document-with-drawtext))    <br>*Fixed in 6000.5.0b7.*

- Editor: Fixed `DrawText` not working when no font is provided.
    ([UUM-137947](https://issuetracker.unity3d.com/issues/custom-control-text-is-not-visible-when-adding-it-to-the-ui-document))<br>
    *First seen in 6000.5.0a8.*    <br>*Fixed in 6000.5.0b7.*

- Editor: ixed NullReferenceException that could occur on domain reload when setting up preview dropdown.
    ([UUM-139557](https://issuetracker.unity3d.com/issues/editor-fails-to-render-and-nre-errors-thrown-when-domain-is-reloaded-after-code-changes-and-image-component-is-visible-in-inspector))    <br>*Fixed in 6000.5.0b6.*
...
- GI: Fixed a bug where lightmap packing would fail with xAtlas when the scene contains meshes whose UV layout has zero area.
    ([UUM-139715](https://issuetracker.unity3d.com/issues/crash-on-xatlas-internal-pack-atlas-findchartlocation-bruteforce-when-generating-the-lighting))    <br>*Fixed in 6000.5.0b7.*
...
- GI: Fixed a bug where meshes with unreferenced vertex positions would sometimes cause crashes during baking, when using the xAtlas packer.
    ([UUM-138494](https://issuetracker.unity3d.com/issues/crash-with-multiple-stacktraces-when-building-lighting-in-a-specific-scene))    <br>*Fixed in 6000.5.0b7.*

- GI: Suppressed spurious FXC warnings in UnifiedRT TraceRay shader.
    ([UUM-139001](https://issuetracker.unity3d.com/issues/switching-platforms-will-trigger-shader-related-warnings-tracetransparentrays))    <br>*Fixed in 6000.5.0b6.*
...
- Scripting: Fixed bug that prevented Ionic.Zlib.CF.plugin dll from being loaded
    ([UUM-140154](https://issuetracker.unity3d.com/issues/could-not-load-ionic-dot-zlib-dot-cf-when-running-a-script-using-zlib-library-functions-in-play-mode))    <br>*Fixed in 6000.5.0b7.*

- Text: Fix NullReferenceException when word wrapping sup and sub tag
    ([UUM-139927](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-when-resizing-a-text-element-in-the-ui-builder-when-it-contains-sup-or-sub-elements-and-wrap-mode-is-enabled))    <br>*Fixed in 6000.5.0b7.*

- URP: Added documentation clarifying that Adaptive Performance can override decal draw distances at runtime.
    ([UUM-138945](https://issuetracker.unity3d.com/issues/urp-decals-become-invisible-when-over-1000-units-away-from-the-camera))    <br>*Fixed in 6000.5.0b7.*
...
### New 6000.5.0b5 Entries since 6000.5.0b4
...
- Animation: Fixed selection loss when entering play mode.
    ([UUM-138302](https://issuetracker.unity3d.com/issues/animation-window-shows-no-animatable-object-selected-when-entering-play-mode-for-the-second-time-with-animated-gameobject-selected))<br>
...
- Editor: Fixed a compile error in DebugStream.cs when Enable Player Debug Display = true in the Project Settings &gt; Physics Settings &gt; Entities window.
    ([UUM-138927](https://issuetracker.unity3d.com/issues/enabling-player-debug-display-in-physics-settings-throws-unclearable-compile-error-in-debugstream-dot-cs-when-entering-play-mode))<br>
...
- Editor: Fixed ahref links for IMGUI.
    ([UUM-138952](https://issuetracker.unity3d.com/issues/clicking-here-link-in-serve-tick-batching-warning-does-nothing-and-throws-failed-to-perform-selection-on-text-error-in-the-console))<br>
...
- Editor: Fixed an issue where built-in meshes and textures could not be selected in the Inspector.
    (UUM-138601)<br>
...
- Editor: Fixed an issue where UI Builder Material property remains empty and throws Invalid URI warning when selecting built-in materials from the object picker.
    ([UUM-138529](https://issuetracker.unity3d.com/issues/ui-builder-material-property-remains-empty-and-throws-invalid-uri-warning-when-selecting-built-in-materials-from-the-object-picker))<br>
...
- Editor: Fixed inconsistent hashcode generation for Volume Profiles.
    ([UUM-130711](https://issuetracker.unity3d.com/issues/switching-graphics-default-or-devlook-profile-to-nightskyrenderingsettings-profile-throws-keynotfoundexception-error-in-the-console-window))<br>
    *First seen in 6000.5.0a5.*

- Editor: Fixed multi edit for enum values.
    ([UUM-138913](https://issuetracker.unity3d.com/issues/cant-change-the-shape-of-multiple-lights-at-the-same-time-using-lighting-search))<br>
    *First seen in 6000.5.0b2.*
...
- Editor: Fixed server build profile adds Standalone quality settings instead of Server ones.
    (UUM-138974)<br>
    *First seen in 6000.6.0a3.*

- Editor: In Search Table View: Fixed infinite loop in multi cell edit.
    ([UUM-137443](https://issuetracker.unity3d.com/issues/lighting-search-window-lags-slash-stutters-when-scrolling-with-a-lot-of-lights-in-the-hierarchy))<br>
...
- Editor: Undo is supported for all Light Types.
    ([UUM-136891](https://issuetracker.unity3d.com/issues/light-type-slash-mode-changes-are-not-undone-with-ctrl-plus-z-shortcut-when-edited-from-lighting-search-window))<br>
    *First seen in 6000.5.0a9.*
...
- Entities: Removed the unused filtering button in the Components Inspector search field.
    ([UUM-138380](https://issuetracker.unity3d.com/issues/add-new-query-block-dropdown-slash-panel-is-empty-when-opened-for-worldtime-search))<br>
    *First seen in 6000.5.0b2.*
...
- Graphics: Fixed an issue where an implicit truncation of vector type shader warning was thrown when building standalone or Android player.
    ([UUM-134633](https://issuetracker.unity3d.com/issues/shader-warning-in-hidden-slash-universal-render-pipeline-slash-copydepth-dot-dot-dot-warning-is-thrown-after-building-a-project))<br>
    *First seen in 6000.5.0a7.*
...
- Profiler: Fixed "Trying to access the DPI setting of a visual element that is not on a panel" warning spam when the Profiler window tab is in the background.
    ([UUM-136392](https://issuetracker.unity3d.com/issues/trying-to-access-the-dpi-setting-of-a-visual-element-that-is-not-on-a-panel-warnings-are-thrown-when-profiling-and-profiler-window-is-not-focused))<br>
...
#### New 6000.5.0b5 Package Changes since 6000.5.0b4
...
- com.unity.xr.arcore: [6.5.0-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.5//changelog/CHANGELOG.html) to [6.5.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.5//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.5.0-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.5//changelog/CHANGELOG.html) to [6.5.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.5//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.5.0-pre.3](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.5//changelog/CHANGELOG.html) to [6.5.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.5//changelog/CHANGELOG.html)

- com.unity.xr.meta-openxr: [2.5.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.5//changelog/CHANGELOG.html) to [2.5.0](https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.5//changelog/CHANGELOG.html)
...
### Preview of Final 6000.5.0b5 Release Notes
...
- Editor: Introduces the Swift project type \(experimental\) in the iOS Player settings.
...
- Package Manager: Added images field to the package Sample class that allows for displaying images in the samples details tab.
...
- Android: Keyboard Area on Android.
...
#### Preview of Final 6000.5.0b5 Package changes
...
- com.unity.ml-agents: [2.0.1](https://docs.unity3d.com/Packages/com.unity.ml-agents@2.0//changelog/CHANGELOG.html) to [4.0.2](https://docs.unity3d.com/Packages/com.unity.ml-agents@4.0//changelog/CHANGELOG.html)
...
- com.unity.xr.hands: [1.7.0](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.7//changelog/CHANGELOG.html) to [1.8.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.8//changelog/CHANGELOG.html)

- com.unity.xr.interaction.toolkit: [3.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.3//changelog/CHANGELOG.html) to [3.5.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.5//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.16.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.16//changelog/CHANGELOG.html) to [1.17.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.17//changelog/CHANGELOG.html)
...
- com.unity.netcode.gameobjects: [2.6.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.6//changelog/CHANGELOG.html) to [2.10.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.10//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.0//changelog/CHANGELOG.html) to [3.1.4](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.0//changelog/CHANGELOG.html) to [3.1.4](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.0//changelog/CHANGELOG.html) to [3.1.4](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.0//changelog/CHANGELOG.html) to [3.1.4](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.1//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.0//changelog/CHANGELOG.html) to [3.1.4](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.1//changelog/CHANGELOG.html)
...
- com.unity.asset-manager-for-unity: [1.7.0](https://docs.unity3d.com/Packages/com.unity.asset-manager-for-unity@1.7//changelog/CHANGELOG.html) to [1.10.0](https://docs.unity3d.com/Packages/com.unity.asset-manager-for-unity@1.10//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html) to [1.3.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.3//changelog/CHANGELOG.html)
