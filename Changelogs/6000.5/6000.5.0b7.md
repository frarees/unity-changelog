...
- Entities Graphics: Fixed an issue where materials and/or meshes would be assigned to the wrong object during live baking.
    ([UUM-139663](https://issuetracker.unity3d.com/issues/materials-move-to-other-gameobjects-in-a-prefab-when-disabling-a-child-gameobject-in-prefab-mode-with-an-open-subscene))    <br>*Fixed in 6000.5.0b8.*
...
### New 6000.5.0b7 Entries since 6000.5.0b6
...
- Netcode for Entities: Source generators no longer log to Console.Out.
    ([UUM-133174](https://issuetracker.unity3d.com/issues/netcode-source-generators-never-finish-in-rider))<br>
...
- Editor: Made the new Hierarchy view automatically fit the content to the window size.
    ([UUM-135423](https://issuetracker.unity3d.com/issues/edited-column-positions-are-not-saved-in-the-hierarchy-when-reopening-the-project))<br>
    *First seen in 6000.5.0a7.*

- Editor: Made the new Hierarchy view automatically fit the content to the window size.
    ([UUM-138388](https://issuetracker.unity3d.com/issues/hierarchyv2-removing-column-only-removes-the-header-label-and-content-but-not-the-column-itself))<br>
    *First seen in 6000.5.0b2.*

- Editor: Vulkan Device Filter Lists asset Inspector now matches current Help Box specifications.
    ([UUM-134651](https://issuetracker.unity3d.com/issues/top-and-bottom-margins-in-the-vulkan-device-filter-inspector-window-do-not-match-the-updated-u6-dot-5-help-box-design-specifications))<br>
    *First seen in 6000.5.0a7.*
...
- GI: Fixed Lighting Search range-based filter ordering.
    ([UUM-137246](https://issuetracker.unity3d.com/issues/some-lighting-search-premade-filters-are-not-ordered-correctly))<br>
    *First seen in 6000.5.0a9.*
...
- Graph Toolkit: Switching selection between variable nodes of the same type, or between a pair of portal nodes, now properly colors the unselected node's border highlight.
    (UUM-138855)<br>
...
- HDRP: Fixed an issue where the History Buffer debug value became blank after interacting with a material debug enum value.
    ([UUM-138138](https://issuetracker.unity3d.com/issues/history-buffer-drop-down-field-in-the-rendering-debugger-window-becomes-empty-after-pressing-the-reset-button))<br>
...
- Package Manager: Fixed an issue where the "Export" menu item appeared enabled in the Project window even when all export options were unavailable.
    ([UUM-135080](https://issuetracker.unity3d.com/issues/export-menu-item-appears-active-in-project-window-while-export-package-dot-dot-dot-and-export-assets-dot-dot-dot-sub-menu-options-are-disabled))<br>
    *First seen in 6000.5.0a7.*
...
- Scripting: Fixed "Lifecycle ERROR" and "NullReferenceException" errors in the console after installing the AI Assistant package \(or any package that introduces assemblies with duplicate simple names\).
    ([UUM-135379](https://issuetracker.unity3d.com/issues/console-displays-lifecycle-error-and-nullreferenceexception-errors-after-ai-assistant-installation))<br>
...
- Shadergraph: Fixed a bug in the Switch Node that conditions list changes would not Undo.
    (UUM-136871)<br>
...
#### New 6000.5.0b7 Package Changes since 6000.5.0b6

#### Packages updated

- com.unity.ml-agents: [4.0.2](https://docs.unity3d.com/Packages/com.unity.ml-agents@4.0//changelog/CHANGELOG.html) to [4.0.3](https://docs.unity3d.com/Packages/com.unity.ml-agents@4.0//changelog/CHANGELOG.html)
...
- com.unity.netcode.gameobjects: [2.10.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.10//changelog/CHANGELOG.html) to [2.11.1](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.11//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.3.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.3//changelog/CHANGELOG.html) to [1.3.0](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.3//changelog/CHANGELOG.html)

### Preview of Final 6000.5.0b7 Release Notes
...
#### Preview of Final 6000.5.0b7 Package changes
...
- com.unity.netcode.gameobjects: [2.6.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.6//changelog/CHANGELOG.html) to [2.11.1](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.11//changelog/CHANGELOG.html)
