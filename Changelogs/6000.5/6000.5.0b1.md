...
- 6000.3.11f1: Color parameter is ignored when creating dynamic text in a UI Document with DrawText()
...
- Adaptive Performance: fix gc allocation
    (UUM-136604)    <br>*Fixed in 6000.5.0b2.*
...
- Build Pipeline: Prevent build failure due to PlayerSettings object lifetime issue
    ...
    *First seen in 6000.5.0a8.*    <br>*Fixed in 6000.5.0b2.*

- Editor: Fixed WebGL input field focusing out after typing.
    ([UUM-137597](https://issuetracker.unity3d.com/issues/input-fields-do-not-maintain-focus-when-they-are-selected-in-a-web-build))    <br>*Fixed in 6000.5.0b2.*
...
- Kernel: Decreased CPU usage when moving NavMesh Obstacles with carving enabled.
    ([UUM-133911](https://issuetracker.unity3d.com/issues/increased-cpu-usage-when-moving-navmesh-obstacles-with-carving-enabled))    <br>*Fixed in 6000.5.0b2.*
...
- UI Toolkit: Fixed a layout cache memory leak that occurred during extended periods of heavy load.
    (UUM-137552)    <br>*Fixed in 6000.5.0b2.*
...
### New 6000.5.0b1 Entries since 6000.5.0a9
...
- Editor: Fixed volumetric clouds white flickering when camera is moving with close alpha clipped geometry.
...
- IL2CPP: Fixed possible stack overflow when script debugging is enabled and Generics create a circular reference.
    (UUM-132940)<br>
...
- Netcode for Entities: Fixed a null reference exception when editing the lists in Project Settings &gt; Multiplayer &gt; Build immediately after adding the Netcode for Entities package.
    ([UUM-135202](https://issuetracker.unity3d.com/issues/project-settings-window-ui-breaks-and-nullreferenceexception-error-thrown-when-adding-many-elements-in-multiplayer-build))<br>
    *First seen in 6000.5.0a8.*
...
- Package Manager: Fixed misaligned links in the Package Manager Details panel.
    ([UUM-132569](https://issuetracker.unity3d.com/issues/documentation-changelog-license-links-are-misaligned-in-package-manager-details-panel))<br>
...
- SRP Core: Added header-level documentation references to rendering debugger.
    ([UUM-134685](https://issuetracker.unity3d.com/issues/no-reference-buttons-are-available-for-rendering-debuggers-material-and-rendering-tabs))<br>
...
#### New 6000.5.0b1 Package Changes since 6000.5.0a9

#### Packages updated

- com.unity.localization: [1.5.9](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html) to [1.5.10](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html)
...
- com.unity.xr.core-utils: [2.6.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.6//changelog/CHANGELOG.html) to [2.6.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.6//changelog/CHANGELOG.html)
...
### Preview of Final 6000.5.0b1 Release Notes
...
#### Preview of Final 6000.5.0b1 Package changes
...
- com.unity.collab-proxy: [2.10.0](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.10//changelog/CHANGELOG.html) to [2.11.4](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.11//changelog/CHANGELOG.html)
...
- com.unity.localization: [1.5.8](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html) to [1.5.10](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.0//changelog/CHANGELOG.html) to [3.1.1](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.0//changelog/CHANGELOG.html) to [3.1.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.0//changelog/CHANGELOG.html) to [3.1.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.0//changelog/CHANGELOG.html) to [3.1.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.1//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.0//changelog/CHANGELOG.html) to [3.1.1](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.1//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html) to [1.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.3//changelog/CHANGELOG.html)
