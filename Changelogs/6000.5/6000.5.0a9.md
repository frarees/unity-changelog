...
- Editor: Editor now correctly clears unused overrides related to `SerializeReference` from prefab instances.
    ([UUM-135932](https://issuetracker.unity3d.com/issues/prefabs-remove-unused-overrides-fails-to-clean-up-overrides-when-the-managed-instance-type-in-serializereference-is-changed))    <br>*Fixed in 6000.5.0b1.*
...
- : Fix error CS0414: The field 'TMP_FontAsset.fontWeights' is assigned but its value is never used
    ([UUM-137481](https://issuetracker.unity3d.com/issues/fix-error-cs0414-the-field-tmp-fontasset-dot-fontweights-is-assigned-but-its-value-is-never-used))
...
### New 6000.5.0a9 Entries since 6000.5.0a8
...
- 2D: Fixed UI inconsistency in Sprite Editor Window HelpBox.
    ([UUM-129868](https://issuetracker.unity3d.com/issues/helpbox-visuals-in-the-sprite-editor-window-is-not-aligned-with-the-latest-style-guide))<br>
    *First seen in 6000.5.0a3.*

- Adaptive Performance: Adaptive Performance Apple to work properly on Vision OS devices with version 1 and 2.
    (UUM-134664)<br>
...
- Animation: Added margin to Sample Rate field.
    ([UUM-134816](https://issuetracker.unity3d.com/issues/samples-text-has-no-padding-on-the-left-side-when-the-animation-window-is-opened))<br>
    *First seen in 6000.5.0a7.*

- Animation: Added maximum width constraint for the left panel in the animation window.
    ([UUM-134499](https://issuetracker.unity3d.com/issues/animation-property-list-has-no-limit-as-to-how-wide-it-can-be-expanded-when-expanding-onto-the-animation-timeline))<br>
    *First seen in 6000.5.0a7.*

- Animation: Fixed an issue where AnimationClip rotation compression would be non-deterministic. Curve compression precision has also been improved as a result.<br>
    *First seen in 6000.5.0a4.*

- Animation: Fixed Animation Window icon when switching light/dark theme.
    ([UUM-134835](https://issuetracker.unity3d.com/issues/animation-window-icon-does-not-properly-change-when-the-editor-theme-is-changed-making-it-difficult-to-see))<br>
    *First seen in 6000.5.0a7.*
...
- Animation: Fixed offset on the play button in the Animation Window.
    ([UUM-134829](https://issuetracker.unity3d.com/issues/animation-window-play-button-is-cut-off-or-off-centered-when-the-animation-window-is-opened))<br>
    *First seen in 6000.5.0a7.*

- Animation: Fixed the clip dropdown providing a menu item to create a new clip for animation clip selection.
    ([UUM-134480](https://issuetracker.unity3d.com/issues/create-new-clip-option-available-without-function-in-the-animation-window))<br>
    *First seen in 6000.5.0a7.*
...
- Editor: Fixed crash when scheduling a job against entities with TransformRef components in a hierarchy.
    (UUM-135777)<br>
    *First seen in 6000.5.0a8.*
...
- EmbeddedLinux: Enabled per-window transparency for vulkan on EmbeddedLinux.
    ([UUM-136225](https://issuetracker.unity3d.com/issues/windowing-fix-per-window-transparency-on-vulkan-for-embeddedlinux))<br>
...
- Entities: Fixed an issue where errors would show up when removing the Entities package from a project.
    ([UUM-135989](https://issuetracker.unity3d.com/issues/errors-are-thrown-after-removing-entities-package))<br>
    *First seen in 6000.5.0a7.*
...
- Entities: Fixed an issue where the Parent filter in the Systems Window would throw an exception when selected.
    ([UUM-134181](https://issuetracker.unity3d.com/issues/exception-is-thrown-when-adding-a-parent-query-block-in-entities-systems-window))<br>
...
- Graph Toolkit: Added or deleting a variable in the Blackboard no longer causes the Default Value field in variables quick settings to flicker.
    ([UUM-133739](https://issuetracker.unity3d.com/issues/gtk-variable-default-value-width-changes-when-adding-a-new-variable-to-the-blackboard))<br>
    *First seen in 6000.5.0a6.*
...
- Graph Toolkit: Fixed broken UI when hovering on nodes and context nodes with custom subtitles. Also fix broken UI when collapsing node with custom subtitle.
    (UUM-136240)<br>
    *First seen in 6000.5.0a7.*
...
- Input System: Fixed a test instability caused by Windows x86 using 4-byte stack alignment which caused a safety-check in test utilities to  discard the IOCTL command when not aligned to 8-byte boundary causing seemingly random failures.
    (UUM-135218)<br>
    *First seen in 6000.5.0a8.*
...
- Linux: Fixed Misaligned "Read more" link and oversized "Install sysroot and toolchain package" button.
    ([UUM-134933](https://issuetracker.unity3d.com/issues/help-box-ui-not-matching-updated-u6-dot-5-design-misaligned-read-more-link-and-oversized-install-sysroot-and-toolchain-package-button))<br>
    *First seen in 6000.5.0a7.*

- Multiplayer: Unity Transport: Avoid throwing a `NullReferenceException` when passing null to `NetworkEndpoint.Parse` and `NetworkEndpoint.TryParse`. Instead, a default-valued `NetworkEndpoint` is returned.
    (UUM-136498)<br>
    *First seen in 6000.5.0a8.*
...
- Physics 2D: Display "Physics Core 2D" consistently in the project settings Editor UI.
    ([UUM-134693](https://issuetracker.unity3d.com/issues/inconsistent-physicscore-naming-in-the-project-settings-window))<br>
    *First seen in 6000.5.0a7.*
...
#### New 6000.5.0a9 Package Changes since 6000.5.0a8
...
- com.unity.xr.core-utils: [2.5.3](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.5//changelog/CHANGELOG.html) to [2.6.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.core-utils@2.6//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.2.0](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html) to [1.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.3//changelog/CHANGELOG.html)
...
### Preview of Final 6000.5.0a9 Release Notes
...
- Bug Reporter: Optimisations to improve launch times.
...
- Documentation: Clarified documentation for PointerEventData.eligibleForClick.

- Documentation: Clarified documentation for PointerEventData.position.
...
- Particles: Rename Effects to Visual Effects in GameObjects menu.
...
- Adaptive Performance: Added documentation.
...
#### Preview of Final 6000.5.0a9 Package changes
...
- com.unity.performance.profile-analyzer: [1.2.4](https://docs.unity3d.com/Packages/com.unity.performance.profile-analyzer@1.2//changelog/CHANGELOG.html) to [1.3.2](https://docs.unity3d.com/Packages/com.unity.performance.profile-analyzer@1.3//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.0//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.0//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.0//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.0//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.1//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.0//changelog/CHANGELOG.html) to [3.1.0](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.1//changelog/CHANGELOG.html)
