...
### New 6000.5.0f1 Entries since 6000.5.0b11

#### Features

- iOS: Added support for gRPC through `UnityWebRequest`.

- VisionOS: Added support for gRPC through `UnityWebRequest`.
...
- Multiplayer: Fixed a write access error with `VirtualProjectSettings.json` when creating a MPPM Player Tag with Perforce connected.
    (UUM-144074)

- UI Toolkit: Added a HelpBox with button to enable the Hierarchy window v2 when Hierarchy Integration is enabled.
    ([UUM-133279](https://issuetracker.unity3d.com/issues/ui-authoring-enable-hierarchy-integration-property-shows-no-informational-message-when-the-new-hierarchy-window-is-disabled))<br>
...
- Editor: Render Pipeline Converter - Removed old Material and Material Reference Upgrade.
    (UUM-142430)<br>
    *First seen in 6000.5.0b9.*

- iOS: Removed note about UnityWebRequest exemption from App Store export regulations due to switch to libcurl from NSURLSession.

- Scripting: Disabled the Code Coverage Support option for 32-bit architecture build targets.
...
- 2D: Fixed an issue where the Light Type could not be changed in the Light Explorer.
    ([UUM-141119](https://issuetracker.unity3d.com/issues/2d-light-type-dropdown-reverts-to-inspector-value-and-cannot-be-changed-in-light-explorer-after-being-modified-in-the-inspector))<br>
    *First seen in 6000.5.0b6.*
...
- 2D: Fixed cleanup of BrushPickStore when BrushPickStore is a project asset.
...
- Animation: Fixed an issue where dopesheet keyframes were incorrectly initialized after a domain reload.
    ([UUM-142312](https://issuetracker.unity3d.com/issues/keyframes-disappear-in-the-docked-animation-window-after-switching-to-web-platform-in-build-profiles))<br>
    *First seen in 6000.5.0b8.*
...
- Asset Pipeline: Fixed an issue where the Reveal In Finder button in the Import Activity window could silently fail.
    ([UUM-137929](https://issuetracker.unity3d.com/issues/reveal-in-finder-button-in-the-import-activity-window-does-nothing-when-clicked))<br>
    *First seen in 6000.5.0b1.*
...
- Editor: Fixed **Switch Profile** button not appearing in the Build Profiles window after adding a Dedicated Server build profile until the window was reopened.
    ([UUM-143216](https://issuetracker.unity3d.com/issues/the-switch-profile-button-does-not-appear-when-a-dedicated-server-build-profile-is-added-until-the-build-profiles-window-is-reopened))<br>
...
- Editor: Fixed an issue where the "Edit Shape" button on the Shadow Caster Overlay remained enabled when using a custom Shadow Caster, even though custom shapes cannot be edited.
    ([UUM-140707](https://issuetracker.unity3d.com/issues/edit-shape-button-on-the-shadow-caster-overlay-is-not-disabled-when-using-the-custom-shadow-caster))<br>
    *First seen in 6000.5.0b5.*
...
- Editor: Fixed material selection in ObjectSelector ignoring subsequent selections after the first one.
    ([UUM-142695](https://issuetracker.unity3d.com/issues/material-selection-ignores-subsequent-selections-when-a-material-has-already-been-selected-once))<br>
    *First seen in 6000.5.0b9.*
...
- Editor: Multiplayer: Instance state and UI when cancelling a local instance in Manual Control.
    ([UUM-140043](https://issuetracker.unity3d.com/issues/warning-icon-remains-visible-when-cancelling-slash-stopping-a-newly-created-local-instance-run-in-a-play-mode-scenario))<br>
    *First seen in 6000.5.0b4.*
...
- Editor: Option in "Build and Run on" in Windows Build Profiles should be called "Xbox PC Remote Tools".
    (UUM-142525)<br>
    *First seen in 6000.5.0b8.*
...
- Editor: \[Android\] Replaced the link to the missing "Gradle Troubleshooting" page in the "Colliding Attributes" error window with a working "Gradle for Android" link for Unity 6.5.
...
- HDRP: Rendering Debugger: Fixed the Reset button not resetting the data.
    ([UUM-138047](https://issuetracker.unity3d.com/issues/reset-button-for-rendering-debugger-does-not-reset-the-debug-settings))<br>
    *First seen in 6000.5.0b1.*
...
- Multiplayer: Unity Transport: Fix accuracy of bandwidth calculations in `NetworkDriver` statistics. When bandwidth usage varied a lot over short periods of time, the calculations would be slightly off compared to reality.
    (UUM-143167)<br>
    *First seen in 6000.5.0b9.*
...
- Particles: Particles: Implemented a two-stage outlier detection in StoreLineData\(\) to resolve ribbon trail meshes from collapsing.
...
- Scripting: Fixed perf regression in array/list -&gt; Span bindings.
    (UUM-138682)<br>
...
- Shadergraph: Fixed an issue causing a "file not found" dialog to pop up when creating a ShaderGraph from the URP renderer feature editor.
    ([UUM-143570](https://issuetracker.unity3d.com/issues/access-denied-prompt-is-opened-and-fullscreen-shadergraph-cannot-be-created-from-the-renderer-features-inspector))

- Shadergraph: Fixed import errors in Shader Graph's Custom Lighting sample.
    ([UUM-142424](https://issuetracker.unity3d.com/issues/errors-are-thrown-when-custom-lighting-shader-graph-sample-is-imported))<br>
    *First seen in 6000.5.0b9.*
...
- SRP Core: Fixed UI Toolkit Volume Profiles in the Rendering Debugger.
    ([UUM-138168](https://issuetracker.unity3d.com/issues/rendering-debugger-window-stops-rendering-the-windows-content-and-throws-nullreferenceexception-when-diffusion-profile-list-component-is-selected-in-the-volume-section))<br>
    *First seen in 6000.5.0b1.*
...
- UI Toolkit: Disabled the UI Document upgrade button when editing a preset.
    ([UUM-144077](https://issuetracker.unity3d.com/issues/argumentexception-object-at-index-0-is-null-is-thrown-when-clicking-add-component-on-a-legacy-ui-document-preset))<br>
    *First seen in 6000.5.0b12.*
...
- UI Toolkit: Fixed PanelRenderer Inspector changes not persisting in scenes.
    ([UUM-143169](https://issuetracker.unity3d.com/issues/panelrenderer-world-space-settings-arent-persisted-in-the-scene))<br>
    *First seen in 6000.5.0b9.*
...
- UI Toolkit: Fixed the object type not being resolved by a PropertyField when it was a native type which referenced a MonoBehaviour.
    ([UUM-142780](https://issuetracker.unity3d.com/issues/nullreferenceexception-is-thrown-when-opening-the-source-asset-object-picker-for-panel-renderer-in-debug-inspector))<br>
    *First seen in 6000.5.0b9.*

- UI Toolkit: Fixed the UI Builder material definition dropdown from including read-only properties or ones that have already been included.
    ([UUM-130877](https://issuetracker.unity3d.com/issues/ui-builder-allows-overriding-read-only-material-properties))<br>
    *First seen in 6000.5.0a5.*
...
- Unity Physics: Fixed a bug when the incremental broadphase was enabled for static and dynamic bodies when a scene was reloaded which resulted in stale data being used.
    ([UUM-143292](https://issuetracker.unity3d.com/issues/trunk-system-dot-invalidoperationexception-errors-are-spammed-in-the-console-when-reloading-a-scene-while-using-incremental-dynamic-and-static-broadphase-in-a-subscene))<br>
    *First seen in 6000.5.0b8.*

- URP: AutodeskInteractive shader when Rendering Mode Fade is not converted to URP AutodeskinteractiveTransparent shader.
    ([UUM-136161](https://issuetracker.unity3d.com/issues/materialconverter-autodesk-interactive-material-rendering-mode-fade-is-not-converted))<br>
    *First seen in 6000.5.0a7.*
...
#### New 6000.5.0f1 Package Changes since 6000.5.0b11

#### Packages updated

- com.unity.2d.tooling: [3.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tooling@3.0//changelog/CHANGELOG.html) to [3.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tooling@3.0//changelog/CHANGELOG.html)
...
- com.unity.xr.openxr: [1.17.0](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.17//changelog/CHANGELOG.html) to [1.17.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.17//changelog/CHANGELOG.html)
...
- com.unity.microsoft.gdk.intelligent-delivery: [1.0.0-pre.2](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.intelligent-delivery@1.0//changelog/CHANGELOG.html) to [1.0.0](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.intelligent-delivery@1.0//changelog/CHANGELOG.html)

### Final 6000.5.0f1 Release Notes

#### Features

- 2D: Added a 2D Profiler that displays real-time visualization of texture atlas usage which offers clear insights into sprite and atlas efficiency during gameplay.

- 2D: Added extensibility support for `Light2D` and `ShadowCaster2D` components. You can now implement custom provider classes to modify or extend their behavior.

- Adaptive Performance: Activated Adaptive Performance Basic Provider for additional platforms.

- Adaptive Performance: The new Apple provider for Adaptive Performance enables thermal warnings for iOS, tvOS, and visionOS and includes a wide range of scalers usable with those warnings.
...
- Asset Pipeline: Import result caching in the Accelerator is now disabled by default for new projects. Projects upgrading to Unity 6.5 can continue to cache import results if cache configuration is already enabled.

- Audio: You can now use `AudioClip` as a Scriptable Generator.
...
- Editor: Added support for custom actions in the Build Profiles window footer.

- Editor: Added support for custom styling for lists and arrays from the `DataTypeStyleMapper`.

- Editor: Added the Swift project type \(experimental\) to the iOS Player settings.
...
- Editor: Project Auditor: Added asynchronous analysis.
...
- Editor: The Project Auditor now detects use of API that will become obsolete in a future Unity version.
...
- Entities: Added a setting in *Preferences* &gt; *Entities* to display hidden entities in the Hierarchy window.

- Entities: Added a way to filter systems by namespaces in the Systems window.
...
- License: Added support for Kerberos proxy authentication.
...
- Netcode for Entities: Netcode for Entities package now includes all the changes from 1.12.0 version.  This aligns the package state between the standalone and built-in versions.

- Package: Moved the Transport package from a separate repository into the Unity Engine as a built-in package.

- Package Manager: Added a *View More Samples* button to the Samples details tab in the *Package Manager* window.

- Package Manager: Added a dedicated Samples view in the *Package Manager* window.
...
- Package Manager: Added publish date as a sorting option on the Samples page.
...
- Physics 2D: Optimized Debug Rendering with more efficient SDF shaders. Fixed `drawThickness` and `drawPointScale` properties so they correctly render in pixel scales. It is recommended to reset the `PhysicsWorldDefinition` to its defaults or use the default values of 1 for `drawThickness`  and 0.5 for `drawPointScale`.
...
- Physics 2D: When using `PhysicsBody` transform writing of interpolation, you can now perform a final interpolation sync before the next simulation. This synchronizes the Transform with the current body pose using the `PhysicsWorld.syncInterpolation` or `PhysicsWorldDefinition.syncInterpolation` options.
...
- UI Toolkit: Added a UXML upgrade framework for applying automated UXML upgrades to fix common issues and deprecated patterns. It can be accessed from the `VisualTreeAsset` Inspector or through `UnityEditor.UIElements.UxmlUpgradeService`.

- UI Toolkit: Added a `PanelRenderer` component to UI Toolkit.

- UI Toolkit: Added an experimental USS Stats window.

- UI Toolkit: Added drag and drop support for the *StyleSheets* window.
...
- UI Toolkit: Added support for `simulate.Click` on world-space content in the UIToolkit Test Framework.
...
- Unity Physics: Added a new sample *Advanced Game Physics Sample - Chain and Gears* to the Unity Physics package. Import the sample into your project from the Samples tab of the Unity Physics package in the Package Manager window.  This sample demonstrates how to use the new Direct Solver to produce an advanced game physics scenario. It uses Unity Physics' novel solver technology to simulate a complex mechanism involving gears interacting with a chain. It combines the new Direct Solver for accurate simulation of the stiff chain links and the gears with the Iterative Solver for efficient simulation of all the collisions in the scene. Unity Physics automatically couples the results of both solvers for lifelike, stable, and efficient simulation results. This setup demonstrates how both solvers combined can capture emerging physical behaviors at real-time simulation rates, such as the jamming of the gears caused by the chain getting stuck between the gears' teeth.
...
- Version Control: Added support to partially apply a shelve in the merge view.
...
- Web: Added a submodule for the Clipper external library.

- Web: Added a submodule for the external `double-conversion` library.
...
- Web: Added submodules for the HierarchyCore module.

- Web: Added submodules for the Physics2D and PhysicsCore2D built-in modules.
...
- 2D: Improved Sprite Atlas Profile module UX.
...
- Android: Added Link Time Optimization in Android Build Profile window.

- Android: Added profiling markers to AndroidPlayer initialization process.

- Android: Enabled ThinLTO for XR.
...
- Android: Improved the dialog messages for Keystore signing error.

- Android: Play.asset-delivery plugin updated from version 2.1.0 to 2.3.0.
...
- Bug Reporter: Added optimizations to improve launch times.
...
- Documentation: Added additional detail for PointerEventData.pointerId.

- DX12: Added a DX12 GraphicsTests job.
...
- Editor: Added an informational message for light loop unroll shader improvement for Meta Platforms.

- Editor: Added an open settings button to "Can not sign the application" dialog.<br>
    Changed warning symbol to error symbol.
...
- Editor: Fixed example script to bind water texture to VFX Graph not compiling.

- Editor: Hierarchy: update HierarchyWindow extensibility API to make it more consistent with the rest of the Hierarchy module APIs.

- Editor: Improved interactivity of progress bar when opening the "Compile and Show Code" dropdown in the Shader Inspector.

- Editor: Improved performance when changing the graphics tier in the Editor.

- Editor: Improved Project Auditor code analysis.

- Editor: Improved the batchmode converter command line tool.
...
- Editor: Obsolete Helpbox can have a replacement component button.
...
- Entities: Entity and section nodes are now parented below subscene nodes in the new Hierarchy.
...
- GI: Modified light probe baking to use the pushoff value from Lightmap Parameters.

- GI: Moved the internal hardware ray-tracing toggle from the internal UI to the bottom bar GUI of the Lighting window. It has not been set as default with this change.
...
- Graphics Tests: Partially reenabled the Frustum For ShadowCaster test.

- Graphics Tests: Reenabled ClearCoat and Mapping tests in URP_Foundation project.
...
- HDRP: Added additional options for Contact Shadows to adjust for performance.
...
- HDRP: Added warning message for DepthOfField inspector on certain platforms.

- HDRP: Improved inspector messaging when advanced water features can have a perfomance impact in a given platform.

- HDRP: Improved Inspector messaging when RTX, SSS, or Film Grain can have a performance impact in a given platform.

- HDRP: Now when building a project, show messages about RTX, SSS or Film Grain performance impact if the platform will have a performance impact.

- HDRP: Optimized thread usage for volumetric lighting filtering.

- HDRP: Render Pipeline Converter: Allowed HDRP to use Readonly material converter.

- HDRP: UX improvements for performance warnings in HDRP produced on certain platforms.
...
- Installer: Removed the activation of .NET 3.5 on Windows systems to greatly reduce the installation time when using the installers directly.
...
- Particles: Renamed *Effects* to *Visual Effects* in the GameObjects menu.
...
- Physics: Changed the default broad-phase type for new projects to *Automatic-Box Pruning*. This improves performance for dynamic setups. You can find the broad-phase type for the physics system at *Project Settings* &gt; *Physics* &gt; *Settings* under the *GameObject* tab.

- Physics: Exposed incremental static broadphase toggle within the Project Settings -&gt; Physics -&gt; Settings pane. Historically incremental static broadphase has always been on, this does carry a performance cost for cases where all static Colliders never move/change. The default of this toggle is always ON.
...
- SRP Core: Fixed the error "Cannot return local actualPasses by reference because it is not a ref local" in RenderGraph PassesData.
...
- SRP Core: Render Pipeline Converter: Scan and Convert now only handles the visible converters.
...
- TextMeshPro: * Added `OnFontMaterialRequest` callback to complement the existing `OnFontAssetRequest` callback that allows custom loading of font related resources that are not contained in a Resources folder when using the &lt;font&gt; and &lt;material&gt; markup tag variants.<br>
...
- UI Toolkit: Added UI Toolkit profiler module.
...
- UI Toolkit: Improved mesh update performance on WebGL.

- UI Toolkit: Improved mesh update performance on WebGPU.
...
- URP: Render Pipeline Converter - BiRP to URP 2D : Added settings converter workflow.
...
- XR: Improved GPU performance on Meta Quest on Forward. Added a loop unroll keyword if there is only one additional light per object selected on the URP Asset.

- XR: Improved GPU performance on Meta Quest on the Forward and Forward+ renderer. If the light `distanceAttenuation` &lt;=0, the renderer avoids calculating light contribution to the pixel.
...
- 2D: Added: Added BlendShape API to SpriteRenderer to enable blend shape animations on 2D sprites.
...
- Android: Added: Added `AndroidAssetPacks.ShowConfirmationDialogAsync` method that wraps Android's `AssetPackManager.showConfirmationDialog` for displaying user confirmation dialogs to download Android asset packs.
...
- Android: Deprecated: Android: AGP 9.0.0 - Removed deprecated attributes including `targetSdkVersion`, `minSdkVersion`, `lintOptions`, `aaptOptions`, and `packagingOptions`.

- Asset Pipeline: Changed: Deprecated AssetImportContext.GetArtifactFilePath in favour of AssetImportContext.GetArtifactData.

- Asset Pipeline: Deprecated: AssetImportContext.GetOutputArtifactFilePath has been deprecated in favour of SetOutputArtifactData and SetOutputArtifactFile.

- Asset Pipeline: Deprecated: Deprecated `TryGetObjectIdentifier(int, out ObjectIdentifier)`, use `TryGetObjectIdentifier(EntityId, out ObjectIdentifier)` instead.
...
- Editor: Added: Added an API to add and remove variables in GTK graphs.
...
- Editor: Added: GTK : Added public API to add/remove node from graph.

- Editor: Added: GTK : Api to connect/disconnect wires<br>
    Added public APIs to connect and disconnect wires in Graph Toolkit. The new APIs are `bool Connect(IPort output, IPort input)` and `bool Disconnect(IPort output, IPort input)`.

- Editor: Added: Introduce build profile helper APIs for: OnActiveProfileChanged, GetAllBuildProfiles, GetBuildProfileAtPath, and GetInstalledPlatforms.
...
- Editor: Changed: \[Android\] Modify Build Settings - indented sub-settings under the Development Build checkbox and show or hide relevant settings depending on build type on Unity 6.5 for all platforms.

- Editor: Deprecated: - `HierarchyFlattenedNodeChildren` is now deprecated, replaced with `HierarchyFlattenedChildrenEnumerable`.<br>
    - `HierarchyViewNodesEnumerable` is now deprecated, replaced with `HierarchyViewModelNodesEnumerable`.
    (UUM-114955)
...
- EmbeddedLinux: Added: Added GameWindow extension method for setting input regions.

- EmbeddedLinux: Added: Added IVI Surface ID setting through the Windowing API.

- EmbeddedLinux: Added: Enabled Multi-windowing API.
...
- Entities: Obsoleted: A, b, OriginatingId and OriginatingSubId in EntityGuid have been made obsolete.
...
- GI: Deprecated: LightingSettings.DenoiserType.Optix is deprecated, resulting in a warning when used. Please use the LightingSettings.DenoiserType.OpenImage lightmap denoiser instead.

- Graph Toolkit: Added: Added API for accessing and modifying node and context node default color. Also adds the color right click menu option on context nodes.
...
- Graph Toolkit: Added: Added quality-of-life APIs for faster graph queries:<br>
    INode.IsConnected: Checks if a node has any connections.<br>
    IVariable.GetNodes: Retrieves all variable nodes associated with a variable.<br>
    IVariable.IsConnected: Checks if a variable has at least one connected variable node in the graph.<br>
    IVariable.NodeCount: Gets the number of variable nodes associated with this variable in the graph.

- Graph Toolkit: Added: Added support to customize a node's icon.

- Graph Toolkit: Added: Added the CategoryPath and Title parameters to NodeAttribute for modifying the path of a node within the graph item library. The path is constructed as "CategoryPath/Title". NodeAttribute.Title will also be used as the default title of its node unless Node.Title is set.

- Graph Toolkit: Added: Added the INode.Subtitle API to access and modify a node's subtitle.

- Graph Toolkit: Added: Added the INode.Title API for accessing and modifying the title of a node.
...
- Graphics: Deprecated: Deprecated instanceID \(int\) field in RayTracingInstanceMaterialCRC and use EntityId type instead.
...
- Profiler: Added: Added Profiler Module tooltip API for the custom charts and custom modules.

- Profiler: Deprecated: Deprecated multiple fields in `UISystemProfilerInfo`, use EntityId versions instead: `instanceIDsCount` to `entityIdsCount`, `instanceIDsIndex` to `entityIdsIndex`, `objectInstanceId` to `objectEntityId`, and `parentId` to `parentEntityId`.
...
- Profiler: Deprecated: Deprecated `AudioProfilerGroupInfo.assetInstanceId`, use `assetEntityId` instead.

- Profiler: Deprecated: Deprecated `AudioProfilerGroupInfo.objectInstanceId`, use `objectEntityId` instead.

- Profiler: Deprecated: Deprecated `EventMarker.objectInstanceId`, use `EventMarker.objectEntityId` instead.

- Profiler: Deprecated: Deprecated `GetUISystemBatchInstanceIDs()`, use `GetUISystemBatchEntityIds()` instead.

- Profiler: Deprecated: Deprecated `NativeObjects_InstanceId` enum value, use `NativeObjects_EntityId` instead.

- Profiler: Deprecated: Deprecated `NativeProfilerTimeline_GetInstanceInfoArgs.out_Id`, use `out_EntityId` instead.

- Profiler: Deprecated: Deprecated `ObjectMemoryInfo.instanceId`, use `entityId` instead.

- Profiler: Deprecated: Deprecated `ProfilerProperty.instanceIDs`, use `entityIds` instead.
...
- Scripting: Added: - Added new method `Hierarchy.SetParent(node, parent, index)` which can be used to change the parent of a node and move it to the specified index in the parent's children list.<br>
    - Added new method `HierarchyCommandList.SetParent(node, parent, index)` which complements the same method in `Hierarchy`.<br>
    - Added new method `HierarchyFlattened.GetChild(parent, index)` to retrieve the child at the specified index for a parent node.<br>
    - Added new method `HierarchyViewModel.GetChild(parent, index)` to retrieve the child at the specified index for a parent node.
    (UUM-114955)
...
- Scripting: Added: Added new APIs and classes to enable HierarchyView and HierarchyWindow customization.
...
- Scripting: Added: Exposed Edit and Play Mode Lifecycle Attributes.

- Scripting: Added: Exposed `OnCode` lifecycle attributes for domain reload event handling.

- Scripting: Changed: - It is now possible to use negative sort index \(full range of `int`, previously was constrained to positive values of `int`\).<br>
    - Method `Hierarchy.SetName(node, name)` now returns `void` instead of `bool`, because the return value is not used.<br>
    - Method `Hierarchy.SetParent(node, parent)` now returns `void` instead of `bool`, because the return value is not used.<br>
    - Enumerable of `HierarchyFlattened.EnumerateChildren` now provides `HierarchyFlattenedNode` instead of `HierarchyNode`, as initially intended.<br>
    - Renamed `HierarchyFlattenedNodeChildren` to `HierarchyFlattenedChildrenEnumerable` for consistency and made the old one deprecated.<br>
    - Renamed `HierarchyViewNodesEnumerable` to `HierarchyViewModelNodesEnumerable`, which was the wrong name \(HierarchyView and HierarchyViewModel are two different thing\), for consistency, and made the old one deprecated.
    (UUM-114955)
...
- UI Toolkit: Added: Added support for PanelRenderer in RuntimeUITestFixtures.
...
- UI Toolkit: Added: Added UI Toolkit profiler category and moved associated markers to this new category.
...
- Android: Android: AGP 9.0.0 - Removed the `versionCode`/`versionName` properties from library Gradle modules as they have no effect. These properties are only taken into account by Gradle in application modules.

- Android: Android: AGP 9.0.0 - Replaced the deprecated ProGuard configuration file `proguard-android.txt` with `proguard-android-optimize.txt`.
...
- Android: Removed x86_64 support completely for Android.
...
- Animation: Migration of the Animation Window to UI Toolkit.
...
- Build Pipeline: Removed force texture readable from build usage tags. Added a new button to the Particle System Shape Module and Terrain Paint Detail to fix non-readable textures.
...
- Editor: Changed the default save location for `Editor.log` to the project's `/Logs/` directory.
...
- Editor: Replaced obsolete `GetInstanceId` calls in Unity Physics baking with `GetEntityId` calls.
...
- Entities: Fixed an issue where the Inspector wrongly displays "This Entity only exists at runtime" when selecting entities from the new Hierarchy.

- Entities: Improved determinism of Runtime Content Management archive folder across builds.
...
- Graphics: Marked Dynamic Batching as deprecated.
...
- HDRP: Added optimization warning for Graphics Compositor for certain platforms.

- HDRP: Added optimization warning for High Quality Line Rendering for certain platforms.
...
- IL2CPP: Changed the serialized form of GenericParameterIndex in the global metadata file to use the smallest possible numeric representation and changed Il2CppGenericContainer's TypeArgc to ushort, reducing the metadata size for most programs.

- IL2CPP: Changed the serialized form of MethodIndex in the global metadata file to use the smallest possible numeric representation, reducing the metadata size for most programs.
...
- Package: Deprecated the WebRTC package in Unity 6.4.
...
- SRP Core: Converted Rendering Debugger Editor and Runtime UI to use UI Toolkit.
...
- UI Toolkit: Enabled multiple documentation versions for UI Test Framework by syncing the package version to the Unity Editor version.
...
- Windows: AsyncReadManager now supports DirectStorage when enabled.
...
- 2D: Fixed crash when a user paints a large number of Tiles onto a Tilemap GameObject with a TilemapCollider2D.
...
- 2D: Fixed exception when using preview toggle in Sprite Editor Window when the imported texture is smaller than the source texture.
...
- 2D: Fixed Spriterenderer's sprite reference does not get reverted back to original after using Sprite Editor Window preview toggle when enter playmode. In addition Sprite Editor Window preview toggle is now only available in edit mode.
...
- Android: Fixed keyboard Area on Android.
...
- Android: Fixed problem with SeekTimeOnResumeVideo test instability.
    (UUM-140837)
...
- Android: Included alpha channel value into  staticSplashScreenBackgroundColor variable.
...
- Animation: Fixed bug where renaming state machine from inspector would not rename corresponding layer.
...
- Asset Pipeline: Fixed an issue where shader caches were incorrectly shared across different platforms that use the same graphics API.
...
- Asset Pipeline: Optimized `AssetImportWorker` shutdown to reduce delays when closing the Editor.
...
- Build Pipeline: Fixed rare crash in ContentFile system within the OnFileStreamEvent function.
    (UUM-135104)

- Build Pipeline: Prevent incorrect path prefix stripping in MonoScriptInfoGenerator.
...
- Editor: Added ability to navigate upward in the serialized property tree using `SerializedProperty.Parent()`.
...
- Editor: Added customization point in SearchViewState to decide how to filter out query syntax errors.

- Editor: Added dynamic filtering for Query Tree.
...
- Editor: Added the Bindings section in the VisualElement inspector that displays the data source like in the UI Builder.
...
- Editor: Added uGUI Instrumentation to analytics assembly.
...
- Editor: AGP 9.0.0 - Use CompilerSdkVersion instead of CompilerSdk in .gradle files.
...
- Editor: Changed to the ProjectSettings/EditorSettings.asset made externally to Unity are now reflected in Asset Database for Cache Accelerator configuration.
...
- Editor: Clean up naming of new worker client and other clean ups.

- Editor: Clean up SceneBackup files when they do not represent unsaved state to avoid spurious recovery dialogues appearing when the editor has crashed.
    (UUM-142761)

- Editor: Converted the Vulkan Device Filter Lists asset Inspector window from Editor GUI to UI Toolkit.
...
- Editor: Editor: Add sender HierarchyView and HierarchyWindow arguments to HierarchyView and HierarchyWindow events.
...
- Editor: Ensure Index at startup is true for new project.
...
- Editor: Ensure we restore view state in CreateGui.
...
- Editor: Ensured AddBlock button images are correctly sized.
    ([UUM-132517](https://issuetracker.unity3d.com/issues/search-icon-visual-quality-drops-after-unity-theme-change-on-non-primary-monitor))
...
- Editor: ExpressionBlock do not have right click menu \(they are readonly\).
...
- Editor: Fixed an issue where the URL to reach the services was malformed under certain circumstances.
...
- Editor: Fixed an issue with importing samples with dependencies from the all samples tab in Package Manager.
    ([UUM-137883](https://issuetracker.unity3d.com/issues/prefab-instance-problem-missing-prefab-asset-errors-are-thrown-in-the-console-window-when-opening-agora-scene-from-hdrp-renderer-shader-user-value-samples))
...
- Editor: Fixed background color performance regression.
    (UUM-120281)
...
- Editor: Fixed broken link to sprites documentation in TMP rich text supported list.

- Editor: Fixed broken RASTER_HINTED font atlas when created in the Font Asset Creator.
    ([UUM-142852](https://issuetracker.unity3d.com/issues/some-glyphs-are-skewed-in-rendered-textmeshpro-font-asset-when-using-raster-hinted-render-mode))

- Editor: Fixed bug where clicking *Delete* in the context menu on a selection of multiple blocks in a context node would only delete the block that was clicked on instead of the entire selection.
    (UUM-137656)
...
- Editor: Fixed grid size and snap increment fields accepting incorrect values.
...
- Editor: Fixed multi-atlas for IMGUI with ATG.
...
- Editor: Fixed Properties window tab title for unnamed inspected objects.
    ([UUM-139943](https://issuetracker.unity3d.com/issues/properties-window-tab-displays-no-title-when-opening-properties-for-a-visual-tree-asset-selected-in-the-editors-hierarchy-window))
...
- Editor: Fixed SRP Sample dependency importer.
    ([UUM-137883](https://issuetracker.unity3d.com/issues/prefab-instance-problem-missing-prefab-asset-errors-are-thrown-in-the-console-window-when-opening-agora-scene-from-hdrp-renderer-shader-user-value-samples))
...
- Editor: Fixed the behavior of overlay that ensure they remain visible in the window.
...
- Editor: Fixed the ping are in the project window when showing a grid, it now includes the icon area.
...
- Editor: GTK : Fixed an issue where analytics would be sent during gtk unit tests.
    (UUM-138048)
...
- Editor: Hierarchy: Fix null reference exception when dragging.
...
- Editor: Index package by default except for source build.
    ([UUM-127103](https://issuetracker.unity3d.com/issues/packages-are-not-indexed-by-default))
...
- Editor: Ixed NullReferenceException that could occur on domain reload when setting up preview dropdown.
...
- Editor: Made the new import scheduler and worker code the default.
...
- Editor: Pressing Tabs doesn't thrown if an expressionBlock is selected.
...
- Editor: Removed timestamp manipulation to get NestedPrefab test passing with OOP.
...
- Editor: Subtract waitforlastpresentationtime from cpu time to correct the active cpu time computation on all platforms where waitforlastpresentationtime happens inside the playerloop.
    (UUM-131842)
...
- Editor: Vulkan Device Filter Lists asset Inspector now uses less space.
    ([UUM-136073](https://issuetracker.unity3d.com/issues/list-is-empty-component-in-vulkan-device-filter-inspector-window-has-excessive-spacing))
...
- EmbeddedLinux: Allow per-window transparency setting using the Windowing API.
...
- Engine Diagnostics: Fixed Usymtool attempting to upload GameAssembly.pdb symbols when building a Windows player with the Mono scripting backend, even though that file only exists for IL2CPP builds.
    ([UUM-137951](https://issuetracker.unity3d.com/issues/usymtool-tries-to-upload-gameassembly-dot-pdb-when-it-doesnt-exist-after-building-with-mono-backend))
...
- Entities: Fixed issue in rare cases where the Entities ILPostProcessor would hang, preventing the project from opening.
...
- Graphics: Added Debug Markers for buffer names.
...
- Graphics: Extend the GraphicsStateCollection Importer Inspector window to link Shaders to existing shader assets.
...
- Graphics: Fixed Vulkan validation error caused by shader compilation issue.
    (UUM-122579)
...
- Graphics: Implement buffer name Debug Markers.
...
- HDRP: Fixed a bug that the indirect draw arguments buffer for local fog volumes is sometimes corrupted.
    (SRP-1086)
...
- IL2CPP: Added variable-width precision when serializing FieldIndex and DefaultDataValueIndex in the global-metadata.dat file resulting in reduced file size for most programs.
...
- Kernel: Decreased CPU usage when moving NavMesh Obstacles with carving enabled.
...
- macOS: Fixed `QualitySettings.maxQueuedFrames` so it is honored when using Metal DisplayLink.
    (UUM-141122)
...
- Multiplayer: Fixed an issue where entering Play Mode with compiler errors changes the Play icon to the a Stop icon even though the Editor is not in Play Mode.
...
- N/A \(internal\): Render Service for Android: fixed soft input dismissal logic when clicking on same input field \(uGui\).
    (UUM-139306)
...
- Netcode for Entities: Fixed issue where prediction switching a static, unchanging ghost \(to predicted\) would cause massive 64-tick rollbacks.

- Netcode for Entities: Fixed issue where the GhostUpdateSystem's predicted ghost history backup lookups were failing whenever other entities within the chunk were deleted \(which caused the cached entityIndexInChunk to be incorrect\).

- Netcode for Entities: Fixed missing profiler marker for GhostReceiveSystem.
...
- Physics: Prevent stack overflow when raycasting on `MeshCollider` with `Use Fast Midphase` cooking option.
...
- Profiler: Select CPU Module when using IProfilerFrameTimeViewSampleSelectionController.SetSelection API.
    (UUM-131459)
...
- QNX: Enabled Multi-windowing API.
...
- Scene/Game View: Fixed an issue where settings the grid position to handle position could go to infinity when handle position was invalid.
...
- Scripting: Fixed bug that prevented Ionic.Zlib.CF.plugin dll from being loaded.
...
- Scripting: Introduced EditModeScope.

- Scripting: Introduced PlayModeScope.
...
- Shadergraph: Fixed a bug that custom extensions changes would not Undo properly.
    (UUM-136836)
...
- SRP Core: Updated RendererFeature Script Template to follow best practices.
...
- Test Framework: Editor will be consider active even when focus is changed during a test run.
    (UUM-113242)
...
- Text: Obsoleted TextCore only APIs.
...
- uGUI: Fixed an issue with the Input Field so it now deactivates properly when `OnSubmit` is triggered with the virtual keyboard status set to Done.
...
- UI Toolkit: Removed builtin resources from UI Builder asset pickers.
    ([UUM-133170](https://issuetracker.unity3d.com/issues/ui-builder-becomes-unresponsive-and-uxml-assets-get-corrupted-when-assigning-a-texture2d-assetreference-variable-to-a-selector))
...
- URP: Material Reference Converter for URP 3D to URP 2D migration. Enables converting existing URP projects from Universal Renderer to 2D Renderer by automatically remapping material references.
...
- VFX Graph: Fixed a "missing script" warning when saving a VFX asset while in Play mode or loading a scene with `VisualEffects` from a script.
    ([UUM-132990](https://issuetracker.unity3d.com/issues/saving-changes-on-the-dirty-vfx-graph-during-the-play-mode-throws-the-referenced-script-unknown-on-this-behaviour-is-missing-warnings))
...
- XR: Quad Views post-processing effects now render correctly without visible seams between inner and peripheral views.
    (UUM-133972)




#### Final 6000.5.0f1 Package changes
...
- com.unity.2d.animation: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@13.0//changelog/CHANGELOG.html) to [15.1.0](https://docs.unity3d.com/Packages/com.unity.2d.animation@15.1//changelog/CHANGELOG.html)

- com.unity.2d.common: [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.common@12.0//changelog/CHANGELOG.html) to [14.0.1](https://docs.unity3d.com/Packages/com.unity.2d.common@14.0//changelog/CHANGELOG.html)
...
- com.unity.2d.psdimporter: [12.0.0](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@12.0//changelog/CHANGELOG.html) to [14.0.3](https://docs.unity3d.com/Packages/com.unity.2d.psdimporter@14.0//changelog/CHANGELOG.html)

- com.unity.2d.spriteshape: [13.0.0](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@13.0//changelog/CHANGELOG.html) to [15.0.3](https://docs.unity3d.com/Packages/com.unity.2d.spriteshape@15.0//changelog/CHANGELOG.html)

- com.unity.2d.tilemap.extras: [6.0.0](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@6.0//changelog/CHANGELOG.html) to [8.0.3](https://docs.unity3d.com/Packages/com.unity.2d.tilemap.extras@8.0//changelog/CHANGELOG.html)

- com.unity.2d.aseprite: [3.0.0](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@3.0//changelog/CHANGELOG.html) to [5.0.3](https://docs.unity3d.com/Packages/com.unity.2d.aseprite@5.0//changelog/CHANGELOG.html)

- com.unity.2d.tooling: [1.0.0-pre.1](https://docs.unity3d.com/Packages/com.unity.2d.tooling@1.0//changelog/CHANGELOG.html) to [3.0.1](https://docs.unity3d.com/Packages/com.unity.2d.tooling@3.0//changelog/CHANGELOG.html)
...
- com.unity.burst: [1.8.25](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html) to [1.8.29](https://docs.unity3d.com/Packages/com.unity.burst@1.8//changelog/CHANGELOG.html)
...
- com.unity.collab-proxy: [2.10.0](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.10//changelog/CHANGELOG.html) to [2.12.4](https://docs.unity3d.com/Packages/com.unity.collab-proxy@2.12//changelog/CHANGELOG.html)
...
- com.unity.formats.alembic: [2.4.0](https://docs.unity3d.com/Packages/com.unity.formats.alembic@2.4//changelog/CHANGELOG.html) to [2.4.5](https://docs.unity3d.com/Packages/com.unity.formats.alembic@2.4//changelog/CHANGELOG.html)
...
- com.unity.localization: [1.5.8](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html) to [1.5.11](https://docs.unity3d.com/Packages/com.unity.localization@1.5//changelog/CHANGELOG.html)
...
- com.unity.ml-agents: [2.0.1](https://docs.unity3d.com/Packages/com.unity.ml-agents@2.0//changelog/CHANGELOG.html) to [4.0.3](https://docs.unity3d.com/Packages/com.unity.ml-agents@4.0//changelog/CHANGELOG.html)
...
- com.unity.performance.profile-analyzer: [1.2.4](https://docs.unity3d.com/Packages/com.unity.performance.profile-analyzer@1.2//changelog/CHANGELOG.html) to [1.4.0](https://docs.unity3d.com/Packages/com.unity.performance.profile-analyzer@1.4//changelog/CHANGELOG.html)
...
- com.unity.purchasing: [4.13.2](https://docs.unity3d.com/Packages/com.unity.purchasing@4.13//changelog/CHANGELOG.html) to [4.15.1](https://docs.unity3d.com/Packages/com.unity.purchasing@4.15//changelog/CHANGELOG.html)

- com.unity.recorder: [5.1.3](https://docs.unity3d.com/Packages/com.unity.recorder@5.1//changelog/CHANGELOG.html) to [5.1.6](https://docs.unity3d.com/Packages/com.unity.recorder@5.1//changelog/CHANGELOG.html)
...
- com.unity.services.analytics: [6.1.1](https://docs.unity3d.com/Packages/com.unity.services.analytics@6.1//changelog/CHANGELOG.html) to [6.3.0](https://docs.unity3d.com/Packages/com.unity.services.analytics@6.3//changelog/CHANGELOG.html)

- com.unity.services.authentication: [3.5.2](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.5//changelog/CHANGELOG.html) to [3.6.1](https://docs.unity3d.com/Packages/com.unity.services.authentication@3.6//changelog/CHANGELOG.html)
...
- com.unity.services.cloud-build: [2.0.5](https://docs.unity3d.com/Packages/com.unity.services.cloud-build@2.0//changelog/CHANGELOG.html) to [2.0.8](https://docs.unity3d.com/Packages/com.unity.services.cloud-build@2.0//changelog/CHANGELOG.html)

- com.unity.services.core: [1.15.2](https://docs.unity3d.com/Packages/com.unity.services.core@1.15//changelog/CHANGELOG.html) to [1.18.0](https://docs.unity3d.com/Packages/com.unity.services.core@1.18//changelog/CHANGELOG.html)

- com.unity.services.vivox: [16.7.0](https://docs.unity3d.com/Packages/com.unity.services.vivox@16.7//changelog/CHANGELOG.html) to [16.10.0](https://docs.unity3d.com/Packages/com.unity.services.vivox@16.10//changelog/CHANGELOG.html)
...
- com.unity.splines: [2.8.2](https://docs.unity3d.com/Packages/com.unity.splines@2.8//changelog/CHANGELOG.html) to [2.8.4](https://docs.unity3d.com/Packages/com.unity.splines@2.8//changelog/CHANGELOG.html)
...
- com.unity.test-framework.performance: [3.2.0](https://docs.unity3d.com/Packages/com.unity.test-framework.performance@3.2//changelog/CHANGELOG.html) to [3.5.0](https://docs.unity3d.com/Packages/com.unity.test-framework.performance@3.5//changelog/CHANGELOG.html)
...
- com.unity.timeline: [1.8.9](https://docs.unity3d.com/Packages/com.unity.timeline@1.8//changelog/CHANGELOG.html) to [1.8.12](https://docs.unity3d.com/Packages/com.unity.timeline@1.8//changelog/CHANGELOG.html)
...
- com.unity.xr.arcore: [6.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.4//changelog/CHANGELOG.html) to [6.5.0](https://docs.unity3d.com/Packages/com.unity.xr.arcore@6.5//changelog/CHANGELOG.html)

- com.unity.xr.arfoundation: [6.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.4//changelog/CHANGELOG.html) to [6.5.0](https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@6.5//changelog/CHANGELOG.html)

- com.unity.xr.arkit: [6.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.4//changelog/CHANGELOG.html) to [6.5.0](https://docs.unity3d.com/Packages/com.unity.xr.arkit@6.5//changelog/CHANGELOG.html)

- com.unity.xr.compositionlayers: [2.1.1](https://docs.unity3d.com/Packages/com.unity.xr.compositionlayers@2.1//changelog/CHANGELOG.html) to [2.4.0](https://docs.unity3d.com/Packages/com.unity.xr.compositionlayers@2.4//changelog/CHANGELOG.html)
...
- com.unity.xr.hands: [1.7.0](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.7//changelog/CHANGELOG.html) to [1.8.0](https://docs.unity3d.com/Packages/com.unity.xr.hands@1.8//changelog/CHANGELOG.html)

- com.unity.xr.interaction.toolkit: [3.3.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.3//changelog/CHANGELOG.html) to [3.5.0](https://docs.unity3d.com/Packages/com.unity.xr.interaction.toolkit@3.5//changelog/CHANGELOG.html)
...
- com.unity.xr.meta-openxr: [2.4.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.4//changelog/CHANGELOG.html) to [2.5.0](https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.5//changelog/CHANGELOG.html)

- com.unity.xr.openxr: [1.16.0-pre.2](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.16//changelog/CHANGELOG.html) to [1.17.1](https://docs.unity3d.com/Packages/com.unity.xr.openxr@1.17//changelog/CHANGELOG.html)
...
- com.unity.multiplayer.playmode: [2.0.0](https://docs.unity3d.com/Packages/com.unity.multiplayer.playmode@2.0//changelog/CHANGELOG.html) to [2.0.2](https://docs.unity3d.com/Packages/com.unity.multiplayer.playmode@2.0//changelog/CHANGELOG.html)
...
- com.unity.dedicated-server: [2.0.0](https://docs.unity3d.com/Packages/com.unity.dedicated-server@2.0//changelog/CHANGELOG.html) to [2.0.2](https://docs.unity3d.com/Packages/com.unity.dedicated-server@2.0//changelog/CHANGELOG.html)

- com.unity.memoryprofiler: [1.1.9](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1//changelog/CHANGELOG.html) to [1.1.12](https://docs.unity3d.com/Packages/com.unity.memoryprofiler@1.1//changelog/CHANGELOG.html)

- com.unity.netcode.gameobjects: [2.6.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.6//changelog/CHANGELOG.html) to [2.12.0](https://docs.unity3d.com/Packages/com.unity.netcode.gameobjects@2.12//changelog/CHANGELOG.html)
...
- com.unity.ai.navigation: [2.0.9](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html) to [2.0.13](https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0//changelog/CHANGELOG.html)

- com.unity.services.deployment: [1.6.2](https://docs.unity3d.com/Packages/com.unity.services.deployment@1.6//changelog/CHANGELOG.html) to [1.7.2](https://docs.unity3d.com/Packages/com.unity.services.deployment@1.7//changelog/CHANGELOG.html)
...
- com.unity.dt.app-ui: [2.1.1](https://docs.unity3d.com/Packages/com.unity.dt.app-ui@2.1//changelog/CHANGELOG.html) to [2.1.7](https://docs.unity3d.com/Packages/com.unity.dt.app-ui@2.1//changelog/CHANGELOG.html)
...
- com.unity.addressables.android: [1.0.7](https://docs.unity3d.com/Packages/com.unity.addressables.android@1.0//changelog/CHANGELOG.html) to [1.1.0](https://docs.unity3d.com/Packages/com.unity.addressables.android@1.1//changelog/CHANGELOG.html)

- com.unity.microsoft.gdk: [1.4.5](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk@1.4//changelog/CHANGELOG.html) to [1.6.0](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk@1.6//changelog/CHANGELOG.html)

- com.unity.microsoft.gdk.tools: [1.4.5](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.tools@1.4//changelog/CHANGELOG.html) to [1.6.0](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.tools@1.6//changelog/CHANGELOG.html)

- com.unity.microsoft.gdk.discovery: [1.1.1](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.discovery@1.1//changelog/CHANGELOG.html) to [1.3.0](https://docs.unity3d.com/Packages/com.unity.microsoft.gdk.discovery@1.3//changelog/CHANGELOG.html)
...
- com.unity.polyspatial: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.0//changelog/CHANGELOG.html) to [3.1.5](https://docs.unity3d.com/Packages/com.unity.polyspatial@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.visionos: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.0//changelog/CHANGELOG.html) to [3.1.5](https://docs.unity3d.com/Packages/com.unity.polyspatial.visionos@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.xr: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.0//changelog/CHANGELOG.html) to [3.1.5](https://docs.unity3d.com/Packages/com.unity.polyspatial.xr@3.1//changelog/CHANGELOG.html)

- com.unity.polyspatial.extensions: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.0//changelog/CHANGELOG.html) to [3.1.5](https://docs.unity3d.com/Packages/com.unity.polyspatial.extensions@3.1//changelog/CHANGELOG.html)

- com.unity.xr.visionos: [3.0.3-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.0//changelog/CHANGELOG.html) to [3.1.5](https://docs.unity3d.com/Packages/com.unity.xr.visionos@3.1//changelog/CHANGELOG.html)
...
- com.unity.services.multiplayer: [1.2.0](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@1.2//changelog/CHANGELOG.html) to [2.1.3](https://docs.unity3d.com/Packages/com.unity.services.multiplayer@2.1//changelog/CHANGELOG.html)

- com.unity.asset-manager-for-unity: [1.7.0](https://docs.unity3d.com/Packages/com.unity.asset-manager-for-unity@1.7//changelog/CHANGELOG.html) to [1.11.0](https://docs.unity3d.com/Packages/com.unity.asset-manager-for-unity@1.11//changelog/CHANGELOG.html)
...
- com.unity.xr.androidxr-openxr: [1.2.0-pre.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.2//changelog/CHANGELOG.html) to [1.3.1](https://docs.unity3d.com/Packages/com.unity.xr.androidxr-openxr@1.3//changelog/CHANGELOG.html)

- com.unity.ai.inference: [2.2.1](https://docs.unity3d.com/Packages/com.unity.ai.inference@2.2//changelog/CHANGELOG.html) to [2.6.1](https://docs.unity3d.com/Packages/com.unity.ai.inference@2.6//changelog/CHANGELOG.html)
...
- [com.unity.cloud.draco@5.4.3](https://docs.unity3d.com/Packages/com.unity.cloud.draco@5.4//changelog/CHANGELOG.html)
...
- [com.unity.cloud.ktx@3.6.3](https://docs.unity3d.com/Packages/com.unity.cloud.ktx@3.6//changelog/CHANGELOG.html)
