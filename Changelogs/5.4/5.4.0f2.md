...
*   Graphics: Texture Array support; seeTexture2DArray class. ![description](/sites/default/files/5_4_feature_texturearrays.png)
...
*   GI: Added de-noising filter to baked final gather.  
    Before: ![description](/sites/default/files/5_4_improvement_final-gather-denoising-before.png) After: ![description](/sites/default/files/5_4_improvement_final-gather-denoising-after.png)
...
*   GI: HDR color picker is now used for ambient color, instead of color plus ambient intensity. ![description](/sites/default/files/5_4_improvement_ambientcolorhdr.png)
...
*   Graphics: Ambient Occlusion now has separate sliders for direct and indirect light. The default value is Ambient Occlusion on indirect light only. ![description](/sites/default/files/5_4_improvement_ambientocclusionseparatesliders.png)
...
*   OpenGL: OpenGLES3.0: Fixed crash and reflection probes corruption on A9 chipsets.
...
*   [\[753940\]](https://issuetracker.unity3d.com/issues/particle-system-simulate-issues) Particles: Particle system Simulate issues
...
*   [\[786561\]](https://issuetracker.unity3d.com/issues/texturesheetanimation-start-frame-range-is-one-frame-longer-than-available-frames-i-dot-e-tilesx-star-tilesy) Particles: Start Frame range is one frame longer than available frames (i.e. TilesX\*TilesY)
...
*   \[790626\] PS Vita: Fixed issue whereby script-only builds did not copy native plugins.
*   \[788521\] PS Vita: Fixed issue whereby use of 'Best Performance' DSP buffer size would result in a crash.
*   \[790626\] PS4: Fixed issue whereby script-only builds did not copy native plugins.
...
*   [\[740148, 759967\]](https://issuetracker.unity3d.com/issues/loaded-and-inactive-canvas-rect-size-is-0) UI: Fixed performance issue when using Screen Space Camera or World space canvases.
...
*   \[800289, 768871\] VCS: Updated VCS plugins from Bitbucket with improved support for IPv6 server connections on Windows and OSX and SSL server connections on Windows, OSX and Linux.
...
*   [\[803250\]](https://issuetracker.unity3d.com/issues/wsa-fullscreen-movie-player-has-no-exit-button) Windows Store: It is now possible to stop playing video using the Escape or Back button when playing video using Handheld.PlayFullScreenMovie.
...
*   [\[763293\]](https://issuetracker.unity3d.com/issues/android-local-assetbundles-do-not-load-on-android) AssetBundles: Fixed AssetBundle.LoadFromFile usage with Application.streamingAssetsPath on Android
*   [\[798640\]](https://issuetracker.unity3d.com/issues/standalone-camera-doesnt-render-to-second-monitor-when-set-by-script-after-first-rendered-frame) Camera: Fixed issue with silently disabling cameras that have non-existing target display set on them.
*   [\[811990\]](https://issuetracker.unity3d.com/issues/plugins-ignored-for-linux-universal-builds) Editor: Fix deployment of native plugins when building Linux Universal player (existing projects will need to reapply plugin importer settings)
*   [\[807174\]](https://issuetracker.unity3d.com/issues/profiler-frame-debugger-while-frame-debugging-onrenderimage-effects-editor-spam-errors) FrameDebugger: Fixed assert 'PPtr cast failed when dereferencing! Casting from Mesh to Renderer!'
...
*   [\[785131\]](https://issuetracker.unity3d.com/issues/display-dot-main-returns-left-screen-instead-of-selected-main) Graphics: Fixed Display.main not always being Display.displays\[0\] in multi-display configurations.
*   [\[790798\]](https://issuetracker.unity3d.com/issues/graphics-directional-light-passes-through-the-tree-leafs-making-them-abnormally-lit) Graphics: Fixed Lambert lighting by removing specular highlight from it. The renderer interprets black specular color as a hint to zero out the specular term.
*   [\[810551, 810692\]](https://issuetracker.unity3d.com/issues/reliablefragmented-channel-stops-working-after-client-has-disconnected-then-reconnects) Networking: Fixed ReliableFragmented channel stops working after client has disconnected, then reconnects.
*   [\[805565\]](https://issuetracker.unity3d.com/issues/shuriken-3d-start-rotation-affects-rotation-over-lifetime-module) Particles: 3D start rotation affects Rotation Over Lifetime module
*   [\[806920\]](https://issuetracker.unity3d.com/issues/shuriken-gettriggerparticles-returns-incorrect-value-for-first-few-frames-running-in-editor) Particles: GetTriggerParticles returns incorrect value for first few frames running in editor
*   [\[791082\]](https://issuetracker.unity3d.com/issues/particle-system-twitches-when-being-moved) Particles: Particle system twitches when being moved in the Editor
*   [\[803866\]](https://issuetracker.unity3d.com/issues/shuriken-particle-dot-getcurrentsize3d-apply-curves-only-to-x-if-separate-axis-is-not-set) Particles: Particle.GetCurrentSize3D apply curves only to x if separate axis is not set
*   [\[521391\]](https://issuetracker.unity3d.com/issues/particlesystems-inconsistent-behavior-with-time-dot-timescale) Particles: ParticleSystem's inconsistent behavior with Time.timeScale
*   \[805843\] Particles: Trigger particle with 0 speed fails to know whether they are inside or outside collider
*   [\[805903\]](https://issuetracker.unity3d.com/issues/shuriken-trigger-radius-scale-property-is-not-exposed-to-public-api) Particles: Trigger radius scale property is not exposed to public API
*   [\[806580\]](https://issuetracker.unity3d.com/issues/object2world-references-are-not-changed-to-unity-objecttoworld-if-they-are-followed-by-a-period-object2world-dot) Shaders: Fixed auto-rename of \_Object2World -> unity\_ObjectToWorld not working in all cases.
*   [\[772003\]](https://issuetracker.unity3d.com/issues/cursor-locked-cursor-is-not-centered-on-the-y-axis-cursor-dot-lockstate-equals-cursorlockmode-dot-locked) UI: Fix inadvertent interaction with UI when cursor is locked
...
*   [\[768871\]](https://issuetracker.unity3d.com/issues/perforce-support-wont-connect-to-helix-cloud-due-to-outdated-p4-api-code) VCS: VCS: Updated VCS plugins from Bitbucket with improved support for IPv6 server connections on Windows and OSX and SSL server connections on Windows, OSX and Linux.
...
*   \[812460\] AI: Fixed regression introduced in 5.4 where baking navmesh can result in wrong height of some polygons and discontinuities across some navmesh tile boundaries. Re-bake navmesh to fix this problem.
*   Android: Audio - Yet another fix for audio focus issues
*   \[790236\] Android: Editor - Fixed an issue where it was impossible to push to devices running Android N Preview
*   \[757111\] Android: Fixed a crash caused by location updates.
*   [\[793738\]](https://issuetracker.unity3d.com/issues/hebrew-is-not-recognized-on-android-by-application-dot-systemlanguage) Android: Fixed an issue where Indonesian and Hebrew weren't properly recognized by SystemInfo
*   Android: Fixed deployment to devices with unknown OpenGL ES target
*   [\[786289\]](https://issuetracker.unity3d.com/issues/crash-on-some-mobile-when-using-argb32-temporary-render-textures-from-unity-5-dot-2-1) Android: Fixed high memory usage of RenderTexture.GetTemporary
*   [\[782985\]](https://issuetracker.unity3d.com/issues/andorid-slash-plugins-java-dot-lang-dot-nosuchmethoderror-when-invoking-public-static-method-with-androidjavaobject) Android: JNI - Throw correct exception when method not found by reflection
*   [\[811173\]](https://issuetracker.unity3d.com/issues/aw-changing-rotation-set-in-one-keyframe-affects-other-keyframe) Animation: Fixed first rotation key frame not properly set when recording in animation window.
*   [\[812168\]](https://issuetracker.unity3d.com/issues/recording-a-rotation-using-the-rotation-gizmo-resets-the-object-rotation-values-to-180) Animation: Fixed invalid values set in euler angle channels when recording in animation window.
*   \[813410\] Animation: Moving m\_LocalEulerAnglesHint makes all scenes and prefabs appear changed
*   [\[811286\]](https://issuetracker.unity3d.com/issues/optimized-game-object-is-rotated-twice-as-much-as-set) Animation: Optimized game object is rotated twice as much as set
*   [\[808080\]](https://issuetracker.unity3d.com/issues/editor-crashes-when-replacing-prefab-with-alt-button-pressed) Editor: Fixed crash when trying to connect a GameObject to a prefab with no root GameObject set
*   [\[750405\]](https://issuetracker.unity3d.com/issues/shaderuniformarray-osx-weird-errors-appear-in-the-console-when-launching-scene-with-different-uniform-array-shaders) Graphics: Fix invalid RenderSurface assert messages
*   \[812169\] Graphics: Fixed a deadlock when launching a DX11 windows standalone player.
*   [\[812427\]](https://issuetracker.unity3d.com/issues/linux-builds-made-with-windows-and-osx-cannot-be-closed) Linux: Fix crash on player exit
*   [\[812427\]](https://issuetracker.unity3d.com/issues/linux-builds-made-with-windows-and-osx-cannot-be-closed) Linux: Fix default vertex array setup
*   [\[805227\]](https://issuetracker.unity3d.com/issues/particles-particles-render-as-trails-in-5-dot-4) Particles: Particles render as trails in 5.4 when driven by animation
*   [\[804400, 800212\]](https://issuetracker.unity3d.com/issues/editor-wheel-collider-results-in-invalidoperationexception) Physics: Fix broken WheelCollider inspector
*   [\[804864\]](https://issuetracker.unity3d.com/issues/assembly-csharp-firstpass-dot-dll-recompiled-on-saving-a-script-that-does-not-belong-to-it) Scripting: Fixed first pass dll being recompiled when saving a script that does not belong to it
*   [\[813964\]](https://issuetracker.unity3d.com/issues/custom-font-error-when-setting-the-font-size) Text Rendering: Fixed issue in which using a non-dynamic font with scaling would report "Font size and style overrides are only supported for dynamic fonts" errors.
*   [\[812389\]](https://issuetracker.unity3d.com/issues/adding-text-ui-to-screen-space-camera-canvas-render-mode-distorts-rect-transform) UI: Fixed objects in screen space cam canvas being created with a non default size
...
*   [\[803319\]](https://issuetracker.unity3d.com/issues/unity-thinks-finger-is-still-pressed-after-dragging-it-out-of-the-window-and-releasing-it-using-a-touchscreen-device) WindowsStandalone: Fix regression where "touch up" events would be lost when occurring outside window bounds
...
*   [\[813940\]](http://issuetracker.unity3d.com/issues/frame-debugger-game-view-doesnt-show-anything-if-globalfog-script-is-enabled) Editor: The Frame Debugger will stop functioning under some conditions such as some image effects enabled. Try disabling as a workaround. Investigation in progress.
...
*   [\[814501\]](http://issuetracker.unity3d.com/issues/imageeffects-tonemapping-and-color-grading-lut-causes-visual-artifacts-in-builds-unity-5-dot-4) Image Effects: Tonemapping & Color Grading LUT type image effects causes visual artifacts. Investigation is in process.
...
*   [\[799533\]](http://issuetracker.unity3d.com/issues/openvr-entered-playmode-with-unsupported-gfx-api-equals-crash) VR: SteamVR does yet not support DX12. This will be coordinated between SteamVR's schedule and Unity's but unclear as to which cycle it will be part of
