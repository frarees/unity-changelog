...
*   Editor: Fix issue with script compilation not triggering correctly when moving a script from one .asmdef folder to another .asmdef folder. ([1082699](https://issuetracker.unity3d.com/issues/unity-doesnt-recognize-missing-assembly-references-when-moving-a-script-thats-referred-by-others-from-one-assembly-to-another))
...
*   Windows: Improves ExclusiveFullscreen resolution not being set if/when DXGI fails to apply requested resolution. ([1058040](https://issuetracker.unity3d.com/issues/screen-dot-setresolution-width-height-fullscreenmode-disregards-resolution-when-changing-to-exclusivefullscreen), 1084985)
...
*   Video: Copying a WebCamTexture to a Texture2D using Graphics.CopyTexture makes the output image gray ([861946](https://issuetracker.unity3d.com/issues/copying-a-webcamtexture-to-a-texture2d-using-graphics-dot-copytexture-makes-the-output-image-gray))
    
*   Video: Editor crashes on changing "Spatial Setting" for ".webm" formats ([1077664](https://issuetracker.unity3d.com/issues/video-editor-crashes-on-changing-spatial-setting-for-dot-webm-formats))
...
*   Video: The size of a .webm format clip is shortened when imported into Unity ([1079014](https://issuetracker.unity3d.com/issues/video-the-size-of-a-webm-format-clip-is-shortened-when-imported-into-unity))
...
*   Video: WebCamTexture.devices returns empty name string when WebCam name contains special characters ([1054494](https://issuetracker.unity3d.com/issues/webcamtexture-dot-devices-returns-empty-name-string-when-webcam-name-contains-special-characters))
