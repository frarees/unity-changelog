2018.3.0b5 Release Notes
========================

Known Issues in 2018.3.0b5
--------------------------
...
*   IL2CPP: Building Development Build fails on empty project when Script Debugging is enabled and Scripting Backend is IL2CPP. ([1079066](https://issuetracker.unity3d.com/issues/lwrp-slash-vrlw-on-android-ui-images-transparency-doesnt-work))
...
New 2018.3.0b5 Entries Since 2018.3.0b4
---------------------------------------
...
2018.3.0b5 Entries Already Released in 2018.2
---------------------------------------------

### Improvements

*   iOS: Add device generation enums for the new iPhones (XS, XS Max & XR).

### Fixes

*   Asset Import: Fixed crash when importing FBX containing a CameraSwitcher node. ([1083284](https://issuetracker.unity3d.com/issues/unity-freezes-when-importing-a-specific-fbx-file), 1084273)
    
*   Editor: Fix Editor hierarchy and Project windows sometimes displaying red text. ([1078331](https://issuetracker.unity3d.com/issues/ongui-editor-hierarchy-and-project-windows-have-red-text-sometimes), 1083370)
    
*   Editor: Fix label for atlas settings. ([1081361](https://issuetracker.unity3d.com/issues/misleading-info-text-in-spriteatlas-asset), 1084989)
    
*   Editor: Fix two Visual Studio Code windows are opened when opening C# Project or script. ([1065936](https://issuetracker.unity3d.com/issues/two-visual-studio-code-windows-are-opened-when-opening-c-number-project-or-script))
    
*   Editor: Fixed Assert.Ignore() tests do not exit Play Mode. ([1071127](https://issuetracker.unity3d.com/issues/playmode-tests-do-not-exit-play-mode-in-2018-dot-2-versions-of-unity), 1082178)
    
*   Editor: Fixed color picker gradient box colors blown out, and the non-linear alpha channel slider. ([1079791](https://issuetracker.unity3d.com/issues/color-picker-palette-has-graphical-artifacts-when-color-space-is-set-to-linear), 1084955)
    
*   iOS: Do not include CoreLocation framework in the Xcode project if the location API is not used. ([1076345](https://issuetracker.unity3d.com/issues/ios-update-location-service-api-according-to-the-new-app-store-guidelines-apps-will-be-rejected-starting-spring-2019))
    
*   Mobile: Fix Standard shader artifacts on mobiles.
    
*   Physics: Allow Joint2D.breakForce and Joint2D.breakTorque to be set to infinity. ([1065618](https://issuetracker.unity3d.com/issues/invalid-assign-attempt-error-is-thrown-when-trying-to-set-joint2ds-breakforce-and-breaktorque-to-infinity-via-script))
    
*   Physics: Fix a crash when instantiating a prefab containing a 2D collider using a CompositeCollider2D. ([1081979](https://issuetracker.unity3d.com/issues/unity-crashes-when-instantiating-a-prefab-with-box-collider-2d-and-composite-collider-2d))
    
*   Physics: Fix contact callback assertion errors when using multi-threaded 2D physics. ([1042478](https://issuetracker.unity3d.com/issues/multithreaded-physics2d-fires-asserts-related-to-contacts2d))
    
*   Physics: Stop intermittent editor crash when using multi-threaded 2D physics. ([1082697](https://issuetracker.unity3d.com/issues/editor-freezes-and-crashes-after-a-few-moments-after-entering-play-mode-with-use-multithreading-enabled))
    
*   Physics: Stop OnCollisionEnter2D occasionally returning zero normal/tangent impulse when using Continuous Collision Detection mode on a Rigidbody2D. ([1080330](https://issuetracker.unity3d.com/issues/continous-sometimes-relativevelocity-returned-in-oncollisionenter2d-is-zero))
    
*   Physics: Stop OnCollisionEnter2D occasionally returning zero relative-velocity when using Continuous Collision Detection mode on a Rigidbody2D. ([1037965](https://issuetracker.unity3d.com/issues/collision2d-dot-contacts-often-reports-a-normalimpulse-of-0-for-heavy-collisions))
    
*   Prefabs: A Fatal Error is thrown when Overriding the size of a List attribute on a prefab. ([1064206](https://issuetracker.unity3d.com/issues/improved-prefabs-a-fatal-error-is-thrown-when-overriding-the-size-of-a-list-attribute-on-a-prefab), 1082056)
    
*   Prefabs: References lost on PrefabInstances when Library folder deleted and a components cross reference other PrefabInstances. ([1071127](https://issuetracker.unity3d.com/issues/playmode-tests-do-not-exit-play-mode-in-2018-dot-2-versions-of-unity), 1082178)
    
*   ps4: Fix for possible hangs when a job goes idle. (1080738)
    
*   Universal Windows Platform: Addresses unhandled exception when issuing WebRequest with URI consisting of domain name and port. ([1066792](https://issuetracker.unity3d.com/issues/uwp-app-crashes-when-calling-unitywebrequest-dot-sendwebrequest-if-url-contains-domain-name-and-port), 1085149)
    
*   WebGL: Fix for camera viewport rect bug in WebGL with linear color space if it non default. ([957652](https://issuetracker.unity3d.com/issues/webgl-linear-color-space-camera-viewport-rect-problem-in-built-game), 1086916)
...
*   Animation: Fix crash when using the GameObjectRecorder with an invalid EditorCurveBinding. ([1076523](https://issuetracker.unity3d.com/issues/unity-crashes-on-unityengine-animation-getfloatvalue-when-using-gameobjectrecorder-dot-takesnapshot))
    
*   Editor: Fix crash with toplevel checkable menu items (linux). ([994584](https://issuetracker.unity3d.com/issues/linux-editor-crash-in-gtk-menu-get-type-on-menu-dot-setchecked-in-menu-item-validation-function))
    
*   Editor: Fix shortcut assignment for GenericMenu/Timeline. ([1080657](https://issuetracker.unity3d.com/issues/regression-timeline-and-genericmenu-dot-additem-incorectly-add-shortcut-strings-in-the-context-menu))
    
*   Editor: Fixed clutch shortcut stuck if key is released while editor is not in focus.
    
*   Editor: Fixed key repeats to not triggering action and menu shortcuts. ([1082227](https://issuetracker.unity3d.com/issues/keyboard-shortcuts-for-undo-duplicate-and-paste-stop-after-1-time-when-held-down))
    
*   Graphics: Fixed scene view filter rendering to work with scriptable render pipelines. (1078948)
    
*   Physics: Fixed erroneous multi-scene console warning when trying to connect to a disabled Joint2D. (1080424)
    
*   Scripting: Fix random crash in GarbageCollectSharedAssets. ([1078869](https://issuetracker.unity3d.com/issues/editor-crashes-when-opening-a-project))
    

Preview of Final 2018.3.0b5 Release Notes
-----------------------------------------
