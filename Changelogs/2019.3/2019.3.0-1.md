...
-   Windows: Fixes file operations failing because relative path exceeds MAX_PATH ([1115524](https://issuetracker.unity3d.com/issues/file-operations-fail-when-relative-path-is-longer-than-max-path-but-its-absolute-path-is-shorter-than-max-path))
