...
### New 2019.3.0b10 Entries since 2019.3.0b9

#### Fixes

*   Android: 1183674 Fix Android cutout in non fullscreen mode and split view ([1183674](https://issuetracker.unity3d.com/issues/android-screen-dot-safearea-and-screen-dot-cutouts-return-incorrect-values-on-phones-with-notches-when-screen-dot-fullscreen-equals-equals-false))  
...
*   Asset Import: Fixed an issue where BC3 (DXT5) encoded textures showed regressed quality. ([1169679](https://issuetracker.unity3d.com/issues/some-normal-maps-has-ripple-effect-and-appears-to-be-lower-in-quality-when-using-default-compression-settings))  
    _This has been backported and will not be mentioned in final notes._
    
*   Asset Pipeline: Fixed an issue where Unity crashed if a serialized Asset contained a yaml file with a null guid. ([1150392](https://issuetracker.unity3d.com/issues/asset-pipeline-v2-editor-throws-a-fatal-guid-is-uninitialized-error-and-crashes-when-upgrading-the-packages))  
...
*   Editor: Editor crashes when importing Acrocatic asset ([1183117](https://issuetracker.unity3d.com/issues/editor-crashes-when-importing-acrocatic-asset))  
    _This has been backported and will not be mentioned in final notes._
    
*   Editor: Editor: Add support for async method execution in batch mode. ([1146672](https://issuetracker.unity3d.com/issues/executemethod-does-not-await-and-exits-without-completing-when-the-method-is-async))
...
*   Editor: Fixed Command line editor build attempt crashing the process (1193650)  
    _This has been backported and will not be mentioned in final notes._
    
*   Editor: Fixed NullReferenceException caused by null Editor shader after a domain reload ([1183719](https://issuetracker.unity3d.com/issues/windowmanagement-nullreferenceexception-is-thrown-on-changing-scale-factor-of-the-screen-from-windows-display-settings))  
    _This has already been backported to older releases and will not be mentioned in final notes._
    
*   Editor: Fixes a problem in the PersistentManager where it's global state can in some situations become corrupted. ([1178508](https://issuetracker.unity3d.com/issues/assetbundle-the-referenced-script-unknown-on-this-behaviour-is-missing-has-occurred-when-loading-assetbundle))
    
*   Editor: Prevent reloading scripts in playmode when a DPI change occurs (1193597)  
    _This has been backported and will not be mentioned in final notes._
    
*   Editor: Replace scenevis and scene picking icons with N\* versions. (1184020)  
    _This has been backported and will not be mentioned in final notes._
    
*   Editor: Tweaked icons for Prefab Variants and Model Prefabs to be easier to distinguish. ([1170417](https://issuetracker.unity3d.com/issues/scene-management-differentiation-of-icons-is-not-visibly-distinct-of-a-prefab-and-variant-when-they-have-overrides))  
    _This is a change to a 2019.3.0a3 change, not seen in any released version, and will not be mentioned in final notes._
    
*   GI: Fixes Gizmos of LightProbes not drawing when selected.  
    _This has been backported and will not be mentioned in final notes._
...
*   Graphics: VFX Graph are not compiled on Mali GPU, GLSL link error is thrown : Most of Mali on GLES doesn't support SSBO, capability handling has been fixed ([1157002](https://issuetracker.unity3d.com/issues/gles3-lwrp-vfx-graph-are-not-compiled-on-mali-gpu-glsl-link-error-is-thrown))  
    _This is a change to a 2019.3.0?0 change, not seen in any released version, and will not be mentioned in final notes._
    
*   iOS: Screen.dpi returns wrong value for iPhone 11 Pro ([1187030](https://issuetracker.unity3d.com/issues/ios-screen-dot-dpi-returns-wrong-value-for-iphone-11-pro))  
    _This has been backported and will not be mentioned in final notes._
...
*   Mobile: \[iOS\]\[Scripting\]iPhoneSettings and iPhoneUtils members are deprecated, but the class itself is missing the deprecatio ([1148276](https://issuetracker.unity3d.com/issues/ios-scripting-all-iphonesettings-members-are-deprecated-but-the-class-itself-is-missing-the-deprecation-attribute))  
    _This has been backported and will not be mentioned in final notes._
...
*   Physics: Physics: Fix triggers not being able to detect overlap with other triggers ([1180386](https://issuetracker.unity3d.com/issues/two-rigidbody-trigger-colliders-do-not-sent-trigger-messages-on-collision))  
...
*   Scripting: \[MacOS\] Fixed issue where you could not switch to Windowed mode via script when Allow FullScreen option was disabled ([1080571](https://issuetracker.unity3d.com/issues/osx-switching-to-windowed-via-scripting-api-fails-when-allow-fullscreen-switch-is-not-checked))  
    _This has been backported and will not be mentioned in final notes._
...
*   UI Elements: Fix VisualElement.generateVisualContent expecting triangles in a wrong winding order. ([1192509](https://issuetracker.unity3d.com/issues/uielements-mesh-api-uses-wrong-winding-order))  
    _This has been backported and will not be mentioned in final notes._
...
### Preview of Final 2019.3.0b10 Release Notes
...
*   Apple TV: Fixed crash on UnityGetJoystickName when calling GetJoystickNames and disconnecting/connecting controller. ([1181481](https://issuetracker.unity3d.com/issues/crash-on-unitygetjoystickname-when-calling-getjoysticknames-and-disconnecting-slash-connecting-controller))
...
*   Editor: Fixed a crash using SerializedProperty on a Script with managed references after a string resize update ([1189693](https://issuetracker.unity3d.com/issues/crash-when-multi-selecting-visual-scripting-graphs-in-project-window))
...
*   SpeedTree: Fixed SpeedTree rendertype from Opaque to TransparentCutout. ([744984](https://issuetracker.unity3d.com/issues/speedtree-leaves-produce-graphical-artifacts-when-using-ssao-in-forward-rendering-path))
