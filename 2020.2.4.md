...
-   UI Toolkit: Fixed an issue where UQuery: Query would not correctly returns all elements. ([1288531](https://issuetracker.unity3d.com/issues/ui-toolkit-visualelement-dot-query-is-empty-when-querying-for))
