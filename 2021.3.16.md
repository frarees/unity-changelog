...
-   Scripting: When switching to UWP it doesn\'t add NET_STANDARD_2\_0 define, it adds NET_4\_6 instead.([UUM-1694](https://issuetracker.unity3d.com/issues/backport-uwp-not-adding-net-standard-2-0-define))
