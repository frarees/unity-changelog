...
-   Package Manager: Fixed the*package not found*errors when creating a new project while offline. (1056225)

-   Scripting: Added missing 2017_4\_OR_NEWER symbol to 2018.x ([1050962](https://issuetracker.unity3d.com/issues/unity-2017-4-or-newer-preprocessor-is-not-recognised-when-using-number-if-unity-2017-4-or-newer-in-a-script), 1056576)
