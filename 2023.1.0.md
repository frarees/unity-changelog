...
-   HDRP: Fixed missing pragma only_renderers in HDRP compute shaders.([UUM-15114](https://issuetracker.unity3d.com/issues/hdrp-shader-errors-are-thrown-in-the-console-window-when-switching-to-an-unsupported-platform-in-build-settings))
